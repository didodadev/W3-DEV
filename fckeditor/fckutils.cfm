...
function FCKeditor_IsCompatibleBrowser()
{
	...
	if( (find( "msie", sAgent ) or find( "trident", sAgent )) and not find( "mac", sAgent ) and not find( "opera", sAgent ) )
	{
		if(sAgent contains 'msie 10' or  sAgent contains 'trident/7.0')
