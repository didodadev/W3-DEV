...
<cfset parameters_ = createObject("component","WMO.params")>
...
config.baseUrl = "#listGetAt(parameters_.systemParam().fusebox.server_machine_list, 1)#/documents/content/";
...
//ATTENTION: The trailing slash is required.
config.baseDir = "#parameters_.systemParam().download_folder#/documents/content/";
 ...
 */
config.images.maxWidth = 2000;
config.images.maxHeight = 1500;
...
config.resourceType[1].name = 'Belgeler';
...
config.resourceType[1].allowedExtensions = '';
...
config.resourceType[3].allowedExtensions = 'swf';
config.resourceType[3].deniedExtensions = '';

config.resourceType[4] = structNew();
config.resourceType[4].name = 'Media';
config.resourceType[4].url = config.baseUrl & 'media';
config.resourceType[4].directory = config.baseDir & 'media';
config.resourceType[4].maxSize = 0;
config.resourceType[4].allowedExtensions = 'mp4,webm,ogg,flv,f4v';
