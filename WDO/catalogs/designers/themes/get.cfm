            ...
            <div class="row">
                <div class="ui-card">
                    <div class="ui-card-item">
                        <p>Aşağıdaki dosya ekleme alanını kullanarak Tema bileşenlerinizi ekleyebilirsiniz.</p>
                        ...
                        <p>Ekleyeceğiniz zip dosyası Tema ile aynı isme sahip olmalı ve boşluk, Türkçe karakter vb içermemelidir.</p>
                        <p>Zip dosyası içerisinde Tema ile aynı isme sahip bir klasör olmalı ve tüm bileşenler bu klasör içerisinde toplanmalıdır.</p>
