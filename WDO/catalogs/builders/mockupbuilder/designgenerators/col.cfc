    ...
    <cffunction name="generate" access="public" returntype="string">
        ...
        <cfscript>
            ...
            for (field in this.data.listOfElements) {
                ...
                fgwidget = createObject("component", "WDO.catalogs.builders.mockupbuilder.designgenerators#extends#.formgroup").init( data:field, domain:this.domain, identcount:this.identcount + 1, elementgroup:this.elementgroup, eventtype:this.eventtype );
