<cfcomponent extends="WDO.catalogs.builders.mockupbuilder.mockup">
    ...
    <cffunction name="generate" access="public" returntype="string">
        ...
        <cfscript>
            ...
            boxwidget = createObject("component", "WDO.catalogs.builders.mockupbuilder.designgenerators.blocks.boxwidget").init(this.data, this.domain, this.eventtype, this.identcount);
            container = boxwidget.generate();
            tblwidget = createObject("component", "WDO.catalogs.builders.mockupbuilder.designgenerators.blocks.tablewidget").init(this.data, this.domain, this.eventtype, this.identcount + 1);
