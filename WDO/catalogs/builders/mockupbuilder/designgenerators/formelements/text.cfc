    ...
    <cffunction name="generate" access="public" returntype="string">
        ...
        <cfscript>
            ...
            */
            ...
            result = iif(len(precodeList), DE(precodeList & crlf() & ident()), DE("")) & super.stringFormat(template, [ stck.name & "_" & element.label, attrVal, valueformat]);
