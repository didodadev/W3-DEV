    ...
    <cffunction name="generate" access="public" returntype="string">
        <cfscript>
            ...
            for ( fkey in structKeyArray( this.data ) ) {
                ...
                fgwidget = createObject("component", "WDO.catalogs.builders.widgetbuilder.designgenerators.graph.formgroupwidget").init( data: element, domain: this.domain, identcount: this.identcount + 1, elementgroup: this.elementgroup, eventtype: this.eventtype );
