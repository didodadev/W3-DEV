    ...
    <cffunction name="generate" access="public" returntype="string">
        <cfscript>
            ...
            if ( element.fieldType eq "hidden input" ) {
                inputwidget = createObject("component", "WDO.catalogs.builders.widgetbuilder.designgenerators.inputfactory").create( type:element.fieldType, data:this.data, domain:this.domain, ident:this.identcount + 1, eventtype:this.eventtype );
