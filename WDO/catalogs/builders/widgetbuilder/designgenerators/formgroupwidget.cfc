    ...
    <cffunction name="generateelements" access="public" returntype="string">
        ...
        <cfscript>
            ...
            else if (arguments.element.fieldType eq "button")
            {
                ...
                buttonwidget = createObject("component", "WDO.catalogs.builders.widgetbuilder.designgenerators.formelements.buttonwidget").init( this.data, this.domain, this.eventtype, this.identcount + 1 );
