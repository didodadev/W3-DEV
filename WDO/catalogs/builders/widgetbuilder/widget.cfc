...
<cfcomponent>
    ...
    <cffunction name="getWidgetDependencyManager">
        <cfreturn createObject("component", "WDO.catalogs.objectResolver").init().resolveByRequest( namespace:"WDO.catalogs.builders.widgetbuilder.widgetdependencies", hasInit:1 )>
    </cffunction>

    <cffunction name="getWidgetComponent">
        <cfreturn createObject("component", "WDO.catalogs.objectResolver").init().resolveByRequest(namespace:"WDO.catalogs.builders.widgetbuilder.widgetcomponents")>
    </cffunction>
