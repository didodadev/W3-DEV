...
<cftry>
	...
	<cfset result = cmpLibrary.addData(
...
<script type="text/javascript">
	window.location.href = '<cfoutput>#request.self#?fuseaction=dev.data_import_library&event=upd&data_import_id=#result.IdentityCol#</cfoutput>';
</script>