...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" height="35">
  <tr>
    <td class="headbold"><cf_get_lang_main no='152.�r�nler'></td>
    ...
    <td>
      <table cellpadding="2" cellspacing="1" border="0" width="100%" align="center">
        <tr class="color-header" height="22">
			<td width="150" class="form-title"><cf_get_lang_main no ='106.Stok Kodu'></td>
			<td class="form-title"><cf_get_lang_main no ='245.�r�n'></td>
			<td class="form-title" width="75"><cf_get_lang no ='317.Ana Birim'></td>
			<td class="form-title" width="150"><cf_get_lang_main no='1736.Tedarik�i'></td>
        </tr>
