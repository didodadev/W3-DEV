<cfcomponent>
    ...
    <cfproperty name="ConfigurationService" type="workcube.WMO.Services.ApplicationConfigurationService">
    ...
    <cffunction name="initialize" access="public">
        ...
        <cfset this.Services = {}>
        <cfset this.ConfigurationService = new workcube.WMO.Services.ApplicationConfigurationService( this.ApplicationVariableScope )>
    </cffunction>
