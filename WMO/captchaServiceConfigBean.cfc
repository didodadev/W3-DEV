...
$Id: captchaServiceConfigBean.cfc 6064 2007-05-18 16:59:50Z pfarrell $
--->
<cfcomponent
	...
	<cffunction name="setMemento" access="public" returntype="captchaServiceConfigBean" output="false">
		...
		<cfset StructAppend(variables.instance, arguments.memento, true) />
		<cfreturn this />
	</cffunction>
	...
	ACCESSORS
	--->
	<cffunction name="setOutputDirectory" access="public" returntype="void" output="false">
	...
	<cffunction name="setOutputDirectoryIsRelative" access="public" returntype="void" output="false">
	...
	<cffunction name="setHashValidPeriod" access="public" returntype="void" output="false">
	...
	<cffunction name="setJpegQuality" access="public" returntype="void" output="false">
	...
	<cffunction name="setJpegUseBaseline" access="public" returntype="void" output="false">
	...
	<cffunction name="setUseAntiAlias" access="public" returntype="void" output="false">
	...
	<cffunction name="setRandStrType" access="public" returntype="void" output="false">
	...
	<cffunction name="setRandStrLen" access="public" returntype="void" output="false">
	...
	<cffunction name="setFontsize" access="public" returntype="void" output="false">
	...
	<cffunction name="setLeftOffset" access="public" returntype="void" output="false">
	...
	<cffunction name="setShearXRange" access="public" returntype="void" output="false">
	...
	<cffunction name="setShearYRange" access="public" returntype="void" output="false">
	...
	<cffunction name="setFontColor" access="public" returntype="void" output="false">
	...
	<cffunction name="setUseGradientBackground" access="public" returntype="void" output="false">
	...
	<cffunction name="setBackgroundColorUseCyclic" access="public" returntype="void" output="false">
	...
	<cffunction name="setUseOvals" access="public" returntype="void" output="false">
	...
	<cffunction name="setOvalColor" access="public" returntype="void" output="false">
	...
	<cffunction name="setOvalUseTransparency" access="public" returntype="void" output="false">
	...
	<cffunction name="setMinOvals" access="public" returntype="void" output="false">
	...
	<cffunction name="setMaxOvals" access="public" returntype="void" output="false">
	...
	<cffunction name="setUseBackgroundLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setBackgroundLineColor" access="public" returntype="void" output="false">
	...
	<cffunction name="setBackgroundLineUseTransparency" access="public" returntype="void" output="false">
	...
	<cffunction name="setBackgroundMinLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setBackgroundMaxLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setUseForegroundLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setForegroundlineColor" access="public" returntype="void" output="false">
	...
	<cffunction name="setForegroundLineUseTransparency" access="public" returntype="void" output="false">
	...
	<cffunction name="setForegroundMinLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setForegroundMaxLines" access="public" returntype="void" output="false">
	...
	<cffunction name="setDefinedFonts" access="public" returntype="void" output="false">
