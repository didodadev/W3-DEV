...
<cfif not isDefined("attributes.barcode")>
	<cfset caller.errors = "<cfoutput>#caller.lang_array_main.item [2178]#</cfoutput>!">
	<cfexit method="exittemplate">
</cfif>
<cfif len(attributes.barcode) gt 13>
	<cfset caller.errors = "<cfoutput>#caller.lang_array_main.item [1679]#</cfoutput> !">
	<cfexit method="exittemplate">
</cfif>
<cfif not isDefined("attributes.type")>
	<cfset caller.errors = "<cfoutput>#caller.lang_array_main.item [1449]#</cfoutput>!">
	<cfexit method="exittemplate">
</cfif>
<cfif not ListFindNoCase('EAN13,EAN8', attributes.type, ',')>
	<cfset caller.errors = "<cfoutput>#caller.lang_array_main.item [2179]#</cfoutput> ! _<cfoutput>#attributes.type#</cfoutput>_">
	<cfexit method="exittemplate">
</cfif>
