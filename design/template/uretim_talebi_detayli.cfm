...
<cfloop list="#liste#" index="i">
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width:210mm;height:260mm;">
        ...
        <tr valign="top">
            <td style="width:25mm;height:15mm;"><!--- <cfif len(CHECK.asset_file_name3)><cfoutput><img src="#user_domain##file_web_path#settings/#CHECK.asset_file_name3#" border="0"></cfoutput></cfif> ---></td>
            <td class="headbold"><strong><cf_get_lang no="932.Üretim Talebi"></strong></td>
        </tr>
        <tr valign="top">
            ...
            <table border="0" style="width:200mm;">
                <tr>
                    <td style="width:24mm;" class="txtbold"><cf_get_lang_main no='44.Üretim'><cf_get_lang_main no='75.No'></td>
                    <td style="width:100mm;">:&nbsp; #get_det_po.p_order_no#</td>
                    <td class="txtbold" style="width:15mm;"><cf_get_lang_main no='1055.Başlama'></td>
                ...
                <tr>
                    <td class="txtbold"><cf_get_lang_main no='799.Sipariş No'></td>
                    <td>:&nbsp; #SIPARIS_NO#</td>
                ...
                <tr>
                    ...
                    <td>:&nbsp; <cfif len(get_det_project.project_id)>#get_det_project.PROJECT_HEAD#</cfif></td>
                </tr>
                <tr>
                    <td class="txtbold"><cf_get_lang no='1776.Satış Çalışan'></td>
                    <td>:&nbsp; #satis_calisani#</td>
                    <td class="txtbold">&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="txtbold"><cf_get_lang_main no='1422.İstasyon'></td>
        ...
        <tr valign="top">
            ...
            <table border="0" style="width:180mm;">
                ...
                <tr class="color-list">
                    <td class="txtbold" style="width:25mm; height:6mm;"><cf_get_lang_main no='106.Stok Kodu'></td>
                    <td class="txtbold" style="width:80mm;"><cf_get_lang_main no='245.Ürün'></td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang_main no='235.Spec'>ID</td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang no='1531.Spec Adı'></td>
                    <td class="txtbold" style="width:15mm;" style="text-align:right;"><cf_get_lang_main no='223.Miktar'></td>
                </tr>
                <cfoutput>
                <tr>
            ...
            <table border="1" style="width:180mm;" cellpadding="5" cellspacing="0">
                <tr>
                    <td colspan="7" class="txtbold"><cf_get_lang no='1224.Ürün Özellikleri'></td>
                </tr>
                <tr class="color-list">
                    <td class="txtbold" style="width:30mm;"><cf_get_lang_main no='220.Özellik'></td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang no='1225.Varyasyon'></td>	
                    <td class="txtbold" style="width:40mm;" style="text-align:right;"><cf_get_lang_main no='217.Açıklama'></td>
                    <td class="txtbold" style="width:20mm;">En</td>	
                    <td class="txtbold" style="width:20mm;">Boy</td>	
                    <td class="txtbold" style="width:20mm;">Alan</td>	
                    <td class="txtbold" style="width:20mm;">Çevre</td>
                </tr> 
            ...
            <cfif isdefined("get_det_po.spect_var_id") and len(get_det_po.spect_var_id)>
                ...
                <tr>
                    <td class="txtbold" colspan="5"><cf_get_lang_main no='235.Spec'>: <cfoutput>#Get_spect_name.product_name# #Get_spect_name.property#</cfoutput></td>
                </tr>
                <tr class="color-list">
                    <td class="txtbold" style="width:25mm; height:6mm;"><cf_get_lang_main no='106.Stok Kodu'></td>
                    <td class="txtbold" style="width:80mm;"><cf_get_lang_main no='245.Ürün'></td>
            ...
            <cfelseif isdefined("get_det_po.is_production") and len(get_det_po.is_production)>
                ...
                <tr>
                    <td class="txtbold" colspan="5">Ürün Ağacı:</td>
                </tr>
                <tr class="color-list">
                    <td class="txtbold" style="width:25mm; height:6mm;"><cf_get_lang_main no='106.Stok Kodu'></td>
                    <td class="txtbold" style="width:80mm;"><cf_get_lang_main no='245.Ürün'></td>
        ...
        <tr>
            ...
            <table border="1" width="100%" cellpadding="5" cellspacing="0">
                <cfoutput>
                <tr>
                    <td style="width:30mm;"><b><cf_get_lang no="930.Sevkiyat Bilgileri"></b></td>
                    <td><b><cf_get_lang_main no='1195.Firma'>:</b> <cfif isdefined("get_or_num.company_id")and len(get_or_num.company_id)>#get_par_info(get_or_num.company_id,1,1,0)#</cfif>
                        <br/><br/>
                        <b><cf_get_lang_main no='166.Yetkili'>:</b> <cfif isdefined("get_or_num.PARTNER_ID") and len(get_or_num.PARTNER_ID)>#get_par_info(get_or_num.PARTNER_ID,0,-1,0)#</cfif>
                        <br/><br/>
                        <b><cf_get_lang_main no='1311.Adres'>:</b> <cfif isdefined("get_or_num.SHIP_ADDRESS") and len(get_or_num.SHIP_ADDRESS)>#get_or_num.SHIP_ADDRESS#</cfif>
                        <br/><br/>
                        <b><cf_get_lang_main no='87.Telefon'>:</b> <cfif isdefined("get_partner.COMPANY_PARTNER_TEL") and len(get_partner.COMPANY_PARTNER_TEL) and isdefined("get_partner.COMPANY_PARTNER_TELCODE") and len(get_partner.COMPANY_PARTNER_TELCODE)>(#get_partner.COMPANY_PARTNER_TELCODE#)  #get_partner.COMPANY_PARTNER_TEL#</cfif>
                        <br/><br/>
                    </td>
                </tr>
                <tr>
                    <td><b><cf_get_lang no="931.Teslimat Şekli"></b></td>
        ...
        <tr>
            <td>
                <cfoutput query="CHECK">
                    ...
                    #CHECK.address#<br/>
                    <b><cf_get_lang_main no='87.Telefon'>:</b> (#CHECK.tel_code#) - #CHECK.tel#,#CHECK.tel2#<br/>
                    <b><cf_get_lang_main no='75.Fax'>:</b> (#CHECK.tel_code#) #CHECK.fax#<br/>
