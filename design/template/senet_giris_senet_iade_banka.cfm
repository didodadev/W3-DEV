...
<div align="center">
	...
	<tr>
		<td align="center" class="formbold">
			...
			<cfif isdefined("attributes.type")>
				<cfif attributes.type eq 97>
					<cfoutput><b><cf_get_lang_main no='598.Senet Giriş Bordrosu'></b></cfoutput>
					<cfset cumle = 'Senet Alınmıştır'>
				<cfelseif attributes.type eq 108>
					<cfoutput><b><cf_get_lang_main no='1509.Senet Giriş İade Bordrosu'></b></cfoutput>
					<cfset cumle = 'Senet İade Edilmiştir'>
				<cfelseif attributes.type eq 109>
					<cfoutput><b><cf_get_lang_main no='1510.Senet Giriş İade Bordrosu(Banka)'></b></cfoutput>
    ...
    <tr>
      <td height="50" colspan="2">
		...
		<cfelseif len(get_action_detail.CONSUMER_ID)>
			<cfoutput><strong>#get_cons_info(get_action_detail.CONSUMER_ID,0,0,0)#</strong></cfoutput>
        </cfif>
		...
		<cfif listlen(list_senet) neq 1 or list_senet is session.ep.money>
			...
			<cf_n2txt number="myNumber" para_birimi="#get_action_detail.CURRENCY_ID#"><cfoutput><strong>#myNumber#</strong> #cumle#</cfoutput> <cf_get_lang no="829.senet alınmıştır">.
		<cfelseif listlen(list_senet) eq 1 and not list_senet is session.ep.money>
			<cfset myNumber = senet_toplam>
			<cf_n2txt number="myNumber" para_birimi="#list_senet#"><cfoutput><strong>#myNumber#</strong> #cumle#</cfoutput> <cf_get_lang no="829.senet alınmıştır">.
		</cfif>
      </td>
    </tr>
  </table>
  ...
  <table width="650">
	...
	<tr>
		<td>
			<table>
				<tr><td height="26" colspan="2" style="height:4mm;">&nbsp;</td></tr>
				<tr>
					<td style="height:5mm;"><strong><cf_get_lang_main no="890.Toplam"> <cf_get_lang_main no="596.Senet"></strong></td>
				...
				<tr>
					...
					<td><strong>:</strong>&nbsp;&nbsp;&nbsp;<cfoutput>#dateformat(get_action_detail.payroll_avg_duedate,'dd/mm/yy')#</cfoutput></td>
				</tr>
				<cfoutput>
