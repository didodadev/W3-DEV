...
<cfloop list="#liste#" index="i">
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width:210mm;height:260mm;">
        ...
        <tr valign="top">
            ...
            <td class="headbold"><strong><cf_get_lang no="602.Üretim Emri"></strong></td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
            ...
            <table border="0" style="width:180mm;">
                ...
                <tr>
                    <td class="txtbold" colspan="5"><cf_get_lang_main no='2212.Sarflar'></td>
                </tr>
                <tr class="color-list">
                    <td class="txtbold" style="width:25mm; height:6mm;"><cf_get_lang_main no='106.Stok Kodu'></td>
                    <td class="txtbold" style="width:80mm;"><cf_get_lang_main no='245.Ürün'></td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang_main no='235.Spec'>ID</td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang no='1531.Spec Adı'></td>
                    <td class="txtbold" style="width:20mm;"><cf_get_lang no='385.Lot No'></td>
                    <td class="txtbold" style="width:15mm;" style="text-align:right;"><cf_get_lang_main no='223.Miktar'></td>
                    <th class="txtbold" style="width:15mm;"><cf_get_lang_main no='224.Birim'></th>
                </tr>
