...
<table cellpadding="1" cellspacing="2" border="0" style="width:190mm;">
	<tr>
    	<td rowspan="40" style="width:5mm;">&nbsp;</td><!--- sol Boşluk --->
        <td style="height:30mm">&nbsp;</td><!--- Üst Boşluk --->
    </tr>
    <tr>
    	<td>
        	<table border="0" width="100%">
                ...
                <tr>
                	<td>
                    	<table border="0">
                        	<tr>
                                <td><strong><cf_get_lang_main no='649.Cari'>:&nbsp;</strong></td>
                                <td><cfif len(get_invoice_close.company_id)><strong>#get_par_info(get_invoice_close.company_id,1,1,0)#</strong><cfelse><strong>#get_cons_info(get_invoice_close.consumer_id,0,0)#</strong></cfif></td>
                            </tr>
                            <tr>
                            	<td>&nbsp;</td>
                                <td><cfif len(get_invoice_close.company_id) and len(get_comp_information.company_address)><strong>#get_comp_information.company_address# &nbsp; #get_comp_information.semt#</strong><cfelse>&nbsp;</cfif></td>
                            </tr>
                            <tr>
                            	<td>&nbsp;</td>
                                <td><strong><cfif len(get_invoice_close.company_id) and len(get_comp_information.country)>#ilce#</cfif> &nbsp;<cfif len(get_invoice_close.company_id) and len(get_comp_information.city)>/#sehir#</cfif></strong></td>
                            </tr>
                            <tr>
                            	<td><strong><cf_get_lang_main no='1104.Ödeme Yöntemi'> :&nbsp;</strong></td>
                                <td><cfif len(get_invoice_close.paymethod_id)><strong>#GET_PAYM.PAYMETHOD#</strong></cfif></td>
                            </tr>
                        </table>
                    </td>
                    <td style="text-align:right;">
                    	<table border="0">
                        	<tr>
                            	<td><strong><cf_get_lang_main no='330.Tarih'> :&nbsp; </strong></td>
                                <td><strong>#dateformat(get_invoice_close.PAPER_ACTION_DATE,dateformat_style)#</strong></td>
                            </tr>
                            <tr>
                            	<td><strong><cf_get_lang_main no='449.Ortalama Vade'> :&nbsp;</strong></td>
                                <td><strong>#dateformat(get_invoice_close.PAPER_DUE_DATE,dateformat_style)#</strong></td>
                            </tr>
                             <tr>
                            	<td><strong><cf_get_lang no='265.Ödeme Emri'><cf_get_lang_main no='75.No'> :&nbsp;</strong></td>
                                <td><strong>#attributes.action_id#</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                	<td style="height:10mm;" colspan="13">&nbsp;</td>
                </tr>
                </cfoutput>
                <tr style="height:130mm;" valign="top">
                	<td colspan="2">
                    	<table align="center" width="100%" border="0">
                            <tr bgcolor="CCCCCC">
                            	<td class="formbold" rowspan="2" style="width:12mm;" align="center" nowrap="nowrap"><cf_get_lang_main no='468.Belge No'></td>
                                <td class="formbold" rowspan="2" style="width:15mm;" align="center"><cf_get_lang_main no='388.İşlem Tipi'></td>
                                <td class="formbold" rowspan="2" style="width:15mm;" align="center"><cf_get_lang_main no='467.İşlem Tarihi'></td>
                                <td class="formbold" rowspan="2" style="width:9mm;" align="center"><cf_get_lang_main no='228.Vade'></td>
                                <td class="formbold" rowspan="2" style="width:12mm;" align="center"><cf_get_lang_main no='469.Vade Tarihi'></td>
                                <td class="formbold" colspan="2" style="width:30mm;" align="center"><cf_get_lang_main no='1511.Belge Tutari'></td>
                                <td class="formbold" colspan="2"  style="width:30mm;" align="center"><cf_get_lang no='65.Kapanmış Tutar'></td>
                                 <cfif attributes.action_type eq 3><td class="formbold" colspan="2" style="width:30mm;" align="center"><cf_get_lang_main no='115.Talepler'></td></cfif>
                                 <cfif attributes.action_type eq 2><td class="formbold" colspan="2"  style="width:30mm;" align="center"><cf_get_lang_main no='116.Emirler'></td></cfif>
                                 <td class="formbold" style="width:30mm;" align="center" colspan="2" ><cfif attributes.action_type eq 1><cf_get_lang no='25.Kapama'><cfelseif attributes.action_type eq 2><cf_get_lang no='17.Talep'><cfelseif attributes.action_type eq 3><cf_get_lang no='24.Emir'></cfif></td>
                            </tr>
                          <cfoutput>
                            <tr bgcolor="CCCCCC">
                                <td class="formbold" align="center">#session.ep.money#<cf_get_lang_main no='261.Tutar'></td> 
                                <td class="formbold"  align="center"><cf_get_lang_main no ='470.İşlem Tutar'></td>
                           ...
                           <cfoutput query="GET_CARI_CLOSED">
                                ...
                                <tr>
                                    <td style="width:9mm;"><cfif len(paper_no)>#paper_no#<cfelse>&nbsp;</cfif></td>
                                    <td align="center"><cfif len(action_name)>#action_name#<cfelse>&nbsp;</cfif></td>
                                    <td nowrap align="center">#dateformat(action_date,dateformat_style)#</td>
                                    <td align="center"><cfif len(get_cari_closed.due_date)>#datediff("d",action_date, get_cari_closed.due_date)#<cfelse>0</cfif></td>
                                    <td nowrap align="center">#dateformat(get_cari_closed.due_date ,dateformat_style)#</td>
                                    <td nowrap align="center">#TLFormat(get_cari_closed.CR_ACTION_VALUE)#&nbsp;#session.ep.money#</td>
                                    <td nowrap align="center"><cfif len(other_cash_act_value)>#TLFormat(other_cash_act_value)#&nbsp;#other_money#</cfif></td>
                                    <td align="center" nowrap>#TLFormat(get_all_action.CLOSED_AMOUNT)#&nbsp;#session.ep.money#</td>
                                    <td align="center" nowrap>#TLFormat(get_all_action.OTHER_CLOSED_AMOUNT)# #I_OTHER_MONEY#</td>
                                    <cfif attributes.action_type eq 3>
                                        <td nowrap align="center">#TLFormat(get_all_action.PAYMENT_VALUE)#&nbsp;#session.ep.money#</td>
                                        <td  nowrap align="center">#TLFormat(get_all_action.OTHER_PAYMENT_VALUE)# #I_OTHER_MONEY#</td>
                                    </cfif>
                                    <cfif attributes.action_type eq 2>
                                        <td nowrap align="center">#TLFormat(get_all_action.P_ORDER_VALUE)#&nbsp;#session.ep.money#</td>
                                        <td nowrap align="center">#TLFormat(get_all_action.OTHER_P_ORDER_VALUE)# #I_OTHER_MONEY#</td>
                                     </cfif>
                                     <td nowrap align="center">#TLFormat(closed_amount)#</td>
                                     <td nowrap align="center">#tlformat(OTHER_CLOSED_AMOUNT)#</td>
                                </tr>
                            </cfoutput>
                                <tr>
                                    <td colspan="13">&nbsp;</td>
                ...
                <tr>
                    <td style="text-align:right;" colspan="13">
                        <table border="0">
                           ...
                           <tr>
                                <td style="width:30mm;" style="text-align:right;"><strong><cf_get_lang no='69.Borç Toplamı'></strong></td>
                                <td style="width:30mm;" style="text-align:right;"><cfoutput><strong>#TLFormat(get_invoice_close.debt_amount_value)#</strong></cfoutput></td>
                               
                            </tr>
                            <tr>
                                <td style="text-align:right;"><strong><cf_get_lang no='70.Alacak Toplamı'></strong></td>
                                <td style="text-align:right;"><cfoutput><strong>#TLFormat(get_invoice_close.claim_amount_value)#</strong></cfoutput></td>
                            </tr>
                           </cfif>
                           <cfif (len(GET_CARI_CLOSED.from_cmp_id) and len(get_invoice_close.company_id) and GET_CARI_CLOSED.from_cmp_id eq get_invoice_close.company_id) or (len(GET_CARI_CLOSED.from_consumer_id) and len(get_invoice_close.consumer_id) and GET_CARI_CLOSED.from_consumer_id eq get_invoice_close.consumer_id)>
                            <tr>
                                <td style="text-align:right;"><strong><cfif attributes.action_type eq 1><cf_get_lang no='25.Kapama'><cfelseif attributes.action_type eq 2><cf_get_lang no='17.Talep'><cfelseif attributes.action_type eq 3><cf_get_lang no='24.Emir'></cfif><cf_get_lang no='66.Tutarı'></strong></td>
                                <td style="text-align:right;"><cfoutput><strong>#TLFormat(get_invoice_close.difference_amount_value)#</strong></cfoutput></td>
                            </tr>
							<cfelse>
                             <tr>
                                <td style="text-align:right;"><strong><cfif attributes.action_type eq 1><cf_get_lang no='25.Kapama'><cfelseif attributes.action_type eq 2><cf_get_lang no='17.Talep'><cfelseif attributes.action_type eq 3><cf_get_lang no='24.Emir'></cfif><cf_get_lang no='66.Tutarı'></strong></td>
                ...
                <tr>
                    <td colspan="3">
                        <table border="0">
                            <tr>
                                <td style="width:30mm;"><strong><cf_get_lang_main no='71.Kayıt'></strong></td>
                                <td><cfoutput><strong>#get_emp_info(get_invoice_close.record_emp,0,0)#</strong></cfoutput></td>
                            </tr>
                        </table>
                    </td>
                </tr>
