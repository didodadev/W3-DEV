...
<cfquery name="GET_DETAIL" datasource="#dsn3#">
	...
	WHERE
		...
		PRODUCTION_ORDER_RESULTS.PR_ORDER_ID = #attributes.action_id# AND
...
<cfquery name="GET_FIS" datasource="#dsn2#">
	SELECT FIS_NUMBER,FIS_TYPE,FIS_ID,FIS_DATE FROM STOCK_FIS WHERE PROD_ORDER_NUMBER = #attributes.action_id# AND PROCESS_CAT = #GET_CAT.PROCESS_CAT_ID#
</cfquery>
<cfquery name="get_stock_info" datasource="#dsn3#">
	SELECT STOCK_CODE,PRODUCT_NAME,PROPERTY FROM STOCKS WHERE STOCK_ID = #GET_ROW_ENTER.stock_id# 
</cfquery>
...
<cfquery name="GET_SERIAL_INFO" datasource="#DSN3#">
	...
	WHERE
		STOCK_ID = #GET_ROW_ENTER.stock_id# AND
		PROCESS_ID = #attributes.action_id# AND
		PROCESS_CAT = 171 AND
		...
		<td style="height:87.5mm;" align="center" valign="top">			
			<table width="98%" align="center">
                ...
                <tr>
                    ...
                    <td><cf_get_lang no='83.Üretim Tarihi'></td>
