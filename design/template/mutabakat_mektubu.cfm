		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>&nbsp;</td>
                        <td style="text-align:right" class="txtbold"><cfoutput><cf_get_lang dictionary_id='57742.Tarih'>: #dateformat(now(),dateformat_style)#</cfoutput><br/></td>
                    </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <cfoutput>
                            ...
                            <cf_get_lang dictionary_id='58762.Vergi Dairesi'>: #get_comp_name.taxoffice# - <cf_get_lang dictionary_id='57752.Vergi No'> : <cfif len(get_comp_name.taxno)>#get_comp_name.taxno#<cfelse>#get_comp_name.tc_identy_no#</cfif><br/>
                            <cf_get_lang dictionary_id='57499.Tel'> : <cfif Len(get_comp_name.company_tel1)>#get_comp_name.company_telcode# #get_comp_name.company_tel1#</cfif> - <cf_get_lang dictionary_id='57488.Fax'> : #get_comp_name.company_fax#
                        </cfoutput><br/>
                        </td>
                    </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cf_get_lang dictionary_id="33286.Nezdimizdeki Cari Hesabınız"> <strong>&nbsp;#tarih_#&nbsp;</strong> <cf_get_lang dictionary_id="33287.tarihi itibari ile"> 
                       <strong>#TLFormat(ABS(get_comp.bakiye))# #mybirim# (#myNumber#)<cfif BORC gt ALACAK><cf_get_lang dictionary_id="57587.Borç"><cfelseif BORC lt ALACAK><cf_get_lang dictionary_id="57588.Alacak"></cfif></strong>
                        <cf_get_lang dictionary_id="33290.bakiye göstermektedir">.<br/>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
						...
						<cfoutput query="get_our_company_info">
							...
							2-) <cf_get_lang dictionary_id='30411.Bakiyede mutabık olmadığınız takdirde hesap ekstrenizi aşağıda belirtilen faks numaralarına veya mail adresine göndermenizi rica ederiz'>
								 #tel_code# #fax# #email# <br/>
                        </cfoutput>
                        </td>
                    </tr>
                </table><br/><hr>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>&nbsp;</td>
                        <td style="text-align:right" class="txtbold"><cfoutput><cf_get_lang dictionary_id='57742.Tarih'>: #dateformat(now(),dateformat_style)#</cfoutput></td>
                    </tr>
                    <tr>
                        <td valign="top"><cf_get_lang dictionary_id='58780.Sayın'>,&nbsp;</td>
                        <td>       
                            <cfoutput query="get_our_company_info">
                                <strong>#company_name#</strong><br/>
                                #address#<br/>
                                <cf_get_lang dictionary_id='58762.Vergi Dairesi'> / <cf_get_lang dictionary_id='57487.No'>: #tax_office# - #tax_no#<br/>
                                <cf_get_lang dictionary_id='57499.Tel'>: <cfif Len(tel) or Len(tel2)>(#tel_code#) #tel# - #tel2#</cfif> - <cf_get_lang dictionary_id='57488.Fax'>: (#tel_code#) #fax# - #fax2#</p>
                                <br/><br/>
