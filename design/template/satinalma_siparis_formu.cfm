...
<table border="0" cellspacing="0" cellpadding="0" style="width:200mm;height:287mm;">
    ...
    <tr valign="top">
        <td valign="top">
                ...
                <tr height="16">
                    <cfoutput query="our_company">
                        ...
                        <td style="text-align:right;">
                            <b>#company_name#</b><br/>
                            #address#<br/>
                            <cf_get_lang dictionary_id='57499.Telefon'>: #tel_code# #tel#<br/>
                            <cf_get_lang dictionary_id='57488.Fax'>: #tel_code# #fax#<br/>
                            #web#&nbsp;&nbsp;#email#
                        </td>
                    </cfoutput>
                </tr>
			...
			<cfoutput>
                <tr>
                    <td width="35%" bgcolor="000000"><font color="FFFFFF" size="3"><cf_get_lang dictionary_id="30008.SATINALMA SİPARİŞ"></font></td>
                    <td style="text-align:left;width:45mm;"><b><cf_get_lang dictionary_id='57880.Belge No'> :</b> #Get_Order.Order_Number#</td>
			...
			<cfoutput>
                ...
                <tr style="height:7mm;">
                    ...
                    <td style="width:30mm;" class="txtbold"><cf_get_lang dictionary_id='58796.Sipariş Veren'></td>
                    <td style="width:70mm;">:
    ...
    <tr valign="top">
        <td>
            <table border="0" cellspacing="0" cellpadding="0" style="width:180mm;">
                <tr bgcolor="CCCCCC">
                    <td class="bold"><cf_get_lang dictionary_id='58585.KOD'></td>
                    <td class="bold"><cf_get_lang dictionary_id='57629.Açıklama'></td>
                    <td class="bold" width="60" style="text-align:right;"><cf_get_lang dictionary_id='57635.Miktar'></td>
                    <td class="bold" style="text-align:right;"><cf_get_lang dictionary_id='34079.Net Fiyat'></td>
                    <td class="bold" style="text-align:right;"><cf_get_lang dictionary_id='57492.Toplam'></td>
                </tr>
    ...
    <tr valign="top">
        <td>
            <table border="0" cellpadding="0" cellspacing="0" align="left">
                <cfoutput>
                    <tr style="height:7mm;">
                        <td style="width:15mm;" class="txtbold"><cf_get_lang dictionary_id='57422.Notlar'> :</td>
			...
			<cfoutput>
                <tr>
                    <td width="100"><cf_get_lang dictionary_id="57565.Ara"> <cf_get_lang dictionary_id="57492.Toplam"></td>
                ...
                <tr>
                    <td><cf_get_lang dictionary_id="33304.Vergi"></td>
    ...
    <tr>
        <td>
            ...
            <cfoutput>
                ...
                <tr style="height:7mm;">
                    <td class="txtbold"><cf_get_lang dictionary_id="33306.ONAYLAR"></td>
                </tr>
                <tr style="height:7mm;">
                    <td style="width:50mm;" class="txtbold"><cf_get_lang dictionary_id='29511.YÖNETİCİ'><cf_get_lang dictionary_id='57500.ONAY'></td>
                    <td style="width:50mm;" class="txtbold"><cf_get_lang dictionary_id='29511.YÖNETİCİ'><cf_get_lang dictionary_id='57500.ONAY'></td>
                </tr>
                <tr style="height:7mm;">
