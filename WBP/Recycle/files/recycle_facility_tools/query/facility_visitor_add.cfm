...
<cftransaction>
    ...
    <cfset addFacilityVisitor = facility_visitor.addFacilityVisitor(
    ...
    <cfset attributes.actionid = addFacilityVisitor.identitycol />
    ...
    <cf_workcube_process 
        ...
        action_page='#request.self#?fuseaction=recycle.facility_visitor&event=upd&refinery_visitor_register_id=#attributes.actionid#' 
