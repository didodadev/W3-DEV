...
<cfset updPeriodicAnalysisOrder = periodic_analysis_order.updPeriodicAnalysisOrder(
    sample_points_id: attributes.sample_points_id,
...
<cfset attributes.actionid = attributes.sample_points_id />