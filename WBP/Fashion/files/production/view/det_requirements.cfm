...
<table class="detail_basket_list" width="100%">
	<thead>
		...
		<tr>
			...
			<th width="50" style="text-align:right;"><cf_get_lang no='124.İhtiyaç'></th>
			<cfset var_class = 'txtbold'>
			<cfif ListLen(attributes.DEPARTMENT_ID,',')>
				<cfloop list="#attributes.DEPARTMENT_ID#" index="_depID_" delimiters=",">
					<cfif var_class is 'form-title'><cfset var_class = 'txtbold'><cfelse><cfset var_class = 'form-title'></cfif> 
					<cfoutput>
						<th class="#var_class#" style="text-align:right;" title="<cf_get_lang_main no='708.Gerçek Stok'>" ><cf_get_lang dictionary_id="54858.G"></th>
						<th class="#var_class#" style="text-align:right;" title="<cf_get_lang no ='287.Aktif Stok=Gerçek Stok - Üretim Emirleri Rezerve'> (Kendi Dışındaki Üretim Emirleri)" ><cf_get_lang dictionary_id="29684.A"></th>
						<cfif x_is_alternative_stock eq 1>
			...
			<cfelse>
				<cfif var_class is 'form-title'><cfset var_class = 'txtbold'><cfelse><cfset var_class = 'form-title'></cfif> 
				<cfoutput>
					<th class="#var_class#" style="text-align:right;" title="<cf_get_lang_main no='708.Gerçek Stok'>" ><cf_get_lang dictionary_id="34287.G"></th>
					<th class="#var_class#" style="text-align:right;" title="<cf_get_lang no ='287.Aktif Stok=Gerçek Stok - Üretim Emirleri Rezerve'>  (Kendi Dışındaki Üretim Emirleri)" ><cf_get_lang dictionary_id="29684.A"></th>
					<cfif x_is_alternative_stock eq 1>
						<th class="#var_class#" style="text-align:right;" title="Alternatif Ürünlerin Satılabilir Stok Toplamı"><cf_get_lang dictionary_id="54866.A.S."></th>
					</cfif>
			...
			<th title="<cf_get_lang no ='290.SatınAlma Siparişleri Rezerve'>" style="text-align:right;"><cf_get_lang no ='289.Sip Rez'></th>
			...
			<th title="<cf_get_lang no ='294.Toplam İhtiyaç'>" style="text-align:right;"><cf_get_lang_main no ='1032.Kalan'></th>
		...
		<tfoot>
			<tr>
				<td colspan="<cfoutput>#colspan_#</cfoutput>" align="right" style="text-align:right;">
					...
					<input type="button" value="<cf_get_lang no ='584.Sevk İrsaliyesine Dönüştür'>" name="sevk_irsaliyesi" id="sevk_irsaliyesi" onClick="kota_kontrol(1);" style="width:140px;">
					<input type="button" value="<cf_get_lang no ='585.Ambar Fişi Oluştur'>" name="ambar_fisi" id="ambar_fisi" onClick="kota_kontrol(2);" style="width:140px;">
