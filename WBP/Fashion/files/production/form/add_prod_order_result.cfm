...
<cf_basket id="order_result_bask">
        ...
        <tbody>
            ...
            <tr id="frm_row#currentrow#" <cfif sifirmiktarli_mamul_gizle>style="display:none;"</cfif> <cfif TREE_TYPE is 'P' >bgcolor="FFCCCC"<cfelseif TREE_TYPE is 'O'>bgcolor="FFCC99"</cfif>>
                <td><input type="hidden" value="#p_order_id#" name="sub_p_order_id#currentrow#" id="sub_p_order_id#currentrow#">
                 ...
                 <td><input type="text" name="STOCK_CODE#currentrow#" id="STOCK_CODE#currentrow#" value="#STOCK_CODE#" style="width:70px; border:none;" readonly=""></td>
                <cfif x_is_barkod_col eq 1><td><input type="text" name="barcode#currentrow#" id="barcode#currentrow#" value="#barcod#" style="width:90px; border:none;" readonly=""></td></cfif>
                ...
                <cfif get_det_po.is_demontaj eq 1><!---demontajda miktar carpmali Demontaj alt ürünler--->
                    <cfif GET_ROW_AMOUNT.RECORDCOUNT>
                        ...
                        <input type="text" name="amount#currentrow#" id="amount#currentrow#" value="#TlFormat(kalan_uretim_miktarı,8)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,1);" class="moneybox" style="width:70px;" <cfif is_change_amount_demontaj eq 0>readonly=""</cfif>>
				</td>
   ...
   <cfif get_det_po.is_demontaj eq 1>
        ...
        <tbody>
            <cfoutput query="#sarf_query#">
                ...
                <tr id="frm_row_exit#currentrow#" <cfif TREE_TYPE is 'P'>bgcolor="66CCFF" title="Phantom Ağaç Ürünü"<cfelseif TREE_TYPE is 'O'>bgcolor="FFCC99" title="Operasyon Ürünü"</cfif>><!--- Eğer fantom ürünün içeriği ise satırın rengini değiştir.. --->
                    ...
                    <td>
                        ...
                        <cfif get_det_po.is_demontaj eq 1><!---demantajda miktar carpmayalim--->
                            <cfif isdefined('GET_SUM_AMOUNT')>
                                ...
                                <cfset sarf_kalan_uretim_emri_new = sarf_kalan_uretim_emri>
                                <input type="text" name="amount_exit#currentrow#" id="amount_exit#currentrow#" value="#TlFormat(sarf_kalan_uretim_emri,0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);aktar('#p_order_id#','#currentrow#');" class="moneybox" style="width:70px;">
                                <input type="hidden" name="amount_exit_#currentrow#" id="amount_exit_#currentrow#" value="#TlFormat(sarf_kalan_uretim_emri,0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);aktar('#p_order_id#','#currentrow#');" class="moneybox" style="width:60px;">
                            <cfelse>
                                <cfset sarf_kalan_uretim_emri_new = get_det_po.AMOUNT>
                                <input type="text" name="amount_exit#currentrow#" id="amount_exit#currentrow#" value="#TlFormat(get_det_po.AMOUNT,0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);aktar('#p_order_id#','#currentrow#');" class="moneybox" style="width:70px;" onClick="aktar('#p_order_id#','#currentrow#');">
                                <input type="hidden" name="amount_exit_#currentrow#" id="amount_exit_#currentrow#" value="#TlFormat(get_det_po.AMOUNT,0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);aktar('#p_order_id#','#currentrow#');" class="moneybox" style="width:60px;" onClick="aktar('#p_order_id#','#currentrow#');">
                            </cfif>
                        <cfelse>
                            <cfif is_free_amount eq 1>
                                <input type="text" name="amount_exit#currentrow#" id="amount_exit#currentrow#" value="#TlFormat(wrk_round(_AMOUNT_,8,1),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:70px;" #_readonly_#>
                                <input type="hidden" name="amount_exit_#currentrow#" id="amount_exit_#currentrow#" value="#TlFormat(wrk_round(_AMOUNT_,8,1),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:60px;" readonly="">
                            <cfelse>	
                                <cfif isdefined('GET_SUM_AMOUNT')><!--- Normal ürün alt ürünleri --->
                                    ...
                                    <input type="text" name="amount_exit#currentrow#" id="amount_exit#currentrow#" value="#TlFormat((sarf_kalan_uretim_emri),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:70px;" #_readonly_# >
                                    <input type="hidden" name="amount_exit_#currentrow#" id="amount_exit_#currentrow#" value="#TlFormat((sarf_kalan_uretim_emri),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:60px;" readonly="">
                                <cfelse>
                                    <input type="text" name="amount_exit#currentrow#" id="amount_exit#currentrow#" value="#TlFormat(wrk_round(_AMOUNT_,8,1),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:70px;" #_readonly_#>
                                    <input type="hidden" name="amount_exit_#currentrow#" id="amount_exit_#currentrow#" value="#TlFormat(wrk_round(_AMOUNT_,8,1),0)#" onKeyup="return(FormatCurrency(this,event,8));" onBlur="hesapla_deger(#currentrow#,0);" class="moneybox" style="width:60px;" readonly="">
                                </cfif>
                    ...
                    <cfif get_module_user(5) and session.ep.COST_DISPLAY_VALID neq 1>
                        <td><input type="text" name="cost_price_exit#currentrow#" id="cost_price_exit#currentrow#" value="#TLFormat(cost_price,4)#" class="moneybox" <cfif is_change_sarf_cost eq 0>readonly<cfelse>onBlur="change_row_cost(#currentrow#);"</cfif>></td>
                        <td>
                            ...
                            <input type="text" name="purchase_extra_cost_exit#currentrow#" id="purchase_extra_cost_exit#currentrow#" value="#TLFormat(purchase_extra_cost,4)#" class="moneybox" readonly>
                        </td>
                        ...
                        <cfif isdefined("x_is_cost_price_2") and x_is_cost_price_2 eq 1>
                            <td><input type="text" name="cost_price_exit_2#currentrow#" id="cost_price_exit_2#currentrow#" value="#TLFormat(cost_price_2,4)#" class="moneybox" <cfif is_change_sarf_cost eq 0>readonly</cfif>></td>
                            <td><input type="text" name="purchase_extra_cost_exit_2#currentrow#" id="purchase_extra_cost_exit_2#currentrow#" value="#TLFormat(wrk_round(purchase_extra_cost_system_2,8,1),4)#" class="moneybox" readonly></td>
    ...
    <table id="table3_cover" name="table3_cover" class="detail_basket_list">
        <iframe name="add_prod" id="add_prod" frameborder="0" vspace="0" hspace="0" scrolling="no" src="<cfoutput>#request.self#?fuseaction=prod.popup_add_production_result&is_show_product_name2=#is_show_product_name2#&iframe=1&spec_name_display=#Evaluate('spec_name_display')#&spec_display=#Evaluate('spec_display')#</cfoutput>&type=outage" width="100%" height="50"></iframe>
        <thead>
            <tr>
