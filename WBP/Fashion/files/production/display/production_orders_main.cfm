    ...
    <div class="row" type="row">
        <div class="col col-3 col-sm-6 col-xs-12" type="column" index="1" sort="true">
            ...
            <div class="form-group" id="item-quantity">
                ...
                <div class="col col-9 col-xs-12">
                    ...
                    <cfinput type="text" name="quantity" id="quantity" required="Yes" maxlength="100" value="#tlformat(get_det_po_party.quantity,0)#" onkeyup="return(formatcurrency(this,event,8));" onBlur="aktar();" style="width:120px;">
                    <cfinput type="hidden" name="quantity_" id="quantity_" required="Yes" maxlength="100" value="#tlformat(get_det_po_party.quantity,0)#" onkeyup="return(formatcurrency(this,event,8));" onBlur="aktar();" style="width:120px;">
                </div>
            </div>
        </div>
        <div class="col col-5 col-sm-9 col-xs-12" type="column" index="2" sort="true">
            ...
            <div class="form-group" id="item-result_amount">
                ...
                <div class="col col-4 col-xs-12">
                   <cfinput type="text" name="result_amount" id="result_amount" maxlength="100" value="#tlformat(get_det_po.row_result_amount,0)#" readonly style="width:65px;">
                </div>
                <label class="col col-2 col-xs-12"><cf_get_lang_main no='1032.Kalan'></label>
                <div class="col col-3 col-xs-12">
                    <cfinput type="text" name="result_amount" id="result_amount" maxlength="100" value="#tlformat(get_det_po.quantity-get_det_po.row_result_amount,0)#" readonly style="width:70px;"> 
                </div>
            </div> 
            </cfif>       
        </div>
