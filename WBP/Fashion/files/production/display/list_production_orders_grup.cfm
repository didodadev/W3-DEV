			...
			<cf_box_search>
				<div class="form-group">
					<div class="input-group">
						...
						<cf_wrk_search_input name="keyword" id="keyword" title="#key_title#" check_column="#checked_list#" checkbox="Üretim Emri No,Operasyon No,Lot No,Referans No,Sipariş Numarası" columnlist="P_ORDER_NO1,DEMAND_NO1,LOT_NO1,REFERENCE_NO1,ORDER_NUMBER1" placeholder="#getLang('','Filtre Ediniz','57701')#">
						<!---<cfinput type="text" name="keyword" id="keyword" title="#key_title#"  >--->
					</div>
				</div>
			...
			<cf_box_search_detail>
					...
					<div class="form-group" id="item-member_name">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<span class="input-group-addon icon-ellipsis btnPointer" title="<cfoutput>#getLang('','Cari Hesap','57519')#</cfoutput>" onClick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_all_pars&field_consumer=search_list.consumer_id&field_comp_id=search_list.company_id&field_member_name=search_list.member_name&field_type=search_list.member_type&select_list=7,8&keyword='+encodeURIComponent(document.search_list.member_name.value));"></span>
							</div>
						</div>
					</div>
					</cfif>
					<div class="form-group" id="item-product_cat">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<span class="input-group-addon icon-ellipsis btnPointer" title="<cfoutput>#getLang('','Kategori Ekle','29481')#</cfoutput>" onClick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_product_cat_names&field_code=search_list.product_cat_code&is_sub_category=1&field_id=search_list.product_catid&field_name=search_list.product_cat');"></span>
							</div>
						</div>
					</div>
					<div class="form-group" id="item-position_name">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<span class="input-group-addon icon-ellipsis btnPointer" title="<cfoutput>#getLang('','Sorumlu Ekle','37118')#</cfoutput>" onClick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_code=search_list.position_code&field_name=search_list.position_name&select_list=1&is_form_submitted=1&keyword='+encodeURIComponent(document.search_list.position_name.value));"></span>
							</div>
						</div>
					</div>
					<div class="form-group" id="item-order_employee">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<span class="input-group-addon icon-ellipsis btnPointer" title="<cfoutput>#getLang('','Satış Çalışanı','36785')#</cfoutput>" onClick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=search_list.order_employee_id&field_name=search_list.order_employee&select_list=1');"></span>
							</div>
						</div>
					</div>
					<div class="form-group" id="item-related_product_name">
						<label class="col col-12 col-md-12 col-sm-12 col-xs-12"><cf_get_lang dictionary_id='36445.Hammadde'></label>
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
				...
				<div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
					<div class="form-group" id="item-station_id">
						<label class="col col-12 col-md-12 col-sm-12 col-xs-12"><cf_get_lang dictionary_id='36371.Tüm İstasyonlar'></label>
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="form-group" id="item-spect_name">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								...
								<span class="input-group-addon icon-ellipsis btnPointer" title="<cfoutput>#getLang('','Spekt','57647')#</cfoutput>" onClick="product_control();"></span>
							</div>
						</div>
					</div>
				...
				<div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
					...
					<div class="form-group" id="item-finish_date">
						...
						<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
							<div class="input-group">
								<cfif session.ep.our_company_info.UNCONDITIONAL_LIST>
									<cfinput type="text" name="finish_date" maxlength="10" value="#dateformat(attributes.finish_date,dateformat_style)#" validate="#validate_style#" >
								<cfelse>
								...
								<span class="input-group-addon no-bg"></span>
								<cfinput type="text" name="finish_date_2" value="#dateformat(attributes.finish_date_2,dateformat_style)#" validate="#validate_style#">
		...
		<cf_grid_list>
			<thead>
				<tr>		
					...
					<th><cf_get_lang dictionary_id='62610.Üretim Emri No'></th>
					...
					<th><cf_get_lang dictionary_id='60278.Ürün Özel Kod'></th>
					<th><cf_get_lang dictionary_id='57657.Ürün'></th>
					<th><cf_get_lang dictionary_id='62561.Müşteri Order No'></th>
					<th><cf_get_lang dictionary_id='62569.Müşteri Model No'></th>
					<th><cf_get_lang dictionary_id='46709.Planlanan Miktar'></th>
					<th><cf_get_lang dictionary_id='62611.Üretimdeki Miktar'></th>
					...
					<th><cf_get_lang dictionary_id='62612.Üretim Başlangıç'></th>
					<th><cf_get_lang dictionary_id='62613.Üretim Bitiş'></th>
					<th></th>			
				</tr>
			</thead>
								...
								<tr>
									<cfif not (isdefined('attributes.is_excel') and attributes.is_excel eq 1)>
										<td align="center" id="order_row#currentrow#" class="color-row" onClick="gizle_goster(order_stocks_color_detail#currentrow#);connectAjaxDetail('#currentrow#','#PRODUCT_ID#','','','','','#ORDER_ID#','','#PARTY_ID#');gizle_goster(siparis_goster#currentrow#);gizle_goster(siparis_gizle#currentrow#);">
											<i id="siparis_goster#currentrow#" class="fa fa-chevron-circle-right fa-2x"  style="cursor:pointer;" title="<cf_get_lang dictionary_id='58596.Göster'>"></i>
											<i id="siparis_gizle#currentrow#" class="fa fa-chevron-circle-down fa-2x" style="cursor:pointer;display:none;"  title="<cf_get_lang dictionary_id='58628.Gizle'>"></i>
										</td>
									</cfif>
									<td>
											<cfif not (isdefined('attributes.is_excel') and attributes.is_excel eq 1)>
...
document.getElementById('keyword').focus();
 <cfif (fuseaction_ is 'demands' or  fuseaction_ is 'order') and is_show_multi_print eq 1>
	...
	function triggerPlusIcon() {
		document.location = '<cfoutput>#request.self#</cfoutput>?fuseaction=textile.order&event=add';
	}
