...
<cfobject name="createcomponent" component="WBP.Fashion.files.cfc.operation_process">
			<cfscript>
                        ...
                        <table border="0" >
                            <tr>
								...
								<td id="fason" style="display:none;">İstasyon
                                    <select class="js-example-basic-single" name="station_id_#attributes.p_operation_id#" id="station_id_g_#attributes.p_operation_id#" style="width:180px;">
                                        <option value="">...Seçiniz...</option>
										<cfloop query="get_w1">
                                            <option value="#station_id#,0,0,0,-1,#EXIT_DEP_ID#,#EXIT_LOC_ID#,#PRODUCTION_DEP_ID#,#PRODUCTION_LOC_ID#">#station_name#</option>
                                        </cfloop>
								...
								<td id="local" style="display:none;">İstasyon
                                    <select class="js-example-basic-single" name="station_id_#attributes.p_operation_id#" id="station_id_f_#attributes.p_operation_id#" style="width:180px;">
                                        <option value="">...Seçiniz...</option>
										<cfloop query="get_w2">
                                            <option value="#station_id#,0,0,0,-1,#EXIT_DEP_ID#,#EXIT_LOC_ID#,#PRODUCTION_DEP_ID#,#PRODUCTION_LOC_ID#">#station_name#</option>
                                        </cfloop>
        ...
        $("#send_prod"+mainoperationid).click(function()
            {
                ...
                var pid=""; $("#pid_"+mainoperationid).val();
                   ...
                   if (stationid == '') stationid= $("#station_id_g_"+mainoperationid).val();
                   if (stationid == '') stationid= $("#station_id_f_"+mainoperationid).val();
                   if(stationid ==''){
