    ...
    <div class="row">
        <div class="col col-12 form-inline ">
            ...
            <div class="form-group">
            	<cf_get_lang dictionary_id='36596.Tüm Gelen İhtiyaçlar'> <input type="checkbox" value="0" name="row_demand_all" id="row_demand_all" checked>
            </div>
            </cfif>
        	<div class="form-group">
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    <div class="form-group" id="item-list_type">
                        ...
                        <select name="list_type" id="list_type">
                            <option value="1" <cfif attributes.list_type eq 1>selected</cfif>><cf_get_lang dictionary_id='36593.Üretim Emirlerinden'>(<cf_get_lang_main dictionary_id='34299.Spec'>)</option>
...
<table class="detail_basket_list" width="100%">
	<thead>
		...
		<tr>
			...
			<cfif isdefined("x_is_price") and x_is_price eq 1>
				<th width="1%" style="text-align:right;"><cf_get_lang dictionary_id='33932.Toplam Fiyat'></th>
...
<cfif attributes.page eq 1 and ((isdefined("stock_id_list_info1") and len(stock_id_list_info1)) or (isdefined("stock_id_list_info2") and len(stock_id_list_info2)))>
	<br/><table width="99%" border="0" cellspacing="1" cellpadding="2" align="center">
		<tr>
			<td class="headbold">
				<a href="javascript:connectAjax();">&raquo;<cf_get_lang dictionary_id='36137.Bulunamayan Kayıtlar'></a>
			</td>
		</tr>
		<tr>
			<td>
...
<cfdump var="#get_metarials#">
<cfdump var="#attributes.product_code#">
