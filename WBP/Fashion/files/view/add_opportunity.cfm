...
<cfinclude template="/V16/sales/query/get_opportunity_type.cfm">
	<script src="/WBP/Fashion/files/js/dropzone.js"></script>
	 <link href="/WBP/Fashion/files/js/dropzone.css" rel="stylesheet" />
                ...
                <div class="col col-12 uniqueRow">
					...
					<div class="row" type="row">
						 <div class="col col-4 col-md-4 col-sm-12 col-xs-12" type="column" index="1" sort="true">
								 ...
								 <div class="form-group" id="item-sales_emp_id">
                                    <label class="col col-4 col-sm-12">Müşteri Temsilcisi<!---<cf_get_lang no='101.Satış Calışan'>---></label>
                                    <div class="col col-8 col-sm-12">
					...
					<div class="row" type="row">
						...
						<div class="row" type="row" style="display:none;">
                            <div class="col col-4 col-md-4 col-sm-12 col-xs-12" type="column" index="1" sort="true">
                                <div class="form-group" id="item-opp_head">
                                    ...
                                    <div class="col col-8 col-sm-12">
                                        ...
                                        <cfelseif isdefined('attributes.cus_help_id') and len(attributes.cus_help_id)>
                                            <cfsavecontent variable="opp_head_"><cf_get_lang no ='15.Etkileşim'>: <cfoutput>#attributes.cus_help_id#</cfoutput></cfsavecontent>
                                ...
                                <div class="form-group" id="item-sales_add_option">
                                    <label class="col col-4 col-sm-12"><cf_get_lang no ='340.Satış Özel Tanım'></label>
                                    <div class="col col-8 col-sm-12">
                            ...
                            <div class="col col-4 col-md-4 col-sm-12 col-xs-12" type="column" index="2" sort="true">
                                ...
                                <div class="form-group" id="item-commethod_id">
                                    <label class="col col-4 col-sm-12"><cf_get_lang_main no='731.Iletişim'></label>
                                    <div class="col col-8 col-sm-12">
                        ...
                        <div class="row" type="row">
                            ...
                            <label class="col col-8 col-xs-12"><span class="hide">Editör</span></label>
                            <div id="fckedit">
