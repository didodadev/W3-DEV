...
<cfif not DirectoryExists("#upload_folder#textile#dir_seperator#iscilik#dir_seperator#")>
	<cfdirectory action="create" directory="#upload_folder#textile#dir_seperator#iscilik#dir_seperator#">
</cfif>
