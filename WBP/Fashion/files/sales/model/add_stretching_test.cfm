...
<cfparam name="attributes.stretching_test_id" default="">
...
<cfscript>
	...
	stretching_test_result = stretching_test.add_stretching_test(
	...
	attributes.stretching_test_id = stretching_test_result.generatedkey;
</cfscript>
...
<cf_workcube_process
	...
	<cfset attributes.actionid ='&st_id=' & attributes.stretching_test_id>
