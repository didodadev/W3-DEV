...
<div id="cutactualing">
    <cfform name="cutactual" method="post">
        ...
        <div class="row">
            <div class="col col-8" data-bind="attr:{ style: hiddenLeft() ? 'display: none;' : 'max-height: 500px; overflow: auto;' }" onscroll="if(!window.list_vertical) { window.list_vertical=true; $('#list_sizes').scrollTop($(this).scrollTop()); setTimeout(function(){window.list_vertical=false}, 20); }" id="list_main">
            ...
            <div data-bind="css: hiddenLeft() ? 'col col-12' : 'col col-4'" style="max-height: 500px; overflow: auto;" id="list_sizes" onscroll="if(!window.list_vertical) { window.list_vertical=true; $('#list_main').scrollTop($(this).scrollTop()); $('#list_sizehead').scrollLeft($(this).scrollLeft()); setTimeout(function(){window.list_vertical=false}, 20); }">
...
<script type="text/javascript" src="/addons/textile/common/js/knockout.js"></script>
