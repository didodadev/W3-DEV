                ...
                <div class="row" type="row">
                    <div class="col col-12" style="overflow: auto;">
						...
						<!---<cf_ajax_list>--->
                            <thead>
                                <tr>
                                    <th rowspan="2">En/Boy Çekme Oranı</th>
                                    <th colspan="2">
                                        <select name="stretching_group" data-bind="options: colorgroup, optionsText: 'group_name', value: selectedcolorgroup, optionsCaption: 'Renk Lotları', optionsValue: 'group_name', event: { change: function() { $root.stretching_group_changed(); } }"></select>
                                    </th>
                                    <th rowspan="2">
                                        <select data-bind="options: measure_sizes_boy, value: activeBoy"></select>
                                        <select multiple="multiple" data-bind="multiselect: { config: { width:100,height:150,checkAllText:'Seç ',uncheckAllText:'Kaldır ',noneSelectedText: 'Beden Seçiniz',selectedText: '# / #Kayıt Seçildi ',open: function () {$('input[type=\'search\']').focus();}}, options: displaysizes, selectedOptions: activesizes }"></select>
                                        ...
                                        <a href="javascript:void()" data-bind="click: function() { self.createRow(); }"><i class="fa fa-plus"></i></a></th>
                                    <!-- ko foreach: self.shownSizes -->
                                    <th rowspan="2" style="border-left: 1px solid #ddd; text-align: center;" data-bind="attr: { colspan: self.activecols().length + 1 }, visible: $root.activesizes().indexOf($data[0]) >= 0"><span data-bind="text: $data[0]"></th>
                                    <!-- /ko -->
                                    <th rowspan="2"></th>
                                </tr>
                                <tr>
                                    <th><input type="text" data-bind="value: evalue" name="erate"></th>
                                    <th><input type="text" data-bind="value: bvalue" name="brate"></th>
                                </tr>
