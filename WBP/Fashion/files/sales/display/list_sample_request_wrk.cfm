        ...
        <cfif GET_SAMPLE_REQ.recordcount>
            <cfoutput query="GET_SAMPLE_REQ" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                ...
                <td>
                    ...
                    <div >
                        <div class="box-list box-list-small col col-12 col-md-12 col-sm-6 col-xs-12 mySlides" style="height:100px;"> 
                            <div class="box-list-content col col-12 box-list-small">
                 ...
                 <cfif isdefined("attributes.is_detail_stage")>
                    <td <cfif len(fabric_stage)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,fabric_stage))#"></cfif></td>
                    <td <cfif len(ACCESSORY_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,ACCESSORY_STAGE))#"></cfif></td>
                    <td <cfif len(PATTERN_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,PATTERN_STAGE))#"></cfif></td>
                    <td <cfif len(WORKSHIP_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,WORKSHIP_STAGE))#"></cfif></td>
                    <td <cfif len(WASH_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,WASH_STAGE))#"></cfif></td>
                    <td <cfif len(MOLD_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,MOLD_STAGE))#"></cfif></td>
                    <td <cfif len(MARKER_STAGE)>style="background-color:#ListGetAt(colorlist,ListFind(colorprocesslist,MARKER_STAGE))#"></cfif></td>
