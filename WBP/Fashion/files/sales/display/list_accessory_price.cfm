...
<cfparam name="attributes.plan_type_id" default="3">
...
<cfset query_product_plan=product_plan.list_productplan(plan_id:attributes.plan_id,plan_type_id:attributes.plan_type_id,req_id:attributes.req_id,project_id:attributes.project_id,date_start:attributes.date_start,date_end:attributes.date_end,req_no:attributes.req_no,project_emp_id:attributes.project_emp_id,task_emp_name:attributes.emp_name,process_stage:attributes.process_stage,access:access,
is_task:is_task,
company_order_no:attributes.order_no,
is_revision:attributes.is_revision
)>
<cfsavecontent variable ="title">
    <cf_get_lang dictionary_id="41260"> <BR/> No
</cfsavecontent>
<cfsavecontent variable ="header">
	<cf_get_lang dictionary_id="41260">
</cfsavecontent>
