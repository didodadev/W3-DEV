...
<cfform name="add_req_process_gm" method="post" action="#request.self#?fuseaction=textile.emptypopup_add_req_process">
	<cf_grid_list>
        ...
        <thead>
            <tr>
				<th width="100"><cf_get_lang dictionary_id='57777.İşlemler'>*</th>
                <th width="30"><cf_get_lang dictionary_id='58693.Seç'>*</th>
				<th width="100"><cf_get_lang dictionary_id='58084.Fiyat'>*</th>
				<th width="100"><cf_get_lang dictionary_id='40935.Revize'> <cf_get_lang dictionary_id='58084.Fiyat'></th>
		...
		<cfoutput query="get_process">
			<tr class="color-row">
				...
				<td nowrap="nowrap">
					<cfif len(IMAGE_PATH)>
						<a href="javascript://" onclick="windowopen('/documents/textile/iscilik/#IMAGE_PATH#','wwide');"><img src="/WBP/Fashion/files/img/file_zcn_store.png" width="24" height="24" /></a>
