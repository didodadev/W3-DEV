            ...
            <cf_box_search_detail>
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                    <div class="form-group" id="form_ul_start_date">
                        <label class="col col-12"><cfoutput>#getLang('','Başlangıç tarihi','58053')#</cfoutput></label>
                        <div class="col col-12">
                            <div class="input-group">
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="3" sort="true">
                    ...
                    <div class="form-group" id="form_ul_ordertype">
                        <label class="col col-12"><cfoutput>#getLang('','sıralama','58924')#</cfoutput></label>
                        <div class="col col-12">
                            <select name="ordertype" id="ordertype">
                                <option value="1" <cfif attributes.ordertype eq 1>selected</cfif>><cf_get_lang dictionary_id='62570.Numune Tarihine Göre Artan'></option>
                                <option value="2" <cfif attributes.ordertype eq 2>selected</cfif>><cf_get_lang dictionary_id='62571.Numune Tarihine Göre Azalan'></option>
                                <option value="3" <cfif attributes.ordertype eq 3>selected</cfif>><cf_get_lang dictionary_id='58050.Son Güncelleme'></option>
                                ...
                                <option value="9" <cfif attributes.ordertype eq 9>selected</cfif>><cf_get_lang dictionary_id='62572.Numune Numarasına Göre Artan'></option>
                                <option value="10" <cfif attributes.ordertype eq 10>selected</cfif>><cf_get_lang dictionary_id='62573.Numune Numarasına Göre Azalan'></option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
                    <div class="form-group" id="form_ul_record_employee">
                        ...
                        <div class="form-group" id="form-order_no">
                            <label class="col col-12"><cf_get_lang dictionary_id='62561.Müşteri Order No'></label>
                            <div class="col col-12">
                                <div class="input-group">
                        ...
                        <div class="form-group" id="form-model_no">
                            <label class="col col-12"><cf_get_lang dictionary_id='62569.Müşteri Model No'></label>
                            <div class="col col-12">
                            <div class="input-group">
                                <cfinput type="text" name="model_no" id="model_no" value="#attributes.model_no#" placeholder="#getLang('','Müşteri Model No','62569')# ">
                            </div>
                        </div>
                    </div>
                        <div class="form-group" id="form-is_detail_stage">
                            <div class="col col-12">
                                <div class="input-group">
                                    <label class="col col-12"><cf_get_lang dictionary_id='62622.Aşama Renklendir'><input type="checkbox" <cfif isdefined("attributes.is_detail_stage")>checked</cfif> name="is_detail_stage" id="is_detail_stage" value=""></label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<cf_grid_list>
    <thead>
        <tr>
            ...
            <th ><a href="javascript://"><i class="fa fa-file-image-o" title="<cf_get_lang dictionary_id ='44564.Ön İzleme'>" alt="<cf_get_lang dictionary_id ='44564.Ön İzleme'>"></i></a></th>
            ...
            <th width="120"><cf_get_lang dictionary_id='57457.Müşteri'></th>
            <th width="120"><cf_get_lang dictionary_id ='58795.Müşteri Temsilcisi'></th>
			<th title="<cf_get_lang dictionary_id='62561.Müşteri Order No'>"><cf_get_lang dictionary_id='62561.Müşteri Order No'></th>
			<th class="drag-enable" width="120"><cf_get_lang dictionary_id='58859.Süreç'>/<cf_get_lang dictionary_id='57482.Aşama'></th>
            <cfif isdefined("attributes.is_detail_stage")>
                <th title="<cf_get_lang dictionary_id='41259.Kumaş Fiyat Talepleri'>"><cf_get_lang dictionary_id='41259.Kumaş Fiyat Talepleri'></th>
                ...
                <th title="<cf_get_lang dictionary_id='41269.Modelhane İşlemleri'>"><cf_get_lang dictionary_id='41269.Modelhane İşlemleri'></th>
                <th title="<cf_get_lang dictionary_id='41264.İşçilik Fiyat Talepleri'>"><cf_get_lang dictionary_id='41264.İşçilik Fiyat Talepleri'></th>
                <th title="<cf_get_lang dictionary_id='62694.Yıkama Fiyat Talepleri'>"><cf_get_lang dictionary_id='62694.Yıkama Fiyat Talepleri'></th>
                <th title="<cf_get_lang dictionary_id='62693.Kesim Operasyonu'>"><cf_get_lang dictionary_id='62693.Kesim Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62692.Nakış Operasyonu'>"><cf_get_lang dictionary_id='62692.Nakış Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62691.Baskı Operasyonu'>"><cf_get_lang dictionary_id='62691.Baskı Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62695.Dikim Operasyonu'>"><cf_get_lang dictionary_id='62695.Dikim Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62696.Yıkama Operasyonu'>"><cf_get_lang dictionary_id='62696.Yıkama Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62697.Numune Ütü - Paket Operasyonu'>"><cf_get_lang dictionary_id='62697.Numune Ütü - Paket Operasyonu'></th>
                <th title="<cf_get_lang dictionary_id='62698.Üretim Ütü - Paket Operasyonu'>"><cf_get_lang dictionary_id='62698.Üretim Ütü - Paket Operasyonu'></th>
            ...
            <th title="<cf_get_lang dictionary_id='42103.Ürün Ağacı'>"><cf_get_lang dictionary_id='42103.Ürün Ağacı'></th>
            <th title="<cf_get_lang dictionary_id='33920.Konfigüratör'>"><cf_get_lang dictionary_id='33920.Konfigüratör'></th>
            <th title="<cf_get_lang dictionary_id='47241.Üretim Siparişleri'>"><cf_get_lang dictionary_id='47241.Üretim Siparişleri'></th>
    ...
    <tbody>
        ...
        <cfif GET_SAMPLE_REQ.recordcount>
            <cfoutput query="GET_SAMPLE_REQ" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                ...
                <td align="center">
					...
					<!---Necip MENEKŞE 10.07.2019--->
                  
                        <cfif not  len(get_product_images.path)>
                            <i class="fa fa-file-image-o" src="/documents/product/#get_product_images.path#"  class="img-thumbnail" title="<cf_get_lang dictionary_id ='44564.Ön İzleme'>" alt="<cf_get_lang dictionary_id ='44564.Ön İzleme'>"></i>
                        <cfelse>
                            <font Color = "44b6ae"a href="javascript://" class="list_chapter_item_img" onclick="windowopen('/documents/product/#get_product_images.path#','page');" width="500" height="450"  >
                              <!---   <cfloop index="i" from="1" to="5">  ---> 
                                     <i  class="fa fa-file-image-o" src="/documents/product/#get_product_images.path#" width="½100" height="%100"  class="img-thumbnail" title="<cf_get_lang dictionary_id ='44564.Ön İzleme'>" alt="<cf_get_lang dictionary_id ='44564.Ön İzleme'>"></i>
                                <!---  </cfloop> --->
                            </a>
                        </cfif>
                 ...
                 <cfif isdefined("attributes.is_detail_stage")>
                    ...
                    <cfloop query="query_oplist">
                        ...
                        <td style="text-align: center;">
                            ...
                            <cfif gerceklesen_op_miktar gt 0 and kalan_miktar lte 0>
                                <span style="display: inline-block; width: 25px; height: 25px; border-radius: 50%; background-color: ##80ff00;" title="İşlem Bitti">&nbsp;</span>
                            <cfelseif gerceklesen_op_miktar eq 0>
                                <span style="display: inline-block; width: 25px; height: 25px; border-radius: 50%; background-color: red;" title="İşlem Başlamadı">&nbsp;</span> 
                            <cfelseif gerceklesen_op_miktar gt 0 and kalan_miktar gt 0>
                                <span style="display: inline-block; width: 25px; height: 25px; border-radius: 50%; background-color: blue;" title="İşlem Devam">&nbsp;</span>
                            </cfif> 
                            </cfif>
                        </td>
                    </cfloop>
                    ...
                    <td>
                        ...
                        <form method="post" target="_blank" action="/index.cfm?fuseaction=textile.tracking">
                            ...
                            <a href="javascript:void(0)" onclick="$(this).closest('form').submit()"><i class="fa fa-cubes fa-2x" aria-hidden="true" title="Üretim Siparişleri Listesi"></i></a>
                        </form>
                        </cf_authcontent>
                    </td>
                    <td align="center">
                    ...
                    <td align="center"><a href="#request.self#?fuseaction=textile.list_sample_request&event=det&req_id=#req_id#&req_no=#req_no#"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></a></td>
                </tr>
        ...
        <cfelse>
            <tr>
                <td <cfif x_update_date eq 1>colspan="19"<cfelse>colspan="19"</cfif>><cfif isdefined("attributes.is_filtre")><cf_get_lang dictionary_id='57484.Kayıt Yok'>!<cfelse><cf_get_lang dictionary_id='57701.Filtre Ediniz'>!</cfif></td>
            </tr>
        </cfif>
    </tbody>
</cf_grid_list>
