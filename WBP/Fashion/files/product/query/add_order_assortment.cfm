...
<script type="text/javascript">
	window.location.href='<cfoutput>#request.self#?fuseaction=textile.product_plan&event=add_order_assortment&send_order=&pid=#attributes.product_id#&req_id=#attributes.req_id#&project_id=#attributes.project_id#&company_id=#attributes.company_id#&partner_id=#attributes.partner_id#&pcode=&type_id=#attributes.type_id#</cfoutput>';
/*	wrk_opener_reload();
	window.close();*/
</script>
