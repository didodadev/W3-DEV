...
<!---<cfdump var="#get_main_tree#" ABORT>--->

<div class="row">
<cfform name="search_form" action="#request.self#?fuseaction=textile.product_tree&pid=#attributes.pid#&req_id=#attributes.req_id#&operation_type_id=#attributes.operation_type_id#">
	<div class="col col-12 uniqueRow">
		<div class="row formContent">
			<div class="row" type="row">
				<div class="col col-2 col-md-2 col-sm-4 col-xs-2" type="column" index="1" sort="true">
					<div class="form-group" id="item-color">
						<label class="col col-4 col-xs-2">Renk</label>
				...
				<div class="col col-2 col-md-2 col-sm-4 col-xs-12" type="column" index="1" sort="true">
					<div class="form-group" id="item-color">
						...
						<div class="col col-12 col-xs-12">
							<input type="checkbox" name="agac_yok" <cfif IsDefined("attributes.agac_yok")>checked</cfif> value="1"> Sadece ağacı olmayan stokları getir.
						</div>
					</div>
				</div>
				<div class="col col-2 col-md-2 col-sm-4 col-xs-12" type="column" index="1" sort="true">
...
<cfform name="all_tree" action="#request.self#?fuseaction=textile.empty_tree_copy" method="post" >			
	...
	<cf_box title="Ürün Ağaçları">
		<div>
			<div class="col col-4">
				<div class="form-group" id="item-process_stage">
					<label class="col col-4 col-xs-4">Süreç</label>
				...
				<table >
					<tbody>
						<tr>
												...
												<cfloop from="1" to="#agac_satirsayisi#" index="i">
													...
													<tr id="frm_row#i#" name="frm_row#i#">
														...
														<td style="text-align:left;">
															<input type="text" style="width:8mm;text-align:right;" name="amount_#currentrow#_#i#" onkeyup="FormatCurrency(this,event);" class="boxtext" value="#tlformat(amount_)#">
														</td>
							...
							<cfelse>
								<td><cfif isdefined("attributes.agac_yok")><h3>Ağacı olmayan stok bulunamadı!<cfelse>Lütfen Ürüne Asorti tanımlayınız!</cfif></h3></td>
							</cfif>	
						</tr>
					</tbody>
					<!---<tfoot>
