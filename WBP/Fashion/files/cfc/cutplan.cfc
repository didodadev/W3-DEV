<cfcomponent>
    ...
    <cffunction name="list_cutplan" access="public">
        ...
        <cfquery name="query_list_cutplan" datasource="#dsn3#">
            ...
            FROM TEXTILE_CUTPLAN_HEAD head
            OUTER APPLY (
        ...
        <cfreturn query_list_cutplan>
    </cffunction>

    <cffunction name="get_cutplan" access="public">
        <cfargument name="cutplan_id" type="numeric">
        <cfquery name="query_get_cutplan" datasource="#dsn3#">
            SELECT head.*, comp.FULLNAME, CONCAT(emp.EMPLOYEE_NAME, ' ', emp.EMPLOYEE_SURNAME) AS EMP_NAME, ord.RELATED_ACTION_ID AS REQ_ID, ohd.ORDER_NUMBER
            FROM TEXTILE_CUTPLAN_HEAD head
            LEFT JOIN #dsn#.COMPANY comp ON head.COMPANY_ID = comp.COMPANY_ID
            LEFT JOIN #dsn#.EMPLOYEES emp ON head.EMP_ID = emp.EMPLOYEE_ID
        ...
        <cfreturn query_get_cutplan>
    </cffunction>

    <cffunction name="add_cutplan" access="public">
        ...
        <cfquery name="query_add_cutplan" datasource="#dsn3#" result="result_add_cutplan">
            INSERT INTO TEXTILE_CUTPLAN_HEAD(
        ...
        <cfreturn result_add_cutplan>
    </cffunction>

    <cffunction name="upd_cutplan" access="public">
        <cfargument name="cutplan_id" type="numeric">
        <cfargument name="company_id">
        <cfargument name="order_id">
        <cfargument name="stage_id">
        ...
        <cfquery name="query_upd_cutplan" datasource="#dsn3#">
            UPDATE TEXTILE_CUTPLAN_HEAD SET
    ...
    <cffunction name="get_cutplan_rows" access="public">
        <cfargument name="cutplan_id">
        <cfquery name="query_get_cutplan_rows" datasource="#dsn3#">
            SELECT * FROM TEXTILE_CUTPLAN_ROW WHERE CUTPLAN_ID = <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_id#'>
        </cfquery>
        <cfreturn query_get_cutplan_rows>
    </cffunction>

    <cffunction name="add_cutplan_row" access="public">
        <cfargument name="cutplan_id">
        <cfargument name="marker_name">
        <cfargument name="marker_output">
        <cfargument name="cutplan_name">
        ...
        <cfquery name="queyr_add_cutplan_row" datasource="#dsn3#" result="result_add_cutplan_row">
            INSERT INTO TEXTILE_CUTPLAN_ROW (
                CUTPLAN_ID, MARKER_NAME, MARKER_OUTPUT, CUTPLAN_NAME, MARKER_HEIGHT, LAYER_AMOUNT, ASSORTMENT_SIZE_AMOUNT, NET_MARKER_METER, GROSS_MARKER_HEIGHT, GROSS_MARKER_METER, MARKER_UNIT_METER, PRODUCTIVITY, AFTER_CUT_METER, MARKER_WIDTH, DRAFT_COLOR, DRAFT_WIDTH, DRAFT_HEIGHT, METO_COLOR, CUT_AMOUNT, RECORD_DATE, RECORD_EMP, RECORD_IP
            ) VALUES (
                <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#cutplan_id#'>
                ,
                ...
                ,
                <cfif isDefined("arguments.cutplan_name") and len(arguments.cutplan_name)>
                    <cfqueryparam cfsqltype='CF_SQL_NVARCHAR' value='#arguments.cutplan_name#'>
                <cfelse>
                    <cfqueryparam cfsqltype='CF_SQL_NVARCHAR' null="true">
                </cfif>
                ,
        ...
        <cfreturn result_add_cutplan_row>
    </cffunction>

    <cffunction name="delete_cutplan_rows" access="public">
        <cfargument name="cutplan_id" type="numeric">
        <cfquery name="query_delete_cutplan_rows" datasource="#dsn3#">
            DELETE TEXTILE_CUTPLAN_ROW WHERE CUTPLAN_ID = <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_id#'>
        </cfquery>
    </cffunction>

    <cffunction name="get_cutplan_sizes" access="public">
        <cfargument name="cutplan_id">
        <cfquery name="query_get_cutplan_sizes" datasource="#dsn3#">
            SELECT * FROM TEXTILE_CUTPLAN_SIZE WHERE CUTPLAN_ID = <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_id#'>
        </cfquery>
        <cfreturn query_get_cutplan_sizes>
    </cffunction>

    <cffunction name="add_cutplan_size" access="public">
        <cfargument name="cutplan_id">
        <cfargument name="size">
        <cfargument name="weight">
        <cfargument name="cut_amount">
        <cfargument name="cutplan_rowid">
        <cfquery name="query_add_cutplan_size" datasource="#dsn3#">
            INSERT INTO TEXTILE_CUTPLAN_SIZE (
                CUTPLAN_ID, CUTPLAN_ROWID, SIZE, WEIGHT, CUT_AMOUNT, RECORD_DATE, RECORD_EMP, RECORD_IP
            ) VALUES (
                <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_id#'>
                ,<cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_rowid#'>
    ...
    <cffunction name="delete_cutplan_size" access="public">
        <cfargument name="cutplan_id">
        <cfquery name="query_delete_cutplan_size" datasource="#dsn3#">
            DELETE TEXTILE_CUTPLAN_SIZE WHERE CUTPLAN_ID = <cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.cutplan_id#'>
        </cfquery>
    </cffunction>
