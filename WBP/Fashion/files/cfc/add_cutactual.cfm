...
<cfset cuthead = cutactual.get_cutactual(attributes.id)>
<cfset stestgroup = stretchingtest.get_stretching_test_groups(cuthead.stretching_test_id)>
<cfset qsizes = cutactual.get_stock_property(cuthead.ORDER_ID)>
<cfset cutrows = cutactual.get_cutactual_rows(attributes.id)>
<cfset cutsizes = cutactual.get_cutactual_sizes(attributes.id)>
<cf_catalystHeader>
...
<div id="cutactualing">
    <cfform name="cutactual" method="post">
        <input type="hidden" name="cutactual_id" value="<cfoutput>#cuthead.CUTACTUAL_ID#</cfoutput>">
        <div class="portBox portBottom">
            <div class="portHeadLight font-green-sharp">
                <span>Kesim Formu</span>
            </div>
                                        ...
                                        <div class="form-group" id="item-consumer_id">
                                            ...
                                            <div class="col col-8 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon btnPointer icon-ellipsis" onclick="windowopen('index.cfm?fuseaction=objects.popup_list_all_pars&amp;field_consumer=cutactual.consumer_id&amp;field_comp_id=cutactual.company_id&amp;field_member_name=cutactual.member_name&amp;field_type=cutactual.member_type&amp;is_period_kontrol=0&amp;select_list=7,8&amp;keyword='+encodeURIComponent(document.cutactual.member_name.value),'list');"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" id="item-emp_id">
                                            ...
                                            <div class="col col-8 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon btnPointer icon-ellipsis" onclick="windowopen('index.cfm?fuseaction=objects.popup_list_positions&field_emp_id=cutactual.emp_id&field_name=cutactual.emp_name &select_list=1,2&is_form_submitted=1&keyword='+encodeURIComponent(cutactual.emp_name.value),'list');"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            ...
            <div class="col col-4" style="overflow: auto;" id="list_sizehead" onscroll="if(!window.list_vertical) { window.list_vertical=true; $('#list_sizes').scrollLeft($(this).scrollLeft()); setTimeout(function(){window.list_vertical=false}, 20); }">
        ...
        <div class="row">
            <div class="col col-8" style="max-height: 500px; overflow: auto;" onscroll="if(!window.list_vertical) { window.list_vertical=true; $('#list_sizes').scrollTop($(this).scrollTop()); setTimeout(function(){window.list_vertical=false}, 20); }" id="list_main">

                <input type="hidden" name="mainlist_count" data-bind="value: mainlist().length">
                <table class="form_list">
                    <thead>
                        <tr style="height: 54px;">
                            <th style="width: 150px;">Pastal Adı</th>
                            <th style="width: 120px;">Pastal Çıktısı</th>
                            <th>Kesim Adı</th>
                            <th>Pastal Boyu</th>
                            <th>Kat/Serim Sayısı</th>
                            <th>Asorti Beden Adedi</th>
                            <th>Net Pastal Metrajı</th>
                            <th>Brüt Pastal Boyu</th>
                            <th>Brüt Pastal Metrajı</th>
                            <th>Birim Pastal Metrajı</th>
                            <th>Verimlilik %</th>
                            <th>Kesimden Sonra Mtr</th>
                            <th>Pastal Eni</th>
                            <th>Çekme Rengi</th>
                            <th>Çekme En</th>
                            <th>Çekme Boy</th>
                    ...
                    <tbody>
                        <!-- ko foreach: mainlist -->
                        <tr data-bind="colorline: draft_color" style="height: 36px;">
                            ...
                            <td><input type="text" data-bind="value: cutactual_name, attr: { name: 'cutactual_name_' + $index(), id: 'cutactual_name_' + $index() }"></td>
                            ...
                            <td><input type="text" data-bind="value: assortment_size_amount, attr: { name: 'assortment_size_amount_' + $index(), id: 'assortment_size_amount_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: net_marker_meter().toFixed(2), attr: { name: 'net_marker_meter_' + $index(), id: 'net_marker_meter_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: gross_marker_height().toFixed(2), attr: { name: 'gross_marker_height_' + $index(), id: 'gross_marker_height_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: gross_marker_meter().toFixed(2), attr: { name: 'gross_marker_meter_' + $index(), id: 'gross_marker_meter_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: marker_unit_meter().toFixed(2), attr: { name: 'marker_unit_meter_' + $index(), id: 'marker_unit_meter_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: productivity, attr: { name: 'productivity_' + $index(), id: 'productivity_' + $index() }"></td>
                            <td><input type="text" data-bind="value: after_cut_meter, attr: { name: 'after_cut_meter_' + $index(), id: 'after_cut_meter_' + $index() }"></td>
                            <td><input type="text" data-bind="value: marker_width, attr: { name: 'marker_width_' + $index(), id: 'marker_width_' + $index() }"></td>
                            <td>
                            ...
                            <td><input type="text" data-bind="value: draft_width, attr: { name: 'draft_width_' + $index(), id: 'draft_width_' + $index() }" readonly></td>
                            <td><input type="text" data-bind="value: draft_height, attr: { name: 'draft_height_' + $index(), id: 'draft_height_' + $index() }" readonly></td>
                            <td>
                            ...
                            <td><input type="text" data-bind="value: cut_amount, attr: { name: 'cut_amount_' + $index(), id: 'cut_amount_' + $index() }" readonly></td>
                            <td><a href="javascript:void(0);" onclick="windowopen('<cfoutput>#request.self#?fuseaction=textile.cutactual&event=cutstretch&project_id=#cuthead.PROJECT_ID#&project_head=#cuthead.PROJECT_HEAD#&cutactual_id=#cuthead.CUTACTUAL_ID#&st_id=#cuthead.STRETCHING_TEST_ID#</cfoutput>&marker_name=' + $(this).data('markername') + '&marker_height=' + $(this).data('markerheight'), 'wide')" data-bind="attr: { 'data-markername': marker_name, 'data-markerheight': marker_height }">Top Detayları</a></td>
            ...
            <div class="col col-4" style="max-height: 500px; overflow: auto;" id="list_sizes" onscroll="if(!window.list_vertical) { window.list_vertical=true; $('#list_main').scrollTop($(this).scrollTop()); $('#list_sizehead').scrollLeft($(this).scrollLeft()); setTimeout(function(){window.list_vertical=false}, 20); }">
            ...
            <div class="col col-12">
                <cfoutput><button type="button" onclick="document.location.href='#request.self#?fuseaction=textile.cutplan&event=copy&cutplan_id=#attributes.id#'">Kopyala</button></cfoutput>
...
<script type="text/javascript">
    ...
    var cutactualingApp = function() {
        ...
        self.createMainlist = function( item ) {
            ...
            var mainitem = {
                ...
                cutactual_name            : ko.observable( item == null ? '' : item.cutactual_name ),
        ...
        self.initial = function () {
            ...
            <cfloop query="cutrows">
                ...
                <cfset rowid = CUTACTUAL_ROWID>
                <cfif cutsizes.recordcount>
                    cutrows.sizes = [
                    <cfloop query="cutsizes">
                    <cfif rowid eq CUTACTUAL_ROWID>
    ...
    cutactualingApp.init( 'cutactualing' );
    //cutactualingApp.sample();

    function formkontrol() {
        cutactualingApp.doUpload();
        return true;
    }
