<cfscript>
    ...
    if (attributes.tabMenuController eq 0)
    {
        ...
        WOStruct['#attributes.fuseaction#']['list']['filePath'] = '/WBP/Fashion/files/sales/display/list_fabric_price.cfm';

        WOStruct['#attributes.fuseaction#']['add'] = structNew();
        WOStruct['#attributes.fuseaction#']['add']['window'] = 'normal';
        WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'textile.fabric_price&event=add';
        WOStruct['#attributes.fuseaction#']['add']['filePath'] = '/WBP/Fashion/files/sales/form/add_fabric_price.cfm';
        WOStruct['#attributes.fuseaction#']['add']['queryPath'] = '/WBP/Fashion/files/sales/query/add_fabric_price.cfm';
        ...
        WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/WBP/Fashion/files/sales/form/upd_fabric_price.cfm';
...
fuseactController = attributes.fuseaction;
		...
		tabMenuStruct['#fuseactController#']['tabMenus']['det']['menus'][0]['onClick'] = "window.open('#request.self#?fuseaction=product.list_product&event=add','list');";
