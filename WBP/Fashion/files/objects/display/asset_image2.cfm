...
<cf_box  add_href="#add2_#" add_href_size="wide"> 
        <cfif getAsset.recordcount>
            ...
            <div class="box-list box-list-small col col-12 col-md-12 col-sm-12 col-xs-12 mySlides">
               
                        <div class=" box-list-image-small" >
                                <div class="box-list-image-content">
                                    <div class="image">
                                        <cfif icon>
                                            <img  src="#imagePath#" style="margin: 10px; width:10px;" class="img-thumbnail">
                                        <cfelse>
                                            <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_download_file&<cfif ext eq "jpg" or ext eq "jpeg" or ext eq "png" or ext eq "bmp" or ext eq "pdf" or ext eq "txt" or ext eq "gif">direct_show=1&</cfif>file_name=#url_##getAsset.asset_file_name#&file_control=asset.form_upd_asset&asset_id=#getAsset.asset_id#&assetcat_id=#getAsset.assetcat_id#','medium');">
                                                <!---<img src="#imagePath#" style="margin: 10px; max-width:50px;min-heigth:30px; ">--->
												<!---<img src="#imagePath#" style="margin:  5px; max-width:195px; max-height:420px; " class="img-thumbnail">--->
												<img src="#imagePath#" style="margin: 10px 10px 10px 10px; width:100px; height:150px;" class="img-thumbnail">
                                            </a>
                                        </cfif>
                                    </div>
                                </div>
				 ...
				 <div class="box-list-footer">
                                ...
                                <cfif is_saveimage>
                                        <div class="box-list-footer-bottom">
												<div class="box-list-button-panel col col-12" style="padding-right:100px margin:0 auto; positoin:absolite; bottom:0px">
