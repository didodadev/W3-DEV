        ...
        <cfif getAsset.recordcount>
            ...
            <div class="box-list box-list-small col col-12 col-md-12 col-sm-6 col-xs-12 mySlides" >
                <div class="box-list-content col col-12" >
                        <div class="box-list-image" style="height: 300px;">
                                <div class="box-list-image-content" >
                                    <div class="image" >
                                        <cfif icon>
                                            <img  src="#imagePath#" >
                                        <cfelse>
                                            <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_download_file&<cfif ext eq "jpg" or ext eq "jpeg" or ext eq "png" or ext eq "bmp" or ext eq "gif">direct_show=1&</cfif>file_name=#url_##getAsset.asset_file_name#&file_control=asset.form_upd_asset&asset_id=#getAsset.asset_id#&assetcat_id=#getAsset.assetcat_id#','medium');">
                                                <img src="documents/product/#getAsset.asset_file_name#" >
                                            </a>
                                        </cfif>
                                    </div>
                                </div>
