...
<cfquery name="GET_PROMS" datasource="#DSN3#">
	...
	WHERE
		P.PROM_STATUS = 1 AND
		<cfif isdefined("attributes.startdate") and isdefined("attributes.finishdate")>
...
<cfif get_proms.recordcount>
	<cffile action="write" nameconflict="overwrite" output="<SIGNATURE=GNDPROMOTION.GDF><VERSION=0227000>" addnewline="yes" file="#upload_folder##file_name#" charset="ISO-8859-9">
...
<cfelse>
	<cffile action="write" nameconflict="overwrite" output="<SIGNATURE=GNDPROMOTION.GDF><VERSION=0227000>" addnewline="yes" file="#upload_folder##file_name#">
</cfif>