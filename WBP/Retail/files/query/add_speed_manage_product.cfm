...
<cfquery name="get_" datasource="#dsn_dev#">
        SELECT * FROM SEARCH_TABLES_PRODUCTS WHERE
            TABLE_ID = #attributes.table_id#
    </cfquery>
<cfset attributes.selected_product_list = valuelist(get_.product_id)>

<cfset attributes.changed_product_list = attributes.selected_product_list>
<cfdump var="#get_.recordcount#">
<cfdump var="#attributes.table_id#">
