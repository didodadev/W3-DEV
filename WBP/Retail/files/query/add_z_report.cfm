...
<cflock name="#CreateUUID()#" timeout="60">
	<cftransaction>
		...
		<cfinclude template="../../finance/query/add_daily_zreport1.cfm">
		<!--- Muhasebe işlemleri --->
		<cfinclude template="../../finance/query/add_daily_zreport2.cfm">
		<!--- Kasa işlemleri --->
		<cfinclude template="../../finance/query/add_daily_zreport3.cfm">
		<!--- Pos işlemleri --->
		<cfinclude template="../../finance/query/add_daily_zreport4.cfm">
		<!--- Stok hareketleri --->
		<cfinclude template="../../finance/query/add_daily_zreport5.cfm">
		<cfif attributes.x_show_info eq 1><!--- xml de seçili ise --->
			<!--- Istatiksel Bilgiler --->
			<cfinclude template="../../finance/query/add_daily_zreport7.cfm">				
		</cfif>
...
<cf_get_lang_set module_name="extra">