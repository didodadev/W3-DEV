...
<cf_big_list_search title="Depo Tüm Stok Raporu">
...
<!-- sil -->
    <table cellpadding="2" cellspacing="1" width="99%" align="center" class="color-border">
        ...
        <tbody>
        	<cfoutput>
            <tr class="color-row">
                <td colspan="<cfif isdefined("attributes.stock_info")>15<cfelse>5</cfif>" style="background-color:##6CC;" class="form-title">Genel Toplamlar</td>
                <cfif listlen(attributes.search_department_id)>
                    <cfloop query="get_list_departments">
        	...
        	<cfoutput query="get_internaldemand">
                ...
                <cfif currentrow eq get_internaldemand.recordcount or not get_internaldemand.stock_code[currentrow + 1] contains ucuncu_>
                	<tr class="color-row">
                    	<td colspan="<cfif isdefined("attributes.stock_info")>15<cfelse>5</cfif>" style="background-color:##6CC;" class="form-title">Toplamlar</td>
                        <cfif listlen(attributes.search_department_id)>
                            <cfloop query="get_list_departments">
