...
<!---<cfquery name="get_comps" datasource="#dsn#">
	ISNULL((SELECT
                ...
                C.CITY,
                CC.COMPANYCAT,
                ISNULL((SELECT PROPERTY1 FROM INFO_PLUS WHERE INFO_OWNER_TYPE = -1 AND OWNER_ID = C.COMPANY_ID AND PROPERTY1 <> ''),'Hayır') AS LISTEDE_GETIRME
            FROM
                COMPANY C,
                COMPANY_CAT CC
            WHERE
...
<cfsavecontent  variable="head"><cf_get_lang dictionary_id='61877.Cari Satış Raporu'></cfsavecontent>
<cf_report_list_search title="#head#">
    <cf_report_list_search_area>
        <cfform action="#request.self#?fuseaction=retail.purchase_sale_company_report" method="post" name="search_depo">
                        ...
                        <div class="row" type="row">	
                            ...
                            <div class="col col-3 col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col col-12 col-xs-12">
                                        <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=retail.popup_select_rival_products&type=10&op_f_name=add_row</cfoutput>','list');"><i class="icn-md fa fa-plus-square"></i></a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col col-12 col-xs-12"></label>
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cf_box uidrop="1" hide_table_column="1">
        <cf_grid_list>
            <thead>
                <tr>
                ...
                <th style="text-align:center;" colspan="6"><cf_get_lang dictionary_id='53263.Toplamlar'></th>
                </tr>
            </thead>
            <thead>
                <tr>
                    ...
                    <cfoutput query="get_list_departments">
                        ...
                        <th style="text-align:right; display:;" rel="depo_cols"><cf_get_lang dictionary_id='39129.Satış Tutarı'>(<cf_get_lang dictionary_id='48656.KDV Hariç'>)</th>
                        <th style="text-align:right; display:;" rel="depo_cols"><cf_get_lang dictionary_id='39129.Satış Tutarı'>(<cf_get_lang dictionary_id='62048.Brüt Kdvsiz'>)</th>
                        <th style="text-align:right; display:;" rel="depo_cols"><cf_get_lang dictionary_id='61545.Brüt KDVli Tutar'></th>
                    </cfoutput>
                    </cfif>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='29959.Satış Miktar'></th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='39129.Satış Tutarı'>(<cf_get_lang dictionary_id='48656.KDV Hariç'>)</th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='39129.Satış Tutarı'>(<cf_get_lang dictionary_id='62048.Brüt Kdvsiz'>)</th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='61545.Brüt KDVli Tutar'></th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='62049.Satış Maliyet Kdvsiz'></th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='62050.Satış Maliyet Kdvli'></th>
                </tr>
            </thead>
            <tbody>
            ...
            <cfoutput query="get_list_departments">
                ...
                <cfoutput query="get_internaldemand">
                    ...
                    <!--- <td style="text-align:right;">#tlformat(row_yeterlilik)#</td>
                        ...
                        <!---<td style="text-align:right; background-color:##CF9;">#tlformat(liste_fiyati_alis)#</td>  emrah ---->
                    ...
                    <tr>
                        <!---<td colspan="9" style="background-color:##CCF;"><b>#last_group_id_#</b> Toplamları</td> 
                        <cfloop from="1" to="#get_list_departments.recordcount#" index="dept">
                            <cfset dept_ = get_list_departments.department_id[dept]>
                            <cfif isdefined("attributes.is_department_multi")>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">
                            ...
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">&nbsp;</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_stok_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_stok_tutar_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_alim_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_alim_tutar_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_satis_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">#tlformat(Evaluate('group_total_satis_tutar_#dept_#'))#</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">&nbsp;</td>
                            <td style="text-align:right; display:;background-color:##CCF;" rel="depo_cols">&nbsp;</td>
                            </cfif>
                        </cfloop>
            ...
            <tfoot>
                <tr>
                    <td colspan="0"><b><cf_get_lang dictionary_id='40035.Genel Toplamlar'></b></th>
                    <cfloop from="1" to="#get_list_departments.recordcount#" index="dept">
                    <cfif isdefined("attributes.is_department_multi")>
                        <td style="text-align:right; display:;" rel="depo_cols">&nbsp;</td>
                        <td style="text-align:right; display:;" rel="depo_cols">&nbsp;</td>
                ...
                <!--- <td style="text-align:right;background-color:##CCF;"><cfif t_row_yeterlilik gt 0>#tlformat(t_row_yeterlilik / t_row_stock_count)#</cfif></td>
                    ...
                    <!---<td style="text-align:right;background-color:##CCF;">#tlformat(t_row_total_liste_fiyati_alis)#</td> emrah --->
