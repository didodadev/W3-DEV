...
<!-- sil -->
    ...
    <thead>             
        <tr>
            <th>Tarih</th>
            <th>Talep Edilen</th>
            <th style="text-align:right; width:50px;">Tale Edilen M. Stok</th>
            <th>Talep Eden</th>
            <th style="text-align:right; width:50px;">Talep Eden M. Stok</th>
            <th>Barkod</th>
            <th>Stok</th>
            <th>No</th>
            <th>Kod</th>
    ...
    <cfif get_dagilim.recordcount>
        ...
        <tr>
            ...
            <td nowrap="nowrap">#DEPT_OUT#</td>
            <td style="text-align:right;">#OUT_STOCK#</td>
            <td nowrap="nowrap">#DEPT_IN#</td>
            <td style="text-align:right;">#IN_STOCK#</td>
            <td>#BARCOD#</td>
            <td nowrap="nowrap">#STOK_ADI#</td>
            <td><a href="#request.self#?fuseaction=stock.upd_dispatch_internaldemand&ship_id=#DISPATCH_SHIP_ID#" target="s_window" class="tableyazi">#DISPATCH_SHIP_ID#</a></td>
            <td>#code#</td>
        ...
        <tr>
            <td colspan="9" class="formbold" style="background-color:##F96;">#dateformat(deliver_date,'dd/mm/yyyy')# Toplam</td>
    ...
    <tfoot>
    	<tr>
            <td colspan="9" class="formbold">Genel Toplam</td>
