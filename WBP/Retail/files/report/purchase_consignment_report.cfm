...
<cfquery name="get_uretici" datasource="#DSN_dev#">
	SELECT SUB_TYPE_ID,SUB_TYPE_NAME FROM EXTRA_PRODUCT_TYPES_SUBS WHERE TYPE_ID = #uretici_type_id# AND SUB_TYPE_ID IN ('7438','7470','7412')
</cfquery>

<cfsavecontent variable="title"><cf_get_lang dictionary_id='62250.Konsinye Alış Satış Raporu'></cfsavecontent>
<cf_report_list_search title="#title#">
    <cf_report_list_search_area>
        <cfform action="#request.self#?fuseaction=retail.purchase_consignment_report" method="post" name="search_depo">
                        ...
                        <div class="row" type="row">	
                            ...
                            <div class="col col-3 col-md-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col col-12 col-xs-12">
                                        <a href="javascript://" onclick="openBoxDraggable('<cfoutput>#request.self#?fuseaction=retail.popup_select_rival_products&type=10&op_f_name=add_row</cfoutput>');"><i class="icn-md icon-plus-square"></i></a>
                                    </div>
                                </div>
                                <div id="product_div">
        ...
        <cf_grid_list>
            <thead>
                <tr>
                    ...
                    <th><cf_get_lang dictionary_id='37916.Satış KDV'></th>
            ...
            <thead>
                <tr>
                    ...
                    <cfoutput query="get_list_departments">
                        ...
                        <th style="text-align:right; display:;" rel="depo_cols"><cf_get_lang dictionary_id='39129.Satış Tutarı'> <cf_get_lang dictionary_id='62251.Brüt KDVli'></th>
                    </cfoutput>
                    </cfif>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62208.Stok Yeterlilik'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62209.Ortalama Satış'></th>
                    <th style="text-align:">S.<cf_get_lang dictionary_id='62214.Tutar Toplam'> H %</th>
                    <th style="text-align:right;">T. <cf_get_lang dictionary_id='62210.Güncel Stok'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62211.Güncel Stok Tutarı'> <cf_get_lang dictionary_id='62212.Toplam Hariç'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='39874.Alış Miktarı'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='39875.Alış Tutarı'> <cf_get_lang dictionary_id='32998.KDV Hariç'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='29959.Satış Miktar'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='39129.Satış Tutarı'> <cf_get_lang dictionary_id='32998.KDV Hariç'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='39129.Satış Tutarı'> <cf_get_lang dictionary_id='62048.Brüt KDVsiz'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='39129.Satış Tutarı'> <cf_get_lang dictionary_id='62251.Brüt KDVli'></th>
                    <th style="text-align:"><cf_get_lang dictionary_id='46811.Alış Fiyat'> <cf_get_lang dictionary_id='32998.KDV Hariç'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62049.Satış Maliyet Kdvsiz'></th>
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62050.Satış Maliyet Kdvli'></th>
                <!---  <th style="text-align:">T. Satış Liste Kdvsiz</th>
                    --->
                    <th style="text-align:">T. <cf_get_lang dictionary_id='62252.Satış Liste KDVli'></th>
                </tr>
            </thead>
            <tbody>
            ...
            <cfoutput query="get_list_departments">
                ...
                <cfoutput query="get_internaldemand">
                    ...
                    <tr>
                        ...
                        <td>#marka#</td>
                        <td>#ambalaj#</td>
                        <td><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=retail.popup_product_stocks&stock_id=#stock_id#','page_display');" class="tableyazi">
                            #stock_code#</a></td>
                        <td>#TAX_PURCHASE#</td>
                        <td>#TAX#</td>
                        <cfloop from="1" to="#get_list_departments.recordcount#" index="dept">
                    ...
                    <tr>
                        <td colspan="8" style=""><b>#last_group_id_#</b> Toplamları</td>
                        <cfloop from="1" to="#get_list_departments.recordcount#" index="dept">
                            <cfset dept_ = get_list_departments.department_id[dept]>
                            <cfif isdefined("attributes.is_department_multi")>
            ...
            <tfoot>
                <tr>
                    <td colspan="6" ><b><cf_get_lang dictionary_id='40035.Genel Toplamlar'></b></th>
                    <cfloop from="1" to="#get_list_departments.recordcount#" index="dept">
                    <cfif isdefined("attributes.is_department_multi")>
                        <td style="text-align:right; display:;" rel="depo_cols">&nbsp;</td>
                        <td style="text-align:right; display:;" rel="depo_cols">&nbsp;</td>
