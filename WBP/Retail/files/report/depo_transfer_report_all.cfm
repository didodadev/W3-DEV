...
<cfsavecontent  variable="head"><cf_get_lang dictionary_id='61868.Depo Sipariş Raporu'></cfsavecontent>
<cf_report_list_search title="#head#">
    <cf_report_list_search_area>
        <cfform action="#request.self#?fuseaction=retail.depo_transfer_report_all" method="post" name="search_depo">
                    ...
                    <div class="row formContent">
                        <div class="row" type="row">
                            <div class="col col-3 col-md-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="col col-12 col-xs-12"><cf_get_lang dictionary_id='56236.Kayıt Tipi'></label>
                                    <div class="col col-12 col-xs-12">
                            ...
                            <div class="col col-3 col-md-6 col-xs-12">
                                <div class="form-group">
                                    <label class="col col-12 col-xs-12"><cf_get_lang dictionary_id='62056.Giriş Departman'></label>
                                    <div class="col col-12 col-xs-12">
                                        <cf_multiselect_check 
                                        query_name="get_departments_search"  
                                        name="search_department_id"
                                        option_text="#getLang('','Departman',62056)#" 
                                        width="180"
                                ...
                                <div class="form-group">
                                    <label class="col col-12 col-xs-12"><cf_get_lang dictionary_id='62057.Çıkış Departman'></label>
                                    <div class="col col-12 col-xs-12">
                                        <cf_multiselect_check 
                                        query_name="get_departments_search"  
                                        name="search_department_id"
        ...
        <cf_grid_list>
            <thead>             
                <tr>
                    ...
                    <!-- sil --><th><cf_get_lang dictionary_id='56535.Talep Edilen'></th><!-- sil -->
                    <!-- sil --><th style="text-align:right; width:50px;"><cf_get_lang dictionary_id='62058.Talep Edilen Miktar Stok'></th><!-- sil -->
                    <th><cf_get_lang dictionary_id='47953.Talep Eden'></th>
                    <!-- sil --><th style="text-align:right; width:50px;"><cf_get_lang dictionary_id='62059.Talep Eden Miktar Stok'></th><!-- sil -->
            ...
            <tfoot>
                <tr>
                    <td colspan="<cfif fusebox.fuseaction contains 'excel'>4<cfelse>8</cfif>" class="formbold"><cf_get_lang dictionary_id='57680.Genel Toplam'></td>
