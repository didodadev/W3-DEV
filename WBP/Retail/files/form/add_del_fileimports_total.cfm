...
<cfform name="form_basket" action="#request.self#?fuseaction=retail.emptypopup_add_del_fileimports_total" method="post" onsubmit="return ( kontrol());">
<input type="hidden" name="is_del_file" id="is_del_file" value="0">
    <table>
		...
		<tr>
			<td>Sayım Tipi</td>
			<td>
				<select name="file_type" id="file_type" style="width:135px;">
