<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['fuseaction']	= 'retail.depo_stock_report_upper';
		WOStruct['#attributes.fuseaction#']['list']['filePath']		= '/WBP/Retail/files/report/depo_stock_report_upper.cfm';
        WOStruct['#attributes.fuseaction#']['list']['queryPath']	= '/WBP/Retail/files/report/depo_stock_report_upper.cfm';
