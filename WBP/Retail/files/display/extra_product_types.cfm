<cf_wrk_grid search_header = "Ürün Ektra Tanımları (Kriterler)" dictionary_count="1" table_name="EXTRA_PRODUCT_TYPES" sort_column="TYPE_NAME" u_id="TYPE_ID" datasource="#dsn_dev#" is_delete="1" search_areas = "TYPE_NAME">
    <cf_wrk_grid_column name="TYPE_ID" header="ID" display="yes" width="50" select="no"/>
