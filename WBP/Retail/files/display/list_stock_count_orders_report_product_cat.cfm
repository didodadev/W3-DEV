...
<cf_report_list_search title="#getLang('','Kategori Bazlı Sayım Karşılaştırma Raporu',62749)#">
    <cf_report_list_search_area>
        <cfform action="#request.self#?fuseaction=retail.list_stock_count_orders_report_product_cat" method="post" name="search_depo">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col col-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon no-bg"></span>
                                                <select name="size_type" id="size_type" style="width:70px;">
...
<cfelse>
 ...
 <!---    <cfquery dbtype="query" name="sum_query">
     	SELECT 
        SUM(TOPLAM_COUNT_TUTAR) FROM get_counts
     </cfquery>--->
