...
<cf_workcube_process 
	...
	action_page='#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['det']['fuseaction']##attributes.demand_id#' 
	warning_description = 'Worknet Talep : #attributes.demand_head#'>

<script type="text/javascript">
    window.location.href = "<cfoutput>#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['det']['nextEvent']##attributes.demand_id#</cfoutput>";
</script>
