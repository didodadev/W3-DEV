...
<cflock name="#CreateUUID()#" timeout="20">
	<cftransaction>
		...
		<cfset cmp = createObject("component","#addonNS#.components.companies.member") />
            ...
            <cfif len(attributes.email)>
                ...
                <cfoutput>
                    <cfsavecontent variable="message">
                        <p class="yazilar">Sayın #attributes.nameless# #attributes.soyad#,</p>
...
<script type="text/javascript">
	<cfoutput>
		window.location.href = '#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['add-partner']['nextEvent']##attributes.company_id#';
	</cfoutput>
</script>
