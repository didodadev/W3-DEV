	...
	<cfif get_interaction.recordcount>
        ...
        <tbody>
			<cfoutput query="get_interaction">
                <tr>
                    <td><a href="#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['interactions-relation']['fuseaction']##cus_help_id#" class="tableyazi">#detail#</a></td>
                    ...
                    <td width="15"><a href="#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['interactions-relation']['fuseaction']##cus_help_id#"><img src="/images/update_list.gif" border="0"></a></td>
                </tr>
            </cfoutput>
            <tr>
                <td colspan="5" style="text-align:right;" class="txtbold">
                    <a href="<cfoutput>#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['interactions-list']['fuseaction']#</cfoutput>"><cf_get_lang_main no="296.Tümü"></a>
                </td>
            </tr>
        </tbody>	
	<cfelse>
