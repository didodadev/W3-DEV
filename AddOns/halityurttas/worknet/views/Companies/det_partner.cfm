<cf_xml_page_edit fuseact="member.detail_partner">
    ...
    <cfset pageHead="Partner: #getPartner.company_partner_name#&nbsp;#getPartner.company_partner_surname#">
    
    <cf_catalystHeader>
    
    <cfform name="upd_partner" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col col-9 col-xs-12">
                <cfinclude template="_det_partner_content.cfm">
                
            </div>
            <div class="col col-3 col-xs-12">
                <cfinclude template="_det_partner_right.cfm">
    ...
    document.getElementById('nameless').focus();
    </script>
