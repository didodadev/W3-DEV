...
<cfform name="search_demand" action="#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['list']['fuseaction']#" method="post">
                ...
                <div class="col col-12 form-inline">
                    <div class="form-group">
                        <div class="input-group x-10">
                            <cfsavecontent variable="filter"><cf_get_lang_main no='48.Filtre'></cfsavecontent>
                            <cfinput type="text" name="keyword" id="keyword" value="#attributes.keyword#" placeholder="#filter#">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group x-10">
                            <input type="text" name="start_date" id="start_date" value="<cfif len(attributes.start_date)><cfoutput>#dateformat(attributes.start_date,'dd/mm/yyyy')#</cfoutput></cfif>" maxlength="10" style="width:65px;" placeholder="Başlangıç Tarihi">
                            <span class="input-group-addon"><cf_wrk_date_image date_field="start_date"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group x-10">
                            <input type="text" name="finish_date" id="finish_date" value="<cfif len(attributes.finish_date)><cfoutput>#dateformat(attributes.finish_date,'dd/mm/yyyy')#</cfoutput></cfif>" maxlength="10" style="width:65px;" placeholder="Bitiş Tarihi">
                            <span class="input-group-addon"><cf_wrk_date_image date_field="finish_date"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group x-10">
                            <cfsavecontent variable="filter"><cf_get_lang_main no='155.Ürün Kategorileri'></cfsavecontent>
            ...
            <div class="row" type="row">
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="form-group" id="item-demand_stage">
                        <label class="col col-4 col-xs-12"><cf_get_lang_main no='70.Aşama'></label>
                        <div class="col col-8 col-xs-12">
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                    ...
                    <div class="form-group" id="item-demand_type">
                        <label class="col col-4 col-xs-12"><cf_get_lang no ='81.Talep Turu'></label>
                        <div class="col col-8 col-xs-12">
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
                    <div class="form-group" id="item-project_id">
                        <label class="col col-4 col-xs-12"><cf_get_lang_main no='4'></label>
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                 ...
                                 <span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_projects&project_id=search_demand.project_id&project_head=search_demand.project_head','list');"></span>
                            </div>
                        </div>
                    </div>            		
                </div>    		    		
...
<cf_big_list>
    <thead>
        <tr>
            ...
            <th class="header_icn_none"><a href="index.cfm?fuseaction=<cfoutput>#WOStruct['#attributes.fuseaction#']['add']['fuseaction']#</cfoutput>" title="Ekle"><img src="/images/plus_list.gif" title="<cf_get_lang_main no='170.Ekle'>" alt="<cf_get_lang_main no='170.Ekle'>"></a></th>
        </tr>
    </thead>
    <tbody>
        <cfif getDemand.recordcount>
            <cfoutput query="getDemand" maxrows="#attributes.maxrows#" startrow="#attributes.startrow#">
                <tr>
                    <td>#currentrow#</td>
                    <td>
                        <a href="#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['det']['fuseaction']##demand_id#" class="tableyazi">#demand_head#</a>
                    </td>
                    <td>
                        <cfif demand_type eq 1><cf_get_lang no ='79.Alım'><cfelse><cf_get_lang no ='80.Satim'></cfif>
                    </td>
                    <!--- query of type --->    
                    <cfset getProductProcess = objectResolver.resolveByRequest("#addonNS#.components.common.process").getProcess(fuseaction:attributes.fuseaction,process_row_id:getDemand.stage_id)/>
                    <!--- /query of type --->
                    <td>#getProductProcess.stage#</td>
                    <td>
                        <cfif is_status eq 1><cf_get_lang_main no ='81.Aktif'><cfelse><cf_get_lang_main no ='82.Pasif'></cfif>
                    </td>
                    <td>
                        #dateformat(start_date,'dd/mm/yyyy')# <cfif len(finish_date)>- #dateformat(finish_date,'dd/mm/yyyy')#</cfif>
                    </td>
                    <td>
                        <a href="#request.self#?fuseaction=#WOStruct['#attributes.fuseaction#']['company']['fuseaction']##company_id#" class="tableyazi">#fullname#</a>
                    </td>
                    <td>
                        <a href="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.detail_partner&pid=#partner_id#" class="tableyazi">#partner_name#</a>
                    </td>
                    <td width="15"><a href="index.cfm?fuseaction=#WOStruct['#attributes.fuseaction#']['company']['fuseaction']##demand_id#" title=" Güncelle "><img src="/images/update_list.gif" alt="<cf_get_lang_main no='52.Güncelle'>" title="<cf_get_lang_main no='52.Güncelle'>"></a></td>
                </tr>
            </cfoutput>
        <cfelse>
            <tr>
    ...
    <tr>
        <td>
          <cf_pages page="#attributes.page#" 
            ...
            adres="#WOStruct['#attributes.fuseaction#']['list']['fuseaction']##url_str#">
