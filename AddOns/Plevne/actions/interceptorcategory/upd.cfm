...
<cfset inst_interceptor_categories.save_interceptor_categories(interceptor_category_id: attributes.interceptor_category_id, title: attributes.title, status: attributes.status, interceptor_kind: attributes.kind)>
