...
<cfset inst_expression.save_expressions(expression_category: attributes.expression_category, expression_body: attributes.expression_body, status: attributes.status)>
