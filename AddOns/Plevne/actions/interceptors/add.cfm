...
<cfset inst_interceptor.save_interceptors(interceptor_category: attributes.interceptor_category, interceptor_path: attributes.interceptor_path, status: attributes.status)>
