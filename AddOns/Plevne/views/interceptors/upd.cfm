...
<cfset query_interceptor = inst_interceptor.get_interceptors(interceptor_id: attributes.id)>

<cf_catalystHeader>
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cf_box>
        <cfform name="add_form" method="post">
            <input type="hidden" name="interceptor_id" value="<cfset writeOutput(attributes.id)>">
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    <div class="form-group" id="item-interceptor_body">
                        ...
                        <div class="col col-8 col-xs-12">
                            <input type="text" name="interceptor_path" value="<cfset writeOutput(query_interceptor.interceptor_path)>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group" id="item-status">
                        ...
                        <div class="col col-8 col-xs-12">
                            <select name="status" id="status">
                                <option value="1" <cfif query_interceptor.status eq 1>selected</cfif>><cf_get_lang dictionary_id='57493.Aktif'></option>
                                <option value="0" <cfif query_interceptor.status eq 0>selected</cfif>><cf_get_lang dictionary_id='57494.Pasif'></option>
                            </select>
                        </div>
                    </div>
                </div>
