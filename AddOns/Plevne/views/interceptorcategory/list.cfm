...
<cfif isDefined("attributes.is_form_submitted")>
    ...
    <cfset query_exp_cats = inst_interceptor_categories.get_interceptor_categories(title: attributes.keyword, status: attributes.status, interceptor_kind: attributes.kind)>
<cfelse>
...
<div class="col col-12">
    ...
    <cfsavecontent variable="title"><cf_get_lang dictionary_id='42988.Kod Kategorisi'></cfsavecontent>
    <cf_box title="#title#" uidrop="1">
        <cf_flat_list>
            <thead>
                ...
                <th style="width: 60px;"><a href="javascript://" onClick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=plevne.interceptorcategory&event=add');"><i class="fa fa-plus" title="<cf_get_lang dictionary_id ='57582.Ekle'>" alt="<cf_get_lang dictionary_id ='57582.Ekle'>"></i></a></th>
            </thead>
            <tbody>
                <cfif attributes.totalrecords gt 0>
                    <cfoutput query="query_exp_cats">
                        <tr>
                            <td>#currentrow#</td>
                            <td><a href="#request.self#?fuseaction=plevne.interceptorcategory&event=det&id=#interceptor_category_id#" class="tbl-yazi">#title#</a></td>
                            <td><cfif status eq "1"><cf_get_lang dictionary_id='57493.Aktif'><cfelse><cf_get_lang dictionary_id='57494.Pasif'></cfif></td>
                            <td><a href="javascript://" onClick="openBoxDraggable('#request.self#?fuseaction=plevne.interceptorcategory&event=upd&id=#interceptor_category_id#');"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id ='57464.Güncelle'>"></i></a></td>
                        </tr>
                    </cfoutput>
                <cfelse>
                    <tr>
