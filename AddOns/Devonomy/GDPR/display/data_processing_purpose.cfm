		...
		<cf_flat_list>
			<thead>
				<tr>
					...
					<th><cf_get_lang dictionary_id='61739.Veri İşleme Amacı'></th>
				...
				<cfif gdpr_data.recordcount>
					...
					<cfoutput query="gdpr_data">
						<tr>
							...
							<!-- sil -->
							<td width="35"><a href="#request.self#?fuseaction=#url.fuseaction#&event=upd&id=#DATA_PROCESSING_PURPOSE_ID#" class="tableyazi"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></a></td>
							<!-- sil -->
						</tr>
					</cfoutput>
				<cfelse>
