	...
	if (isdefined("attributes.form_submitted"))
{
	...
	gdpr_data = gdpr_comp.get_data_subject_group(
...
<div class="col col-12 col-xs-12">
	<cf_box>
		<cfform name="data_subject_group" action="#request.self#?fuseaction=#url.fuseaction#">
	...
	<cf_box title="#getLang('','Veri Konusu Grubu',61737)#">
		<cf_flat_list>
			<thead>
				<tr>
				...
				<cfif gdpr_data.recordcount>
					...
					<cfoutput query="gdpr_data">
						<tr>
							...
							<td>#DATA_SUBJECT_GROUP_DESCRIPTION#</td>
							<td>#status[ArrayFind(status, function(struct){ return struct.value == gdpr_data.IS_ACTIVE;} )]["name"]#</td>
							<!-- sil -->
							<td width="35"><a href="#request.self#?fuseaction=#url.fuseaction#&event=upd&id=#DATA_SUBJECT_GROUP_ID#" class="tableyazi"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></i></a></td>
							<!-- sil -->
						</tr>
					</cfoutput>
				<cfelse>
