...
<div class="col col-12 col-xs-12">
	...
	<cf_box  title="#getLang('','Güvenlik Önlemi',61733)#" uidrop="1" hide_table_column="1">
		<cf_flat_list>
			<thead>
				<tr>
					<th width="35"><cf_get_lang dictionary_id='58577.Sıra'></th>  
					<th><cf_get_lang dictionary_id='61733.Güvenlik Önlemi'></th>
					<th><cf_get_lang dictionary_id='61744.Güvenlik Önlem Tipi'></th>
				...
				<cfif gdpr_data.recordcount>
					...
					<cfoutput query="gdpr_data">
						<tr>
							...
							<!-- sil -->
							<td width="35"><a href="#request.self#?fuseaction=#url.fuseaction#&event=upd&id=#data_precaution_id#" class="tableyazi"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></a></td>
							<!-- sil -->
						</tr>
					</cfoutput>
				<cfelse>
