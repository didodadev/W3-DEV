<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'AddOns/N1-Soft/textile/sales/display/list_currency_history.cfm';
		...
		WOStruct['#attributes.fuseaction#']['addCurrencies']['filePath'] = 'AddOns/N1-Soft/textile/sales/form/add_currency_info.cfm';
		WOStruct['#attributes.fuseaction#']['addCurrencies']['queryPath'] = 'AddOns/N1-Soft/textile/sales/query/add_currency_info_act.cfm';
		...
		WOStruct['#attributes.fuseaction#']['addCurrenciesHistory']['filePath'] = 'AddOns/N1-Soft/textile/sales/form/add_currency_hist_info.cfm';
		WOStruct['#attributes.fuseaction#']['addCurrenciesHistory']['queryPath'] = 'AddOns/N1-Soft/textile/sales/query/add_currency_hist_info_act.cfm';
