...
<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'AddOns/n1-soft/textile/product/display/list_product_models.cfm';
		
		WOStruct['#attributes.fuseaction#']['add'] = structNew();
		WOStruct['#attributes.fuseaction#']['add']['window'] = 'popup';
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'textile.popup_add_product_model';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'AddOns/n1-soft/textile/product/form/add_product_model.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'AddOns/n1-soft/textile/product/query/add_product_model.cfm';
		...
		if(isdefined("attributes.model_id"))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'AddOns/n1-soft/textile/product/form/add_product_model.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'AddOns/n1-soft/textile/product/query/add_product_model.cfm';
