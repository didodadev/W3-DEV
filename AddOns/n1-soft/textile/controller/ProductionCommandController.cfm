<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'AddOns/n1-soft/textile/production/display/list_production_orders_grup.cfm';	
		
		WOStruct['#attributes.fuseaction#']['upd'] = structNew();
		WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
		WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'textile.order';
		WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'AddOns/N1-Soft/textile/production/form/upd_prod_order.cfm';
		WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/upd_production_order.cfm';
		...
		WOStruct['#attributes.fuseaction#']['updquery']['filePath'] = 'AddOns/N1-Soft/textile/production/query/upd_production_order.cfm';
		WOStruct['#attributes.fuseaction#']['updquery']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/upd_production_order.cfm';
		...
		if(IsDefined("attributes.event") && (attributes.event is 'upd' || attributes.event is 'del'))
		{
			...
			WOStruct['#attributes.fuseaction#']['del']['filePath'] = 'AddOns/N1-Soft/textile/production/query/del_production_order.cfm';
			WOStruct['#attributes.fuseaction#']['del']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/del_production_order.cfm';
