<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'AddOns/N1-Soft/textile/production/display/list_prod_order_results.cfm';
		...
		if(attributes.event is 'add')
		{
			...
			WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'AddOns/N1-Soft/textile/production/form/add_prod_order_result.cfm';
			WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/add_prod_order_result.cfm';
		...
		if(isdefined("attributes.party_id") and isdefined("attributes.pr_order_id"))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'AddOns/N1-Soft/textile/production/form/upd_prod_order_result.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/upd_prod_order_result.cfm';
		...
		if(IsDefined("attributes.event") && (attributes.event is 'upd' || attributes.event is 'del'))
		{
			...
			WOStruct['#attributes.fuseaction#']['del']['filePath'] = 'AddOns/N1-Soft/textile/production/query/upd_prod_order_result.cfm';
			WOStruct['#attributes.fuseaction#']['del']['queryPath'] = 'AddOns/N1-Soft/textile/production/query/upd_prod_order_result.cfm';
