...
<cf_big_list_search title="Üretim Siparişleri">
            ...
            <div class="col col-12 form-inline ">
                ...
                <div class="form-group">
                    <select name="durum_siparis" id="durum_siparis">
                       <option value="" <cfif not len(attributes.durum_siparis)>selected</cfif>><cf_get_lang_main no='296.Tümü'></option>
                       <option value="1" <cfif attributes.durum_siparis eq 1>selected</cfif>><cf_get_lang no='136.Üretim Emri Verilenler'></option>
                       <option value="0" <cfif attributes.durum_siparis eq 0>selected</cfif>><cf_get_lang no='154.Üretim Emri Verilmeyenler'></option>
                       <option value="2" <cfif attributes.durum_siparis eq 2>selected</cfif>>Operasyon Dağıtımı Yapılanlar</option>
                       <option value="3" <cfif attributes.durum_siparis eq 3>selected</cfif>>Operasyon Dağıtımı Yapılmayanlar</option>
                       <option value="4" <cfif attributes.durum_siparis eq 4>selected</cfif>>ÜE Sonuç Girilenler</option>
                       <option value="5" <cfif attributes.durum_siparis eq 5>selected</cfif>>ÜE Sonuç Girilmeyenler</option>
                   </select>
               </div>
                <div class="form-group">
                    <select name="date_filter" id="date_filter">
                        <option value=""><cf_get_lang_main no='1512.Tüm Tarihler'></option>
                        <option value="1" <cfif attributes.date_filter eq 1>selected</cfif>><cf_get_lang no ='503.Sipariş Tarihine Göre Artan'></option>
                        <option value="0" <cfif attributes.date_filter eq 0>selected</cfif>><cf_get_lang no ='504.Sipariş Tarihine Göre Azalan'></option>
                        <option value="2" <cfif attributes.date_filter eq 2>selected</cfif>><cf_get_lang no ='505.Tesim Tarihine Göre Artan'></option>
                        <option value="3" <cfif attributes.date_filter eq 3>selected</cfif>><cf_get_lang no ='506.Teslim Tarihine Göre Azalan'></option>
                        <option value="4" <cfif attributes.date_filter eq 4>selected</cfif>><cf_get_lang no ='507.Ürün İsmine Göre Artan'></option>
                        <option value="5" <cfif attributes.date_filter eq 5>selected</cfif>><cf_get_lang no ='508.Ürün İsmine Göre Azalan'></option>
                        <option value="6" <cfif attributes.date_filter eq 6>selected</cfif>><cf_get_lang no ='509.Cari İsmine Göre Artan'></option>
                        <option value="7" <cfif attributes.date_filter eq 7>selected</cfif>><cf_get_lang no ='510.Cari İsmine Göre Azalan'></option>
                        <option value="8" <cfif attributes.date_filter eq 8>selected</cfif>><cf_get_lang no ='39.Stok Koduna Göre  Artan'></option>
                        <option value="9" <cfif attributes.date_filter eq 9>selected</cfif>><cf_get_lang no ='41.Stok Koduna Göre  Azalan'></option>
                    </select>
                </div>
                <div class="form-group">
        ...
        <div class="row" type="row">
            <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                ...
                <div class="form-group" id="item-sales_partner">
                    <label class="col col-12"><cf_get_lang no='473.Satış Ortağı'></label>
                    <div class="col col-12">
                        <div class="input-group">
            ...
            <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                ...
                <div class="form-group" id="item-project-member_name">
                    <label class="col col-12"><cf_get_lang_main no='4.Proje'> <cf_get_lang_main no='107.Cari Hesap'></label>
                    <div class="col col-12">
                        <div class="input-group">
                            ...
                            <span class="input-group-addon icon-ellipsis btnPointer" title="" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_all_pars&field_consumer=search.pro_consumer_id&field_comp_id=search.pro_company_id&field_member_name=search.pro_member_name&field_type=search.pro_member_type&select_list=7,8&keyword='+encodeURIComponent(document.search.pro_member_name.value),'list');"></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
                    ...
                    <div class="col col-12">
                        <div class="input-group">
                            <cfif session.ep.our_company_info.UNCONDITIONAL_LIST>
                             ...
                             <cfelse>
                                <input required="Yes" maxlength="10" type="text" name="start_date_order" id="start_date_order"  validate="#validate_style#" style="width:65px;" value="<cfoutput>#dateformat(attributes.start_date_order,dateformat_style)#</cfoutput>">
                            </cfif>
                            ...
                            <cfelse>
                                <cfinput required="Yes" maxlength="10" type="text" name="finish_date_order" id="finish_date_order" value="#dateformat(attributes.finish_date_order,dateformat_style)#"  validate="#validate_style#" style="width:65px;">
                            </cfif>
                ...
                <div class="form-group" id="item-start_date">
                    ...
                    <div class="input-group">
                            ...
                            <cfelse>
                                <cfinput type="text" name="start_date" id="start_date" required="Yes" maxlength="10"  validate="#validate_style#" style="width:65px;" value="#dateformat(attributes.start_date,dateformat_style)#">
                            </cfif>
                            ...
                            <cfelse>
                                <input required="Yes" maxlength="10" type="text" name="finish_date" id="finish_date" value="<cfoutput>#dateformat(attributes.finish_date,dateformat_style)#</cfoutput>"  validate="#validate_style#" style="width:65px;">
                            </cfif>
...
<table width="100%">
	<tr>
		...
		<td style="text-align:right;"><cf_get_lang_main no='128.Toplam Kayıt'>:<cfoutput>#attributes.totalrecords#</cfoutput>&nbsp;-&nbsp;<cf_get_lang_main no='169.Sayfa'>:<cfoutput>#attributes.page#/#lastpage#</cfoutput></td>
	</tr>
</table>
</cfif>
...
function operasyon_dagit(crtrow,prod_id,stock_id,order_amount,order_id,spect_main_id,renkid,operasyon_id,plan_id,req_no,order_no){
						    ...
						    marj=filterNum(marj);
							document.getElementById('order_id_').value=order_id;
							document.getElementById('order_amount_').value=order_amount;
							document.getElementById('plan_id_').value=plan_id;
							document.getElementById('pid_').value=prod_id;
							document.getElementById('sid_').value=stock_id;
                            document.getElementById('req_id').value=plan_id;
                            document.getElementById('req_no').value=req_no;
                            document.getElementById('order_no').value=order_no;
                            document.getElementById('marj_').value=marj;
