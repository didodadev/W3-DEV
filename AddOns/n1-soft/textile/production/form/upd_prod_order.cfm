...
<div class="row">
	...
	<div class="col col-9 col-xs-12 uniqueRow">
		<div class="row formContent">
			...
			<cfsavecontent variable="message">Üretim Emri Verilen Stoklar</cfsavecontent>
					...
					<div id="REL_ORD_LIST" style="display:none;">
						<cfinclude template="../display/list_related_p_orders.cfm">
					</div>
...
<script type="text/javascript">
	...
	function add_row_exit(is_add_info_,row_kontrol_exit,is_phantom_exit,is_sevk_exit,is_property_exit,is_free_amount_exit,stock_code_exit,product_id_exit,stock_id_exit,product_name_exit,stock_code_exit,spec_main_id_exit,spect_name_exit,lot_no_exit,amount_exit,unit_id_exit,unit_exit,spect_id_exit)
	{
		...
		newCell = newRow.insertCell(newRow.cells.length);
		newCell.innerHTML = '<input type="text" name="spec_main_id_exit' + row_count_exit +'" id="spec_main_id_exit' + row_count_exit +'" readonly style="width:40px;" value="'+ spec_main_id_exit+'"><input type="hidden" name="spect_id_exit' + row_count_exit +'" id="spect_id_exit' + row_count_exit +'" value="'+ spect_id_exit+'"> <input name="spect_name_exit' + row_count_exit +'" id="spect_name_exit' + row_count_exit +'" value="'+ spect_name_exit+'" readonly style="width:200px;"> <input type="hidden" name="spect_main_row_exit#currentrow#" id="spect_main_row_exit#currentrow#" value="#SPECT_MAIN_ROW_ID#"> <a href="javascript://" onclick="pencere_ac_spect(\'#currentrow#\',2);"><img src="/images/plus_thin.gif" align="absbottom" border="0"></a>';
	...
	function add_row_outage(is_add_info_,row_kontrol_outage,is_phantom_outage,is_sevk_outage,is_property_outage,is_free_amount_outage,stock_code_outage,product_id_outage,stock_id_outage,product_name_outage,stock_code_outage,spec_main_id_outage,spect_name_outage,lot_no_outage,amount_outage,unit_id_outage,unit_outage,spect_id_outage)
	{
		...
		newCell = newRow.insertCell(newRow.cells.length);
		newCell.innerHTML = '<input type="hidden" name="product_id_outage' + row_count_outage +'" id="product_id_outage' + row_count_outage +'" value="'+product_id_outage+'"><input type="hidden" name="stock_id_outage' + row_count_outage +'" id="stock_id_outage' + row_count_outage +'"  value="'+stock_id_outage+'"><input type="text" name="product_name_outage' + row_count_outage +'" id="product_name_outage' + row_count_outage +'" value="'+product_name_outage+'" readonly style="width:280px;"><a href="javascript://" onClick="pencere_ac_product_outage('+ row_count_outage +');"><img src="/images/plus_thin.gif" border="0" align="absbottom"></a>';
		newCell = newRow.insertCell(newRow.cells.length);
		newCell.innerHTML = '<input type="text" name="spec_main_id_outage' + row_count_outage +'" id="spec_main_id_outage' + row_count_outage +'" value="'+spec_main_id_outage+'" readonly style="width:40px;"><input type="hidden" name="spect_id_outage' + row_count_outage +'" id="spect_id_outage' + row_count_outage +'" value="'+spect_id_outage+'"> <input name="spect_name_outage' + row_count_outage +'" id="spect_name_outage' + row_count_outage +'" value="'+spect_name_outage+'" readonly style="width:200px;"> <a href="javascript://" onclick="pencere_ac_spect(\'#currentrow#\',2);"><img src="/images/plus_thin.gif" align="absbottom" border="0"></a>';
		<cfif isdefined("is_show_lot_no") and is_show_lot_no eq 1>
			newCell = newRow.insertCell(newRow.cells.length);
