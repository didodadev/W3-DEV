		...
		<cfquery name="query_add_supplier" datasource="#dsn3#" result="add_supplier">
				INSERT INTO
					...
					(
						...
						<cfif IsDefined("arguments.form_product_catid") and  len(arguments.form_product_catid) and len(arguments.form_product_cat)><cfqueryparam cfsqltype='CF_SQL_INTEGER' value='#arguments.form_product_catid#'><cfelse>NULL</cfif>,
					<cfif isdefined("arguments.form_product_id")>
