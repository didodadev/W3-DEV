<cfcomponent>
	...
	<cffunction name="copy_measure_header" access="public">
		...
		<cfif len(arguments.target_id)>
			...
			<cfquery name="query_target" datasource="#dsn3#">
				UPDATE #dsn3#.TEXTILE_MEASUREMENT_HEADER SET ERATE = <cfqueryparam cfsqltype='CF_SQL_DECIMAL' scale="2" value='#query_source.ERATE#'>, BRATE = <cfqueryparam cfsqltype='CF_SQL_DECIMAL' scale="2" value='#query_source.BRATE#'> 
	...
	<cffunction name="copy_measure_items" access="public">
		...
		<cfquery name="query_result" datasource="#dsn3#">
			...
			SELECT #arguments.target_mh_id#, REQUEST_ID, ROW_INDEX, BOY_ID, STOCK_ID, EBTYPE, MEASURE_POINT, SERIAL_INC, DESCRIPTION, TARGET, 0, 0, 0, 0, 0, 0
