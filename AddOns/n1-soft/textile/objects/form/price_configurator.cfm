	...
	<cf_big_list_search_area>
		...
		<div class="row form-inline">
				...
				<div class="form-group x-2">
					<a href="javascript://"	onclick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_print_files&iid=#req_id#&print_type=481<cfif isdefined('attributes.money')>&iiid=#attributes.money#</cfif></cfoutput>','page')"><i class="icon-print"></i></a>
				  </div>
            </div>
...
<cf_big_list>
	<thead>
		...
		<input type="hidden" name="record_num" value="<cfoutput>#get_detail.recordcount#</cfoutput>">
			<th>Sıra No</th>
			<th>Ürün</th>
			<th>Talep Edilen Hammaddeler</th>
			<th>Miktar</th>	
			<th>Revize Miktar</th>
			<th>Birim</th>
			<th>Birim Fiyat</th>
			...
			<th>Para Birimi</th>
			<th>Planlanan Tutar TL</th>
			<th>Revize TL Tutar</th>
			<th>Planlanan Döviz Tutar</th>
			<th>Revize Döviz Tutar</th>
		</tr>
	</thead>
	<tbody>
	<cfset ptt = 0>
	...
	<cfoutput query="get_detail">
		<tr>
			...
			<td text-wrap:suppress; style="text-align:right;"><input type = "text" id="r_q#currentrow#" name ="r_q#currentrow#" onblur="satirhesapla('#currentrow#', '#MONEY_TYPE#')", value = "#tlformat(REVIZE_QUANTITY,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="10px" class="box" ></td>
			...
			<td text-wrap:suppress; style="text-align:right;"><input type = "text" id ="r_p#currentrow#" name ="r_p#currentrow#" onblur="satirhesapla('#currentrow#', '#MONEY_TYPE#')" value = "#tlformat(REVIZE_PRICE,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="10px" class="box"></td>
			<td text-wrap:suppress; style="text-align:center;">#MONEY_TYPE#</td>
			<td text-wrap:suppress; style="text-align:right;"><input type ="text" style="text-align:right;" id ="p_t#currentrow#" name ="p_t#currentrow#" value = "#tlformat(QUANTITY*PRICE*moneylist[MONEY_TYPE],textile_round)#"  size="10px" onkeyup="return(FormatCurrency(this,event,#textile_round#));" readonly>  TL</td>
			<td text-wrap:suppress; style="text-align:right;"><input type ="text" style="text-align:right;" id ="r_t#currentrow#" name ="r_t#currentrow#" value = "#tlformat(REVIZE_QUANTITY*REVIZE_PRICE*moneylist[MONEY_TYPE],textile_round)#" class="box" size="10px" onkeyup="return(FormatCurrency(this,event,#textile_round#));" readonly>  TL</td>
			<td text-wrap:suppress; style="text-align:right;"><input type ="text" style="text-align:right;" id ="pd#currentrow#" name ="pd#currentrow#" value ="#tlformat((QUANTITY*PRICE*moneylist[MONEY_TYPE])/moneylist[attributes.money],textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));"  size="10px" readonly>&nbsp;#attributes.money#</td>
			<td text-wrap:suppress; style="text-align:right;"><input type ="text" style="text-align:right;" id ="rd#currentrow#" name ="rd#currentrow#" value ="#tlformat((REVIZE_QUANTITY*REVIZE_PRICE*moneylist[MONEY_TYPE])/moneylist[attributes.money],textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" class="box" size="10px" readonly>&nbsp;#attributes.money#</td>			
			<td width="250px"></td>
	...
	<cfoutput>
		<tr>
			<td text-wrap:suppress; colspan="10">Toplam :</td>
			<td text-wrap:suppress; style="text-align:right;"><input  type="text" name="ptt" id="ptt" value="#tlformat(ptt,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="10px" > TL</td>
			<td text-wrap:suppress; style="text-align:right;"><input class="box" type="text" name="rtt" id="rtt" value="#tlformat(rtt,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="10px" > TL</td>
			<td text-wrap:suppress; style="text-align:right;"><input  type="text" name="pdt" id="pdt" value="#tlformat(pdt,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="10px" > #attributes.money#</td></td>
			<td text-wrap:suppress; style="text-align:right;"><input class="box" type="text" name="rdt" id="rdt" value="#tlformat(rdt,textile_round)#" onkeyup="return(FormatCurrency(this,event,#textile_round#));"size="10px" > #attributes.money#</td></td>
...
<table class="big_list draggable no-remember-ordering" style="float:top">
<thead>
	<tr>
		<th>Kurlar</th>
		<th>Fiyatlama</th>
...
<tbody>
	<tr valign="top">
		<td text-wrap:suppress; width="10%" height="100px">
		<cfinclude template="/AddOns/N1-Soft/textile/objects/display/dsp_money.cfm">
		</td>
		
		
		<cfoutput><cfset i="">
		<td text-wrap:suppress; width="30%" >
			<table class="big_list draggable no-remember-ordering"   >
				...
				<tr >
					<td>Gyg+İmalat Firesi</td>
					<td style="text-align:right;">%<input type = "text" style="text-align:right;" id = "gyg_oran" name = "gyg_oran" onblur="hesapla();" onkeyup="return(FormatCurrency(this,event,#textile_round#));" value = "#get_opportunity.gyg_fire#" size="8px"></td>
				...
				<tr>
					...
					<td style="text-align:right;">%<input type = "text" style="text-align:right;" id = "komisyon" name = "komisyon" onblur="hesapla();" value = "#get_opportunity.commission#" onkeyup="return(FormatCurrency(this,event,#textile_round#));" size="8px"></td>
