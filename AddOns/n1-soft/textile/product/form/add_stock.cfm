		...
		<cfform name="frmProfile" id="frmProfile" method="post" action="#request.self#?fuseaction=textile.list_sample_request&event=add_profile" style="width: 100%;">
			...
			<div class="col col-3" type="column" index="" sort="true">
				<div class="form-group" id="item-txt_head">
					<label class="col col-4 col-xs-12">Tanım</label>
			...
			<div class="col col-3" type="column" index="" sort="true">
				<div class="form-group" id="item-">
					<div class="col col-12 col-xs-12">
						<button type="submit" name="opr" class="btn green-haze"><cfif len(attributes.profile)>Güncelle<cfelse>Ekle</cfif></button>
						<cfif len(attributes.profile)><input type="submit" class="btn green-haze" value="Sil" name="opr"></cfif>
					</div>
				</div>
			</div>
		</cfform>
	...
	<div class="col col-3">
		...
		<table class="table table-hover">
			<cfoutput query="get_profile_list">
				<tr><td><a href="index.cfm?fuseaction=textile.list_sample_request&event=add_stock&pid=#attributes.pid#&pcode=#attributes.pcode#&req_id=#attributes.req_id#&profile=#PROFILEID#">#HEAD#</a></td></tr>
			</cfoutput>
		</table>
	</div>
	<div class="col col-9">
