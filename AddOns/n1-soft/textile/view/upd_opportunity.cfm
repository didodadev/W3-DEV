...
<cfinclude template="/V16/sales/query/get_opportunity.cfm">
...
<cfinclude template="/V16/sales/query/get_opportunity_offers.cfm">
<cfinclude template="/V16/sales/query/get_opp_pluses.cfm">
...
<cf_catalystHeader>
<cfinclude template="detail_opportunity.cfm">
