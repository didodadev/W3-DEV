...
<cfscript>
	...
	CreateCompenentWash = CreateObject("component","AddOns.N1-Soft.textile.cfc.wash_plan");
...
<cf_catalystHeader>
	...
	<cfform name="plan"  method="post" action="#request.self#?fuseaction=textile.emptypopup_upd_product_plan">				   				
			...
			<div class="col col-12 col-xs-12 ">
				...
				<div class="col col-2 col-xs-2 ">
							<cf_get_workcube_asset title="Yıkama" company_id="#session.ep.company_id#" asset_cat_id="-3" module_id='99' action_section='WASH_PLAN_ID' action_id='#query_product_plan.plan_id#'>
				</div>
			</div>
                ...
                <div class="row" type="row">
					<cf_big_list>
						...
						<cfoutput query="list_washplan">
							<tr>
								<td>#currentrow# <input type="hidden" value="#wash_id#" name="washid#currentrow#"></td>
						...
						<tfoot>
							<td colspan="4">Toplam Fiyat</th>
							<td style="text-align:right;"><cfoutput>#tlformat(toplamfiyat)#</cfoutput></td>
						</tfoot>
				</cf_big_list>
				<div class="row">
				<cf_workcube_buttons is_upd='1' is_delete=0 add_function='kontrol_()'>	
				</div>
				</div>
			</div>
		</div>
