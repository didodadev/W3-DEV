...
<div class="row">
 <div class="col col-12">
	...
	<div class="col col-3 col-xs-12 ">
						...
						<cf_get_workcube_asset title="Kalıp" company_id="#session.ep.company_id#" asset_cat_id="-3" module_id='99' action_section='MOLD_PLAN_ID' action_id='#get_mold_planid.plan_id#'>
			</div>
</div>
<div class="col col-12">
