...
<cfparam name="attributes.st_id" default="0">
...
<cfscript>
    ...
    if ( attributes.checkTotal > 0 ) 
    {
        query_stretching_test = stretching_test.get_stretching_test_by_opp(attributes.project_id, attributes.opp_id, attributes.order_id, attributes.purchasing_id);
    } else {
...
<cfform name="stretching_test" method="post">
    <input type="hidden" name="stretching_test_id" value="<cfoutput>#iif(attributes.checkTotal gt 0 and query_stretching_test.recordcount eq 1, "query_stretching_test.STRETCHING_TEST_ID", DE(""))#</cfoutput>">
    <div class="row">
                ...
                <div class="row" type="row">
                    ...
                    <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                        <div class="form-group" id="item-stretching_test_id">
                            ...
                            <div class="col col-8 col-xs-12">
                                <input type="text" name="stretching_test_id" id="stretching_test_id" value="<cfoutput>#iif(attributes.checkTotal gt 0 and query_stretching_test.recordcount eq 1, "query_stretching_test.STRETCHING_TEST_ID", DE(""))#</cfoutput>" disabled="disabled">
                            </div>
                        </div>
                        <div class="form-group" id="item-order_id">
                            <label class="col col-4 col-xs-12">Order No</label>
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    <input type="hidden" name="order_id" id="order_id" value="<cfoutput>#query_stretching_test.ORDER_ID#</cfoutput>">
                                    <input type="text" name="order_title" id="order_title" style="width:140px;" readonly="" value="<cfoutput>#query_stretching_test.ORDER_HEAD#</cfoutput>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="item-project_id">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <input name="project_head" type="text" id="project_head" value="<cfoutput>#iif(attributes.checkTotal gt 0 and query_stretching_test.recordcount eq 1, "query_stretching_test.PROJECT_HEAD", DE(""))#</cfoutput>" readonly="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
                        <div class="form-group" id="item-purchasing_id">
                            <label class="col col-4 col-xs-12">Satinalma No</label>
                            <div class="col col-8 col-xs-12">
                                <input type="hidden" name="purchasing_id" id="purchasing_id" value="<cfoutput>#iif(attributes.checkTotal gt 0 and query_stretching_test.recordcount eq 1, "query_stretching_test.PROJECT_ID", DE(""))#</cfoutput>">
                                <input type="text" name="purchasing_head" id="purchasing_head" value="<cfoutput>#iif(attributes.checkTotal gt 0 and query_stretching_test.recordcount eq 1, "query_stretching_test.PURCHASE_HEAD", DE(""))#</cfoutput>" readonly="">
                            </div>
                        </div>
                    </div>
                </div>
