            ...
            <div class="row form-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group x-2">
                        <a href="javascript://"	onclick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_print_files&iid=#req_id#&print_type=72&iiid=#attributes.mh_id#</cfoutput>','page')"><i class="icon-print"></i></a>
                    </div>
                </div>
            </div>
        </cfform>
                        ...
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <!-- ko foreach: self.shownSizes -->
                                    <th style="border-left: 1px solid #ddd; text-align: center;" data-bind="visible: $root.activesizes().indexOf($data[0]) >= 0">&Iota;stenen</th>
...
<script type="text/javascript" src="/addons/n1-soft/textile/js/knockout.js"></script>
<script type="text/javascript">
