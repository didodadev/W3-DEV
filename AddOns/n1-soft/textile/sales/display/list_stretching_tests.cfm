...
<cfform name="list_stretching_test" method="post">
    ...
    <cf_big_list_search title="Çekme Testleri">

        <cf_big_list_search_area>

            <div class="row form-inline">
                <div class="form-group" id="form-opp_id">
                    <div class="input-group x-10"><cfinput type="text" name="opp_id" id="opp_id" value="#attributes.opp_id#" placeholder="Numune No -#getLang('main',68)#"></div>
                </div>
...
<cf_big_list>
    <thead>
        <tr>
            ...
            <th style="width:10%;"><a href="<cfoutput>#request.self#</cfoutput>?fuseaction=textile.stretching_test&event=add"><img src="images/plus_list.gif"></a></th>
        </tr>
    </thead>
    <tbody>
        <cfif attributes.totalrecords>
            ...
            <tr>
                ...
                <td>
                    <a href="#request.self#?fuseaction=#pagefuseact#&event=add&st_id=#STRETCHING_TEST_ID#"><i class="fa fa-edit fa-2x"></i></a>
                </td>
            </tr>
            </cfoutput>
        <cfelse>
