            ...
            <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
               <div class="form-group" id="form_ul_record_employee">
                ...
                <div class="form-group" id="form-model_no">
                    <label class="col col-12">Müşteri Model No</label>
                    <div class="col col-12">
                      <div class="input-group">
                ...
                <div class="form-group" id="form-is_detail_stage">
                    <label class="col col-12">Aşama Renklendir</label>
                    <div class="col col-12">
                      <div class="input-group">
...
<cf_big_list>
    <thead>
        <tr>
            <th></th>
            <th style="width:130px;" title="Ürün Resmi">Resim</th>
            <th title="Model Oluşturma Tarihi"><cf_get_lang_main no='330.Tarih'></th>
            <th title="Model Üretim Teslim Terihi">Teslim</th>
			<th title="Ürüne Bağlı Proje Numarası">Proje</th>
			<th title="Model Kategorisi">Kategori</th>
            <th title="Model No">Model No</th>
			<th title="Model No">Marka</th>
            <th title="Müşteri Adı">Müşteri</th>
            <th title="Müşteri Temsilcisi">Müşteri Temsilcisi</th>
			<th title="Müşteri Order Numarası">M.Order No</th>
            <!---<th>Müşteri Temsilcisi</th>--->
            <!---<th title="Ürün No">Ürün</th>--->
            <!---<th>Tasarımcı</th>--->
            <th title="Süreç Adı"><cf_get_lang_main no='1447.Süreç'></th>
    <cfif isdefined("attributes.is_detail_stage")>
            <th title="Kumaş Fiyat Talepleri">KFT</th>
            <th title="Aksesuar Fiyat Talepleri">AFT</th>
            <th title="Modelhane İşlemleri">Mİ</th>
            <th title="İşçilik Fiyat Talepleri">İFT</th>
            <th title="Yıkama Fiyat Talepleri">YFT</th>
            <th title="Kesim Operasyonu">KSM</th>
            <th title="Nakış Operasyonu">NKŞ</th>
            <th title="Baskı Operasyonu">BSK</th>
            <th title="Dikim Operasyonu">DKM</th>
            <th title="Yıkama Operasyonu">YKM</th>
            <th title="Numune Ütü - Paket Operasyonu">NÜP</th>
            <th title="Üretim Ütü - Paket Operasyonu">ÜÜP</th>
            ...
            <th title="Ürün Ağacı">ÜA</th>
            <th title="Konfigratör">C</th>
            <th title="Üretim Siparişleri">ÜS</th>
            ...
            <cfoutput query="GET_SAMPLE_REQ" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                ...
                <td>
                 ...
                 <cfif isdefined("attributes.is_detail_stage")>
                    ...
                    <td align="center"><a href="#request.self#?fuseaction=textile.list_sample_request&event=det&req_id=#req_id#&req_no=#req_no#"><i class="fa fa-edit fa-lg" title="Güncelle"></a></td>
                </tr>
