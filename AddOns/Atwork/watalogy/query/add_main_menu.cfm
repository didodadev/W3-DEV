<cflock name="#CREATEUUID()#" timeout="20">
    <cftransaction>
       ...
       <!--- <cfquery name="GET_SITESNEW" datasource="#dsn#">	
                INSERT INTO
                    B2B2C_SITES (SITE_NAME, SITE_PATH)
                VALUES
                	(<cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.menu_name#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="/B2B2C">)
        </cfquery>--->
