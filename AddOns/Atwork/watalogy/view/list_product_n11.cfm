                ...
                <div class="col col-12 form-inline">
                    ...
                    <div class="form-group">
                    	<div class="input-group">
                            ...
                            <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_collected_barcode<cfif session.ep.isBranchAuthorization>&is_branch=1</cfif>','medium','pos_islem');"><img src="/images/barcode_print.gif" title="<cf_get_lang no='687.Toplu Barkod Yazdır'>"></a>
                            <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_barcod_search','medium');"><img src="/images/barcode.gif" title="<cf_get_lang no='688.Barkod Ara'>"></a>
                    	</div>
                    </div>
               </div>
           </div>
	...
	<cf_big_list id="list_product_big_list">
        <thead>
            <tr>
                ...
                <th><cf_get_lang_main no='222.Ürt Kodu'></th>
                <th><cf_get_lang_main no='224.Birim'></th>
                <th><cf_get_lang_main no='227.KDV'></th>
                <th><cf_get_lang no='364.Max'></th>
                <th><cf_get_lang no='363.Min'></th>
                ...
                <th><cf_get_lang no='29.S D Tarihi'></th>
                <!-- sil -->
                <th class="header_icn_none"><a href="<cfoutput>#request.self#?fuseaction=product.list_product&event=add</cfoutput>"><img src="/images/plus_list.gif" title="<cf_get_lang_main no='170.Ekle'>"></a></th>
                <!-- sil -->
            </tr>
        </thead>
        <tbody>
            <cfif get_product.recordcount>
                ...
                <cfoutput query="get_product">
                    <tr oncontextmenu="javascript:wrk_right_menu('PRODUCT_ID',#PRODUCT_ID#);return false;"> 
                        ...
                        <td style="text-align:right;">#max_margin#</td>
                        <td style="text-align:right;">#min_margin#</td>
                        <cfif attributes.price_catid is "-1">
                            <td style="text-align:right;"><a href="#request.self#?fuseaction=product.list_price_change&event=det&pid=#get_product.product_id#" class="tableyazi">#TLFormat(get_product.price,session.ep.our_company_info.purchase_price_round_num)# #get_product.money#</a></td>
                            <td style="text-align:right;"><a href="#request.self#?fuseaction=product.list_price_change&event=det&pid=#get_product.product_id#" class="tableyazi"><cfif get_product.is_kdv >#TLFormat(get_product.price_kdv,session.ep.our_company_info.purchase_price_round_num)#<cfelse>#TLFormat(get_product.price*(100+get_product.tax)/100,session.ep.our_company_info.purchase_price_round_num)#</cfif> #get_product.money#</a></td>
                        <cfelse>
                            <td style="text-align:right;"><a href="#request.self#?fuseaction=product.list_price_change&event=det&pid=#get_product.product_id#" class="tableyazi">#TLFormat(get_product.price,session.ep.our_company_info.sales_price_round_num)# #get_product.money#</a></td>
                        ...
                        <td width="65"><cfif isdate(get_product.update_date)>#dateformat(get_product.update_date,dateformat_style)#<cfelse>#dateformat(get_product.record_date,dateformat_style)#</cfif></td>
                        <!-- sil -->
                        <td width="1%"><a href="#request.self#?fuseaction=#fuseaction_info#.list_product&event=det&pid=#get_product.product_id#"><img src="/images/update_list.gif" title="<cf_get_lang_main no='52.Guncelle'>"></a></td>
                        <!-- sil -->
                    </tr>
                </cfoutput>
            <cfelse>
