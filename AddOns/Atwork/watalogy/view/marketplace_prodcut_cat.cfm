<cfif session.ep.admin eq 1>
	<cfscript>
        marketplace = createObject("component","AddOns.Atwork.watalogy.cfc.marketplace");
        marketplace.dsn = dsn;
...
<cf_popup_box title="#getLang('main',155)# - #getLang('main',23)#">
	<cfform name="form_market_place" action="#request.self#?fuseaction=watalogy.emptypopup_marketplace_product_cat" enctype="multipart/form-data" method="post">
