...
<cfform name="search_product" action="#request.self#?fuseaction=watalogy.list_product_cat_marketplace" method="post">
		...
		<cfif productcats.recordcount>
		  <cfoutput query="productcats" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
			...
			<tr>
				...
				<!-- sil -->
				<td style="width:15px;"><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=watalogy.popup_upd_marketplace_product_cat&product_catid=#product_catid#','list');"><img src="/images/update_list.gif" title="<cf_get_lang_main no='52.guncelle'>"></a></td>
				<!-- sil -->
			</tr>
		  </cfoutput>
		<cfelse>
