component extends="AddOns/Wocial/Component/oauth2" accessors="true" {
	...
	**/
	public facebook function init(
		...
		required string authEndpoint = 'https://www.facebook.com/v10.0/dialog/oauth', 
		required string accessTokenEndpoint = 'https://graph.facebook.com/v10.0/oauth/access_token',
