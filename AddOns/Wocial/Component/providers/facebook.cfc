component extends = "/AddOns/Wocial/Component/providers/providerProperties"{
	...
	public struct function run(){
		...
		var oFacebook = createObject("component", "AddOns/Wocial/Component/oauth2Builders/facebook").init(
			client_id           = clientId,
