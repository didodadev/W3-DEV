    ...
    <cf_form_list id="table6">
        <thead>
            <tr>
                ...
                <th style="text-align:center;width:30px;cursor:pointer">&nbsp;ÜK&nbsp;</th>
        ...
        <cfoutput query="get_piece_row">
            ...
            <tr id="frm_row_exit#currentrow#">
                <td nowrap="nowrap" title="<cfif PACKAGE_PARTNER_ID gt 0>#getLang('main',2867)#</cfif>" style="text-align:right;cursor: pointer; vertical-align:middle;<cfif isdefined('attributes.design_piece_row_id') and attributes.design_piece_row_id eq PIECE_ROW_ID>background-color:LightGray</cfif>">
