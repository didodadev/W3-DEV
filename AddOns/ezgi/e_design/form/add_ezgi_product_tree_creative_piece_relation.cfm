		...
		<table>
            ...
            <tr height="25px"  id="piece_default_type_">
                ...
                <td valign="top">
                    ...
                    <!---&nbsp;
                 	<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=prod.popup_add_ezgi_default_piece','small');"><img src="/images/plus_list.gif" border="0" title="Örnek Parça Ekle" style="vertical-align:top" ></a>--->
                </td>
            </tr>
