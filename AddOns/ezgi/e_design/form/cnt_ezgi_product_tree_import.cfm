    ...
    <cf_big_list id="list_product_big_list">
        <thead>
            <tr>
                ...
                <th style="text-align:center; width:250px"><cfoutput>#getLang('main',1995)# #getLang('main',245)# #getLang('main',485)#</cfoutput></th>
				<th style="text-align:center;"><cfoutput>#getLang('main',245)# #getLang('main',485)#</cfoutput></th>
           		...
           		<tr id="row_#currentrow#">
                    ...
                    <cfif partner_id eq 0>
                        ...
                        <cfelseif hata eq 3> 
                            ...
                            <td style="text-align:center;" nowrap="nowrap">
                                <img src="images/ok_list_empty.gif" title="#getLang('main',2976)#" />
                            </td>
                            <td style="text-align:center;" nowrap="nowrap">
                            	<cfif type eq 1 or (type eq 2 and paket_stop eq 0) or (type eq 3 and modul_stop eq 0)>
                                	<input type="checkbox" id="select_#type#_#IID#" name="select_#type#_#IID#" value="1" checked>
                  	...
                  	<cfelse>
                    	<td style="text-align:center;" nowrap="nowrap"><span style="color:green"><strong>#getLang('main',2978)#</strong></span></td>
                      	<td style="text-align:center;" nowrap="nowrap">
                       		<img src="images/c_ok.gif" title="#getLang('main',2978)#" />
                      	</td>
                       	<td style="text-align:center;" nowrap="nowrap">
                        	<img src="images/lock_buton.gif" title="#getLang('main',2978)#" />
                        </td>
                    </cfif>
				</tr>
      		</cfoutput>
...
<script language="javascript">
	...
	{
		document.getElementById("old_product").action = "<cfoutput>#request.self#</cfoutput>?fuseaction=prod.emptypopup_cnt_ezgi_import_creative_workcube";
