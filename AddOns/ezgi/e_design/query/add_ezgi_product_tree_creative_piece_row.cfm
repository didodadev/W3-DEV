<cfquery name="GET_DEFAULT_EBATLAMA" datasource="#dsn3#">
	...
	FROM           
    	OPERATION_TYPES AS OTT INNER JOIN
     	EZGI_DESIGN_DEFAULTS AS EDD ON OTT.OPERATION_TYPE_ID = EDD.DEFAULT_CUTTING_OPERATION_TYPE_ID
</cfquery>
<cfif not GET_DEFAULT_EBATLAMA.recordcount>
	<script type="text/javascript">
		alert("Genel Default Tanımlarda Ebatlama Operasyonu Tanımlı Değil. Düzenleyip Tekrar Deneyin!");
		window.close()
	</script>
    <cfabort>
</cfif>
