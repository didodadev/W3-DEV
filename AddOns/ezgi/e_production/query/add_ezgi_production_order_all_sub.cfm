...
<cfif not isdefined("is_import_prod")>
    <table border="1">
    <tr>
        <td><cfif attributes.is_demand eq 1><cf_get_lang_main no='115.Talepler'><cfelse><cf_get_lang_main no='3452.Üretim Emirleri'></cfif><cf_get_lang_main no='3453.Oluşturuluyor..Lütfen Bekleyiniz...'></td>
    </tr>
...
<cfelse>
	<script type="text/javascript">
    	alert('<cf_get_lang_main no='3454.Sipariş Satırlarında Spec Seçilmemiş Kayıtlar Mevcut'>, <cf_get_lang_main no='3455.Lütfen Siparişi Kontrol Ediniz'> !');
		history.go(-1);
    </script>
</cfif>
<cfif not isdefined("is_import_prod")>
