...
<cfif not isdefined("is_import_prod")>
	...
	<cf_workcube_process
        ...
        <cfelse>
            ...
            <cfelse>
                    <a href="#request.self#?fuseaction=prod.upd_ezgi_master_sub_plan_manual&master_plan_id=#attributes.master_plan_id#&master_alt_plan_id=#attributes.master_alt_plan_id#&islem_id=#attributes.islem_id#">Üretim Emirlerine Gitmek İçin Tıklayınız!</a>
            </cfif>
     	</cfif>
        <!---Ezgi Bilgisayar Özelleştirme Bitişi--->
        </cfoutput>
