<!-- Description : Mutabakat, BA, BS ve Cari Hatırlatma Tablolarıdır. 
Developer: Tufan Çakıroğlu
Company : Workcube
Destination: Period-->
<querytag>
	IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '@_dsn_period_@' and TABLE_NAME='CARI_LETTER')
    BEGIN
	...
	END;
	IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '@_dsn_period_@' and TABLE_NAME='CARI_LETTER_ROW')
    BEGIN
