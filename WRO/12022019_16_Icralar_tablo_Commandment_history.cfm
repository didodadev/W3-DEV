<!-- Description : COMMANDMENT_HISTORY tablosunun eklenmesi
Developer: Kayhan KAYA
Company : Workcube
Destination: Main-->
<querytag>
	IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='COMMANDMENT_HISTORY' )
	BEGIN
		CREATE TABLE [COMMANDMENT_HISTORY](
		[COMMANDMENT_HISTORY_ID] [int] IDENTITY(1,1) NOT NULL,
