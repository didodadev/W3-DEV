...
Destination: Company-->
<querytag>
	IF NOT EXISTS( SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '@_dsn_company_@' and TABLE_NAME='STOCK_RESERVE_ARCHIVE')
    BEGIN
		CREATE TABLE [STOCK_RESERVE_ARCHIVE](
