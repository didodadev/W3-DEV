	...
	$G.init=function(id,name,_4e4,_4e5,edit,_4e7,_4e8,_4e9,_4ea,_4eb,_4ec,_4ed,_4ee,_4ef,_4f0,_4f1,_4f2,_4f3,_4f4,_4f5,_4f6,_4f7,_4f8,_4f9,_4fa,_4fb,_4fc,_4fd,_4fe)
	{
		...
		if(_4e5)
		{
			...
			if(_4f7)
			{
				...
				_509.addButton({text: <cfoutput>"<cf_get_lang_main no='49.Kaydet'>"</cfoutput> ,handler:$G.saveNewRecord,scope:_508});
				_509.addButton({text: <cfoutput>"<cf_get_lang_main no='50.Vazgeç'>"</cfoutput> ,handler:$G.cancelNewRecord,scope:_508});
			}
			if(_4f8)
			{
