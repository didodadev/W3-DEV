...
if(_4e5){
_503.bbar=new Ext.PagingToolbar({pageSize:_4f0,store:_4eb,emptyMsg:"Görüntülenecek Başlık Yok"});
if(_4fa&&(_4f7||_4f8)){
var _509=_503.bbar;
if(_4f7){
_509.addButton({text:_4f7,handler:$G.insertRow,scope:_508});
_509.addButton({text:" Kaydet ",handler:$G.saveNewRecord,scope:_508});
_509.addButton({text:" İptal ",handler:$G.cancelNewRecord,scope:_508});
}
if(_4f8){
