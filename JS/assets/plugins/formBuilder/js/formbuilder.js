...
(function() {
  ...
  BuilderView = (function(_super) {
    ...
    BuilderView.prototype.bindSaveEvent = function() {
      ...
      this.saveFormButton.attr('disabled', true).text(Formbuilder.options.dict.SAVE_FORM);
    ...
    BuilderView.prototype.scrollLeftWrapper = function($responseFieldEl) {
	  ...
	  // Scroll olayını kontrol ediyordu burası
    };
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = 'Başlık';
    ...
    Formbuilder.options = {
      ...
      HTTP_ENDPOINT: '',
      HTTP_METHOD: 'POST',
      AUTOSAVE: false, // Otomatik kaydetme
      CLEAR_FIELD_CONFIRM: 'Eklediğiniz alandaki veriler silinecektir. Emin misiniz?',
      mappings: {
      ...
      dict: {
        ALL_CHANGES_SAVED: 'Değişiklikler kaydedildi',
        SAVE_FORM: 'Kaydet',
        UNSAVED_CHANGES: 'Değişiklikleri kaydetmediniz. İşleminiz iptal edilecek!'
      }
    };
...
(function() {
  Formbuilder.registerField('date', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-calendar\"></span></span> Tarih"
  });
...
(function() {
  Formbuilder.registerField('date', {
    order: 0,
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />  <span class=\"fa fa-calendar\"></span>",
...
(function() {
  Formbuilder.registerField('dropdown', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeBlank: true, multiple:true}) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> Selectbox",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
      ...
      attrs.field_options.include_blank_option = true;
	  attrs.field_options.multiple = false;
      return attrs;
    }
  });
...
__p += '<div class=\'fb-edit-section-header\'>Options</div>\n\n';
 ...
 if (typeof multiple !== 'undefined'){ ;
	__p += '\n  <label>\n    <input type=\'checkbox\' data-rv-checked=\'model.' +
	((__t = ( Formbuilder.options.mappings.MULTIPLE )) == null ? '' : __t) +
	'\' />\n      Çoklu Seçim\n  </label>\n';
 } ;
__p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
((__t = ( Formbuilder.options.mappings.OPTIONS )) == null ? '' : __t) +
'\'>\n  <input type="checkbox" class=\'js-default-updated\' data-rv-checked="option:checked" />\n <input type="text" data-rv-input="option:value" class=\'option-value-input\' style="width:50px;" placeholder="Value" /> <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>Yeni Alan Ekle</a></li>\n    <li><a data-target=\'#editField\'>Alan Güncelle</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content scrollContent fb-tab-content-scroll\'>\n    ' +
