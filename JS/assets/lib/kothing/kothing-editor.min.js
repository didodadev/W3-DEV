        ...
        L = {
          ...
          isFormatElement: function (e) {
            return (
              e &&
              1 === e.nodeType &&
              (/^(P|DIV|STYLE|H[1-6]|PRE|LI|TH|TD)$/i.test(e.nodeName) ||
                this.hasClass(
                  e,
          ...
          _notTextNode: function (e) {
            return (
              1 === e.nodeType &&
              (this.isComponent(e) ||
                /^(br|input|select|canvas|img|iframe|audio|video|style|script|meta|link)$/i.test(
                  "string" == typeof e ? e : e.nodeName
                ))
            );
          },
          _disallowedTags: function (e) {
            return /^(xmeta|xscript|xlink|xstyle|[a-z]+\:[a-z]+)$/i.test(e.nodeName);
          },
            ...
            (t.lang = t.lang || T.a),
              ...
              (t._defaultTagsWhitelist =
                "string" == typeof t._defaultTagsWhitelist
                  ? t._defaultTagsWhitelist
                  : "br|p|div|style|pre|blockquote|h[1-6]|ol|ul|li|hr|figure|figcaption|img|iframe|audio|video|source|table|thead|tbody|tr|th|td|a|b|strong|var|i|em|u|ins|s|span|strike|del|sub|sup|code"),
