...
<head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="i/js/designer/mages/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="images/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="images/favicon-16x16.png">
	<link rel="mask-icon" href="images/safari-pinned-tab.svg" color="#d89000">
	<link rel="stylesheet" type="text/css" href="/js/designer/js/croppie/croppie.min.css">
    <link rel="stylesheet" type="text/css" href="/js/designer/styles/grapheditor.css">
