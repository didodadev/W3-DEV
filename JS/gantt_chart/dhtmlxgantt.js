...
! function(t) {
    ...
    function n(t) {
        ...
        if (t && "object" == typeof t) {
            for (r = {}, i = [Array, Number, String, Boolean], e = 0; e < i.length; e++) t instanceof i[e] && (r = e ? new i[e](t) : new i[e]);
            h.isDate(t) && (r = new Date(t));
            for (e in t) Object.prototype.hasOwnProperty.apply(t, [e]) && (r[e] = n(t[e]))
        }
        return r || t
    }
    ...
    var n = i(0),
        ...
        s = function() {
            ...
            return t.prototype.destructor = function() {
                ...
                "string" == typeof t && (t = [t]);
                for (var r = {}, n = 0; n < t.length; n++) a.addClassName(i, t[n]), r[t[n]] = !0;
                e._currentBorders = r
    ...
    o.prototype = {
        ...
        setSize: function(t, e) {
            ...
            for (var i = this.getGridColumns(), n = 0, r = 0, a = i.length; r < a; r++) n += 1 * i[r].width;
            var s;
        ...
        _clearLayers: function(t) {
            for (var e = this.$gantt.$services.getService("layers"), i = e.getDataRender(this.$config.bind), n = 0; n < this._taskLayers.length; n++) i.removeLayer(this._taskLayers[n]);
            this._taskLayers = []
        },
        ...
        _setColumnsWidth: function(t, e) {
            ...
            for (var u = l > 0 ? 1 : -1; l > 0 && 1 === u || l < 0 && -1 === u;) {
                ...
                for (s = e + 1; s < n.length; s++) {
                    var g = n[s].width + u;
                    if (g == this._getColumnWidth(n[s], i, g) && (l -= u, n[s].width = g), !l) break
                }
                if (_ == l) break
            }
            if (l && e > -1) {
    ...
    function n(t, e) {
        ...
        return {
            ...
            detachAll: function() {
                for (var t = 0; t < i.length; t++) e(i[t].element, i[t].event, i[t].callback, i[t].capture), e(i[t].element, i[t].event, i[t].callback, void 0), e(i[t].element, i[t].event, i[t].callback, !1), e(i[t].element, i[t].event, i[t].callback, !0);
                i = []
            },
            extend: function() {
    ...
    var n = i(3),
        ...
        s = function(t) {
            ...
            return n(e, t), e.prototype.destructor = function() {
                ...
                for (var r, a = !1, s = [], o = [], l = 0; l < e.length; l++) r = e[l], t[r.$config.scroll] ? n(r) : r.shouldHide() ? n(r) : r.shouldShow() ? i(r) : r.isVisible() ? s.push(r) : o.push(r);
                for (var d = {}, l = 0; l < s.length; l++) s[l].$config.group && (d[s[l].$config.group] = !0);
                for (var l = 0; l < o.length; l++) r = o[l], r.$config.group && d[r.$config.group] && i(r);
                return a
                ...
                if (this.$root && !this._resizeInProgress && (this.callEvent("onBeforeResize", []), i = !0, this._resizeInProgress = !0), t.prototype.resize.call(this, !0), t.prototype.resize.call(this, !1), i) {
                    ...
                    if (this.$config.autosize && (this.autosize(this.$config.autosize), o = !0), o) {
                        this.resize();
                        for (var a = 0; a < n.length; a++) n[a].$config.hidden || n[a].setContentSize()
                    }
                ...
                for (var e, i, n, r = 0, a = 0, s = 0; s < this.$cells.length; s++) i = this.$cells[s], i.$config.hidden || (e = i.getContentSize(t), "scrollbar" === i.$config.view && t[i.$config.scroll] && (e.height = 0, e.width = 0), i.$config.resizer && (this._xLayout ? e.height = 0 : e.width = 0), n = i._getBorderSizes(), this._xLayout ? (r += e.width + n.horizontal, a = Math.max(a, e.height + n.vertical)) : (r = Math.max(r, e.width + n.horizontal), a += e.height + n.vertical));
    ...
    function n(t, e) {
        for (var i, n, r, a = 0, s = t.length - 1; a <= s;)
            if (i = Math.floor((a + s) / 2), n = +t[i], r = +t[i - 1], n < e) a = i + 1;
            else {
                if (!(n > e)) {
                    for (; + t[i] == +t[i + 1];) i++;
                    return i
    ...
    l.prototype = {
        ...
        _clearLayers: function(t) {
            ...
            for (var r = 0; r < this._linkLayers.length; r++) n.removeLayer(this._linkLayers[r]);
    ...
    o.prototype = r.mixin({
        _buildTree: function(t) {
            ...
            for (var n = 0, a = t.length; n < a; n++) e = t[n], this._add_branch(e), e.$level = this.calculateItemLevel(e), r.defined(e.$open) || (e.$open = r.defined(e.open) ? e.open : this.$openInitially());
            this._updateOrder()
        },
        parse: function(t) {
            this.callEvent("onBeforeParse", [t]);
        ...
        _changeIdInner: function(t, e) {
            ...
            for (var r = 0; r < i.length; r++) this.setParent(this.getItem(i[r]), e);
        ...
        eachParent: function(t, e) {
            for (var i = e; this.getParent(i) && this.exists(this.getParent(i));) i = this.getItem(this.getParent(i)), t.call(this, i)
        },
        ...
        sort: function(t, e, i) {
            ...
            if (a) {
                ...
                s.sort(n);
                for (var o = 0; o < s.length; o++) a[o] = s[o].id, this.sort(t, e, a[o])
            }
        },
        filter: function(t) {
    ...
    n.plugin = function(t) {
        ...
        for (var t = i(25)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
        return t._internal_id = n._seed++, n.$syncFactory && n.$syncFactory(t), i(110)(t), t
    }, t.exports = n
}, function(t, e, i) {
    function n() {
    ...
    t.exports = function() {
        var t = new n;
        i(26)(t), t.$services = t.$inject(i(27)), t.config = t.$inject(i(28)), t.ajax = i(29)(t), t.date = i(30)(t);
        var e = i(31)(t);
        ...
        var l = i(11)();
        t.event = l.attach, t.eventRemove = l.detach, t._eventRemoveAll = l.detachAll, t._createDomEventScope = l.extend, o.mixin(t, i(34)(t));
        var d = i(35).init(t);
        ...
        }), t.mixin(t, d.layersApi), i(61)(t), t.$services.setService("layers", function() {
            return d.layersService
        });
        var c = i(62);
        return t.mixin(t, c()), i(63)(t), i(69)(t), i(72)(t), i(79)(t), i(80)(t), i(82)(t), i(83)(t), i(84)(t), i(85)(t), i(92)(t), i(93)(t), i(94)(t), i(95)(t), i(96)(t), i(97)(t), i(98)(t), i(99)(t), i(100)(t), i(101)(t), i(102)(t), i(103)(t), i(104)(t), i(105)(t), i(106)(t), i(107)(t), i(109)(t), t
    }
}, function(t, e) {
    t.exports = function(t) {
        t.$inject = function(t) {
    ...
    t.exports = function(t) {
        var e = {
            init: function() {
                ...
                for (var i = e.date.month_full, n = e.date.month_full_hash = {}, r = 0; r < i.length; r++) n[i[r]] = r
            },
    ...
    t.exports = function(t) {
        ...
        function r(t) {
            if (p) {
                ...
                if (n) return t.preventDefault && t.preventDefault(), !(t.cancelBubble = !0)
            } else;
        }
        ...
        return t.attachEvent("onMessagePopup", function(t) {
            ...
            for (var e = 0; e < $.length; e++) $[e] === t && ($.splice(e, 1), e--)
        }), t.attachEvent("onDestroy", function() {
            a.cover && a.cover.parentNode && a.cover.parentNode.removeChild(a.cover);
            for (var t = 0; t < $.length; t++) $[t].parentNode && $[t].parentNode.removeChild($[t]);
        ...
        r = function(t) {
            return function(e) {
                ...
                function n(t, e, i, n) {
                    var r = u[t][e];
                    if (r)
                        for (var a = 0; a < r.length; a++)(i || r[a].root) && r[a].root !== i || r[a].handler.apply(this, n)
                }
                ...
                function c(t, e, i, n) {
                    if (u[t])
                        for (var r = 0; r < u[t].length; r++) u[t][r].root == n && (u[t].splice(r, 1), r--)
                }
        ...
        function e(e, i, s) {
            ...
            return s && s.setAttribute(n.config().layer_attribute, !0), a[e] = {
                render_item: function(e, i) {
                    if (i = i || s, l && !l(e)) return void this.remove_item(e.id);
                    var n = o.call(t, e);
                    this.append(e, n, i)
                },
                clear: function(t) {
                ...
                append: function(t, e, i) {
                    if (!e) return void(this.rendered[t.id] && this.remove_item(t.id));
    ...
    function n(t) {
        ...
        return {
            ...
            prepareConfigs: function(t, e, i, n, r, a, s) {
                ...
                for (var c = 0; c < d.length - 1; c++) this.alineScaleColumns(d[d.length - 1], d[c]);
                for (var c = 0; c < d.length; c++) s && this.reverseScale(d[c]), this.setPosSettings(d[c]);
                return d
            },
        ...
        var i = function() {
            ...
            n = {
                column_before_start: t.bind(function(t, i, n) {
                    var a = e.$getConfig();
                    if (!r.locateAttribute(n, a.grid_resizer_column_attribute)) return !1;
                ...
                column_drag_move: t.bind(function(t, i, n) {
                    ...
                    if (h < u && (h = u), a.keep_grid_width) {
                        for (var v = 0, p = l + 1; p < o.length; p++) o[p].min_width ? _ -= o[p].min_width : a.min_grid_column_width && (_ -= a.min_grid_column_width), o[p].max_width && !1 !== v ? v += o[p].max_width : v = !1;
                ...
                column_drag_end: t.bind(function(i, n, r) {
                    ...
                    if (d.max_width && d.max_width < h && (h = d.max_width), !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) && d.width != h) {
                        if (d.width = h, a.keep_grid_width) o = a.grid_width;
                            ...
                            for (var c = l, u = s.length; c < u; c++) o += s[c].width;
    ...
    function i(t) {
        ...
        function h(e, i, n, r, a) {
            var s, o, l = t.getState(); + n.start_date >= +l.min_date && (s = [i, a.rtl ? "task_right" : "task_left", "task_start_date"], o = r(s.join(" ")), o.setAttribute("data-bind-property", "start_date"), e.appendChild(o)), +n.end_date <= +l.max_date && (s = [i, a.rtl ? "task_left" : "task_right", "task_end_date"], o = r(s.join(" ")), o.setAttribute("data-bind-property", "end_date"), e.appendChild(o))
        }
        return e
    }
    t.exports = i
            ...
            a = {
                ...
                get_points: function(e, i) {
                    ...
                    if (c.from_start && c.to_start) this.point_to(l.left, d), h ? (this.point_to(l.down, s), this.point_to(l.right, o)) : (this.point_to(l.right, o), this.point_to(l.down, s)), this.point_to(l.right, d);
                        ...
                        if (h = n.e_x > n.x + 2 * d, this.point_to(l.right, d), h) o -= d, this.point_to(l.down, s), this.point_to(l.right, o);
                        else {
                            o -= 2 * d;
                            var u = s > 0 ? 1 : -1;
                        ...
                        if (c.from_start && !c.to_start)
                            ...
                            } else o += d, this.point_to(l.down, s), this.point_to(l.right, o)
                    } else this.point_to(l.right, d), h ? (this.point_to(l.right, o), this.point_to(l.down, s)) : (this.point_to(l.down, s), this.point_to(l.right, o)), this.point_to(l.left, d);
                    return this.path
                },
    ...
    function n(t) {
        function e(e, i) {
            ...
            for (var l, d = [], c = 0; c < n.length; c++) {
                ...
                } else u = f.template ? f.template(e) : e[f.name], r.isDate(u) && (u = s.date_grid(u, e)), _ = u, u = "<div class='gantt_tree_content'>" + u + "</div>";
                ...
                m.push(u), a.rtl && (m = m.reverse()), h = "<div class='" + v + "' style='text-align:center;" + y + "' " + p + ">" + m.join("") + "</div>", d.push(h)
            }
    ...
    function n(t, e) {
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
            ...
            t.defined(e.$getConfig().dnd_sensitivity) && (s.config.sensitivity = e.$getConfig().dnd_sensitivity), s.attachEvent("onBeforeDragStart", t.bind(function(r, a) {
                ...
                for (var e = null, i = n(), r = i.getItems(), a = 0, s = r.length; a < s; a++) r[a].$level == t && (e = r[a]);
                return e ? e.id : null
                ...
                if (d.exists(u) || (u = s.lastTaskOfLevel(l.order_branch_free ? c.$level : 0)) == s.config.id && (u = null), d.exists(u)) {
                    ...
                    if (d.getIndexById(_.id) * l.row_height + l.row_height / 2 < h) {
                        var g = d.getIndexById(_.id),
                            ...
                            p = d.getItem(f);
                        if (p) {
                            if (p.id == c.id) return l.order_branch_free && d.isChildOf(c.id, _.id) && 1 == d.getChildren(_.id).length ? void d.move(c.id, d.getBranchIndex(_.id) + 1, d.getParent(_.id)) : void 0;
                            _ = p
                        } else if (f = d.getIdByIndex(g), p = d.getItem(f), r(p, c) && p.id != c.id) return void d.move(c.id, -1, d.getParent(p.id))
                    } else if (l.order_branch_free && _.id != c.id && r(_, c)) {
                        if (!d.hasChild(_.id)) return _.$open = !0, void d.move(c.id, -1, _.id);
                        if (d.getIndexById(_.id) || l.row_height / 3 < h) return
                    }
                    for (var g = d.getIndexById(_.id), v = d.getIdByIndex(g - 1), m = d.getItem(v), k = 1;
                        (!m || m.id == _.id) && g - k >= 0;) v = d.getIdByIndex(g - k), m = d.getItem(v), k++;
                    if (c.id == _.id) return;
            ...
            on_mouse_down: function(i, n) {
                if (2 != i.button || void 0 === i.button) {
                    ...
                    if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                        ...
                        if (!l || !d) return n.parentNode ? this.on_mouse_down(i, n.parentNode) : void 0;
                        if (d)
                            if (d.mode && d.mode != r.drag_mode.ignore && r["drag_" + d.mode]) {
                                if (s = e.locate(n), o = e.copy(e.getTask(s) || {}), e.isReadonly(o)) return this.clear_drag_state(), !1;
                                if (e.isSummaryTask(o) && !r.drag_project && d.mode != r.drag_mode.progress) return void this.clear_drag_state();
                                d.id = s;
                        ...
                        else if (e.checkEvent("onMouseDown") && e.callEvent("onMouseDown", [l.split(" ")[0]]) && n.parentNode) return this.on_mouse_down(i, n.parentNode)
                    }
                }
            },
    ...
    function n(t) {
        ...
        function o() {
            for (var i = null, n = t.$data.tasksStore.getItems(), r = 0, a = n.length; r < a; r++) i = n[r], i.$source = [], i.$target = [];
            ...
            function() {
                ...
                t.attachEvent("onBeforeTaskDelete", function(i, n) {
                    ...
                    r[e] && t.$data.linksStore.silent(function() {
                        for (var i in r[e]) t.$data.linksStore.removeItem(i), n(r[e][i]);
                        r[e] = null
                    })
                })
            ...
            return {
                ...
                refreshTask: function(t, e) {
                    ...
                    if (i && this.isTaskVisible(t)) {
                        ...
                        for (var n = 0; n < i.$target.length; n++) this.refreshLink(i.$target[n])
                    }
                },
                ...
                clearAll: function() {
                    for (var t = n.call(this), e = 0; e < t.length; e++) t[e].clearAll();
    ...
    function i() {
        ...
        return {
            select: function(e) {
                if (e) {
                    if (t == e) return t;
                    if (!this._skip_refresh && !this.callEvent("onBeforeSelect", [e])) return !1;
        ...
        var r = e.getDatastore(t),
            a = {
                ...
                renderItems: function(t) {
                    ...
                    for (var n = r.getVisibleItems(), i = 0; i < e.length; i++) e[i].render_items(n)
                }
            };
    ...
    function n(t) {
        ...
        t._dp_init = function(i) {
            t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"), i.setTransactionMode("POST", !0), i.serverProcessor += (-1 != i.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", i._serverProcessor = i.serverProcessor, i.$gantt = this, i.styles = {
                ...
                error: "gantt_error",
                clear: ""
            }, i._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], n.call(this, t, i), o.call(this, t, i), l.call(this, t, i), i.attachEvent("onDestroy", function() {
                e(t, i)
            }), r(t, i)
    ...
    t.exports = function(t) {
        for (var e = [i(73), i(74), i(75), i(76), i(77), i(78)], n = 0; n < e.length; n++) e[n] && e[n](t)
    }
}, function(t, e, i) {
    var n = i(1);
    t.exports = function(t) {
    ...
    function i(t) {
        ...
        function n(e, i) {
            for (var n, r = i.join("_") + "_" + e, a = {}, s = 0; s < i.length; s++) a[i[s]] = !0;
        ...
        function a(i, n, r) {
            ...
            var _, g, f = [];
            for (var l in o) _ = new Date(1 * l), g = t.date.add(_, 1, s), f.push({
                start_date: _,
                end_date: g,
                tasks: o[l].tasks
            });
    ...
    t.exports = function(t) {
        function e(e) {
            if (t.config.branch_loading && t._load_url) {
                if (!t.getUserData(e, "was_rendered") && !t.getChildren(e).length && t.hasChild(e)) return !0
            }
            return !1
        }
        var n = i(18),
    ...
    var n = i(8);
    t.exports = function(t) {
        i(81)(t), n.prototype.getGridColumns = function() {
            for (var t = this.$getConfig(), e = t.columns, i = [], n = 0; n < e.length; n++) e[n].hide || i.push(e[n]);
            return i
        }
    }
}, function(t, e) {
    ...
    t.exports = function(t) {
        t.load = function(e, i, n) {
            ...
            serialize: function() {
                ...
                for (var r = 0, a = n.links.length; r < a; r++) i.push(this._copyLink(n.links[r]));
    ...
    n.prototype = {
        ...
        _getDayHoursForMultiple: function(t, e) {
            for (var i = [], n = !0, r = 0, a = !1, s = this.$gantt.date.day_start(new Date(e)), o = 0; o < 24; o++) a = t.reduce(function(t, e) {
    ...
    n.prototype = {
        ...
        _getWorkUnitsBetweenGeneric: function(t, e, i, n) {
            ...
            for (var _ = !1; a.valueOf() < s.valueOf();) c = this._nextDate(a, i, n), _ = c.valueOf() > s.valueOf(), this._isWorkTime(a, i) && ((h || u && _) && (o = r[i + "_start"](new Date(a)), l = r.add(o, n, i)), h ? (h = !1, c = this._nextDate(o, i, n), d += (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : u && _ ? (u = !1, d += (s.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : d++), a = c;
            return d
        },
    ...
    t.exports = function(t) {
        t.isUnscheduledTask = function(t) {
            ...
            if (!i) return r;
            var o, l, d;
            if (s == i.unit && a == i.step && +r >= +i.min_date && +r <= +i.max_date) d = Math.floor(t.columnIndexByDate(r)), i.trace_x[d] || (d -= 1, i.rtl && (d = 0)), l = new Date(i.trace_x[d]), o = t.date.add(l, a, s);
            else {
    ...
    t.exports = function(t) {
        ...
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function() {
            ...
            if (void 0 === e && (e = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this.getTaskType(e)) {
                ...
                for (var r, a = this._lightbox_template, s = this.config.buttons_left, o = 0; o < s.length; o++) {
                    var l = this.config._migrate_buttons[s[o]] ? this.config._migrate_buttons[s[o]] : s[o];
                    r = this._waiAria.lightboxButtonAttrString(l), a += "<div " + r + " class='gantt_btn_set gantt_left_btn_set " + l + "_set'><div dhx_button='1' class='" + l + "'></div><div>" + this.locale.labels[l] + "</div></div>"
                }
                s = this.config.buttons_right;
                for (var o = 0; o < s.length; o++) {
                    var l = this.config._migrate_buttons[s[o]] ? this.config._migrate_buttons[s[o]] : s[o];
                    r = this._waiAria.lightboxButtonAttrString(l), a += "<div " + r + " class='gantt_btn_set gantt_right_btn_set " + l + "_set' style='float:right;'><div dhx_button='1' class='" + l + "'></div><div>" + this.locale.labels[l] + "</div></div>"
                }
                a += "</div>", i.innerHTML = a, t._waiAria.lightboxAttr(i), t.config.drag_lightbox && (i.firstChild.onmousedown = t._ready_to_dnd, i.firstChild.onselectstart = function() {
                    return !1
                ...
                for (var c = i.getElementsByTagName("div"), o = 0; o < c.length; o++) {
                    var h = c[o];
                ...
                for (var o = 0; o < d.length; o++) {
                    ...
                    if (u.id && document.getElementById(u.id)) {
                        ...
                        if (f) {
                            ...
                            p && (u.inputId = p.id || "input_" + t.uid(), p.id || (p.id = u.inputId), g.setAttribute("for", u.inputId))
                        }
                    }
                }
                this.resizeLightbox(), this._init_lightbox_events(this), i.style.display = "none", i.style.visibility = "visible"
            }
                ...
                if (i.getAttribute("dhx_button")) t.callEvent("onLightboxButton", [i.className, i, e]);
                    ...
                    if (-1 != o.indexOf("gantt_custom_button"))
                        if (-1 != o.indexOf("gantt_custom_button_"))
                            for (n = i.parentNode.getAttribute("index"), s = i; s && -1 == r.getClassName(s).indexOf("gantt_cal_lsection");) s = s.parentNode;
                        else n = i.getAttribute("index"), s = i.parentNode, i = i.firstChild;
                ...
                for (var h = "", u = 0; u < n.length; u++) {
                    ...
                    switch (_) {
                        case "%Y":
                            ...
                            for (var k = v; k < m; k++) g += "<option value='" + k + "'>" + k + "</option>";
                            break;
                        case "%m":
                            e._time_format_order[1] = u, e._time_format_order.size++;
                            for (var k = 0; k < 12; k++) g += "<option value='" + k + "'>" + this.locale.date.month_full[k] + "</option>";
                            break;
                        case "%d":
                            e._time_format_order[0] = u, e._time_format_order.size++;
                            for (var k = 1; k < 32; k++) g += "<option value='" + k + "'>" + k + "</option>";
                            break;
                        case "%H:%i":
                            e._time_format_order[3] = u, e._time_format_order.size++;
                            var k = c,
                                y = l.getDate();
                            for (e._time_values = []; k < d;) g += "<option value='" + k + "'>" + this.templates.time_picker(l) + "</option>", e._time_values.push(k), l.setTime(l.valueOf() + 60 * this._get_timepicker_step() * 1e3), k = 24 * (l.getDate() != y ? 1 : 0) * 60 + 60 * l.getHours() + l.getMinutes()
                    }
                    if (g) {
            ...
            duration: {
                render: function(t) {
                    ...
                    var i = this.locale.labels[this.config.duration_unit + "s"],
                        ...
                        s = "<div class='gantt_duration' " + n + "><input type='button' class='gantt_duration_dec' value='−'" + r + "><input type='text' value='5' class='gantt_duration_value'" + r + " " + a + "><input type='button' class='gantt_duration_inc' value='+'" + r + "> " + i + " <span></span></div>";
    ...
    t.exports = function(t) {
        t.getTaskType = function(e) {
            ...
            render: function(e) {
                ...
                for (var s in i) !1 == !a(s, i[s]) && r.push({
                    key: i[s],
                    label: n["type_" + s]
                });
                e.options = r;
    ...
    t.exports = function(t) {
        ...
        t._touch_events = function(n, r, a) {
            ...
            for (var l, d = 0, c = !1, h = !1, u = null, _ = null, g = null, f = 0; f < i.length; f++) t.eventRemove(i[f][0], i[f][1], i[f][2]);
            i = [], i.push([t.$container, n[0], function(i) {
                var n = e();
                if (!a(i) && c) {
                    _ && clearTimeout(_);
                    var o = r(i);
                    if (n && (n.drag.id || n.drag.start_drag)) return n.on_mouse_move(o), i.preventDefault && i.preventDefault(), i.cancelBubble = !0, !1;
                    if (!t._prevent_touch_scroll) {
                        if (o && u) {
                            ...
                            if (!h && (Math.abs(g) > 5 || Math.abs(f) > 5) && (t._touch_scroll_active = h = !0, d = 0, l = t.getScrollState()), h) {
                                ...
                                if (l.x != p.x && f > 2 * g || l.y != p.y && g > 2 * f) return s(i)
                            }
                        }
                        return s(i)
                    }
    ...
    t.exports = function(t) {
        var e = i(19);
        t.assert = i(108)(t), t.init = function(e, i, r) {
    ...
    t.exports = function(t) {
        ...
        for (var i = ["message", "alert", "confirm", "modalbox", "uid", "copy", "mixin", "defined", "bind", "assert"], n = [], r = 0; r < i.length; r++) window.dhtmlx[i[r]] || (n.push(i[r]), dhtmlx[i[r]] = function(i) {
            return function() {
