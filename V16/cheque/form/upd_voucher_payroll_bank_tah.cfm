...
<cf_xml_page_edit fuseact="cheque.form_add_voucher_payroll_bank_tah">
...
<cfelse>	
    ...
    <cf_catalystHeader>
<cf_box>
<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_voucher_payroll_bank_tah">
    ...
    <input type="hidden" name="payroll_acc_cari_voucher_based" id="payroll_acc_cari_voucher_based" value="<cfoutput>#GET_ACTION_DETAIL.VOUCHER_BASED_ACC_CARI#</cfoutput>">
     <cf_basket_form id="voucher_payroll_bank_tah">
     	<cf_box_elements>
                        ...
                        <div class="form-group" id="item-employee_id">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon icon-ellipsis btnPointer" onClick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_payroll_revenue.EMPLOYEE_ID&field_name=form_payroll_revenue.emp_name<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=1,9','list','popup_list_positions');" title="<cf_get_lang dictionary_id='58586.İşlem Yapan'>"></span>
                                </div>
                            </div>    
                        </div>
                    </div>
                    <div class="col col-4 col-md-4 col-sm-4 col-xs-12" type="column" index="2" sort="true">
                        <div class="form-group" id="item-wrkBankAccounts">
                            ...
                            <div class="col col-8 col-xs-12">
                                <cf_wrkBankAccounts width='220' control_status = '1' selected_value = '#get_action_detail.payroll_account_id#'>
                            </div>    
                        </div>
                        <div class="form-group" id="item-masraf_currency">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="col col-9 col-xs-12">
                                    <cfinput type="text" name="masraf" class="moneybox" message="#message#" style="width:75px;"  onkeyup="return(FormatCurrency(this,event));" value="#TLformat(get_action_detail.MASRAF)#">
     ...
     <cf_basket id="voucher_payroll_bank_tah_bask">
