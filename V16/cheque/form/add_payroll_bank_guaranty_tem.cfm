...
<cf_box>
<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_add_payroll_bank_guaranty_tem">
	...
	<cf_basket_form id="payroll_bank_quaranty_team">
                        ...
                        <div class="form-group" id="item-payroll_revenue_date">
                            ...
                            <div class="col col-8 col-xs-12">
                            	<div class="input-group">
                                    <cfinput value="#dateformat(now(),dateformat_style)#"  validate="#validate_style#" required="Yes"  type="text" name="payroll_revenue_date" style="width:125px;" onBlur="change_money_info('form_payroll_revenue','payroll_revenue_date');">
                     ...
                     <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                        <div class="form-group" id="item-payroll_account_id">
                          ...
                          <div class="col col-8 col-xs-12">
                              ...
                              <cf_wrkBankAccounts control_status = '1' account_type='#acc_type_#'>
                          </div>
                      </div>
                        <div class="form-group" id="item-masraf">
                        	<label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58930.Masraf'></label>
                            <div class="col col-6 col-xs-12">
                                <cfinput type="text" name="masraf" required="yes" class="moneybox" style="width:75px;" onKeyup="return(FormatCurrency(this,event));" value="0">
                        ...
                        <div class="form-group" id="item-credit_limit_id">
                            ...
                            <div class="col col-8 col-xs-12">
                            	<div class="input-group">
                                    ...
                                    <cfinput type="text" name="credit_limit_name" id="credit_limit_name" value="" style="width:220px;">
                ...
                <cf_box_footer>
                    ...
                    <cf_workcube_buttons is_upd='0' add_function='kontrol_add_tem()'>
                </cf_box_footer>
    </cf_basket_form>
