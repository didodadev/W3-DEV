...
<cf_catalystHeader>
<cf_box>
<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_add_voucher_bank_guaranty_return" >
		...
		<cf_box_elements>
                        ...
                        <div class="form-group" id="item-emp_name">
                            ...
                            <div class="col col-9 col-xs-12"> 
                            	<div class="input-group">
                                	...
                                	<cfsavecontent variable="message"><cf_get_lang dictionary_id='50257.Tahsil Edeni Seçiniz !'></cfsavecontent>
                    ...
                    <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
						...
						<div class="form-group" id="item-cash_id">
                            ...
                            <div class="col col-9 col-xs-12"> 
                            	<select name="cash_id" id="cash_id" style="width:220px;">
									<cfoutput query="get_cashes">
                                        <option value="#cash_id#;#branch_id#;#cash_currency_id#">#cash_name#-#cash_currency_id#</option>
                                    </cfoutput>
                                </select>
                            </div>
                        </div>
