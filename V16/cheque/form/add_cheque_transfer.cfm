...
<cf_box>
<cfform name="form_payroll_basket" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_add_cheque_transfer">
    ...
    <cf_basket_form id="cheque_transfer">
                <cf_box_elements>
                        ...
                        <div class="form-group" id="item-payroll_revenue_date">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <cfinput value="#dateformat(now(),dateformat_style)#" validate="#validate_style#" required="Yes" message="#message#" type="text" name="payroll_revenue_date" onBlur="change_money_info('form_payroll_basket','payroll_revenue_date');">
     ...
     <cf_basket id="cheque_transfer_bask">
