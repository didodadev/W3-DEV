...
<cf_catalystHeader>
	<cf_box>
<cfform name="form_payroll_basket" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_cheque_transfer">
    ...
    <input type="hidden" name="action_id" id="action_id" value="<cfoutput>#url.id#</cfoutput>">
    ...
    <cf_basket id="cheque_transfer_bask_bask">
