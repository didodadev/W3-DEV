...
<cfelse>
    ...
    <cf_catalystHeader>
<cf_box>
	<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_payroll_bank_guaranty_return">
...
<script type="text/javascript">
	...
	function check()
	{
		...
		if(document.form_payroll_revenue.masraf.value != "" && filterNum(document.form_payroll_revenue.masraf.value,2)> 0)
		{
			...
			{
				alert("<cf_get_lang dictionary_id ='52051.Gider Kalemi Seçiniz'>!");
				return false;
			}
