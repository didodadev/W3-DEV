...
<cfelse>
    ...
    <cf_catalystHeader>
    <cf_box>
	<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_payroll_voucher_revenue&id=#URL.ID#">
        ...
        <cf_box_elements>
                            ...
                            <div class="form-group" id="item-payroll_revenue_date">
                                ...
                                <div class="col col-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <cfinput value="#dateformat(GET_ACTION_DETAIL.payroll_revenue_date,dateformat_style)#" validate="#validate_style#" required="Yes" readonly message="#message#" type="text" name="payroll_revenue_date" style="width:125px;" onBlur="change_money_info('form_payroll_revenue','payroll_revenue_date');">
                            ...
                            <div class="form-group" id="item-employee_id">
                                ...
                                <div class="col col-8 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon icon-ellipsis btnPointer" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_payroll_revenue.EMPLOYEE_ID&field_name=form_payroll_revenue.emp_name<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=1,9','list','popup_list_positions');" title="<cf_get_lang dictionary_id='50233.Tahsil Eden'>"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col col-4 col-md-4 col-sm-4 col-xs-12" type="column" index="2" sort="true">
                            <div class="form-group" id="item-cash_id">
                                ...
                                <div class="col col-8 col-xs-12">
                                    <cf_wrk_Cash name="cash_id" acc_code="1" currency_branch="1" value="#get_action_detail.payroll_cash_id#">                                    
                                </div>
                            </div>
                            <div class="form-group" id="item-sistem_masraf_tutari">
                                ...
                                <div class="col col-8 col-xs-12">
                                    <div class="col col-9 col-xs-12">
                                        <cfinput type="text" style="width:75px;" name="masraf" required="yes" onKeyup="return(FormatCurrency(this,event));" value="#TLformat(get_action_detail.MASRAF)#">
                        ...
                        <div class="col col-4 col-md-4 col-sm-4 col-xs-12" type="column" index="3" sort="true">
                            <div class="form-group" id="item-ACTION_DETAIL">
                                ...
                                <div class="col col-8 col-xs-12">
                                    <cfoutput><textarea name="action_detail" id="action_detail" style="width:150px;height:50px;">#get_action_detail.action_detail#</textarea></cfoutput>
                                </div>
                            </div>
...
<script type="text/javascript">
	...
	function check()
	{
		...
		if(document.form_payroll_revenue.masraf.value != "" && filterNum(document.form_payroll_revenue.masraf.value,2)> 0)
		{
			...
			{
				alert("<cf_get_lang dictionary_id='50018.Gider Kalemi Seçiniz'>!");
				return false;
			}
		}			
