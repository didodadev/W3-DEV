...
<cf_box>
<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_add_payroll_bank_guaranty_return" >
	...
	<input type="hidden" name="bordro_type" id="bordro_type" value="1,5,10">
 	<input type="hidden" name="x_detail_acc_card" id="x_detail_acc_card" value="<cfoutput>#x_detail_acc_card#</cfoutput>">
        <cf_basket_form id="payroll_bank_quaranty_return">
	                <cf_box_elements>
	                        ...
	                        <div class="form-group" id="item-emp_name">
	                            ...
	                            <div class="col col-8 col-xs-12">
	                                <div class="input-group">
	                                    ...
	                                    <cfinput type="text" name="emp_name" value="#get_emp_info(session.ep.userid,0,0)#" required="yes" style="width:220px;" readonly>
	                                    <span class="input-group-addon icon-ellipsis btnPointer" title="<cf_get_lang dictionary_id='58586.İşlem Yapan'>" OnClick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_payroll_revenue.EMPLOYEE_ID&field_name=form_payroll_revenue.emp_name<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=1','list','popup_list_positions');"></span>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
							<div class="form-group" id="item-BankAccounts">
	                            ...
	                            <div class="col col-8 col-xs-12">
	                                <cf_wrkBankAccounts width='220' control_status = '1'>
	                            </div>
	                        </div>
							<div class="form-group" id="item-cash_id">
	                            <label class="col col-4 col-xs-12"><cf_get_lang_main dictionary_id='57520.Kasa'></label>
	                            <div class="col col-8 col-xs-12">
									<cf_wrk_Cash name="cash_id" currency_branch="1" cash_status="1">
	                            </div>
	                        </div>
	                        <div class="form-group" id="item-masraf">
	                            <label class="col col-4 col-xs-12"><cf_get_lang_main dictionary_id='58930.Masraf'></label>
	                        ...
	                        <div class="form-group" id="item-expense_center">
	                            <label class="col col-4 col-xs-12"><cf_get_lang_main dictionary_id='58460.Masraf Merkezi'></label>
	                            <div class="col col-8 col-xs-12">
	                    ...
	                    <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="3" sort="true">
							...
							<div class="form-group" id="item-exp_item_name">
	                            <label class="col col-4 col-xs-12"><cf_get_lang_main dictionary_id='58551.Gider Kalemi'></label>
	                            <div class="col col-8 col-xs-12">
	                                <div class="input-group">
	                                    ...
	                                    <span class="input-group-addon icon-ellipsis btnPointer" title="<cf_get_lang_main dictionary_id='58551.Gider Kalemi'>" OnClick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_exp_item&field_id=form_payroll_revenue.exp_item_id&field_name=form_payroll_revenue.exp_item_name','list');"></span>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
    ...
    <cf_basket id="payroll_bank_quaranty_return_bask">
