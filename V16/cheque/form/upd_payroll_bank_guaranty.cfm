...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cf_box>
	    <cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_payroll_bank_guaranty&ID=#attributes.ID#">
            ...
            <cf_basket_form id="payroll_bank_quaranty">
                        <cf_box_elements>
                            <div class="col col-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                        <cf_workcube_process_cat slct_width="237" process_cat=#get_action_detail.process_cat#>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <cfinput value="#dateformat(GET_ACTION_DETAIL.payroll_revenue_date,dateformat_style)#" validate="#validate_style#" required="Yes" message="#message#" type="text" readonly name="payroll_revenue_date" onBlur="change_money_info('form_payroll_revenue','payroll_revenue_date');">
                            ...
                            <div class="col col-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='29449.Banka Hesabı'></label>
                                    <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                        <cf_wrkBankAccounts width='237' control_status = '1' selected_value = '#get_action_detail.payroll_account_id#'>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='58930.Masraf'></label>
                                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12">
                                        <cfinput type="text" name="masraf"  class="moneybox" required="yes" onkeyup="return(FormatCurrency(this,event));" value="#TLformat(get_action_detail.MASRAF)#">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="exp_item_name" id="exp_item_name" value="<cfif len(get_action_detail.exp_item_id)><cfoutput>#get_expense_item.expense_item_name#</cfoutput></cfif>" onFocus="AutoComplete_Create('exp_item_name','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID','exp_item_id','','3','200');">
