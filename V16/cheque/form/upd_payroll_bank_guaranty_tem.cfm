...
<cfelse>
	...
	<cf_box>
 	<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_payroll_bank_guaranty_tem">
		...
		<input type="hidden" name="bordro_type" id="bordro_type" value="13">
		...
		<cf_basket_form id="payroll_bank_quaranty_team">
                	<cf_box_elements>
                    	<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                        	<div class="form-group" id="item-process_cat">
                                 ...
                                 <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                 	<cf_workcube_process_cat slct_width="220" process_cat=#get_action_detail.process_cat#>
                                 </div>
                            </div>
						   ...
						   <div class="form-group" id="item-payroll_revenue_date">
							...
							<div class="col col-8 col-md-8 col-sm-8 col-xs-12">
								<div class="input-group">
								   ...
								   <cfinput value="#dateformat(GET_ACTION_DETAIL.payroll_revenue_date,dateformat_style)#" validate="#validate_style#" required="Yes" message="#message#" type="text" readonly name="payroll_revenue_date" style="width:125px;" onBlur="change_money_info('form_payroll_revenue','payroll_revenue_date');">
                            ...
                            <div class="form-group" id="item-EMPLOYEE_ID">
                                 ...
                                 <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                 	<div class="input-group">
                                        ...
                                        <cfinput type="text" name="emp_name" value="#get_emp_info(get_action_detail.PAYROLL_REV_MEMBER,0,0)#" required="yes" message="#message#" style="width:220px;" readonly>
							...
							<cfif len(get_action_detail.CREDIT_LIMIT)>
                             ...
                             <cfelse>
                                <cfset get_credit_limit.credit_limit_id = ''>
                                <cfset get_credit_limit.limit_head = ''>
                            </cfif>
                        ...
                        <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
							<div class="form-group" id="item-payroll_account_id">
								<label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='50342.banka Hesap'></label>
								<div class="col col-8 col-md-8 col-sm-8 col-xs-12">
							...
							<div class="form-group" id="item-credit_limit_id">
								<label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='58963.Kredi Limiti'></label>
								<div class="col col-8 col-md-8 col-sm-8 col-xs-12">
									<div class="input-group">
									   <input type="hidden" name="credit_limit_id" id="credit_limit_id" value="<cfoutput>#get_credit_limit.credit_limit_id#</cfoutput>">
									   <cfinput type="text" name="credit_limit_name" id="credit_limit_name" value="#get_credit_limit.limit_head#" style="width:220px;">
									   <span class="input-group-addon icon-ellipsis btnPointer" onClick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_credit_limit&credit_limit_id=form_payroll_revenue.credit_limit_id&limit_head=form_payroll_revenue.credit_limit_name','list');"></span>
								   </div>
								</div>
						   </div>
                        </div>
		...
		<cf_basket id="payroll_bank_quaranty_team_bask">
