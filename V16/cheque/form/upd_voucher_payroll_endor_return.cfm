...
<cfelse>
    ...
    <cf_catalystHeader>
	<cf_box>
	<cfform name="form_payroll_revenue" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_voucher_payroll_endor_return">
    ...
    <input type="hidden" name="id" id="id" value="<cfoutput>#attributes.id#</cfoutput>">
  		 <cf_box_elements>
					<div class="col col-4 col-md-4 col-sm-4 col-xs-12" type="column" index = "1" sort="true">
						...
						<div class="form-group" id="item-payroll_no">
							<label class="col col-3 col-xs-12"><cf_get_lang dictionary_id='50225.Bordro No'></label>
							<div class="col col-9 col-xs-12">
						...
						<div class="form-group" id="item-payroll_revenue_date">
							...
							<div class="col col-9 col-xs-12">
								<div class="input-group">
                                    ...
                                    <cfinput value="#dateformat(get_action_detail.payroll_revenue_date,dateformat_style)#" validate="#validate_style#" required="Yes" message="#message#" type="text" name="payroll_revenue_date" style="width:150px;" onBlur="change_money_info('form_payroll_revenue','payroll_revenue_date');">									
						...
						<div class="form-group" id="item-pro_employee_id">
							...
							<div class="col col-9 col-xs-12">
								<div class="input-group">
                    				...
                    				<span class="input-group-addon icon-ellipsis btnPointer"  onClick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_payroll_revenue.pro_employee_id&field_name=form_payroll_revenue.emp_name<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=1,9','list','popup_list_positions');" title="<cf_get_lang dictionary_id='58586.İşlem Yapan'>"></span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group" id="item-company_id">
							...
							<div class="col col-9 col-xs-12">
								<div class="input-group">
                                    ...
                                    <cfinput type="text" name="company_name" id="company_name" value="#member_name#" style="width:150px;" readonly required="yes" message="#message#">									
                    				<span class="input-group-addon icon-ellipsis btnPointer" onclick="javascript:windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_pars&is_cari_action=1&select_list=1,2,3,9&field_comp_id=form_payroll_revenue.company_id&field_member_name=form_payroll_revenue.company_name&field_name=form_payroll_revenue.company_name&field_consumer=form_payroll_revenue.consumer_id&field_emp_id=form_payroll_revenue.employee_id&field_type=form_payroll_revenue.member_type<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>','list','popup_list_pars');" title="<cf_get_lang dictionary_id='57519.Cari Hesap'>"></span>
								</div>
							</div>
						</div>
        ...
        <cf_basket id="endor_return_bask">
