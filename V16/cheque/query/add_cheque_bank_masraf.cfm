...
<cfif isdefined("attributes.id") and isdefined("is_upd_action")>
	<cfquery name="get_bank_actions" datasource="#dsn2#">
		SELECT ACTION_ID FROM BANK_ACTIONS WHERE PAYROLL_ID = #attributes.ID#
	</cfquery>
<cfelse>
...
<cfif get_bank_actions.recordcount>
	...
	<cfquery name="GET_ACT_ID" datasource="#dsn2#">
		SELECT ACTION_ID AS ACT_ID FROM BANK_ACTIONS WHERE PAYROLL_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.id#">
	</cfquery>
