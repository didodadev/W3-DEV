...
<cflock name="#createUUID()#" timeout="60">
	...
	<cf_workcube_process_cat 
		...
		is_action_file = 1
		action_db_type = '#dsn2#'
		action_page='#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_add_voucher_transfer&event=upd&id=#p_id#'
...
<script type="text/javascript">
	window.location.href="<cfoutput>#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_add_voucher_transfer&event=upd&id=#p_id#</cfoutput>";
</script>
