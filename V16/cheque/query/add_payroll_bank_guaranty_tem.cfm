...
<cflock name="#createUUID()#" timeout="60">
	...
	<cfscript>
		...
		<cf_workcube_process_cat 
			...
			is_action_file = 1
			action_db_type = '#dsn2#'
			action_page='#request.self#?fuseaction=cheque.form_add_payroll_bank_guaranty_tem&event=upd&ID=#p_id#'
...
<script type="text/javascript">
	window.location.href="<cfoutput>#request.self#?fuseaction=cheque.form_add_payroll_bank_guaranty_tem&event=upd&ID=#p_id#</cfoutput>";
</script>
