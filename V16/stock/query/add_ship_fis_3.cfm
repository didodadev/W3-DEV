...
<cfloop from="1" to="#attributes.rows_#" index="i">
	...
	<cfscript>
		...
		indirim_carpan=(100-discount_rw) * (100-discount2_rw) * (100-discount3_rw) * (100-discount4_rw) * (100-discount5_rw);
   ...
   <!--- <cfif isdefined("attributes.DELIVER_DATE_FRM") and len(attributes.txt_department_in)>
	...
	<cfquery name="add_stock_row" datasource="#dsn2#">
		INSERT INTO 
			#new_dsn2_group_alias#.STOCK_FIS_ROW
				(
					...
					UNIT,
					UNIT_ID,							
					<cfif isdefined("attributes.price#i#")>PRICE,</cfif>
					<cfif isdefined("attributes.price_other#i#")>PRICE_OTHER,</cfif>
					TAX,
					DISCOUNT1,
					DISCOUNT2,
					DISCOUNT3,
		...
		VALUES
				(
					...
					<cfif isdefined("attributes.price#i#")>#evaluate("attributes.price#i#")#,</cfif>
					<cfif isdefined("attributes.price_other#i#")>#evaluate("attributes.price_other#i#")#,</cfif>
	...
	<cfif attributes.fis_type eq 115>
		<cfset olmasi_gereken_stok = get_stock_amount(evaluate("attributes.stock_id#i#"))>
		<cfif not len(olmasi_gereken_stok)><cfset olmasi_gereken_stok=0></cfif>
		<cfif multi lt olmasi_gereken_stok>
			<cfset fire_fisi_gerekiyor=1>
			<cfif len(session_list)><cfset session_list="#session_list#,#I#"><cfelse><cfset session_list="#I#"></cfif>
		</cfif>
	</cfif>
	...
	<cfquery name="upd_serial" datasource="#dsn2#">
		UPDATE
			#new_dsn3_group_alias#.SERVICE_GUARANTY_NEW
		SET
			PROCESS_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#GET_ID.MAX_ID#">,
			...
			PROCESS_NO = <cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.FIS_NO#">,
