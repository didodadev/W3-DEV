...
<cfquery name="GET_PURCHASE" datasource="#DSN2#">
	SELECT SHIP_NUMBER,PURCHASE_SALES FROM SHIP WHERE PURCHASE_SALES=1 AND SHIP_NUMBER='#SHIP_NUMBER#'
</cfquery>
	...
	<cfif get_process_type.IS_STOCK_ACTION eq 1><!--- Stok hareketi yapılsın --->
        ...
        <cfquery name="upd_serial" datasource="#dsn2#">
            ...
            SET
                ...
                DEPARTMENT_ID = <cfqueryparam cfsqltype="cf_sql_integer"  value="#attributes.department_in_id#">,
                LOCATION_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.location_in_id#">
            WHERE
	...
	<cfscript>
		...
		basket_kur_ekle(action_id:MAX_ID.IDENTITYCOL,table_type_id:2,process_type:0);
			...
			<cf_workcube_process_cat 
				...
				is_action_file = 1
				action_page='#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_add_sale&event=upd&ship_id=#MAX_ID.IDENTITYCOL#'
				action_file_name='#get_process_type.action_file_name#'
				action_db_type = '#dsn2#'
				is_template_action_file = '#get_process_type.action_file_from_template#'>
                <cf_add_log employee_id="#session.ep.userid#" log_type="1" action_id="#MAX_ID.IDENTITYCOL#" action_name="#SHIP_NUMBER# Eklendi" paper_no="#SHIP_NUMBER#"  period_id="#session.ep.period_id#" process_type="#get_process_type.PROCESS_TYPE#" data_source="#dsn2#">
	</cftransaction>
</cflock>

<!--- seri no--->
<cfloop from="1" to="#attributes.rows_#" index="i">
	<cfif isdefined("attributes.is_serial_no#i#") and isdefined("attributes.guaranty_purchasesales#i#")>
...
<!--- <cfif session.ep.our_company_info.is_cost eq 1 and get_process_type.IS_COST eq 1><!--- sirket maliyet takip ediliyorsa not js le yonlenioyr cunku cost_action locationda calismiyor --->
	<cfscript>cost_action(action_type:2,action_id:GET_ID.MAX_ID,query_type:1);</cfscript>
	<script type="text/javascript">
		window.location.href="<cfoutput>#request.self#?fuseaction=stock.add_stock_in_from_customs&event=upd&ship_id=#GET_ID.MAX_ID#</cfoutput>";
	</script>
<cfelse> --->
<!--- </cfif> --->
<script type="text/javascript">
	window.location.href="<cfoutput>#request.self#?fuseaction=stock.add_stock_in_from_customs&event=upd&ship_id=#MAX_ID.IDENTITYCOL#</cfoutput>";
</script>
