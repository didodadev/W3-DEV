...
<div class="row">
    <div class="col col-9 col-xs-12">
        <cfsavecontent variable="title"><cf_get_lang dictionary_id="32835.Karşılama Raporu"></cfsavecontent>
        <!--- Karşılama Raporu--->
        <cf_box title="#title#"box_page = "#request.self#?fuseaction=objects.popup_associated_tables&ship_id=#attributes.ship_id#&is_sale=1" closable="0"></cf_box>
