<cfif isDefined("attributes.stock_id")>
	...
	<cfquery name="GET_INVOICE_ID_IN" datasource="#DSN2#">
		...
		<cfif attributes.tax IS 1>
			((IR.PRICE*(100-IR.DISCOUNT1)*(100-IR.DISCOUNT2)*(100-IR.DISCOUNT3)*(100-IR.DISCOUNT4)*(100-IR.DISCOUNT5))/10000000000)+(((IR.PRICE*(100-IR.DISCOUNT1)*(100-IR.DISCOUNT2)*(100-IR.DISCOUNT3)*(100-IR.DISCOUNT4)*(100-IR.DISCOUNT5))/10000000000)*TAX/100) AS PRICE,
		<cfelse>
