...
<table width="650" height="700" align="center" cellpadding="0" cellspacing="0" border="0">
    <tr> 
      <td class="headbold" align="center"><cf_get_lang dictionary_id="51212.TERFİ-TRANSFER-ROTASYON TALEP FORMU"></td>
    </tr>
	<tr valign="top"> 
		<td> 
		<table width="100%" align="center" cellpadding="2" cellspacing="1" border="1">
			<cfoutput>
			<tr> 
				<td><input type="checkbox"<cfif get_per_form.is_rise>checked</cfif>>&nbsp;TERFİ</td>
				...
				<td><input type="checkbox" <cfif get_per_form.is_salary_change>checked</cfif>>&nbsp;ÜCRET DEĞİŞİKLİĞİ</td>
			</tr>
			<tr>
				...
				<td colspan="2" width="325"><b><cf_get_lang dictionary_id="51231.SİCİL NO"> :</b> #get_per_form.sicil_no#</td>
			</tr>
			<tr>
				<td colspan="2"><b><cf_get_lang dictionary_id="57790.DOĞUM YERİ">/<cf_get_lang dictionary_id="58593.Tarihi"> :</b> #get_per_form.emp_birth_city#/<cfif len(get_per_form.emp_birth_date)>#dateformat(get_per_form.emp_birth_date,dateformat_style)#</cfif></td>
				<td colspan="2"><b><cf_get_lang dictionary_id="51232.İŞE GİRİŞ TARİHİ"> :</b> <cfif len(get_per_form.work_startdate)>#dateformat(get_per_form.work_startdate,dateformat_style)#</cfif></td>
			</tr>
			<tr>
				<td colspan="2"><b>ÖĞRENİM DURUMU :</b>
				...
				<td colspan="2"><b>ASKERLİK DURUMU:</b>
			...
			<tr>
				...
				<td colspan="2" class="txtbold" align="center"><cf_get_lang dictionary_id="56535.TALEP EDİLEN"></td>
			</tr>
			<tr>
				<td>&nbsp;<cfif isdefined("get_head_exist")>#get_head_exist.name#</cfif></td>
				<td align="center" colspan="2" class="txtbold"><cf_get_lang dictionary_id="51201.GRUP BAŞKANLIĞI"></td>
			...
			<tr>
				...
				<td align="center" colspan="2" class="txtbold"><cf_get_lang dictionary_id="51205.ÜCRET"></td>
				<td>&nbsp;#TLFormat(get_per_form.salary_request)# #get_per_form.salary_request_money#</td>
			</tr>
			<tr>
				<td colspan="4" align="center" class="txtbold"><cf_get_lang dictionary_id="51211.ÖZLÜK HAKLARI"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><b><cf_get_lang dictionary_id="51208.TAHMİNİ TAŞINMA TARİHİ"> :</b> #dateformat(get_per_form.move_date,dateformat_style)#</td>
			</tr>
			<tr>
				<td colspan="4">
					<table>
						<tr>
							<td height="50"><b><cf_get_lang dictionary_id="59026.AÇIKLAMA"> :</b> #get_per_form.detail#</td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td colspan="4"><b><cf_get_lang dictionary_id="51236.TOPLAM ÇALIŞTIĞI SÜRE"> :</b> #get_per_form.work_year# Yıl - #get_per_form.work_month# Ay - #get_per_form.work_day# Gün</td>
			</tr>
			<tr>
				<td colspan="2"><b><cf_get_lang dictionary_id="51209.YENİ GÖREVE BAŞLAMA TARİHİ"> :</b> #dateformat(get_per_form.new_start_date,dateformat_style)#</td>
