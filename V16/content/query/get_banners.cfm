...
<cfquery name="GET_BANNERS" datasource="#DSN#">
	...
	WHERE
		...
		<cfif isdefined("attributes.keyword") and len(attributes.keyword)>AND BANNER_NAME LIKE #sql_unicode()#'%#attributes.keyword#%' COLLATE SQL_Latin1_General_CP1_CI_AI</cfif>
