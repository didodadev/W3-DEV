    ...
    <cffunction name="loadDesign" access="remote" returntype="any" output="no">
        ...
        <cfquery name="get_upstations" datasource="#dsn#_#arguments.company_id#">
        	SELECT
                ...
                (SELECT TYPE_NAME FROM #dsn#.SETUP_MARINA_PART_TYPES WHERE TYPE_ID = WORKSTATIONS.MARINA_PART_TYPE_ID) AS partName
			FROM
            	WORKSTATIONS
			WHERE
        ...
        <cfloop query="get_upstations">
            ...
            <cfquery name="get_substations" datasource="#dsn#_#arguments.company_id#">
                SELECT
                    ...
                    DESIGN_INFO AS designInfo,
                    (SELECT ELECTRIC_TYPE_NAME FROM #dsn#.SETUP_ELECTRIC_TYPE WHERE ELECTRIC_TYPE_ID = WS.ELECTRIC_TYPE) AS elecType
                FROM
                    WORKSTATIONS WS
                WHERE
