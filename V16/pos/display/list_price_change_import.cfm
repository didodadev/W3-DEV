...
<cfinclude template="../query/get_price_change_import.cfm">
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cfsavecontent variable="header_"><cf_get_lang dictionary_id ='58725.Fiyat Değişim Import'></cfsavecontent>
                ...
                <cfoutput query="get_stock_imports" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                    <tr>
                        ...
                        <td align="center" nowrap width="45">
                            <cfif not imported>					
                                <a href="javascript://" onClick="if (confirm('Fiyat Değişim İmport Belgesini Silme İşlemini Geri Alamazsınız !\nEmin misiniz ?')) windowopen('#request.self#?fuseaction=objects.emptypopup_del_file_price_change_import&i_id=#I_ID#','small');"><i class="fa fa-minus" title="<cf_get_lang dictionary_id='36015.İmportları Sil'>"></i></a>
                            </cfif>
                        </td>
                    </tr>
                </cfoutput>
