...
<cfinclude template="../query/get_file_export_promotion.cfm">
        ...
        <cf_grid_list>
            <thead>
                <tr>
                    ...
                    <th><cfif session.ep.isBranchAuthorization><cf_get_lang dictionary_id='45899.Ürün Sayısı'><cfelseif fusebox.circuit is 'pos'><cf_get_lang dictionary_id='45899.Ürün Sayısı'></cfif></th>
                    ...
                    <a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_export_promotion</cfoutput>','small','popup_export_promotion');"><i class="fa fa-plus" title="<cfif session.ep.isBranchAuthorization><cf_get_lang dictionary_id='36043.Export Ekle'><cfelseif fusebox.circuit is 'pos'><cf_get_lang dictionary_id='36043.Export Ekle'></cfif>"></a></th>
                </tr>
            </thead>
            <tbody>
                <cfoutput query="get_file_export_promotions" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                  <tr>
                    ...
                    <td><cfif target_system eq -1>Genius<cfelseif target_system eq -2>MPOS<cfelseif target_system eq -3>NCR<cfelse><cf_get_lang dictionary_id ='36057.Bilinmiyor'></cfif></td>
                    <td>#product_count#</td>
                    ...
                    <td><cfif session.ep.admin><a href="javascript://" onClick="javascript:if(confirm('<cf_get_lang dictionary_id='36159.Kayıtlı Stok Export Belgesini Siliyorsunuz! Emin misiniz'>?')) windowopen('#request.self#?fuseaction=pos.emptypopup_del_stock_export_file&e_id=#e_id#','small'); else return false;"><i class="fa fa-minus"></i></a></cfif></td>
                  </tr>
                </cfoutput>
...
function kontrol()
{
	return date_check(document.list_export_promotion.start_date,document.list_export_promotion.finish_date,"<cf_get_lang dictionary_id ='36063.Bitiş Tarihi Başlangıç Tarihinden Küçük'>!");
}
</script>
