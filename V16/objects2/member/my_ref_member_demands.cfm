            ...
            WHERE
                ...
                <cfif isdefined("attributes.my_ref_keyword") and len(attributes.my_ref_keyword)>
                    <cfif len(attributes.my_ref_keyword) eq 1>
                        AND C.CONSUMER_NAME LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.my_ref_keyword#%">
                    <cfelse>
                        AND (C.CONSUMER_NAME LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#attributes.my_ref_keyword#%"> OR C.CONSUMER_SURNAME LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#attributes.my_ref_keyword#%">)
                    </cfif>
                </cfif>
        </cfquery>
    <cfelse>
            ...
            <tbody>
                ...
                <cfelse>
                    <tr class="color-row" style="height:20px;"> 
                        <td colspan="5"><cfif isdefined("attributes.form_submitted")><cf_get_lang dictionary_id="57484.Kayit Yok"> !<cfelse><cf_get_lang dictionary_id="57701.Filtre Ediniz"> !</cfif></td>
                    </tr>
                </cfif>
            </tbody>
        </table>
