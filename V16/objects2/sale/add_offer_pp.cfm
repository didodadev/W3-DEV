...
<cfform name="offer_form" method="post" action="#request.self#?fuseaction=objects2.emptypopup_add_offer_pp">
<cfoutput>
	...
	<tr>
		<td>
			<table>
				...
				<tr>
					<td valign="top"><cf_get_lang_main no='217.Aiklama'></td>
				...
				<tr>
					<td><cf_get_lang_main no='45.Msteri'> *</td>
					<cfinclude template="../query/get_emps_pars_cons.cfm">
					<td><select name="member" id="member" style="width:200px;">
						...
						<cf_get_lang_main no='1104.Odeme Yontemi'>
