...
<cfset xfa.upd= "objects2.emptypopup_upd_cv">
	...
	<table width="98%" height="35" align="center" cellpadding="0" cellspacing="0" border="0">
		<tr>
			...
			<cfquery name="get_app_pos" datasource="#dsn#">
				SELECT * FROM EMPLOYEES_APP_POS WHERE EMPAPP_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#get_app.empapp_id#">
			</cfquery>
			<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=hr.popup_add_app_pos&app_pos_id=#get_app_pos.app_pos_id#&empapp_id=#get_app.empapp_id#</cfoutput>','medium');"> <img src="/images/notkalem.gif" title="Basvuru Ekle" border="0"></a>
			<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=hr.popup_select_list_empapp&empapp_id=#get_app.empapp_id#</cfoutput>','medium');"> <img src="/images/file.gif" title="Seçim Listeleri" border="0"></a>
			<cfoutput>
				<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=hr.popup_list_app_history&empapp_id=#empapp_id#','list');"><img src="/images/history.gif" border="0"  title="<cf_get_lang_main no='61.Tarihçe'>"></a> 
				<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&iid=#attributes.empapp_id#&print_type=170','page','workcube_print');"><img src="/images/print_plus.gif" title="<cf_get_lang_main no='62.Yazdır'>" border="0"></a>
				<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=objects.popup_operate_page&operation=emptypopup_print_app&action=print&id=#attributes.empapp_id#&module=hr&iframe=1','page');return false;"><img src="/images/print.gif" border="0" title="<cf_get_lang_main no='62.yazıcıya gönder'>"></a>
			</cfoutput>
			<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_page_warnings&action=#attributes.fuseaction#&action_name=empapp_id&action_id=#attributes.empapp_id#</cfoutput>','list');"> <img src="/images/bugpro.gif" title="<cf_get_lang_main no='345.Uyarılar'>" border="0"></a>
			</td>
		</tr>
	</table>
	...
	<td valign="top">
		...
		<tr class="color-border">
			<td>
					...
					<td class="color-row">
						<table>
							...
							<tr>
								...
								<td>
									<cfsavecontent variable="message"><cf_get_lang no='22.dahili tel girmelisiniz'></cfsavecontent>
							...
							<tr>
								...
								<td><select name="mobilcode" id="mobilcode" style="width:48px;">
									...
									<cfsavecontent variable="message"><cf_get_lang no='22.Mobil Telefon Girmelisiniz'></cfsavecontent>
							...
							<tr>
								...
								<td><cfinput type="text" name="email" value="#get_app.email#" validate="email" style="width:150px;" maxlength="100" message="Mail Adresini Giriniz!">
								</td>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="homecounty" id="homecounty" value="<cfoutput>#get_app.homecounty#</cfoutput>" style="width:150px;"> 
						...
						<tr>
							...
							<select name="homecountry" id="homecountry" style="width:150px;">
								...
								<option value="#get_country.country_id#" <cfif (get_app.homecountry eq get_country.country_id) or (get_country.is_default eq 1)>selected</cfif>>#get_country.country_name#</option>
								</cfoutput>
							</select>
							</td>
						</tr>
						<tr>
							...
							<tr>
								<td>
									...
									<cf_get_lang no='208.Fotoğrafı Sil'>
									</cfif>
								</td>
								<td>
									<cfif len(get_app.photo)>
							...
							<tr>
								<td width="115"><cf_get_lang_main no='1315.Doğum Tarih'></td>
								<td width="185">
				...
				<tr class="color-row">
					<td height="20" STYLE="cursor:pointer;" onClick="gizle_goster(gizli3);"><strong><cf_get_lang no='197.Kişisel Bilgileri Giriniz'></strong></td>
				</tr>
				<tr STYLE="display:none;"  ID="gizli3">
					...
					<table>
						<tr>
							<tr>
								...
								<td>
									...
									<cf_get_lang_main no='1547.Erkek'>
									<input type="radio" name="sex" id="sex" value="0" <cfif get_app.sex eq 0>checked</cfif>>
									<cf_get_lang_main no='1546.Kadin'> 
								</td>
								<td><cf_get_lang no='815.Medeni Durum'></td>
								<td>
						...
						<tr>
							...
							<td><cf_get_lang no='307.Şehit Yakını Misiniz'></td>
						...
						<tr>
							...
							<td width="110"><!--- <cf_get_lang no='578.SSK No'> ---></td>
							<td><!--- <cfinput type="text" name="socialsecurity_no" style="width:150px;" maxlength="50" value="#get_app.socialsecurity_no#"> ---></td>
						</tr>
						<tr>
							...
							<cfsavecontent variable="message_driver"><cf_get_lang_main no ='370.Tarih Değerinizi Kontrol Ediniz'></cfsavecontent>
								<cfinput type="text" name="licence_start_date" value="#DateFormat(get_app.licence_start_date,'dd/mm/yyyy')#" maxlength="10" validate="eurodate" message="#message_driver#" style="width:65px;">
						...
						<tr height="22">
							...
							<td valign="top"><cf_get_lang no='826.Geçirdiğiniz Ameliyat'></td>
						...
						<tr height="22" <cfif get_app.military_status neq 1>style="display:none"</cfif> id="Yapti">
							...
							<table>
								<tr>
									...
									<td width="100" nowrap><cf_get_lang no='325.Süresi'> (<cf_get_lang no='823.Ay Olarak Giriniz'>)</td>
								...
								<tr>
									<td></td>
									<td><input type="radio" name="military_rank" id="military_rank" value="0" <cfif get_app.military_rank eq 0>checked</cfif>> Er</td>
									<td></td>
				...
				<tr STYLE="display:none;"  ID="gizli1">
					...
					<table>
						...
						<tr height="22">
							...
							<td><cf_get_lang_main no='1028.Ana Adı'></td>
						...
						<tr height="22">
							<td colspan="4"><STRONG><cf_get_lang no='561.Cüzdanın'></STRONG></td>
						</tr>
						<tr height="22">
						...
						<tr height="22">
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='351.veriliş tarihi'></cfsavecontent>
				...
				<!--- Eğitim --->
				<tr>
					<td colspan="4" class="color-row" STYLE="cursor:pointer;" onClick="gizle_goster(gizli4);"><strong><cf_get_lang no='225.Eğitim  Bilgileri'></strong></td>
				</tr>
				<tr STYLE="display:none;" ID="gizli4">
					...
					<table border="0">
						<tr>
							<td colspan="5" height="25" class="formbold"><cf_get_lang no='225.Eğitim Bilgileri'></td>
						</tr>
						<tr>
								...
								<table id="table_edu_info" border="0" cellpadding="0" cellspacing="1">
								 <input type="hidden" name="row_edu" id="row_edu" value="<cfoutput>#get_edu_info.recordcount#</cfoutput>">
									<tr class="txtboldblue">
										...
										<td>
											<input name="record_numb_edu" id="record_numb_edu" type="hidden" value="0"><a href="javascript://" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects2.popup_add_edu_info&ctrl_edu=0','small');"><img src="/images/plus_list.gif" title="Eğitim Bilgisi Ekle" border="0"></a>
										</td>
									</tr>
									...
									<tr id="frm_row_edu#currentrow#">
										...
										<td style="width:10;">&nbsp;</td>
										<td>
											<input type="text" style="width:70;" name="edu_start#currentrow#" id="edu_start#currentrow#" class="boxtext" value="#edu_start#" readonly>
										</td>
										<td>
											<input type="text" style="width:70;" name="edu_finish#currentrow#" id="edu_finish#currentrow#" class="boxtext" value="#edu_finish#" readonly>
										</td>
										<td>
						...
						<!--- <tr> 90 GÜNE SİLİNSİN 20071122 YD
							<td width="110"></td>
							<td class="txtboldblue">Giriş Yılı</td>
							<td class="txtboldblue"><cf_get_lang no='869.Mez Yılı'></td>
							<td class="txtboldblue"><cf_get_lang no='1068.Not Ort'></td>
							<td class="txtboldblue"><cf_get_lang no='202.Bölüm'></td>
						</tr>
						<tr>
							<td><cf_get_lang no='593.İlköğretim'></td>
							<td>
								<cfinput type="text" name="edu1" style="width:190px;" maxlength="75" value="#get_app.edu1#">
							</td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='873.İlkokul Giriş tarihi girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfinput type="text" name="edu1_rank" style="width:40px;" maxlength="10" value="#get_app.edu1_rank#">
							</td>
						</tr>
						<tr>
							<td><cf_get_lang no='594.Ortaokul'></td>
							<td>
								<cfinput type="text" name="edu2" style="width:190px;" maxlength="75" value="#get_app.edu2#">
							</td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='874.Ortaokul Giriş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='251.Ortaokul Bitiş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfinput type="text" name="edu2_rank" style="width:40px;" maxlength="10" value="#get_app.edu2_rank#">
							</td>
						</tr>
						<tr>
							<td><cf_get_lang no='595.Lise'></td>
							<td>
								<cfinput type="text" name="edu3" style="width:190px;" maxlength="75" value="#get_app.edu3#">
							</td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='875.Lise Giriş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='189.Lise Bitiş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfinput type="text" name="edu3_rank" style="width:40px;" maxlength="10" value="#get_app.edu3_rank#">
							</td>
							<td>
								<select name="edu3_part" style="width:190px;">
									<option value=""><cf_get_lang no='1069.Lise Bölümleri'></option>
								...
								<!--- <cfinput type="text" name="edu3_part" style="width:150px;" maxlength="75" value="#get_app.edu3_part#"> --->
							</td>
						</tr>
						<tr>
							<td><cf_get_lang no='596.Üniversite'></td>
							<td>
								<select name="edu4_id"  style="width:190px;">
								<option value=""><cf_get_lang no='1070.Üniversiteler'></option>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='876.Üniversite Giriş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfinput type="text" name="edu4_rank" style="width:40px;" maxlength="10" value="#get_app.edu4_rank#">
							</td>
							<td>
								<select name="edu4_part_id"  style="width:190px;">
									<option value=""><cf_get_lang no='1071.Bölümler'></option>
						...
						<tr>
							<td><cf_get_lang no='596.Üniversite'> 2</td>
							<td>
							...
							<td>
								<cfinput type="text" name="edu4_rank_2" style="width:40px;" maxlength="10" value="#get_app.edu4_rank_2#">
							</td>
							<td>
						...
						<tr>
							<td><cf_get_lang no='1072.Diğer Üniversite'></td>
						...
						<tr>
							<td><cf_get_lang no='597.Yüksek Lisans'></td>
							<td>
								<cfinput type="text" name="edu5" style="width:190px;" maxlength="75" value="#get_app.edu5#">
							</td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='877.Yüksek Lisans Giriş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='178.Yüksek Lisans Bitiş Tarihi Girmelisiniz'></cfsavecontent>
							...
							<td>
								<cfinput type="text" name="edu5_rank" style="width:40px;" maxlength="10" value="#get_app.edu5_rank#">
							</td>
							<td>
								<cfinput type="text" name="edu5_part" style="width:190px;" maxlength="100" value="#get_app.edu5_part#">
							</td>
						</tr>
						<tr>
							<td><cf_get_lang no='248.Doktora'></td>
							<td>
								<cfinput type="text" name="edu7" value="#get_app.edu7#" style="width:190px;" maxlength="75" >
							</td>
							<td>
								<cfinput type="text" name="edu7_start" value="#get_app.edu7_start#" style="width:40px;" maxlength="4" validate="integer" message="#message#" range="1900,">
								<cfsavecontent variable="message"><cf_get_lang no='870.Okul Giriş yılı girmelisiniz'></cfsavecontent>
							</td>
							<td>
								<cfinput type="text" name="edu7_finish" value="#get_app.edu7_finish#" style="width:40px;" maxlength="4" validate="integer" message="#message#" range="1900,">
								<cfsavecontent variable="message"><cf_get_lang no='712.Okul Mezuniyet yılı girmelisiniz'></cfsavecontent>
							</td>
							<td></td>
							<td>
								<cfinput type="text" name="edu7_part" value="#get_app.edu7_part#" style="width:190px;" maxlength="75">
							</td>
						</tr> --->
					</table>
					<table>
						...
						<tr>
							...
							<td>
								<select name="lang1" id="lang1" style="width:80px;">
									<option value=""><cf_get_lang no='846.Seçiniz'> 
					...
					<table>
						...
						<tr>
							...
							<td><cfinput type="text" name="kurs1_yil" style="width:75px;"  value="#dateformat(get_app.KURS1_YIL,'yyyy')#" maxlength="4" range="1900," validate="integer" message="Kurs 1 İçin Yılı Girin!"></td>
							<td><cfinput type="text" name="kurs1_yer" style="width:160px;" value="#get_app.KURS1_YER#" maxlength="150"></td>
							<td><cfinput type="text" name="kurs1_gun" style="width:55px;" value="#get_app.KURS1_GUN#" validate="integer" message="Kurs 1 Gün Sayısını Girin!"></td>
						</tr>
						<tr>
							<td><cf_get_lang_main no='68.Konu'></td>  
							<td><cfinput type="text" name="kurs2" style="width:160px;" value="#get_app.KURS2#" maxlength="150"></td>
							<td><cfinput type="text" name="kurs2_yil" style="width:75px;" value="#dateformat(get_app.KURS2_YIL,'yyyy')#" maxlength="4" range="1900," validate="integer" message="Kurs 2 İçin Yılı Girin!"></td>
							<td><cfinput type="text" name="kurs2_yer" style="width:160px;" value="#get_app.KURS2_YER#" maxlength="150"></td>
							<td><cfinput type="text" name="kurs2_gun" style="width:55px;" value="#get_app.KURS2_GUN#" validate="integer" message="Kurs 2 Gün Sayısını Girin!"></td>
						</tr>  
						<tr>
							<td><cf_get_lang_main no='68.Konu'></td>  
							<td><cfinput type="text" name="kurs3" style="width:160px;" value="#get_app.KURS3#" maxlength="150"></td>
							<td><cfinput type="text" name="kurs3_yil" style="width:75px;" value="#dateformat(get_app.KURS3_YIL,'yyyy')#" maxlength="4" range="1900," validate="integer" message="Kurs3 İçin Yılı Girin!"></td>
							<td><cfinput type="text" name="kurs3_yer" style="width:160px;" value="#get_app.KURS3_YER#" maxlength="150"></td>
							<td><cfinput type="text" name="kurs3_gun" style="width:55px;" value="#get_app.KURS3_GUN#" validate="integer" message="Kurs 3 Gün Sayısını Girin!"></td>
						</tr>
						<tr>
				...
				<tr>
					<td colspan="4" class="color-row" STYLE="cursor:pointer;" onClick="gizle_goster(gizli2);"><strong><cf_get_lang no='759.Deneyim İş Tecrübesi'></strong></td>
				</tr>
				<tr STYLE="display:none;"  ID="gizli2">
					   ...
					   <cfquery name="get_work_info" datasource="#DSN#">
						 ...
						 <input type="hidden" name="row_count" id="row_count" value="<cfoutput>#get_work_info.recordcount#</cfoutput>">
							<tr class="txtboldblue">
								...
								<td><input name="record_num" id="record_num" type="hidden" value="0"><a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=objects2.popup_upd_work_info&control=0</cfoutput>','medium');"><img src="/images/button_gri.gif" title="İş Tecrübesi Ekle" border="0"></a></td>
							</tr>
					...
					<!--- <table>
						<tr>
							<td valign="top" class="txtbold" colspan="4"><cf_get_lang no='222.İş Tecrübesi'> 1
								<cfif len(get_app.exp1_fark)>
									<cfoutput>: #round(get_app.exp1_fark/365)# <cf_get_lang no='367.yıl'>(#get_app.exp1_fark#)<cf_get_lang_main no='78.Gün'> </cfoutput>
								</cfif>
							</td>
						</tr>					
						<tr>
						...
						<tr>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='715.deneyim 1 başlangıç tarihi'></cfsavecontent>
							...
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='177.deneyim 1 Bitiş Tarihi girmelisiniz'></cfsavecontent>
						...
						<tr height="22">
							<td valign="top"><cf_get_lang no='847.Kod / Telefon'></td>
							<td >
							...
							<td><cf_get_lang no='38.Ücret'> (<cf_get_lang no='1079.Son Ayın Brüt Ücreti'>)</td>
							<td>
						...
						<tr>
							<td><cf_get_lang no='1080.Ek Ödemeler'></td>
							<td>
								<input type="text" name="exp1_extra_salary" style="width:150px;" maxlength="75" value="<cfoutput>#get_app.exp1_extra_salary#</cfoutput>">
							</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
						<tr height="22">
							<td valign="top"><cf_get_lang no='1081.Görev Sorumluluk ve Ek Açıklamalar'></td>
							<td colspan="3"><textarea name="exp1_extra" id="exp1_extra" style="width:457px;height:40px;"><cfoutput>#get_app.exp1_extra#</cfoutput></textarea></td>
						</tr>
						<tr height="22">
							<td valign="top"><cf_get_lang no='247.Ayrılma nedeni'></td>
						...
						<tr>
							<td valign="top" class="txtbold" colspan="4"><cf_get_lang no='222.İş Tecrübesi'> 2
								<cfif len(get_app.exp2_fark)>
									<cfoutput>: #round(get_app.exp2_fark/365)# <cf_get_lang no='367.yıl'>(#get_app.exp2_fark#)<cf_get_lang_main no='78.Gün'></cfoutput>
								</cfif>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td><cf_get_lang_main no='89.Başlangıç'></td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='724.deneyim 2 başlangıç tarihi'></cfsavecontent>
							...
							<td><cf_get_lang_main no='90.Bitiş'></td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='732.deneyim 2 bitiş tarihi'></cfsavecontent>
						...
						<tr>
							<td valign="top"><cf_get_lang no='1081.Görev Sorumluluk ve Ek Açıklamalar'></td>
							<td colspan="3"><textarea name="exp2_extra" id="exp2_extra" style="width:457px;height:40px;"><cfoutput>#get_app.exp2_extra#</cfoutput></textarea></td>
						</tr>
						<tr>
							<td valign="top"><cf_get_lang no='247.Ayrılma nedeni'></td>
						...
						<tr>
							<td valign="top" class="txtbold" colspan="4"><cf_get_lang no='222.İş Tecrübesi'> 3 
							<cfif len(get_app.exp3_fark)>
								<cfoutput>: #round(get_app.exp3_fark/365)# <cf_get_lang no='367.yıl'>(#get_app.exp3_fark#)<cf_get_lang_main no='78.Gün'></cfoutput>
							</cfif>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td><cf_get_lang_main no='89.Başlangıç'></td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='737.deneyim 3 başlangıç tarihi girmelisiniz'></cfsavecontent>
							...
							<td><cf_get_lang_main no='90.Bitiş'></td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='738.deneyim 3 bitiş tarihi girmelisiniz'></cfsavecontent>
						...
						<tr>
							<td><cf_get_lang no='847.Kod / Telefon'></td>
							<td>
								<cfsavecontent variable="message"><cf_get_lang no='22.Telefon Kodu girmelisiniz'></cfsavecontent>
						...
						<tr>
							<td colspan="3"><textarea name="exp3_extra" id="exp3_extra" style="width:457px;height:40px;"><cfoutput>#get_app.exp3_extra#</cfoutput></textarea></td>
						</tr>
						<tr>
							<td><cf_get_lang no='247.Ayrılma nedeni'></td>
						...
						<tr>
							<td valign="top" class="txtbold" colspan="4"><cf_get_lang no='222.İş Tecrübesi'> 4
								<cfif len(get_app.exp4_fark)>
									<cfoutput>: #round(get_app.exp4_fark/365)# <cf_get_lang no='367.yıl'>(#get_app.exp4_fark#)<cf_get_lang_main no='78.Gün'></cfoutput>
								</cfif>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td valign="top"><cf_get_lang no='1081.Görev Sorumluluk ve Ek Açıklamalar'></td>
							<td colspan="3"><textarea name="exp4_extra" id="exp4_extra" style="width:457px;height:40px;"><cfoutput>#get_app.exp4_extra#</cfoutput></textarea></td>
						</tr>
						<tr>
							<td valign="top"><cf_get_lang no='247.Ayrılma nedeni'></td>
				...
				<tr STYLE="display:none;"  ID="gizli5">
					...
					<table>
						...
						<tr>
							...
							<td>
								<cfsavecontent variable="message_kod1"><cf_get_lang no='21.Lütfen Telefon Kodu Giriniz'></cfsavecontent>
								<cfsavecontent variable="message_tel1"><cf_get_lang no='22.Lütfen Telefon Numarası Giriniz'></cfsavecontent>
								<cfinput value="#get_app.ref1_telcode_emp#" type="text" name="ref1_telcode_emp" style="width:40px;" maxlength="3" validate="integer" message="#message_kod1#" >
								<cfinput value="#get_app.ref1_tel_emp#" type="text" name="ref1_tel_emp" style="width:106px;" maxlength="7" validate="integer" message="#message_tel1#" >
							</td>
							<td><cf_get_lang_main no='16.webmail'></td>
						...
						<tr>
							<td><cf_get_lang_main no='87.Tel'></td>
							<td>
								<cfsavecontent variable="message_kod2"><cf_get_lang no='21.Lütfen Telefon Kodu Giriniz'></cfsavecontent>
								<cfsavecontent variable="message_tel2"><cf_get_lang no='22.Lütfen Telefon Numarası Giriniz'></cfsavecontent>
								<cfinput value="#get_app.ref2_telcode_emp#" type="text" name="ref2_telcode_emp" style="width:40px;" maxlength="3" validate="integer" message="#message_kod2#" >
								<cfinput value="#get_app.ref2_tel_emp#" type="text" name="ref2_tel_emp" style="width:106px;" maxlength="7" validate="integer" message="#message_tel2#" >
							</td>
							<td><cf_get_lang_main no='16.webmail'></td>
						...
						<tr>
							<td><cf_get_lang_main no='87.Tel'></td>
							<td>
								<cfsavecontent variable="message_ref1_telcode"><cf_get_lang no='21.Lütfen Telefon Kodu Giriniz'></cfsavecontent>
								<cfsavecontent variable="message_ref1_tel"><cf_get_lang no='22.Lütfen Telefon Numarası Giriniz'></cfsavecontent>
								<cfinput value="#get_app.ref1_telcode#" type="text" name="ref1_telcode" style="width:40px;" maxlength="3" validate="integer" message="#message_ref1_telcode#" >
								<cfinput value="#get_app.ref1_tel#" type="text" name="ref1_tel" style="width:106px;" maxlength="7" validate="integer" message="#message_ref1_tel#" >
							</td>
							<td><cf_get_lang_main no='16.webmail'></td>
						...
						<tr>
							<td><cf_get_lang_main no='87.Tel'></td>
							<td>
								<cfsavecontent variable="message_ref2_telcode"><cf_get_lang no='21.Lütfen Telefon Kodu Giriniz'></cfsavecontent>
								<cfsavecontent variable="message_ref2_tel"><cf_get_lang no='22.Lütfen Telefon Numarası Giriniz'></cfsavecontent>
								<cfinput value="#get_app.ref2_telcode#" type="text" name="ref2_telcode" style="width:40px;" maxlength="3" validate="integer" message="#message_ref2_telcode#" >
								<cfinput value="#get_app.ref2_tel#" type="text" name="ref2_tel" style="width:106px;" maxlength="7" validate="integer" message="#message_ref2_tel#" >
							</td>
							<td><cf_get_lang_main no='16.webmail'></td>
...
<!---aile bilgileri--->
			<tr>
				<td colspan="4" class="color-row" height="20" STYLE="cursor:pointer;" onClick="gizle_goster(gizli12);"><STRONG><cf_get_lang no='861.Aile Bilgileri'></STRONG></td>
			</tr>
			<tr STYLE="display:none;" ID="gizli12">
				<td class="color-row">
					<table border="0">
						<tr>
							<td>
							  <table  cellspacing="1" cellpadding="2" width="100%" border="0" id="table_list">
								  ...
								  <input type="hidden" name="rowCount" id="rowCount" value="">
									...
									<td><cf_get_lang_main no='162.Şirket'></td>
									<td><cf_get_lang_main no='1085.Pozisyon'></td>
									<td> <input type="button" class="eklebuton" title="Ekle" onClick="addRow()"></td>
								  </tr>
								  ...
								  <cfif get_relatives.recordcount>
									...
									<input type="hidden" name="relative_sil#currentrow#" id="relative_sil#currentrow#" value="0">
									  <tr>
										<td><input type="text" name="name_relative#currentrow#" id="name_relative#currentrow#" value="#get_relatives.name#" maxlength="50" style="width:75px;"></td>
										<td><input type="text" name="surname_relative#currentrow#" id="surname_relative#currentrow#" value="#get_relatives.surname#" maxlength="50" style="width:75px;"></td>
										<td><select name="relative_level#currentrow#" id="relative_level#currentrow#" style="width:55px;">
												<option value="1" <cfif get_relatives.relative_level eq 1>selected</cfif>><cf_get_lang no='795.Baba'></option>
												<option value="2" <cfif get_relatives.relative_level eq 2>selected</cfif>><cf_get_lang no='796.Anne'></option>
										...
										<td><cfinput type="text" name="birth_date_relative#currentrow#" value="#dateformat(get_relatives.birth_date,'dd/mm/yyyy')#" validate="eurodate" maxlength="10" style="width:65px;">
										<cf_wrk_date_image date_field="birth_date_relative#currentrow#"></td>
										<td><cfinput type="text" name="birth_place_relative#currentrow#" value="#get_relatives.birth_place#" style="width:65px;"></td>
										<!--- <td><cfinput type="text" name="tc_identy_no_relative#currentrow#" value="#get_relatives.tc_identy_no#" style="width:75px;"></td> --->
										<td>
											...
											<input type="checkbox" name="education_status_relative#currentrow#" id="education_status_relative#currentrow#" value="1" <cfif get_relatives.education_status eq 1>checked</cfif>><cf_get_lang no="398.Okuyor">
										</td>
										...
										<td><a href="javascript://" onClick="relative_sil(#currentrow#);"><img src="../../images/delete_list.gif" border="0" title="Sil"></a></td>
									  </tr>
									  </cfoutput>
									 </cfif>
							  </table>
...
<!---çalışmak istediği dep--->
		<td colspan="4" class="color-row" height="20" STYLE="cursor:pointer;" onClick="gizle_goster(gizli11);"><STRONG><cf_get_lang no='862.Çalışmak İstediğiniz Birimler'></STRONG></td>
				<tr STYLE="display:none;"  ID="gizli11">
					...
					<cfelse>
						<tr><td><cf_get_lang no='865.Sisteme kayıtlı birim yok'>.</td></tr>
					</cfif>
					</table>
				</td>
			</tr>
<!---//calışmak istediği--->				
					...
					<table>
						...
						<tr>
							...
							<table>
								...
								<tr>
									<td nowrap><!--- <STRONG><cf_get_lang no='242.Kabul Edildiğiniz Takdirde İşe Başlayabileceğiniz Tarih'></STRONG> ---></td>
									<td>
										<!--- <cfsavecontent variable="message"><cf_get_lang no='742.Kabul Edildiğiniz Taktirde İşe Başlayabileceğiniz Tarih girmelisiniz'></cfsavecontent>
										<cfinput type="text" name="STARTDATE_IF_ACCEPTED" value="#dateformat(get_app.STARTDATE_IF_ACCEPTED,'dd/mm/yyyy')#" style="width:100px;" validate="eurodate" message="#message#">
						...
						<tr>
							<td colspan="2">
								<textarea name="applicant_notes" id="applicant_notes" maxlength="300" onkeyup="return ismaxlength(this)" onBlur="return ismaxlength(this);" message="<cfoutput>#message1#</cfoutput>"  style="width:600px;height:100px;"><cfoutput>#GET_APP.APPLICANT_NOTES#</cfoutput></textarea>
							</td>
						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<table>
						<tr>
							<td width="500">
								<cfif len(get_app.RECORD_EMP)><cf_get_lang_main no='71.Kayıt'> :<cfoutput>#get_emp_info(get_app.RECORD_EMP,0,0)#&nbsp;#dateformat(date_add('h',session.pp.time_zone,get_app.RECORD_DATE),'dd/mm/yyyy')# #timeformat(date_add('h',session.pp.time_zone,get_app.RECORD_DATE),'HH:MM')#</cfoutput></cfif><br/>
								<cfif len(get_app.UPDATE_EMP)>Güncelleyen : <cfoutput>#get_emp_info(get_app.update_emp,0,0)# - #dateformat(date_add('h',session.pp.time_zone,get_app.update_date),'dd/mm/yyyy')# #timeformat(date_add('h',session.pp.time_zone,get_app.update_date),'HH:MM')#</cfoutput></cfif>
							</td>
							<td  style="text-align:right;">
				...
				<table cellspacing="1" cellpadding="2" width="100%" border="0">
					...
					<tr class="color-header">
						<td class="color-row" valign="middle" align="center">
							<cfif len(get_app.photo)>
							<cf_get_server_file output_file="hr/#get_app.photo#" output_server="#get_app.photo_server_id#" output_type="0"  image_link="1" alt="#getLang('main',164)#" title="#getLang('main',164)#">
							<cfelse>
	...
	<br/>
		<table cellspacing="0" cellpadding="0" width="98%" border="0" align="center">
			<tr class="color-border">
				...
				<table cellspacing="1" cellpadding="2" width="100%" border="0">
					<tr class="color-header" height="22">
						<td width="100%" class="form-title"><cf_get_lang_main no='47.Yazışmalar'></td>
						<td><a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=hr.popup_app_add_mail&empapp_id=#attributes.empapp_id#</cfoutput>','large');"><img src="/images/plus_square.gif" title="Mail Ekle" border="0"></a></td>
					</tr>
					<tr class="color-row" height="20" >
						<td colspan="2">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<cfquery name="GET_EMPAPP_MAIL" datasource="#DSN#">
								SELECT * FROM EMPLOYEES_APP_MAILS WHERE EMPAPP_ID = #attributes.EMPAPP_ID# AND APP_POS_ID IS NULL AND LIST_ID IS NULL
							</cfquery> 
							...
							<tr>
								...
								<td width="15"  style="text-align:right;"><a href="javascript://" onClick="windowopen('#request.self#?fuseaction=hr.popup_app_upd_mail&empapp_id=#attributes.empapp_id#&EMP_APP_MAIL_ID=#EMP_APP_MAIL_ID#','medium');"><img src="/images/update_list.gif" border="0"></a></td>
							</tr>
							</cfoutput>
							</cfif>
	...
	<br/>
	<!--- 	<cfinclude template="../query/get_perf_results_app.cfm"> --->
		<table cellspacing="0" cellpadding="0" width="98%" border="0" align="center">
			<tr class="color-border">
				<td>
				<table cellspacing="1" cellpadding="2" width="100%" border="0">
					<tr class="color-header" height="22">
						<td class="form-title"><cf_get_lang no='1026.Değerlendirmeler'></td>
						<td  width="8%"  style="text-align:right;"><a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=hr.popup_app_empapp_list_quizs<cfif isdefined('attributes.empapp_id')>&empapp_id=#attributes.empapp_id#</cfif>&form_type=2&is_cv=1</cfoutput>','list');"> <img src="/images/plus_square.gif" title="Başvuru Pozisyonuna Ö D Formu Ekle" border="0"></a></td>
					</tr>
					<tr class="color-row" height="20" >
						<td colspan="2">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<cfquery name="GET_APP_QUIZ" datasource="#dsn#">
								...
								WHERE 
									...
									AND EMPLOYEES_APP_QUIZ.EMPAPP_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.empapp_id#">
							</cfquery>
								...
								<tr>
									...
									<td width="10%"  style="text-align:right;">
										...
										<cfif GET_APP_PERF_RESULT.RecordCount>
											#GET_APP_PERF_RESULT.USER_POINT#&nbsp;/&nbsp;#GET_APP_PERF_RESULT.PERFORM_POINT#
											<cfif not listfindnocase(denied_pages,'hr.form_upd_app_performance')>
												<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=hr.popup_form_upd_app_performance&APP_PER_ID=#GET_APP_PERF_RESULT.APP_PER_ID#&is_cv=1','page')"> <img src="/images/update_list.gif" border="0" title="<cf_get_lang_main no='354.Formu Güncelle'>"> </a>
											</cfif>
										<cfelse>
											<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=hr.popup_form_add_app_performance&quiz_id=#quiz_id#&emp_app_quiz_id=#GET_APP_QUIZ.EMP_APP_QUIZ_ID#&empapp_id=#attributes.empapp_id#&is_cv=1','page')"><img src="/images/plus_list.gif" title="<cf_get_lang_main no='350.Formu Doldur'>" border="0"></a>
										</cfif>
									</td>
								</tr>
								</cfoutput>
...
function addRow()
{
	...
	newCell = newRow.insertCell();
	newCell.innerHTML = '<select name="relative_level' + rowCount + '" style="width:55px;"><option value="1"><cf_get_lang no="180.Babası"></option><option value="2"><cf_get_lang no="385.Annesi"></option><option value="3"><cf_get_lang no="190.Eşi"></option><option value="4"><cf_get_lang no="168.Oğlu"></option><option value="5"><cf_get_lang no="149.Kızı"></option><option value="6">Kardeşi</option></select>';
	newCell = newRow.insertCell();
	newCell.innerHTML = '<input type="text" name="birth_date_relative' + rowCount + '" value="" style="width:65px;">';
	newCell.innerHTML +='<a href="javascript://" onclick=windowopen("<cfoutput>#request.self#?fuseaction=objects.popup_calender</cfoutput>&alan=employe_detail.birth_date_relative' + rowCount + '","date");><img src="/images/calendar.gif" align="absmiddle" border="0"></a>';
	newCell = newRow.insertCell();
	newCell.innerHTML = '<input type="text" name="birth_place_relative' + rowCount + '" value="" style="width:65px;">';
	/*newCell = newRow.insertCell();
	newCell.innerHTML = '<input type="text" name="tc_identy_no_relative' + rowCount + '" value="" style="width:75px;">';*/
	newCell = newRow.insertCell();
	newCell.innerHTML = '<select name="education_relative' + rowCount + '" style="width:65px;"><option value=""><cf_get_lang no="346.Seçiniz"></option><cfoutput query="get_edu_level"><option value="#EDU_LEVEL_ID#" >#EDUCATION_NAME#</option></cfoutput></select><input type="checkbox" name="education_status_relative' + rowCount + '" value="1"><cf_get_lang no="398.Okuyor">';
	newCell = newRow.insertCell();
...
{
	alan=eval('document.employe_detail.relative_sil'+satir);
	alan.value=1;
	alan=eval('document.employe_detail.name_relative'+satir);
	alan.value="";
	alan=eval('document.employe_detail.surname_relative'+satir);
	alan.value="";
}
...
function gonder(exp_name,exp_position,exp_start,exp_finish,exp_sector_cat,exp_task_id,exp_telcode,exp_tel,exp_salary,exp_extra_salary,exp_extra,exp_reason,control,my_count,is_cont_work)
{
	if(control == 1)
	{
		...
		if(exp_sector_cat != '')
		{
			var get_emp_cv_new = wrk_safe_query("obj2_get_emp_cv_new",'dsn',0,);
...
function gonder_edu(edu_type,ctrl_edu,count_edu,edu_id,edu_name,edu_start,edu_finish,edu_rank,edu_high_part_id,edu_part_id,edu_part_name,is_edu_continue)
{
	...
	else
	{
		...
		new_Cell_Edu.innerHTML = '<input style="width:80;" type="text" name="edu_type_name' + row_edu + '" value="'+ edu_type_name +'" class="boxtext" readonly>';
		if(edu_id != '' && edu_id != -1)
		{
			var get_cv_edu_new = wrk_safe_query("obj2_get_cv_edu_new",'dsn',0,edu_id);
			if(get_cv_edu_new.recordcount)
				var edu_name_degisken = get_cv_edu_new.SCHOOL_NAME;
			new_Cell_Edu = new_Row_Edu.insertCell();
			new_Cell_Edu.innerHTML = '<input style="width:185;" type="text" name="edu_name' + row_edu + '" value="'+ edu_name_degisken +'" class="boxtext" readonly>';
		}
		else
		{
			new_Cell_Edu = new_Row_Edu.insertCell();
			new_Cell_Edu.innerHTML = '<input style="width:185;" type="text" name="edu_name' + row_edu + '" value="'+ edu_name +'" class="boxtext" readonly>';
		}
		new_Cell_Edu = new_Row_Edu.insertCell();
		new_Cell_Edu.innerHTML = '<input style="width:10;" type="hidden" name="gizli' + row_edu + '" value="" class="boxtext" readonly>';
		new_Cell_Edu = new_Row_Edu.insertCell();
		new_Cell_Edu.innerHTML = '<input style="width:70;" type="text" name="edu_start' + row_edu + '" value="'+ edu_start +'" class="boxtext" readonly>';
		new_Cell_Edu = new_Row_Edu.insertCell();
		new_Cell_Edu.innerHTML = '<input style="width:70;" type="text" name="edu_finish' + row_edu + '" value="'+ edu_finish +'" class="boxtext" readonly>';
		new_Cell_Edu = new_Row_Edu.insertCell();
		...
		if(edu_high_part_id != undefined && edu_high_part_id != '' && edu_high_part_id != -1)
		{
			...
			if(get_cv_edu_high_part_id.recordcount)
				var edu_part_name_degisken = get_cv_edu_high_part_id.HIGH_PART_NAME;
			new_Cell_Edu = new_Row_Edu.insertCell();
			new_Cell_Edu.innerHTML = '<input style="width:100;" type="text" name="edu_part_name' + row_edu + '" value="'+ edu_part_name_degisken +'" style="width:150px;" class="boxtext" readonly>';
		}
