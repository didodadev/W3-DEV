...
<input type="button" value="+" style="width:20px; heigth:18px;" onclick="window.open('<cfoutput>#request.self#?fuseaction=objects.popup_calender_ik</cfoutput>&alan=employe_detail.start_date','','top=100,left=100,width=250,height=180');">

buradaki url den gelecek olan alan parametresi form.alan_adi şeklinde gönderilmeli

TolgaS kariyer portal için konuldu
--->
...
<cfsavecontent variable="mayis"><cf_get_lang_main no='184.mayis'></cfsavecontent>
...
<cfsavecontent variable="kasim"><cf_get_lang_main no='190.kasim'></cfsavecontent>
<cfsavecontent variable="aralik"><cf_get_lang_main no='191.aralik'></cfsavecontent>
...
function  FillCalendar()
{
	...
	var NumDaysInMonth, i, t;
  	...
  	if (Midx == -1){
   		alert ("<cf_get_lang no ='1190.Ay İsmi Algılanamadı'> !");
   		return;
  	}
...
<table cellpadding="0" cellspacing="0" align="center" class="ik1">
  <tr>
    <td align=center>
      <table border=0  cellspacing=1 cellpadding="2" width="100%">
        <form name="calform">
          <tr>
            ...
            <input name="text" id="text" type=text value="January" class="boxtext" style="width:70px;">
			<input type=button value=">>" onClick="IncDecMonth(1)">
		  </th>
          </tr>
          <tr bgcolor="#FFB74A" height="25">
            <th class="form-title"><cf_get_lang_main no='207.pzt'></th>
            <th class="form-title"><cf_get_lang_main no='208.sal'></th>
            <th class="form-title"><cf_get_lang_main no='209.crs'></th>
            <th class="form-title"><cf_get_lang_main no='210.per'></th>
            <th class="form-title"><cf_get_lang_main no='211.cum'></th>
            <th class="form-title"><cf_get_lang_main no='212.cmt'></th>
            <th class="form-title"><cf_get_lang_main no='213.paz'></th>
          </tr>
