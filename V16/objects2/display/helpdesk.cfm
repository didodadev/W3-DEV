        ...
        <table cellspacing="1" cellpadding="2" align="right">
            <tr>
                ...
                <td>
                    ...
                    <cfinput type="text" name="keyword" id="keyword" value="#attributes.keyword#" style="width:75px;">
                </td>
                <td>
                    ...
                    <input type="submit" onclick="kontrol()" value="<cfoutput>#getLang('main',499)#</cfoutput>">
                </td>
            </tr>
        </table>
    </cfform>
...
<table cellspacing="1" cellpadding="2" class="color-list" style="width:100%">
	<tr class="color-header" style="height:22px;">
        <th></th>
        <th class="form-title" style="width:40px;"><cf_get_lang_main no='75.No'></th>
        <th class="form-title" style="width:160px;"><cf_get_lang_main no='1140.Konu'></th>
        <th class="form-title" style="width:100px;"><cf_get_lang_main no='1717.Başvuru Yapan'></th>
        <th class="form-title" style="width:80px;"><cf_get_lang_main no='344.Süreç'></th>
        <th class="form-title" style="width:65px;"><cf_get_lang_main no='330.Tarih'></th>
        <th class="form-title" style="width:150px;"><cf_get_lang no='47.Başvuru Durumu'></th>
        <cfif isDefined('attributes.is_helpdesk_button') and attributes.is_helpdesk_button eq 1><th style="width:15px;"><a href="<cfoutput>#request.self#</cfoutput>?fuseaction=objects2.add_service_help"><img src="/images/plus_list.gif" border="0"></a></th></cfif>
    </tr>
...
<cfif isdefined('attributes.is_paging') and attributes.is_paging eq 1>
	<cfif attributes.totalrecords gt attributes.maxrows>
        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center" class="color-row" style="width:100%; height:35px;">
            <tr>
                <td>
                    <cf_pages page="#attributes.page#" page_type="2" maxrows="#attributes.maxrows#" totalrecords="#attributes.totalrecords#" button_type="1" startrow="#attributes.startrow#" adres="#attributes.fuseaction##adres#&form_submitted=1" name="content_main2">
                </td>
