...
<cfquery name="GET_MY_" datasource="#DSN#" maxrows="1">
	...
	WHERE 
		...
		<cfelseif isdefined("session.cp.our_company_id")>
			IS_ACTIVE = 1 AND SITE_TYPE = 3 AND SITE_DOMAIN = <cfqueryparam cfsqltype="cf_sql_varchar" value="#cgi.http_host#">
		...
		<cfelseif isdefined("session.ep")>
			IS_ACTIVE = 1 AND 
            SITE_DOMAIN = <cfqueryparam cfsqltype="cf_sql_varchar" value="#cgi.http_host#"> AND 
			MENU_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#session.ep.menu_id#"> 
...
<cfquery name="GET_DESIGN_STYLES" datasource="#DSN#">
    SELECT DESIGN_ID, DESIGN_PATH FROM MAIN_SITE_OBJECT_DESIGN
</cfquery>
...
<cfif get_site_pages.recordcount>
    ...
    <section style="<cfif len(my_margin_left_)>margin-left:<cfoutput>#my_margin_left_#</cfoutput>px;margin-right:<cfoutput>#my_margin_left_#</cfoutput>px;</cfif><cfif len(get_my_.content_menu_background)>background-image:url(<cf_get_server_file output_file="settings/#get_my_.content_menu_background#" output_server="#get_my_.content_menu_bg_server_id#" output_type="4" alt="#lang_array.item[1315]#" title="#lang_array.item[1315]#">);<cfelse>background-color:###get_my_.color_content_menu#;</cfif><cfif len(get_my_.top_inner_marjin)>margin-top:<cfoutput>#get_my_.top_inner_marjin#</cfoutput>px;</cfif>" class="main">
    	<cfif get_4.recordcount>
            <section class="main_area" style="width:100%;">
            	<cfoutput query="get_4">
                            ...
                            <cfquery name="GET_ALL_FOR_LANGS" datasource="#DSN#">
                                ...
                                WHERE 
                                    <!---(
                                    	...
                                    	(TABLE_NAME = 'MAIN_MENU_SELECTS' AND COLUMN_NAME = 'LINK_NAME') OR
            							(TABLE_NAME = 'MAIN_MENU_LAYER_SELECTS' AND COLUMN_NAME = 'LINK_NAME') OR
                                    	(TABLE_NAME = 'SETUP_PARTNER_POSITION' AND COLUMN_NAME = 'PARTNER_POSITION') OR
					                    (TABLE_NAME = 'SETUP_PARTNER_DEPARTMENT' AND COLUMN_NAME = 'PARTNER_DEPARTMENT') OR
                                    	(TABLE_NAME = 'SETUP_COUNTRY' AND COLUMN_NAME = 'COUNTRY_NAME') OR
                                    	(TABLE_NAME = 'MAIN_SITE_LAYOUTS_SELECTS' AND COLUMN_NAME = 'OBJECT_NAME') OR
                                        (TABLE_NAME = 'PRODUCT_CAT' AND COLUMN_NAME = 'PRODUCT_CAT')
                                    ) AND --->
                                    ITEM <> '' AND
                                    LANGUAGE = <cfqueryparam cfsqltype="cf_sql_varchar" value="#session_base.language#">
                            </cfquery>
                        </cfif>
						<cfquery name="GET_OBJECT_NAME" dbtype="query">
                        	SELECT * FROM GET_ALL_FOR_LANGS WHERE (TABLE_NAME = 'MAIN_SITE_LAYOUTS_SELECTS' AND COLUMN_NAME = 'OBJECT_NAME') AND UNIQUE_COLUMN_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#row_id#">
                        </cfquery>
                        <cfif get_object_name.recordcount>
                            <cfsavecontent variable="content_header">#get_object_name.item#</cfsavecontent>
                        <cfelse>
                    ...
                    <cfif len(content)>
                        <cfquery name="GET_DESIGN_STYLE" dbtype="query">
                            SELECT * FROM GET_DESIGN_STYLES WHERE DESIGN_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#design_id#">
                        </cfquery>
                       	<div id="area_#this_row_id_#" class="main_top_area" style="width:100%; height:100%;">
        ...
        <cfif get_1.recordcount>
        	<section class="main_area" <cfif get_site_pages.left_width neq 0>style="width:<cfoutput>#get_site_pages.left_width#</cfoutput>px;"<cfelse>style="width:100%;"</cfif>>
				<cfoutput query="get_1">
                    ...
                    <cfif len(content)>
                        ...
                        <div id="area_#this_row_id_#" class="main_left_area" <cfif get_site_pages.left_width neq 0>style="width:#get_site_pages.left_width#px;"<cfelse>style="width:100%;"</cfif>>
                            <cfinclude template="/#get_design_style.design_path#">
                        </div>
                    </cfif>                           
                </cfoutput>
        ...
        <cfif get_2.recordcount>
        	<section class="main_area" <cfif get_site_pages.center_width neq 0> style="width:<cfoutput>#get_site_pages.center_width#</cfoutput>px; <cfif get_1.recordcount>margin-left:<cfoutput>#get_site_pages.margin#</cfoutput>px;</cfif>" <cfelse> style="width:100%; <cfif get_1.recordcount>margin-left:<cfoutput>#get_site_pages.margin#</cfoutput>px;</cfif>"</cfif>>
				<cfoutput query="get_2">
                    ...
                    <cfif len(content)>
                        ...
                        <div id="area_#this_row_id_#" class="main_center_area" <cfif get_site_pages.center_width neq 0>style="width:#get_site_pages.center_width#px;"<cfelse>style="width:100%;"</cfif>>
                            <cfinclude template="/#get_design_style.design_path#">
                        </div>
                    </cfif>                           
                </cfoutput>
        ...
        <cfif get_3.recordcount>
        	<section class="main_area" <cfif get_site_pages.right_width neq 0> style="width:<cfoutput>#get_site_pages.right_width#</cfoutput>px;<cfif get_2.recordcount>margin-left:<cfoutput>#get_site_pages.margin#</cfoutput>px;</cfif>" <cfelse> style="width:100%;<cfif get_2.recordcount>margin-left:<cfoutput>#get_site_pages.margin#</cfoutput>px;</cfif>"</cfif>>
				<cfoutput query="get_3">
                    ...
                    <cfif len(content)>
                        ...
                        <div id="area_#this_row_id_#" class="main_right_area" <cfif get_site_pages.right_width neq 0>style="width:#get_site_pages.right_width#px;"<cfelse>style="width:100%;"</cfif>>
                            <cfinclude template="/#get_design_style.design_path#">
                        </div>
                    </cfif>                           
                </cfoutput>
