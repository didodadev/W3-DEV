...
<cfif upd_work.recordcount>
	  			...
	  			<table align="center" cellpadding="0" cellspacing="0" border="0" style="width:98%">
					<tr>
		  				<td style="vertical-align:top">
							...
							<table cellspacing="2" cellpadding="2" border="0" style="width:580px;">
			  					<tr>
							  	...
							  	<tr>
									...
									<td>
                                        ...
                                        <cfelse>
                                          <!---   <cf_workcube_process is_upd='0' select_value = '#upd_work.work_currency_id#' process_cat_width='110' is_detail='1'> --->
                                        </cfif>
									...
									<td colspan="2" style="vertical-align:top">
								  		<table cellpadding="0" cellspacing="0" style="width:100%;">
											<tr>
                                                ...
                                                <cfif isDefined('attributes.is_related_work') and attributes.is_related_work eq 1>
                                                	<td style="text-align:right;">İlişkili İş :</td>
                                                </cfif>
											</tr>
								  		</table>
									</td>
                                    	...
                                    	<cfif isDefined('attributes.is_related_work') and attributes.is_related_work eq 1>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:top">
                                                        <input type="text" name="rel_work" id="rel_work" value="<cfoutput>#upd_work.related_work_id#</cfoutput>" style="width:250px;" readonly="yes">
					...
					<tr>
					  	<td>
							<table border="0">
							  	<tr>
									<td colspan="5">&nbsp;<cf_get_lang_main no='68.Başlık'></td>
							  	</tr>
							  	<tr>
									<td colspan="5">
							  	...
							  	<tr>
									<td colspan="5">&nbsp;<cf_get_lang_main no='359.Ayrıntı'></td>
							  	</tr>
                                <tr>
                                	<td colspan="5">
								...
								<cfif isDefined('attributes.is_real_dates') and attributes.is_real_dates eq 1>
                                    <tr>
                                        <td style="width:150px;">Gerçekleşen <cf_get_lang_main no='243.Baş Tarihi'> </td>
                                        <td style="width:130px;"><cf_get_lang_main no='79.Saat'></td>
                                        <td style="width:100px;">Gerçekleşen <cf_get_lang_main no='288.Bitiş Tarihi'> </td>
                                        <td><cf_get_lang_main no='79.Saat'></td>
                                    </tr>
                                    <tr>    
                                        <td>
                                            <cfsavecontent variable="message">Lütfen İşin Gerçekleşen Başlama Tarihini Giriniz!</cfsavecontent>
                                            <cfinput type="text" name="work_h_start"  id="work_h_start"  value=""message="#message#"style="width:75px;" validate="eurodate">
                                        ...
                                        <td><!---#dateformat(fdate,'dd/mm/yyyy')#--->
                                            <cfsavecontent variable="message">Lütfen İşin Gerçekleşen Bitiş Tarihini Giriniz!</cfsavecontent>
                                            <cfinput type="text" name="work_h_finish" id="work_h_finish" value="" message="#message#" style="width:75px;" validate="eurodate">
                             	...
                             	<tr>
                                	<td style="width:97px">Planlanan <cf_get_lang_main no='243.Baş Tarihi'> </td>
									<td style="width:97px">Planlanan <cf_get_lang_main no='288.Bitiş Tarihi'> </td>
                                    <td>Özel Tanım</td>
                                </tr>
                            	<tr>
                                    <td><!---#dateformat(sdate,'dd/mm/yyyy')#--->
									  	<cfsavecontent variable="message">Lütfen İşin Planlanan Başlama Tarihini Giriniz!</cfsavecontent>
									  	<cfinput type="text" name="startdate_plan"  id="startdate_plan"  value="" required="Yes" message="#message#"style="width:75px;" validate="eurodate">
									  	<cf_wrk_date_image date_field="startdate_plan">
									</td>
									<td style="width:97px">
                                    	<cfsavecontent variable="message">Lütfen İşin Planlanan Bitiş Tarihini Giriniz!</cfsavecontent>
                                    	<cfinput type="text" name="finishdate_plan" id="finishdate_plan" value="" required="Yes" message="#message#" style="width:75px;" validate="eurodate">
									  	<cf_wrk_date_image date_field="finishdate_plan">
                                     </td>
                                     <td>
								...
								<tr style="height:35px;">
									...
									<td colspan="3" align="right" style="text-align:right;"> 
										<cfif upd_work.record_par eq session.pp.userid>
											<cf_workcube_buttons is_upd='1' add_function='chk_work(#upd_work.project_id#)'>
										<cfelse>
                        ...
                        <td style="vertical-align:top;">
                        	<cfif isDefined('attributes.is_stock_receipt') and attributes.is_stock_receipt eq 1>
                                <cfinclude template="../display/list_stock_receipts.cfm">
                            </cfif>
                        </td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		{
			if((document.getElementById('pro_id').value > 0) && (document.getElementById('project_id').value>0)&&(document.getElementById('rel_work_id') != undefined && document.getElementById('rel_work_id').value!=0)&&(document.getElementById('rel_work_id') != undefined && document.getElementById('rel_work_id').value!="")&&(document.getElementById('project_id').value!=pro_id))
