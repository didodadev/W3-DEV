	...
	<tr class="color-list" style="vertical-align:middle; height:35px;">
		<td>
			<table align="center" style="width:98%">
				<tr>
					<td class="headbold" style="vertical-align:bottom;"><cf_get_lang no='1625.Belge Güncelle'></td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<td colspan="2">
						<table border="0">
							...
							<tr>
								...
								<td style="vertical-align:top;"><textarea name="detail" id="detail" style="width:200px; height:80px;"><cfoutput>#get_asset.asset_detail#</cfoutput></textarea></td>
							</tr>
							<tr>
								<td></td>
								<td height="25"><cf_workcube_buttons is_upd='1' delete_page_url='#request.self#?fuseaction=objects2.emptypopup_del_asset_file&asset_id=#get_asset.asset_id#' add_function="input_control()"></td>
							</tr>
						</table>
					</td>
				</tr>
