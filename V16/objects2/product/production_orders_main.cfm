			...
			<tr>
				...
				<td>
					<!--- <cf_wrkProject
						...
						boxwidth="600"
						boxheight="400"> --->
                    <cfif len(get_det_po.project_id)>
                        <cfquery name="GET_PROJECT" datasource="#DSN#">
                            SELECT PROJECT_HEAD FROM PRO_PROJECTS WHERE PROJECT_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#get_det_po.project_id#">
                        </cfquery>
                    <cfelse>
                    	<cfset get_project.recordcount = 0>
                    </cfif>
					<input type="hidden" name="project_id" id="project_id" value="#get_det_po.project_id#" style="width: 140px;">
					<input type="text" name="project_head" id="project_head" value="<cfif get_project.recordcount>#get_project.project_head#</cfif>" onfocus="AutoComplete_Create('project_head','PROJECT_HEAD','PROJECT_HEAD','get_project','','PROJECT_ID','project_id','','3','148');" autocomplete="off" style="width: 140px;">
				</td>
			</tr>
			<tr>
