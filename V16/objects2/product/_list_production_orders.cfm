...
<cfform name="search_list" action="#request.self#?fuseaction=#attributes.fuseaction#" method="post">
    ...
    <input type="hidden" name="is_excel" value="0">
                    ...
                    <tr>
                        ...
                        <td>
                           <!--- <select name="station_id" id="station_id" style="width:170px;">
                            ...
                            <select name="prod_order_stage" style="width:100px;">
                        ...
                        <td>
                            <select name="oby" style="width:90px;">
                        ...
                        <td>
                            <select name="status" style="width:65px;">
            	...
            	<table align="right">		  
                    <tr>
                        <td align="right">
                            ...
                            <input type="text" name="spect_name" value="<cfoutput>#attributes.spect_name#</cfoutput>" style="width:110px;">
                            <a href="javascript://" onclick="product_control();"><img src="/images/plus_thin.gif"></a>
                            ...
                            <input type="text"   name="product_name"  id="product_name" style="width:110px;"  value="<cfoutput>#attributes.product_name#</cfoutput>" passthrough="readonly=yes" onfocus="AutoComplete_Create('product_name','PRODUCT_NAME','PRODUCT_NAME','get_product_autocomplete','0','PRODUCT_ID,STOCK_ID','product_id,stock_id','','3','225');" autocomplete="off">
                            <a href="javascript://" onclick="spect_remove();windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects2.popup_product_names&field_id=search_list.stock_id&product_id=search_list.product_id&field_name=search_list.product_name&keyword='+encodeURIComponent(document.search_list.product_name.value),'list');"><img src="/images/plus_thin.gif"></a>
                            <cfif isdefined("is_show_production_station") and is_show_production_station eq 1>
                                <cfif fuseaction_ is 'order'>
                                    <select name="production_stage" style="width:125px;height:65px" multiple="multiple">
                ...
                <table align="right">
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="product_cat_code" value="<cfif len(attributes.product_cat)><cfoutput>#attributes.product_cat_code#</cfoutput></cfif>">
                            ...
                            <a href="javascript://"onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects2.popup_product_cat_names&field_code=search_list.product_cat_code&is_sub_category=1&field_id=search_list.product_catid&field_name=search_list.product_cat','list');"><img src="/images/plus_thin.gif" title="Kategori Ekle"></a>
                            ...
                            <cfif fuseaction_ is 'operations'>
                                ...
                                <select name="operation_order" style="width:105px;">
							...
							<!---<cfif not (isdefined('attributes.is_excel') and attributes.is_excel eq 1)>
                                <td>
                                    <cfif len(_station_id_)>
                                        <a class="tableyazi" href="#request.self#?fuseaction=objects2.detail_prod_order&station_id=#station_id#">#get_station_prod(station_id)#</a>
                                    </cfif>
                                </td>
							<cfelse> --->
								<td>
