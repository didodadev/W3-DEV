...
<cfparam name="attributes.request_date" default="#dateformat(get_flexible_worktime.request_date,dateformat_style)#" />
<cfparam name="attributes.branch_id" default="#get_flexible_worktime.branch_id#" />
            ...
            <cfform name="flexible_worktime" id="flexible_worktime" action="" enctype="multipart/form-data" method="post">
                <cf_box_elements>
                    ...
                    <div class="col col-5 col-md-6 col-xs-12" type="column" index="1" sort="true">
                        ...
                        <div class="form-group" id="item-employee">
                            ...
                            <div class="col col-9 col-xs-12">
                                <div class="input-group">
                                    <input type="hidden" name="employee_id" id="employee_id" value="<cfoutput><cfif fuseaction is 'myhome'>#session.ep.userid#<cfelse>#get_flexible_worktime.employee_id#</cfif></cfoutput>">
                                    <input type="hidden" name="position_id" id="position_id" value="<cfoutput><cfif fuseaction is 'myhome'>#session.ep.position_code#<cfelse>#get_flexible_worktime.position_id#</cfif></cfoutput>">
                                    <input type="text" name="employee" id="employee" onFocus="AutoComplete_Create('employee','MEMBER_NAME','MEMBER_NAME','get_member_autocomplete','\'3,9\',\'0\',\'0\',\'0\',\'\',\'\',\'\',\'1\'','EMPLOYEE_ID,MEMBER_TYPE','employee_id','','3','135');" style="width:120px;" value="<cfoutput><cfif fuseaction is 'myhome'>#get_emp_info(attributes.employee_id,0,0)#<cfelse>#get_emp_info(get_flexible_worktime.employee_id,0,0)# </cfif></cfoutput>"  <cfif fuseaction is 'myhome'>disabled</cfif>>
                        ...
                        <div class="form-group" id="item-branch">
                            ...
                            <div class="col col-9 col-xs-12">
                                ...
                                <cfif fuseaction is 'myhome'>
                                    <cfoutput> <input type = "hidden" id = "branch_id" name = "branch_id" value = "#listlast(session.ep.user_location,'-')#"></cfoutput>
                                </cfif>
                            </div>
                        </div>
                        <div class="form-group" id="item-department">
                            ...
                            <div class="col col-9 col-xs-12" id="department_div">
                                ...
                                <cfif fuseaction is 'myhome'>
                                    <cfoutput><input type = "hidden" id = "department_id" name = "department_id" value = "#listfirst(session.ep.user_location,'-')#"></cfoutput>
                                </cfif>
                            </div>
                        </div>
                        <div class="form-group" id="item-employee">
                ...
                <div class = "col col-12 col-md-12 col-xs-12 ">
                    ...
                    <cf_grid_list margin="1">
                        <thead>
                            ...
                            <cfif fuseaction is 'hr' or is_approve_page eq 1><th style="width:45px;"></th></cfif>
                        </thead>
                                    ...
                                    <cfif not len(flexible_date)>
                                        ...
                                        <tr id = "row_#currentrow#" name = "#currentrow#">
                                            ...
                                            <td style = "text-align:center" nowrap="nowrap">
                                                <cf_wrktimeformat name="flexible_start_hour#currentrow#" value = "#flexible_start_hour#"><select id="flexible_start_min#currentrow#" name="flexible_start_min#currentrow#">
                                                ...
                                                <cf_wrktimeformat name="flexible_finish_hour#currentrow#" value = "#flexible_finish_hour#"><select id="flexible_finish_min#currentrow#" name="flexible_finish_min#currentrow#">
                                                    <option value=""><cf_get_lang dictionary_id="58827.min"></option>
                                                    <cfloop from="0" to="59" index="i" step="5">
                                            ...
                                            <cfif fuseaction is 'hr' or is_approve_page eq 1>
                ...
                <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                    <cf_box_footer>
                        ...
                        <cf_workcube_buttons is_upd='1' add_function="kontrol()" delete_page_url='#request.self#?fuseaction=#fuseaction#.flexible_worktime&event=del&flexible_id=#attributes.flexible_id#'>
                    </cf_box_footer>
                </div>
            </cfform>
        </div>
...
<script type="text/javascript">
    ...
    function is_approve(valid_type_,approve_id)
	{
		...
		var send_address = '<cfoutput>#request.self#</cfoutput>?fuseaction=hr.flexible_worktime&event=ajaxApprove&valid_type='+ valid_type_ +'&approve_id='+approve_id;
