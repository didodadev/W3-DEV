...
<form name="add_warning" action="<cfoutput>#request.self#</cfoutput>?fuseaction=myhome.popup_form_add_warning" method="post">
	<input type="hidden" name="act" id="act" value="<cfoutput>myhome.upd_target_plan_forms&per_id=#attributes.per_id#</cfoutput>">
</form>
<!---/// uyarı için eklenen form--->
...
<cfsavecontent variable="message"><cf_get_lang dictionary_id='31609.Performans Formu Sonuç'></cfsavecontent>
<cf_popup_box title="#message# #GET_EMP.EMPLOYEE_NAME# #GET_EMP.EMPLOYEE_SURNAME#" right_images="#right#">
	  <cfform name="add_perform_result" method="post" action="#request.self#?fuseaction=myhome.emptypopup_add_req_type_quiz_result">
...
<table>
	...
	<tr>
		<td colspan="4" class="txtboldblue"><cf_get_lang dictionary_id ='31610.Birinci Amirin Değerlendirmesi'></td>
	</tr>
	<tr>
		<td colspan="2" class="txtbold" align="center"><cf_get_lang dictionary_id ='57964.Hedefler'></td>
		<td colspan="2" class="txtbold" align="center"><cf_get_lang dictionary_id ='58709.Yetkinlikler'></td>
	</tr>
	<tr height="50">
	...
	<tr>
		<td colspan="4" class="txtboldblue"><cf_get_lang dictionary_id='31611.Çalışan Değerlendirmesi'></td>
	</tr>
	<tr>
		<td colspan="2" class="txtbold" align="center"><cf_get_lang dictionary_id ='57964.Hedefler'></td>
		<td colspan="2" class="txtbold" align="center"><cf_get_lang dictionary_id ='58709.Yetkinlikler'></td>
	...
	<tr>
		<td colspan="4" class="txtboldblue"><cf_get_lang dictionary_id ='56799.Yetkinlik Gelişimine Dönük Öneriler & Eylem Planları'></td>
	</tr>
	<tr height="50">
	...
	<tr>
		<td><cf_get_lang dictionary_id ='31615.Hedef/Yetkinlik No'></td>
		<td width="120"><cf_get_lang dictionary_id ='31616.Hedef/Yetkinlik Sonuç Değerlendirme'></td>
		<td><cf_get_lang dictionary_id ='29784.Ağırlık'></td>
...
<cfoutput query="GET_TARGET">
	...
	<tr>
		<td colspan="3"  style="text-align:right;"><cf_get_lang dictionary_id ='31619.Hedef Toplam'></td>
		<td  style="text-align:right;"><cfoutput>#target_total#</cfoutput></td>
	</tr>
	<tr>
		<td colspan="3"  style="text-align:right;"><cf_get_lang dictionary_id ='31620.Hedefler Düzeltilmiş Toplam'></td>
		<td  style="text-align:right;">
...
<cfoutput query="get_quiz_chapters">
	...
	<tr>
		<td colspan="3"  style="text-align:right;"><cf_get_lang dictionary_id ='31621.Yetkinlikler Toplam'></td>
		<td  style="text-align:right;"><cfoutput>#chapter_total#</cfoutput></td>
	</tr>
	<tr>
		<td colspan="3"  style="text-align:right;"><cf_get_lang dictionary_id ='31475.Yetkinlikler Düzeltilmiş Toplam'></td>
		<td  style="text-align:right;">
	...
	<tr>
		<td colspan="3"  style="text-align:right;"><cf_get_lang dictionary_id ='31573.Nihai Değerlendirme'></td>
		<td  style="text-align:right;"><cfoutput>#TLFormat(chapter_edit_point+target_edit_point,2)#</cfoutput>
		<input type="hidden" name="user_point" id="user_point" value="<cfoutput>#chapter_edit_point+target_edit_point#</cfoutput>"></td>
	</tr>
	<cfset amir_onay = "">
	<cfif GET_PER_TARGET.recordcount><!--- Çalışanın son amirinin onayladıktan sonra formun güncellemenmemesi için.. --->
		<cfif len(GET_PER_TARGET.FIRST_BOSS_CODE)>
			<cfset amir_onay=GET_PER_TARGET.FIRST_BOSS_VALID_FORM>
		</cfif>
		<cfif len(GET_PER_TARGET.SECOND_BOSS_CODE)>
			<cfset amir_onay=GET_PER_TARGET.SECOND_BOSS_VALID>
		</cfif>
		<cfif len(GET_PER_TARGET.THIRD_BOSS_CODE)>
			<cfset amir_onay=GET_PER_TARGET.THIRD_BOSS_VALID>
		</cfif>
		<cfif len(GET_PER_TARGET.FOURTH_BOSS_CODE)>
			<cfset amir_onay=GET_PER_TARGET.FOURTH_BOSS_VALID>
		</cfif>
		<cfif len(GET_PER_TARGET.FIFTH_BOSS_CODE)>
			<cfset amir_onay=GET_PER_TARGET.FIFTH_BOSS_VALID>
		</cfif>
	</cfif>
	<cfif listfind(position_list,GET_PER_TARGET.FIRST_BOSS_CODE,',') or session.ep.userid eq GET_EMP.EMPLOYEE_ID>
		<tr>
		  <td colspan="4"  style="text-align:right;"><!--- Çalışanın son amiri onaylamadıysa ---><cfif not len(amir_onay)><cf_workcube_buttons is_upd='0'>&nbsp;&nbsp;&nbsp;<cfelse><font color="FFF0000"><cf_get_lang dictionary_id='32322.Performans Sonuç Formu Tamemen Onaylandığı İçin Güncelleme Yapılamaz'>.</font></cfif> </td>
		</tr>
	</cfif>
	<tr>
		<td colspan="4">
			<table>
				<tr>
					<td width="100"></td>
					<td width="400" class="txtboldblue"><cf_get_lang dictionary_id ='57570.Ad Soyad'></td>
					<td width="100" class="txtboldblue"><cf_get_lang dictionary_id ='57500.Onay'></td>
				</tr>
				<tr>
					...
					<cfif GET_PER_TARGET.FIRST_BOSS_VALID neq 1 and listfind(position_list,GET_PER_TARGET.FIRST_BOSS_CODE,',')>
					 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
						<input type="Image" src="/images/valid.gif" alt="<cf_get_lang_main no='1063.'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_1.value='1'} else {return false}" border="0">
					<cfelseif GET_PER_TARGET.FIRST_BOSS_VALID eq 1>
						...
						<cfif session.ep.userid eq GET_PER_TARGET.FIRST_BOSS_ID>
						 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
							<input type="Image" src="/images/refusal.gif" alt="<cf_get_lang dictionary_id ='56805.Süreci İptal Et'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_1.value='-1'} else {return false}" border="0">
						</cfif>
					<cfelse>
				...
				<tr>
					...
					<cfif GET_PER_TARGET.FIRST_BOSS_VALID eq 1 and GET_PER_TARGET.SECOND_BOSS_VALID neq 1 and listfind(position_list,GET_PER_TARGET.SECOND_BOSS_CODE,',')>
						<input type="hidden" name="amir_valid_2" id="amir_valid_2" value="">
						 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
						<input type="Image" src="/images/valid.gif" alt="<cf_get_lang dictionary_id='1063.'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_2.value='1'} else {return false}" border="0">
				...
				<tr>
					...
					<cfif GET_PER_TARGET.SECOND_BOSS_VALID eq 1 and GET_PER_TARGET.THIRD_BOSS_VALID neq 1 and listfind(position_list,GET_PER_TARGET.THIRD_BOSS_CODE,',')>
						<input type="hidden" name="amir_valid_3" id="amir_valid_3" value="">
						 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
						<input type="Image" src="/images/valid.gif" alt="<cf_get_lang dictionary_id='1063.'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_3.value='1'} else {return false}" border="0">
				...
				<tr>
					...
					<cfif GET_PER_TARGET.THIRD_BOSS_VALID eq 1 and GET_PER_TARGET.FOURTH_BOSS_VALID neq 1 and listfind(position_list,GET_PER_TARGET.FOURTH_BOSS_CODE,',')>
						<input type="hidden" name="amir_valid_4" id="amir_valid_4" value="">
						 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
						<input type="Image" src="/images/valid.gif" alt="<cf_get_lang dictionary_id='1063.'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_4.value='1'} else {return false}" border="0">
				...
				<tr>
					...
					<cfif GET_PER_TARGET.FOURTH_BOSS_VALID eq 1 and GET_PER_TARGET.FIFTH_BOSS_VALID neq 1 and listfind(position_list,GET_PER_TARGET.FIFTH_BOSS_CODE,',')>
						<input type="hidden" name="amir_valid_5" id="amir_valid_5" value="">
						 <cfsavecontent variable="message"><cf_get_lang dictionary_id ='31575.Onaylamakta Olduğunuz belge şirketinizi ve sizi bağlayacak konular içerebilir Onaylamak istediğinizden emin misiniz '></cfsavecontent>
						<input type="Image" src="/images/valid.gif" alt="<cf_get_lang dictionary_id='1063.'>" onClick="if (confirm('<cfoutput>#message#</cfoutput>')) {document.add_perform_result.amir_valid_5.value='1'} else {return false}" border="0">
