          ...
          <div class="col col-6 col-xs-12" type="column" index="1" sort="true" data-formulacontainer="mandate">
               ...
               <cfif 1 eq 1 >
                    <div class="form-group" id="item-process_stage">
                         ...
                         <cfelse>
                         <cfoutput><input type="hidden" name="process_stage" id="process_stage" value="#iif(isDefined("mandate_query"), "mandate_query.process_stage", DE(''))#"></cfoutput>
                    </cfif>
               <cfif 1 eq 1 >
                    <div class="form-group" id="item-employee_name">
                         ...
                         <cfoutput><input type="hidden" name="employee_id" id="mandate_employee_id" value="#iif(isDefined("mandate_query"), "mandate_query.employee_id", DE(''))#"></cfoutput>
                              ...
                              <cfelse>
                                   <cfoutput><input type="text" name="employee_name" id="mandate_employee_name" value="#iif(isDefined("mandate_query"), "mandate_query.employee_name", DE(session.ep.name & " " & session.ep.surname))#" readonly></cfoutput>
                              </cfif>
                         </div>
                    </div>
               <cfelse>
               ...
               <cfif 1 eq 1 >
                    <div class="form-group" id="item-mandate_name">
                         ...
                         <div class="col col-8 col-xs-12">
                              ...
                              <cfelse>
                                   <cfoutput><input type="text" name="mandate_name" id="mandate_mandate_name" value="#iif(isDefined("mandate_query"), "mandate_query.mandate_name", DE(''))#"   readonly></cfoutput>
                              </cfif>
                         </div>
                    </div>
               <cfelse>
               ...
               <div class="form-group" id="item-startdate">
                    ...
                    <cfelse>
                    <cfoutput><input type="hidden" name="startdate" id="startdate" value="#mandate_query.startdate#"></cfoutput>
                    </cfif>
               <cfif 1 eq 1 >
               <div class="form-group" id="item-finishdate">
                    ...
                    <cfelse>
                    <cfoutput><input type="hidden" name="finishdate" id="finishdate" value="#mandate_query.finishdate#"></cfoutput>
                    </cfif>
               <cfif 1 eq 1 >
