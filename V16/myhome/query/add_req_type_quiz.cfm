...
<cflocation url="#request.self#?fuseaction=myhome.popup_form_add_req_type_quiz&position_code=#attributes.position_code#&per_id=#attributes.per_id#" addtoken="no">
