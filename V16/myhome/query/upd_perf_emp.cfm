<cfif isdefined('attributes.quiz_id')><!--- formdan gelmiyorsa sorun olmaması için konuldu--->
	...
	<cfset quiz_point = 0>
	<cfset quiz_point_yonetici = 0>
	<cfset quiz_point_calisan = 0> 
		...
		<cfif get_result_detail_chapter.recordcount>
			<cfquery name="ADD_RESULT_DETAIL_CHAPTER" datasource="#dsn#">
				...
				SET
					...
					<cfif isdefined("attributes.manager1_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION1 = '#Replace(EVALUATE("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager1_exp1_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION1 = NULL
					</cfif>
					<cfif isdefined("attributes.manager2_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION1 = '#Replace(EVALUATE("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager2_exp1_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION1 = NULL
					</cfif>
					<cfif isdefined("attributes.manager3_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION1 = '#Replace(EVALUATE("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager3_exp1_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION1 = NULL
					</cfif>
					...
					<cfif isdefined("attributes.manager1_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION2 ='#Replace(EVALUATE("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager1_exp2_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION2 = NULL
					</cfif>
					<cfif isdefined("attributes.manager2_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION2 ='#Replace(EVALUATE("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager2_exp2_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION2 = NULL
					</cfif>
					<cfif isdefined("attributes.manager3_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION2 ='#Replace(EVALUATE("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager3_exp2_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION2 = NULL
					</cfif>
					...
					<cfif isdefined("attributes.manager1_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION3 ='#Replace(EVALUATE("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager1_exp3_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION3 = NULL
					</cfif>
					<cfif isdefined("attributes.manager2_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION3 ='#Replace(EVALUATE("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager2_exp3_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION3 = NULL
					</cfif>
					<cfif isdefined("attributes.manager3_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION3 ='#Replace(EVALUATE("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager3_exp3_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION3 = NULL
					</cfif>
					...
					<cfif isdefined("attributes.manager1_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION4 ='#Replace(EVALUATE("attributes.manager1_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager1_exp4_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager1_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER1_EXPLANATION4 = NULL
					</cfif>
					<cfif isdefined("attributes.manager2_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION4 ='#Replace(EVALUATE("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager2_exp4_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER2_EXPLANATION4 = NULL
					</cfif>
					<cfif isdefined("attributes.manager3_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION4 ='#Replace(EVALUATE("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'
					<cfelseif isdefined("attributes.manager3_exp4_#get_quiz_chapters.currentrow#") and not len(evaluate("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"))>
					,MANAGER3_EXPLANATION4 = NULL
					</cfif>
				WHERE	
					RESULT_ID = #RESULT_ID# AND
					CHAPTER_ID=#attributes.CHAPTER_ID#
		...
		<cfelse>
			<cfquery name="ADD_RESULT_DETAIL_CHAPTER" datasource="#dsn#">
				INSERT INTO
					...
					<cfif isdefined("attributes.manager1_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"))>,MANAGER1_EXPLANATION1</cfif>
					<cfif isdefined("attributes.manager2_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"))>,MANAGER2_EXPLANATION1</cfif>
					<cfif isdefined("attributes.manager3_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"))>,MANAGER3_EXPLANATION1</cfif>
					...
					<cfif isdefined("attributes.manager1_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"))>,MANAGER1_EXPLANATION2</cfif>
					<cfif isdefined("attributes.manager2_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"))>,MANAGER2_EXPLANATION2</cfif>
					<cfif isdefined("attributes.manager3_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"))>,MANAGER3_EXPLANATION2</cfif>
					...
					<cfif isdefined("attributes.manager1_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"))>,MANAGER1_EXPLANATION3</cfif>
					<cfif isdefined("attributes.manager2_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"))>,MANAGER2_EXPLANATION3</cfif>
					<cfif isdefined("attributes.manager3_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"))>,MANAGER3_EXPLANATION3</cfif>
					...
					<cfif isdefined("attributes.manager1_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("manager1_exp4_.exp4_#get_quiz_chapters.currentrow#"))>,MANAGER1_EXPLANATION4</cfif>
					<cfif isdefined("attributes.manager2_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"))>,MANAGER2_EXPLANATION4</cfif>
					<cfif isdefined("attributes.manager3_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"))>,MANAGER3_EXPLANATION4</cfif>
					)
				VALUES
					(
					#RESULT_ID#,
					...
					<cfif isdefined("attributes.manager1_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager1_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager2_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager2_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager3_exp1_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager3_exp1_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					...
					<cfif isdefined("attributes.manager1_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager1_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager2_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager2_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager3_exp2_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager3_exp2_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					...
					<cfif isdefined("attributes.manager1_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager1_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager2_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager2_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager3_exp3_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager3_exp3_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					...
					<cfif isdefined("attributes.manager1_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager1_exp4_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager1_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager2_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager2_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					<cfif isdefined("attributes.manager3_exp4_#get_quiz_chapters.currentrow#") and len(evaluate("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"))>,'#replace(evaluate("attributes.manager3_exp4_#get_quiz_chapters.currentrow#"),"'"," ","all")#'</cfif>
					)
			</cfquery>
		</cfif>
		<cfinclude template="../query/get_quiz_questions.cfm">
			...
			<cfif IsDefined('attributes.user_answer_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')>
				...
				<cfquery name="UPD_RESULT_DETAIL" datasource="#dsn#">
					...
					SET
						...
						<cfif isdefined("attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#")>
						QUESTION_EMP_OPENED_ANSWERS = '#EVALUATE('attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')#',
						</cfif>
						EMP_GD = #GD#,<!--- get_quiz_info.form_open_type eq 1 and --->
						<cfelseif isdefined('amir_onay') and len(amir_onay) and  amir_onay is 1 and isdefined('attributes.manager_1_emp_id') and len(attributes.manager_1_emp_id) and isdefined('attributes.manager_1_pos_name') and len(attributes.manager_1_pos_name) and session.ep.userid eq attributes.manager_1_emp_id>
						...
						<cfif isdefined("attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#")>
						QUESTION_MAN_EMP_OPENED_ANSWERS = '#EVALUATE('attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')#',
						</cfif>
						MAN_EMP_GD = #GD#,
						...
						<cfif isdefined("attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#")>
						QUESTION_MANAGER1_OPENED_ANSWERS = '#EVALUATE('attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')#',
						</cfif>
						MANAGER1_GD = #GD#,
						...
						<cfif isdefined("attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#")>
						QUESTION_MANAGER2_OPENED_ANSWERS = '#EVALUATE('attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')#',
						</cfif>
						MANAGER2_GD = #GD#,
						...
						<cfif isdefined("attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#")>
						QUESTION_MANAGER3_OPENED_ANSWERS = '#EVALUATE('attributes.gd_opened_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#')#',
						</cfif>
						MANAGER3_GD = #GD#,
						</cfif>
			...
			<cfelse>
				...
				<cfquery name="UPD_RESULT_DETAIL" datasource="#dsn#">
					...
					SET
						...
						EMP_GD = #GD#,	<!---  and get_quiz_info.form_open_type eq 1 --->			
						<cfelseif isdefined('amir_onay') and len(amir_onay) and  amir_onay is 1 and isdefined('attributes.manager_1_emp_id') and len(attributes.manager_1_emp_id) and isdefined('attributes.manager_1_pos_name') and len(attributes.manager_1_pos_name) and session.ep.userid eq attributes.manager_1_emp_id>
	...
	<cfquery name="upd_perform" datasource="#dsn#">
		...
		<cfif len(quiz_point)>
		<cfif session.ep.userid eq attributes.emp_id>
			EMP_PERFORM_POINT = #quiz_point#, <!---  and get_quiz_info.form_open_type eq 1 --->
		<cfelseif isdefined('amir_onay') and len(amir_onay) and amir_onay is 1 and isdefined('MANAGER_1_EMP_ID') and len(MANAGER_1_EMP_ID) and isdefined('MANAGER_1_POS_NAME') and len(MANAGER_1_POS_NAME) and session.ep.userid eq MANAGER_1_EMP_ID>
		...
		<cfif len(puan) and puan and quiz_point and IS_PERF_SALARY_RESULTING eq 1>
			<cfif session.ep.userid eq attributes.emp_id>
			EMP_POINT = #puan#,
			EMP_POINT_OVER_5 = #user_point_over_5#,<!--- and get_quiz_info.form_open_type eq 1 --->
			<cfelseif isdefined('amir_onay') and len(amir_onay) and amir_onay is 1  and isdefined('MANAGER_1_EMP_ID') and len(MANAGER_1_EMP_ID) and isdefined('MANAGER_1_POS_NAME') and len(MANAGER_1_POS_NAME) and session.ep.userid eq MANAGER_1_EMP_ID>
			MAN_EMP_POINT = #puan#,
			...
			<cfelseif isdefined('MANAGER_2_EMP_ID') and len(MANAGER_2_EMP_ID) and isdefined('MANAGER_2_POS_NAME') and len(MANAGER_2_POS_NAME) and session.ep.userid eq MANAGER_2_EMP_ID>
			MANAGER2_POINT = #puan#,
			MANAGER2_POINT_OVER_5 = #user_point_over_5#,
			<cfelseif isdefined('MANAGER_3_EMP_ID') and len(MANAGER_3_EMP_ID) and isdefined('MANAGER_3_POS_NAME') and len(MANAGER_3_POS_NAME) and session.ep.userid eq MANAGER_3_EMP_ID>
			MANAGER3_POINT = #puan#,
		...
		<cfelse>
			<cfif session.ep.userid eq attributes.emp_id>
			EMP_POINT = NULL,
			EMP_POINT_OVER_5 = NULL,<!---  and get_quiz_info.form_open_type eq 1 --->
			<cfelseif isdefined('amir_onay') and len(amir_onay) and amir_onay is 1 and isdefined('MANAGER_1_EMP_ID') and len(MANAGER_1_EMP_ID) and isdefined('MANAGER_1_POS_NAME') and len(MANAGER_1_POS_NAME) and session.ep.userid eq MANAGER_1_EMP_ID>
			MAN_EMP_POINT = NULL,
		...
		<cfif isdefined("attributes.manager_2_career_status") and len(attributes.manager_2_career_status)>
			MANAGER_2_CAREER_STATUS=#attributes.manager_2_career_status#,
		<cfelse>
			MANAGER_2_CAREER_STATUS=NULL,
		</cfif>
		...
		<cfif isdefined("attributes.manager_2_career_exp")>MANAGER_2_CAREER_EXP='#attributes.manager_2_career_exp#',</cfif>
		...
		<cfif isdefined("attributes.manager_2_training_cat") and len(attributes.manager_2_training_cat)>
			MANAGER_2_TRAINING_CAT = ',#attributes.manager_2_training_cat#,',
		<cfelse>
			MANAGER_2_TRAINING_CAT = NULL,
		</cfif>
		...
		<cfif isdefined("attributes.manager_2_training_exp")>MANAGER_2_TRAINING_EXP='#attributes.manager_2_training_exp#',</cfif>
		<cfif isdefined("attributes.manager_3_training_exp")>MANAGER_3_TRAINING_EXP='#attributes.manager_3_training_exp#',</cfif>
		<cfif isdefined("attributes.manager_career_status") and listfindnocase('1,2,3',attributes.manager_career_status)>
		...
		<cfif isdefined("attributes.manager_2_career_status") and listfindnocase('1,2,3',attributes.manager_2_career_status)>
			POSITION_CAT_ID_2_1 = <cfif isdefined("attributes.POSITION_CAT_ID_1") and len(attributes.POSITION_CAT_ID_1)>#attributes.POSITION_CAT_ID_1#<cfelse>NULL</cfif>,
			POSITION_CAT_ID_2_2 = <cfif isdefined("attributes.POSITION_CAT_ID_2") and len(attributes.POSITION_CAT_ID_2)>#attributes.POSITION_CAT_ID_2#<cfelse>NULL</cfif>,
			POSITION_CAT_ID_2_3 = <cfif isdefined("attributes.POSITION_CAT_ID_3") and len(attributes.POSITION_CAT_ID_3)>#attributes.POSITION_CAT_ID_3#<cfelse>NULL</cfif>,
		<cfelse>
			POSITION_CAT_ID_2_1 = NULL,
			POSITION_CAT_ID_2_2 = NULL,
			POSITION_CAT_ID_2_3 = NULL,
		</cfif>
