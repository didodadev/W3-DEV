...
<!---<cfif attributes.comp_selection neq 4>--->
	...
	<cfloop query="get_branch_profile_det">
		...
		<cfset attributes.sal_mon = get_branch_profile_det.sal_mon>
		<cfset attributes.sal_year = get_branch_profile_det.sal_year> 
...
<cfset GET_EMP_OUT_TOTAL_PREVIOUS_MONTH  = 0>
<cfif attributes.comp_selection eq 4>
	...
	<!---<cfloop from="1" to="12" index="month3_">--->
		...
		<cfset get_emp_in_the_past = get_emp_in_the_past_.recordcount - get_emp_in_the_past_2_.recordcount>
	<!---</cfloop>--->
</cfif>
