...
<cfelseif isDefined("attributes.expense_date")>
...
<cfif isdefined("attributes.expense_employee_id")> 
    <cfif listlen(attributes.expense_employee_id,'_') eq 2>
        ...
        <cfset attributes.employee_id = listFirst(attributes.expense_employee_id,'_')>
    </cfif>
<cfelse>
	<cfset acc_type_id = ''>
	<cfset attributes.employee_id = listFirst(attributes.EXPENSE_EMPLOYEE_ID,'_')>
    ...
    <cftransaction>    
		<cfquery name="add_expense_total_cost" datasource="#dsn2#" result="MAX_ID">
			...
			(
				...
				<cfif isdefined("attributes.other_total_amount") and len(attributes.other_total_amount)>#attributes.other_total_amount#<cfelse>NULL</cfif>,
				<cfif isdefined("attributes.other_kdv_total_amount") and len(attributes.other_kdv_total_amount)>#attributes.other_kdv_total_amount#<cfelse>NULL</cfif>,
				<cfif isdefined("attributes.other_net_total_amount") and len(attributes.other_net_total_amount)>#attributes.other_net_total_amount#<cfelse>NULL</cfif>,
				<cfif isdefined("rd_money_value") and len(rd_money_value)><cfqueryparam cfsqltype="cf_sql_varchar" value="#rd_money_value#"><cfelse>NULL</cfif>,
				...
				<cfif isdefined("attributes.expense_date") and len(attributes.expense_date)>#attributes.expense_date#<cfelse>NULL</cfif>,
				...
				<cfif isdefined("attributes.detail")>#attributes.total_amount#<cfelse>NULL</cfif>,
				<cfif isdefined("attributes.kdv_total_amount") and len(attributes.kdv_total_amount)>#attributes.kdv_total_amount#<cfelse>NULL</cfif>,
				<cfif isdefined("attributes.net_total_amount") and len(attributes.net_total_amount)>#attributes.net_total_amount#<cfelse>NULL</cfif>,
				...
				<cfif isdefined("attributes.EXPENSE_HR_ALLOWANCE") and len(attributes.EXPENSE_HR_ALLOWANCE)>#attributes.EXPENSE_HR_ALLOWANCE#<cfelse>NULL</cfif>,
				...
				<cfif evaluate("attributes.row_kontrol#i#")>
					...
					<cfquery name="add_expense_rows" datasource="#dsn2#">
						...
						(
							...
							<cfif isdefined("form_row_detail") and len(form_row_detail)><cfqueryparam cfsqltype="cf_sql_varchar" value="#form_row_detail#"><cfelse>NULL</cfif>,
							<cfif isdefined("attributes.system_relation") and len(attributes.system_relation)><cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.system_relation#"><cfelse>NULL</cfif>,
							0,
							0,
							<cfif isdefined("attributes.expense_employee") and len(attributes.expense_employee) and len(attributes.expense_employee_id)>#attributes.expense_employee_id#<cfelse>NULL</cfif>,
							...
							<cfif isdefined("form_total") and len(form_total)><cfqueryparam cfsqltype="cf_sql_varchar" value="#form_total#"><cfelse>NULL</cfif>,
							...
							<cfif isdefined("form_money_1") and len(form_money_1)><cfqueryparam cfsqltype="cf_sql_varchar" value="#form_money_1#"><cfelse>NULL</cfif>,
							...
							<cfif isdefined("form_tax_rate") and len(form_tax_rate)><cfqueryparam cfsqltype="cf_sql_varchar" value="#form_tax_rate#"><cfelse>NULL</cfif>,
							...
							<cfif isdefined("form_product_name") and len(form_product_name)><cfqueryparam cfsqltype="cf_sql_varchar" value="#left(form_product_name,40)#"><cfelse>NULL</cfif>,
							<cfif isdefined("form_quantity") and len(form_quantity)>#form_quantity#<cfelse>1</cfif>,
							<cfif isdefined("form_stock_unit") and len(form_stock_unit)><cfqueryparam cfsqltype="cf_sql_varchar" value="#form_stock_unit#"><cfelse>NULL</cfif>,
							...
							#now()#,
                            <cfif len(allowance_expense_type)><cfqueryparam cfsqltype="cf_sql_integer" value="#allowance_expense_type#"><cfelse>NULL</cfif>,
                            <cfif len(allowance_day)><cfqueryparam cfsqltype="cf_sql_integer" value="#allowance_day#"><cfelse>NULL</cfif>
						)
					</cfquery>
				</cfif>
			</cfloop>
		...
		<cfif len(paper_number)>
			<cfquery name="UPD_GENERAL_PAPERS" datasource="#DSN2#">
				UPDATE 
					#DSN#.GENERAL_PAPERS_MAIN
				SET
					ALLOWENCE_EXPENSE_NUMBER = #paper_number#
				WHERE
					ALLOWENCE_EXPENSE_NUMBER IS NOT NULL
			</cfquery>
		</cfif>
...
<cf_workcube_process 
	...
	<cfif isdefined("attributes.process_cat") and len(attributes.process_cat)>
		<cfquery name="get_process_cat_type" datasource="#dsn2#">
...
<cfif attributes.cost_type eq 1>
    ...
    <script type="text/javascript">
    	window.location.href = "<cfoutput>#request.self#?fuseaction=myhome.allowance_expense&event=upd&request_id=#request_id_#</cfoutput>";
    </script>
<cfelse>
	<script type="text/javascript">
    	window.location.href = "<cfoutput>#request.self#?fuseaction=hr.allowance_expense&event=upd&request_id=#MAX_ID.IDENTITYCOL#</cfoutput>";
    </script>
</cfif>
