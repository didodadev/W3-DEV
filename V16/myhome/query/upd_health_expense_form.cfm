...
<cfif isdefined("attributes.ch_member_type") and len(attributes.ch_member_type) and isDefined('attributes.emp_id') and len(attributes.emp_id)>
...
<cfif not isdefined("attributes.is_del")>
    ...
    <cfif isDefined("attributes.payment_date") and len(attributes.payment_date)>
    ...
    <cfquery name="upd_health_expense" datasource="#dsn2#">
        ...
        SET
            ...
            EMP_ID =  <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.expense_employee_id#">,
            EXPENSE_DATE = <cfif isdefined("attributes.expense_date") and len(attributes.expense_date)><cfqueryparam cfsqltype="cf_sql_date" value="#attributes.expense_date#"><cfelse>NULL</cfif>,
            PROCESS_DATE = <cfif isdefined("attributes.process_date") and len(attributes.process_date)><cfqueryparam cfsqltype="cf_sql_date" value="#attributes.process_date#"><cfelse>NULL</cfif>,
            INVOICE_DATE = <cfif isdefined("attributes.invoice_date") and len(attributes.invoice_date)><cfqueryparam cfsqltype="cf_sql_date" value="#attributes.invoice_date#"><cfelse>NULL</cfif>,
            DETAIL =  <cfif isdefined("attributes.reason_ill") and len(attributes.reason_ill)><cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.reason_ill#"><cfelse>NULL</cfif>,
            UPDATE_DATE =  #now()#,
            UPDATE_EMP = #session.ep.userid#,
            UPDATE_IP  = <cfqueryparam cfsqltype="cf_sql_varchar" value="#cgi.remote_addr#">,
            TOTAL_AMOUNT = <cfif isdefined("attributes.expense_amount") and len(attributes.expense_amount)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.expense_amount#"><cfelse>NULL</cfif>,
            EXPENSE_STAGE = <cfif isdefined("attributes.process_stage") and len(attributes.process_stage)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.process_stage#"><cfelse>NULL</cfif>,
            ...
            DEPARTMENT_ID = <cfif isdefined("attributes.department_id") and len(attributes.department_id)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.department_id#"><cfelse>NULL</cfif>,
            NET_KDV_AMOUNT = <cfif isdefined("attributes.tax_value") and len(attributes.tax_value)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.tax_value#"><cfelse>NULL</cfif>,
            NET_TOTAL_AMOUNT  = <cfif isdefined("attributes.lastTotal") and len(attributes.lastTotal)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.lastTotal#"><cfelse>NULL</cfif>,
            MONEY = <cfif isDefined("attributes.moneyType") and len(attributes.moneyType)><cfqueryparam cfsqltype="cf_sql_nvarchar" value="#attributes.moneyType#"><cfelse>NULL</cfif>,
            TREATMENT_ID = <cfif isdefined("attributes.treatment_id") and len(attributes.treatment_id)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.treatment_id#"><cfelse>NULL</cfif>,
            ...
            TREATED  = <cfif isdefined("attributes.is_relative") and len(attributes.is_relative)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.is_relative#"><cfelse>NULL</cfif>,
            ASSURANCE_ID =  <cfif isdefined("attributes.ASSURANCE_ID") and len(attributes.ASSURANCE_ID)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.assurance_id#"><cfelse>NULL</cfif>,
            PAPER_TYPE = <cfif isdefined("attributes.expense_paper_type") and len(attributes.expense_paper_type)><cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.expense_paper_type#"><cfelse>NULL</cfif>,
            OUR_COMPANY_HEALTH_AMOUNT=<cfif isdefined("attributes.our_company_health_amount") and len(attributes.our_company_health_amount)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.our_company_health_amount#"><cfelse>NULL</cfif>,
            EMPLOYEE_HEALTH_AMOUNT=<cfif isdefined("attributes.employee_health_amount") and len(attributes.employee_health_amount)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.employee_health_amount#"><cfelse>NULL</cfif>,
            ...
            EXPENSE_TYPE = <cfif isdefined("attributes.expense_type") and len(attributes.expense_type)> <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.expense_type#"><cfelse>NULL</cfif>,
            TREATMENT_AMOUNT = <cfif isdefined("attributes.TreatmentlastTotal") and len(attributes.TreatmentlastTotal)> <cfqueryparam cfsqltype="cf_sql_float" value="#attributes.TreatmentlastTotal#"><cfelse>NULL</cfif>,
            SYSTEM_RELATION = <cfif isdefined("attributes.system_relation") and len(attributes.system_relation)><cfqueryparam cfsqltype="cf_sql_varchar" value="#attributes.system_relation#"><cfelse>NULL</cfif>,
            TREATMENT_AMOUNT_RATE = <cfif isdefined("attributes.treatment_rate") and len(attributes.treatment_rate)> <cfqueryparam cfsqltype="cf_sql_float" value="#attributes.treatment_rate#"><cfelse>NULL</cfif>,
            COMPANY_AMOUNT_RATE = <cfif isdefined("attributes.comp_health_rate") and len(attributes.comp_health_rate)> <cfqueryparam cfsqltype="cf_sql_float" value="#attributes.comp_health_rate#"><cfelse>NULL</cfif>,
            COMPANY_NAME = <cfif isdefined("attributes.expense_comp_name") and len(attributes.expense_comp_name)> <cfqueryparam cfsqltype="cf_sql_nvarchar" value="#attributes.expense_comp_name#"><cfelse>NULL</cfif>,
            ASSURANCE_TYPE_ID = <cfif isdefined("attributes.assurance_type_id") and len(attributes.assurance_type_id)><cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.assurance_type_id#"><cfelse>NULL</cfif>,
            AMOUNT_1 = <cfif isdefined("attributes.amount_1") and len(attributes.amount_1)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_1#"><cfelse>NULL</cfif>,
            AMOUNT_2 = <cfif isdefined("attributes.amount_2") and len(attributes.amount_2)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_2#"><cfelse>NULL</cfif>,
            AMOUNT_3 = <cfif isdefined("attributes.amount_3") and len(attributes.amount_3)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_3#"><cfelse>NULL</cfif>,
            AMOUNT_4 = <cfif isdefined("attributes.amount_4") and len(attributes.amount_4)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_4#"><cfelse>NULL</cfif>,
            AMOUNT_KDV_1 = <cfif isdefined("attributes.amount_kdv_1") and len(attributes.amount_kdv_1)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_kdv_1#"><cfelse>NULL</cfif>,
            AMOUNT_KDV_2 = <cfif isdefined("attributes.amount_kdv_2") and len(attributes.amount_kdv_2)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_kdv_2#"><cfelse>NULL</cfif>,
            AMOUNT_KDV_3 = <cfif isdefined("attributes.amount_kdv_3") and len(attributes.amount_kdv_3)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_kdv_3#"><cfelse>NULL</cfif>,
            AMOUNT_KDV_4 = <cfif isdefined("attributes.amount_kdv_4") and len(attributes.amount_kdv_4)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.amount_kdv_4#"><cfelse>NULL</cfif>,
            PAYMENT_INTERRUPTION_VALUE = <cfif isdefined("attributes.interrupt") and len(attributes.interrupt)><cfqueryparam cfsqltype="cf_sql_float" value="#attributes.interrupt#"><cfelse>NULL</cfif>,
            PAYMENT_DATE = <cfif isdefined("attributes.payment_date") and len(attributes.payment_date)><cfqueryparam cfsqltype="cf_sql_date" value="#attributes.payment_date#"><cfelse>NULL</cfif>
        WHERE
        ...
        <cfif get_health_expense_relation.EXPENSE_ITEM_PLANS_ID eq "">
            <cfquery name="upd_health_expense_relation" datasource="#dsn2#">
                UPDATE
                    EXPENSE_ITEM_PLAN_REQUESTS
                SET
                    EXPENSE_ITEM_PLANS_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.expense_id#">
                WHERE
                    EXPENSE_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.health_id#">
            </cfquery>
        </cfif>
    ...
    <cfif attributes.fuseaction eq 'hr.health_expense_approve'> 
        ...
        <cf_workcube_process_cat 
            ...
            action_page='#request.self#?fuseaction=#fusebox.circuit#.health_expense_approve&event=upd&health_id=#attributes.health_id#'
            action_db_type="#dsn2#"
    ...
    <!--- Muhasebe hareketleri Bütce Ek ödenek ve kesinti ---->
                ...
                <cfif not isdefined("is_decease") and ((isdefined("attributes.x_is_employee_relative_payment") and attributes.x_is_employee_relative_payment eq 1 and attributes.is_relative eq 2) or (isdefined("attributes.x_is_employee_payment") and attributes.x_is_employee_payment eq 1 and attributes.is_relative eq 1)) and  get_payments.recordcount and (is_allowance_deduction eq 1 or is_deduction eq 1) and corparate_health_amount neq 0> 
                    ...
                    <cfif len(get_program_parameters.PAYMENT_INTERRUPTION_ID)><!--- bordro akış parametrelerinde Kesinti  tanımlanışsa --->
                        ...
                        <cfif get_interruption.recordcount>
                            <cfif get_interruption.recordcount and is_deduction eq 1>  
                ...
                <cfscript>
                    ...
                    if(is_account eq 1){
                        if(isdefined("attributes.relative_id") and len(attributes.relative_id)){ 
                            ...
                            //Çalışana Kesilen Faturadan KDV indirimi yapılır evet ise
                            ...
                            else{ // Tedavi esnasında çalışan payını ödüyor mu? xml i hayır ise
                                if(x_is_employee_amount eq 0)  
                                    corparate_health_amount = (attributes.lastTotal - (attributes.employee_health_amount + attributes.interrupt));
                                else
                                    corparate_health_amount = (attributes.lastTotal - (attributes.employee_health_amount + attributes.interrupt));
                                borc_hesaplar_list =  get_Acc_code.ACCOUNT_CODE; //  bordro gider kaleminin muhasebe hesabı 770 
                                borc_tutarlar_list = corparate_health_amount; 
                                alacak_hesaplar_list = get_program_parameters.EMployee_ACCOUNT_CODE; // çalışandan çekmek yerine bordro akış parametrelerine eklendi
                                if(len(get_program_parameters.LIMIT_INTERRUPTION_ACCOUNT_CODE) and is_deduction eq 1 and attributes.x_is_limit_interruption eq 1){
                                    alacak_tutarlar_list = corparate_health_amount + attributes.interrupt;
                    ...
                    <cfscript>
                      if(is_account eq 1){
                        ...
                        if(isdefined("attributes.relative_id") and len(attributes.relative_id)){ 
                            ...
                            if(attributes.tax_value neq 0  and get_expense_rows.recordcount){
                                for (row in get_expense_rows){
                                    ...
                                    //kdv_rate_ = (attributes.tax_value_*100)/borcValue1;
                        ...
                        <cfif get_interruption.recordcount>
                            ...
                            <cfif  get_payments.recordcount and is_allowance_deduction eq 1> 
                                <cfset get_allowance_expense = allowance_expense_cmp.ADD_SALARYPARAM_PAY(
                                    comment_pay :  get_payments.comment_pay,<!--- Ödenek İsmi --->
                                    comment_pay_id : get_payments.odkes_id,<!---Ödenek Id --->
                                    amount_pay : attributes.interrupt,<!--- Ödenek (Kurum Payı) --->
                                    ssk : get_payments.ssk,<!--- ssk 1 : muaf, 2: muaf değil ---> 
                                    tax : get_payments.tax,<!--- vergi 1 : muaf, 2: muaf değil---> 
                                    is_damga : get_payments.is_damga,<!--- damga vergisi --->
                                    is_issizlik : get_payments.is_issizlik,<!--- işsizlik ---> 
                            ...
                            <!--- Çalışan Kesinti ve Ödenek İşlemi Bordroya Yansır hayır seçili ve çalışan kendisi ise veya Çalışan Yakını Kesinti ve Ödenek İşlemi Bordroya Yansır hayır seçili ise ve çalışan yakını ise ---> 
                            <cfelseif (isdefined("attributes.x_is_employee_relative_payment") and attributes.x_is_employee_relative_payment eq 0 and attributes.is_relative eq 2) or (isdefined("attributes.x_is_employee_payment") and attributes.x_is_employee_payment eq 0 and attributes.is_relative eq 1)>
                                <cfif attributes.x_is_employee_amount eq 0>
                                    <CFSET interrupt_amount = attributes.employee_health_amount +  attributes.interrupt>
                                <cfelse>
                                    <CFSET interrupt_amount = attributes.interrupt>
                                </cfif>
                                <cfscript>
    ...
    <cfif fusebox.circuit is 'myhome'>
        <cfset attributes.health_id = contentEncryptingandDecodingAES(isEncode:1,content:attributes.health_id,accountKey:'wrk')>
    </cfif>
    <script type="text/javascript">
...
<cfelse>
    <cflock timeout="30" name="#CreateUUID()#">
        ...
        <cfquery name="del_" datasource="#dsn2#">
            DELETE FROM EXPENSE_ITEM_PLAN_REQUESTS WHERE EXPENSE_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.health_id#">
        </cfquery>
         <cfscript>
            butce_sil(action_id:attributes.health_id,process_type:2503);
            muhasebe_sil(action_id:attributes.health_id,process_type:2503);
        ...
        <cfif isDefined("attributes.EXPENSE_ITEM_PLANS_ID") and len(attributes.EXPENSE_ITEM_PLANS_ID)>
            <cfquery name="del_" datasource="#dsn2#">
                UPDATE EXPENSE_ITEM_PLANS SET EXPENSE_ITEM_PLANS_ID = NULL WHERE EXPENSE_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.EXPENSE_ITEM_PLANS_ID#">
            </cfquery>
        </cfif>
        </cftransaction>
    </cflock>
    ...
    <cfset delete_health_get = allowance_expense_cmp.DELETE_SALARYPARAM_GET_FROM_HEALTH_ID(expense_health_id : attributes.health_id)>
    <script type="text/javascript">
        window.location.href = "<cfoutput>#request.self#?fuseaction=#fusebox.circuit#.health_expense_approve</cfoutput>";
    </script>
</cfif>