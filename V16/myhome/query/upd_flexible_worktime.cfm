...
<cfif listfirst(attributes.fuseaction,'.') is 'myhome'>
    <cfset action_id_ = "flexible_worktime&event=upd&flexible_id=#flexible_worktime_id_#">
<cfelse>
    <cfset action_id_ = "flexible_worktime&event=upd&flexible_id=#flexible_worktime_id_#&emp_id=#attributes.employee_id#">
</cfif>
<cf_workcube_process 
        is_upd='1' 
        old_process_line='0'
