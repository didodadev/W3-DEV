<!--- Alinacak Teklifler, Satinalma Teklifleri --->
...
<!--- <cf_ajax_list>
	<tbody>
		<cfoutput query="get_offer_list" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
			<tr>
				<td width="130" style="text-align:right;">#TLFormat(price)#&nbsp;#other_money#</td>
				<td width="200"><a href="#request.self#?fuseaction=purchase.list_offer&event=upd&OFFER_ID=#offer_id#" class="tableyazi">#offer_number#</a></td>
				<td>
					<cfif len(GET_OFFER_LIST.PARTNER_ID)>
						<cfquery name="GET_RESP" datasource="#dsn#">
							...
							WHERE 
								...
								COMPANY_PARTNER.PARTNER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#get_offer_list.partner_id#">
						</cfquery>
