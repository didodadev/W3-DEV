...
<cfif fusebox.circuit eq 'myhome'>
    ...
    <cfset attributes.employee_id = contentEncryptingandDecodingAES(isEncode:0,content:attributes.employee_id,accountKey:session.ep.userid)>
</cfif>
...
<table width="99%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td class="txtbold"><cf_get_lang dictionary_id='57570.Adı ve Soyadı'></td>
	...
	<tr>
		...
		<td class="txtbold"><cf_get_lang dictionary_id='45494.Uyruğu(Yabancı ise ülke adı)'></td>
		<td><cf_get_lang dictionary_id='54265.T.C'>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	<tr>
		...
		<td>&nbsp;<cf_get_lang dictionary_id='30631.Tarih'>: #dateformat(GET_FEE.FEE_DATEOUT, dateformat_style)#</td>
...
<table width="99%" border="1" cellspacing="0" cellpadding="0">
	<tr align="center">
		<td colspan="4" class="formbold">B-<cf_get_lang dictionary_id='53466.İŞKAZASININ'></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="txtbold"><cf_get_lang dictionary_id='57570.Olduğu Sırada'> <br/>
		<cf_get_lang dictionary_id='57570.Adı ve Soyadı'>Sigortalının Yaptığı İş ve Bu İşin Mahiyeti</td>
		<td colspan="2">&nbsp;#get_fee.emp_work# 
		<cfif GET_FEE.RELATIVE_REPORT eq 1>
				- <cf_get_lang dictionary_id='53920.İŞ GÖREMEZLİK ÖDENEĞİ İÇİNDİR'>
		...
		<cfelseif GET_FEE.ACCIDENT eq 1>
				- <cf_get_lang dictionary_id='31465.İŞ KAZASI'>
		</cfif>
		</td>
	</tr>
	<tr>
...
<table width="99%" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td class="printbold" width="150">
			<cf_get_lang dictionary_id='59430.Prim Ödeme Halinin Sona Erip Ermediğini “Sona Erdi” veya “Sona Ermedi” Şeklinde ve El İle Yandaki Haneye Yazınız.'>
		</td>
		<td width="200">&nbsp;</td>
			<td width="200" class="printbold" valign="top" nowrap="nowrap">
			<cf_get_lang dictionary_id='45527.Sona erdi ise; erdiği tarih'>;
			 <cfif isdefined('detail.FINISH_DATE') and len(detail.FINISH_DATE)><cfoutput>#dateFormat(detail.FINISH_DATE,dateformat_style)#</cfoutput></cfif> 
		</td>
	</tr>
</table>
<br/>
<table width="99%" border="1" cellspacing="0" cellpadding="0" class="print">
	<tr align="center">
		<td colspan="7" class="formbold">C-<cf_get_lang dictionary_id='59406.SİGORTALININ PRİM ÖDEME GÜN SAYISI'></td>
	</tr>
	<tr class="printbold">
		<td width="25">&nbsp;</td>
		<td>&nbsp;</td>
...
<table width="99%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="txtbold" valign="top"><cf_get_lang dictionary_id='53833.İşverenin'> <cf_get_lang dictionary_id='59416.Adı ve Soyadı / Unvanı'><br/>
		#ssk.company_name#
		</td>
		...
		<br/>
			...
			<tr align="center">
			  <td colspan="26"><cf_get_lang dictionary_id='44617.İŞYERİ SİCİL NO'></td>
				...
				<tr class="printbold">
					<td rowspan="2">M</td>
					<td colspan="4" align="center"><cf_get_lang dictionary_id='53824.İŞ KOLU KODU'></td>
...
<tr>
	<td valign="top"><cf_get_lang dictionary_id='59432.Yukarıda ki bilgilerin yanlış olması sebebiyle sigortalının eşi 
		ve geçindirmekle yükümlü olduğu çocukları ile ana ve babasına Kurumca yersiz olarak yapılan her
		türlü masrafları ödemeyi kabul ederim'>
