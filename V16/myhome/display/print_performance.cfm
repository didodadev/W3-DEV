<cfinclude template="../query/get_perf_detail2.cfm">
<cfscript>
                ...
                <tr>
                  <td class="color-row"><table>
                      ...
                      <tr>
						...
						<td><cf_get_lang dictionary_id='29666.Amir'></td>
                      ...
                      <tr>
						...
						<td><cfif get_perf_detail.record_type is 1><cf_get_lang dictionary_id='31403.Asıl'>
							<cfelseif get_perf_detail.record_type is 2><cf_get_lang dictionary_id='31406.Görüş'> 1
							<cfelseif get_perf_detail.record_type is 3><cf_get_lang dictionary_id='31406.Görüş'> 2
							<cfelseif get_perf_detail.record_type is 4><cf_get_lang dictionary_id='31408.Ara Değerlendirme'>
							</cfif>
						</td>
					  </tr>
					  <tr>
      ...
      <table border="0">
        <tr class="color-list" align="center">
          ...
          <cfif get_quiz_chapters.ANSWER_NUMBER neq 0>
			...
			<td width="30">&nbsp;</td>
			<cfif session.ep.userid neq get_perf_detail.MANAGER_3_EMP_ID and get_quiz_info.form_open_type neq 2><td class="txtbold"><cf_get_lang dictionary_id='57576.Çalışan'></td></cfif>
			<cfif session.ep.userid neq attributes.emp_id>
			<td class="txtbold"><cf_get_lang dictionary_id='35927.1.Amir'></td>
			<cfif get_quiz_info.form_open_type neq 2><td class="txtbold"><cf_get_lang dictionary_id='31740.Ortalama Değer'></td></cfif>
			</cfif>
        </tr>
        <!--- Sorular basliyor --->
        <cfloop query="get_quiz_questions">
          ...
          <cfloop from="1" to="20" index="i">
            <cfif len(evaluate("get_quiz_questions.answer#i#_photo")) or len(evaluate("get_quiz_questions.answer#i#_text"))>
              <tr class="color-list">
	            <td align="center"><cf_get_lang dictionary_id='32290.Gözlemlenemedi'></td>
                <td>
					<cfloop query="GET_EMP_QUIZ_ANSWERS">
	   ...
	   <cfif (attributes.emp_id eq session.ep.userid and get_quiz_chapters.is_emp_exp3 neq 1) or (get_perf_detail.manager_3_emp_id eq session.ep.userid and get_quiz_chapters.is_chief3_exp3 neq 1) or (get_perf_detail.manager_1_emp_id eq session.ep.userid and get_quiz_chapters.is_chief1_exp3 neq 1) or (get_perf_detail.manager_2_emp_id eq session.ep.userid and get_quiz_chapters.is_chief2_exp3 neq 1)>
		...
		<tr>
			<td colspan="1" valign="top">#EVALUATE("chapter_exp_#get_quiz_chapters.currentrow#.EXPLANATION3")#</td>
		</tr>
		</cfif>
		</cfif>
...
<tr height="20" class="color-row">
  <td><cf_get_lang dictionary_id='31429.Kayıtlı Bölüm Bulunamadı'>!</td>
                ...
                <tr>
                  <td class="color-row">
                    <table>
					  ...
					  <tr>
						<td>
							<cfif get_perf_detail.EMPLOYEE_OPINION_ID is 1><cf_get_lang dictionary_id='30986.Değerlendirmeye Katılıyorum'><cfelseif get_perf_detail.EMPLOYEE_OPINION_ID is 0><cf_get_lang dictionary_id='30987.Değerlendirmeye Katılmıyorum'></cfif>
				...
				<tr>
					...
					<table id="b_carrer">
						<tr align="center" class="color-list">
							...
							<cfif get_perf_detail.manager_3_emp_id neq session.ep.userid>
							<td class="txtboldblue"><cf_get_lang dictionary_id='29511.Yönetici'></td>
							<td>
						...
						<tr class="color-list">
							...
							<td colspan="3"><cfoutput>#get_perf_detail.other_career_exp#</cfoutput></td>
						</tr>
						<cfif get_quiz_info.form_open_type neq 2 and get_perf_detail.manager_3_emp_id neq session.ep.userid>
						<tr class="color-list">
							<td class="txtboldblue"><cf_get_lang dictionary_id='31617.Çalışan Açıklama'></td>
							<td colspan="3"><cfoutput>#get_perf_detail.emp_career_exp#</cfoutput></td>
						</tr>
						</cfif>
						<cfif get_perf_detail.manager_3_emp_id eq session.ep.userid>
						<tr class="color-list">
						...
						<tr class="color-list">
							...
							<td colspan="3"><cfoutput>#get_perf_detail.manager_career_exp#</cfoutput></td>
						</tr>
						</cfif>
					</table>
					</td>
					...
					<cfquery name="get_training_cat" datasource="#dsn#">
						...
						<table id="b_gelisim">
							<tr class="color-list">
								...
								<cfif get_perf_detail.manager_3_emp_id neq session.ep.userid><td class="txtbold" align="center"><cf_get_lang dictionary_id='29511.Yönetici'></td></cfif>
				...
				<cfif not isdefined("attributes.is_myhome")>
                ...
                <tr class="color-header" height="22">
				 ...
				 <cfif get_quiz_info.is_extra_record is 1>
                      ...
                      <tr>
                        <td><cf_get_lang dictionary_id='32293.Kişinin Aldığı Değerlendirme Puanı'><!---  (5 üzerinden) ---></td>
						  <td><b>(<cfoutput>#get_perf_detail.USER_POINT_OVER_5#</cfoutput> / 5)</b></td>
                      </tr>
					  </cfif>
				  <cfif get_quiz_info.is_extra_record_emp is 1>
					  ...
					  <tr>
						...
						<td><b>(<cfoutput>#get_perf_detail.emp_point_over_5#</cfoutput> / 5)</b></td>
					  </tr>
					  </cfif>
				   </cfif>
				   <cfif get_quiz_info.is_extra_record is 1>
					 <cfif isnumeric(get_perf_detail.manager_point) and isnumeric(get_perf_detail.perform_point)>
					  <tr>
						<td><cf_get_lang dictionary_id='32295.Yöneticiden Aldığı Değerlendirme Puanı'><!---  (5 üzerinden) ---></td>
						  <td><b>(<cfoutput>#get_perf_detail.manager_point_over_5#</cfoutput> / 5)</b></td>
					  </tr>
					  </cfif>
				 	</cfif>
                    </table>
				...
				<tr class="color-row">
					<td>
						<table>
							<tr>
								<td width="120"><b><cf_get_lang dictionary_id='57576.Çalışan'></b><br/><cf_get_lang dictionary_id='58957.İmza'></td>
								<td  width="120"><b><cf_get_lang dictionary_id='29666.Amir'></b><br/><cf_get_lang dictionary_id='58957.İmza'></td>
								<td  width="120"><b><cf_get_lang dictionary_id='29666.Amir'></b><br/><cf_get_lang dictionary_id='58957.İmza'></td>
							</tr>
							<tr height="25">
								<td width="120"></td>
