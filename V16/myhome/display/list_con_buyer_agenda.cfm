...
<cf_medium_list_search title="#message#">
    <cf_medium_list_search_area>
        ...
        <cfform name="search" method="post" action="#request.self#?fuseaction=myhome.popup_list_con_buyer_agenda&consumer_id=#attributes.consumer_id#">
        <table>
            <tr>
...
<cf_medium_list>
    <thead>
        <tr>
            <th colspan="4"><cf_get_lang dictionary_id='57658.Üye'> : 
            <cfinclude template="../query/get_consumer.cfm">
            <cfoutput>#GET_CONSUMER.consumer_name# #GET_CONSUMER.consumer_surname#</cfoutput></th>
        </tr>
        <tr>
            <th width="50"><cf_get_lang dictionary_id='57487.No'></th>
            <th><cf_get_lang dictionary_id='57480.Başlık'></th>
            <th width="150"><cf_get_lang dictionary_id='31124.Olay Kategorisi'></th>
	  ...
	  <tr> 
	    <td>
		  <cf_pages page="#attributes.page#"
			  ...
			  adres="myhome.popup_list_con_buyer_agenda#url_str#"> 
	    </td>
