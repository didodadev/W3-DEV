...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cfsavecontent variable="head"><cf_get_lang dictionary_id="60305.Magic Accounter"></cfsavecontent>
				...
				<cfif get_wizards.recordcount>
					<cfoutput query="get_wizards" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
						<tr>
							...
							<td><a href="#request.self#?fuseaction=account.MagicAuditorRun&wizard_id=#wizard_id#"><i class="fa fa-random" aria-hidden="true"></i></a></td>
							<!-- sil -->
						</tr>  
					</cfoutput>
				<cfelse>
