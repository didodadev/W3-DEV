<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	...
	<cf_box title="#head#" add_href="#request.self#?fuseaction=account.form_add_account_card_payment_type" is_blank="0">
        ...
        <div class="col col-9 col-md-9 col-sm-9 col-xs-12">
            <cfform  method="post" name="account_card_payment_type" action="#request.self#?fuseaction=account.emptypopup_add_account_card_payment_type">
                <cf_box_elements>
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" index="1" type="column" sort="true">
                        <div class="form-group" id="payment_type">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="Text" name="payment_type" id="payment_type" value="" maxlength="100" required="Yes">							
                            </div>	
                        </div>
                    ...
                    <div  class="col col-6 col-md-6 col-sm-6 col-xs-12" index="2" type="column" sort="true">
                        <div class="form-group" id="is_active">
                            <cfinput type="checkbox" name="is_active" id="is_active" value="1" checked/><cf_get_lang_main no='81.Aktif'>
                        </div>
                    </div>
                </cf_box_elements>
                <cf_box_footer>
