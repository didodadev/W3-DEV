<!---
    File :          eirsaliye.common.cfc
    Author :        Halit Yurttaş <halityurttas@gmail.com>
    Date :          23.05.2020
    Description :   Eirsaliye ayar ve genel veriler katmanı
    Notes :         
--->
...
<cfcomponent>
    ...
    <cffunction name="GetEShipmentIntegrationInfo" access="public" hint="E-irsaliye entegrasyon bilgileri">
        <cfquery name="query_integrationinfo" datasource="#dsn2#">
            SELECT
                1 AS ESHIPMENT_TEST_SYSTEM,
                'https://efaturatest.doganedonusum.com/' AS ESHIPMENT_TEST_URL,
                'https://connector.doganedonusum.com/' AS ESHIPMENT_LIVE_URL
        </cfquery>
    ...
    <cffunction name="GetAuthorizationVars" access="public">
        <cfquery name="get_authorizaton" datasource="#dsn2#">
            SELECT ESHIPMENT_COMPANY_CODE, ESHIPMENT_USER_NAME, ESHIPMENT_PASSWORD FROM #dsn#.ESHIPMENT_INTEGRATION_INFO WHERE COMP_ID = #session.ep.company_id#
        </cfquery>
