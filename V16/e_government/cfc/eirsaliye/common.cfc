...
<cfcomponent>
    ...
    <cffunction name="GetEShipmentIntegrationInfo" access="public" hint="İrsaliye entegrasyon bilgileri">
        <cfquery name="query_integrationinfo" datasource="#dsn2#">
            SELECT * FROM #dsn#.ESHIPMENT_INTEGRATION_INFO WHERE COMP_ID = #session.ep.company_id#
        </cfquery>
        ...
        <cfquery name="getShipment" datasource="#dsn2#">
            SELECT 
                ...
                <cfif len(arguments.company_id)>
                    ...
                    CASE WHEN ISNULL(S.SHIP_ADDRESS_ID,0) > 0 THEN S.ADDRESS ELSE COMP.COMPANY_ADDRESS END AS ADDRESS2,
    ...
    <cffunction name="GET_ESHIPMENT_DETAIL" access="public" returntype="any">
        ...
        <cfquery name="GET_ESHIPMENT_DETAIL" datasource="#DSN2#">
            SELECT
                ...
                ERD.SENDER_TAX_ID,
                ERD.RECEIVER_TAX_ID,
                ERD.RECEIVER_POSTBOX_NAME,
                ERD.SENDER_POSTBOX_NAME,
                ERD.PROFILE_ID,
                ERD.TOTAL_AMOUNT,
                ERD.ISSUE_DATE,
                ERD.ISSUE_TIME,
