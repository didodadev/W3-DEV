<cfcomponent>
    ...
    <cffunction name="GetEArchiveIntegrationInfo" access="public" hint="E-arsiv entegrasyon bilgileri">
        <cfquery name="query_integrationinfo" datasource="#dsn2#">
            SELECT
                ...
                'https://authsoapapitest.superentegrator.com/' AS EARSIV_TEST_URL,
                'https://authsoapapi.superentegrator.com/' AS EARSIV_LIVE_URL
            FROM
    ...
    <cffunction name="GetAuthorizationVars" access="public">
        <cfquery name="get_authorizaton" datasource="#dsn2#">
            ...
            FROM
                #dsn#.EARCHIVE_INTEGRATION_INFO
                JOIN #dsn#.OUR_COMPANY AS OC ON OC.COMP_ID = EARCHIVE_INTEGRATION_INFO.COMP_ID
            WHERE
                EARCHIVE_INTEGRATION_INFO.COMP_ID = #session_base.company_id#
        </cfquery>
