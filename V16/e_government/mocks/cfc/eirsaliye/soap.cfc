...
<cfcomponent>
    ...
    <cffunction name="init">
        ...
        <cfif integrationinfo.recordcount gt 0>
            <cfif integrationinfo.ESHIPMENT_TEST_SYSTEM eq 1>
                <cfset this.urlPrefix = "https://netdespatchintegrationwithoutmtomtest.eveelektronik.com.tr/">
            <cfelse>
                <cfset this.urlPrefix = "https://netdespatchintegrationwithoutmtom.eveelektronik.com.tr/">
            </cfif>
        </cfif>
    </cffunction>
    ...
    <cffunction name="SendHttp" access="private">
        ...
        <cfhttp url="#this.urlPrefix##arguments.UrlPostfix#" method="post" result="requestResult">
            ...
            <cfhttpparam type="header" name="content-legth" value="#trim(arguments.body)#">
        ...
        <cftry>
            <cfxml variable="xmlresult">
                <soap:Envelope xmlns:xop="http://www.w3.org/2004/08/xop/include" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
                    ...
                    <soap:Header>
                        <wsa:Action>http://tempuri.org/GetAvailableDespatchesResponse</wsa:Action>
                        <wsa:MessageID>urn:uuid:bdd83fd2-6749-436b-9d8e-38014e524372</wsa:MessageID>
                        <wsa:RelatesTo>urn:uuid:542c83da-6d25-47a4-a0bb-73b075760371</wsa:RelatesTo>
                        <wsa:To>http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous</wsa:To>
                        <wsse:Security>
                            <wsu:Timestamp wsu:Id="Timestamp-211a129a-e572-46a8-aad8-878c4df3bacd">
                                <wsu:Created>2018-04-18T08:29:33Z</wsu:Created>
                                <wsu:Expires>2018-04-18T08:34:33Z</wsu:Expires>
                            </wsu:Timestamp>
                        </wsse:Security>
                    </soap:Header>
                    <soap:Body>
                        <GetAvailableDespatchesResponse xmlns="http://tempuri.org/">
                            <GetAvailableDespatchesResult>
                                ...
                                <Despatches>
                                    <DespatchInfoResult>
                                        <ServiceResult>Successful</ServiceResult>
                                        <ServiceResultDescription>Process Done
                                            Succesfully. You can get the Despatch Raw Data
                                            with GetDespatch web method using UUID.</ServiceResultDescription>
                                        <UUID>4F45F77B-55CC-46A2-BCC2-60910CC517A0</UUID>
                                        <DespatchId>IRS2018000000001</DespatchId>
                                        <StatusCode>1</StatusCode>
                                        <StatusDescription>GÖNDERLYOR</StatusDescription>
                                        <ErrorCode>0</ErrorCode>
                                        <Despatchadvicetypecode>SEVK</Despatchadvicetypecode>
                                                <Sendertaxid>1111111073</Sendertaxid>
                                                <Receivertaxid>2650702563</Receivertaxid>
                                                <Profileid>TEMELIRSALIYE</Profileid>
                                                <Issuedate>2018-01-26T00:00:00</Issuedate>
                                                <Issuetime>2018-01-28T00:00:00</Issuetime>
                                                <Partyname>DTPAS</Partyname>
                                                <ReceiverPostBoxName>urn:mail:defaultpk@digitalplanet.com.tr</ReceiverPostBoxName>
                                                <SenderPostBoxName>defaultgb</SenderPostBoxName>
                                                <TotalAmount>0</TotalAmount>
                                                <Createdate>2018-01-28T17:00:14.08</Createdate>
                                    ...
                                    <DespatchInfoResult>
                                        ...
                                        <ServiceResultDescription>Process Done
                                            Succesfully. You can get the Despatch Raw Data
                                            with GetDespatch web method using UUID.</ServiceResultDescription>
                                        <UUID>64f60bcc-9069-442c-be2a-930c903de2e6</UUID>
                                        <DespatchId>D012020000000033</DespatchId>
                                        <StatusCode>24</StatusCode>
                                        <StatusDescription>SSTEME KAYDEDLD</StatusDescription>
                                        <ErrorCode>0</ErrorCode>
                                        <Despatchadvicetypecode>SEVK</Despatchadvicetypecode>
                                        <Sendertaxid>1111111073</Sendertaxid>
                                        <Receivertaxid>4172444408</Receivertaxid>
                                        <Profileid>TEMELIRSALIYE</Profileid>
                                        <Issuedate>2018-01-26T00:00:00</Issuedate>
                                        <Issuetime>2018-01-28T00:00:00</Issuetime>
                                        <Partyname>DTPAS</Partyname>
                                        ...
                                        <SenderPostBoxName>defaultgb</SenderPostBoxName>
                                        <TotalAmount>0</TotalAmount>
                                        <Createdate>2018-01-28T20:53:07.503</Createdate>
                                        <Direction>Incoming</Direction>
                                    </DespatchInfoResult>
                                </Despatches>
                            </GetAvailableDespatchesResult>
                        </GetAvailableDespatchesResponse>
                    </soap:Body>
                </soap:Envelope>
            </cfxml>
    ...
    <cffunction name="GetAvailableDesptachesWithDate" access="private" hint="Gelen irsaliye listesini verir. GetAvailableDespatches fonksiyonuna tarih belirtildiğinde çalışır">
        ...
        <cftry>
            <cfset httpresult = SendHttp("IntegrationService.asmx", "http://tempuri.org/GetAvailableDesptachesWithDate", despatch_data)>
            <cfxml variable="xmlresult"><cfoutput>#httpresult.Filecontent#</cfoutput></cfxml>
    ...
    <cffunction name="GetAvailableReceipts" access="public" hint="İrsaliye yanıt listesini verir">
        ...
        <cftry>
            <cfset httpresult = SendHttp("IntegrationService.asmx", "http://tempuri.org/GetAvailableReceipts", despatch_data)>
            <cfxml variable="xmlresult"><cfoutput>#httpresult.Filecontent#</cfoutput></cfxml>
            ...
            <cfelse>
                <cfloop array="#xmlresult.Envelope.Body.GetAvailableDespatchesResponse.GetAvailableReceiptsResult.Receipments.xmlchildren#" index="child">
    ...
    <cffunction name="GetReceiptAdvice" access="public" hint="İrsliye yanıtını alır">
        ...
        <cftry>
            <cfset httpresult = SendHttp("IntegrationService.asmx", "http://tempuri.org/GetReceiptAdvice", despatch_data)>
            <cfxml variable="xmlresult"><cfoutput>#httpresult.Filecontent#</cfoutput></cfxml>
    ...
    <cffunction name="AcceptDespatch" access="public" hint="Gelen irsaliyenin kabulu için kullanılır">
        ...
        <cftry>
            <cfset httpresult = SendHttp("IntegrationService.asmx", "http://tempuri.org/AcceptDespatch", despatch_data)>
            <cfxml variable="xmlresult"><cfoutput>#httpresult.Filecontent#</cfoutput></cfxml>
