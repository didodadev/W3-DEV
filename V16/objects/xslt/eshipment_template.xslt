...
<!-- <img src ="BASE64 LOGO EKLEME ALANI"/> -->
								</td>
								<td width="20%">
									<div id="qrcode" style="width:1px; height:1px;"></div>
					...
					<tbody>
						<tr align="left">
							<td id="notesTableTd" height="100">
								...
								<xsl:for-each select="n1:DespatchAdvice/cac:SellerSupplierParty/cac:Party"> 
								<xsl:if test="./cac:PartyIdentification/cbc:ID/@schemeID = 'VKN'">
									<b>&#160;&#160;&#160;&#160;&#160;&#160;Asıl Satıcı VKN: </b>
								  <xsl:value-of select="./cac:PartyIdentification/cbc:ID"/><br/>
									...
									<xsl:if test="./cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
                                     <b>&#160;&#160;&#160;&#160;&#160;&#160;Asıl Satıcı TCKN:</b>
									    <xsl:value-of select="./cac:PartyIdentification/cbc:ID"/><br/>
										 ...
										 <xsl:if test="n1:DespatchAdvice/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
							        <b>&#160;&#160;&#160;&#160;&#160;&#160;Asıl Satıcı Ad Soyad: </b>
									<xsl:value-of select="n1:DespatchAdvice/cac:SellerSupplierParty/cac:Party/cac:Person/cbc:FirstName"/>&#160;<xsl:value-of select="n1:DespatchAdvice/cac:SellerSupplierParty/cac:Party/cac:Person/cbc:FamilyName"/><br/>
                                     </xsl:if>
									...
									<xsl:if test="./cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
                                     <b>&#160;&#160;&#160;&#160;&#160;&#160;Asıl Alıcı TCKN:</b>
									    <xsl:value-of select="./cac:PartyIdentification/cbc:ID"/><br/>
										 ...
										 <xsl:if test="n1:DespatchAdvice/cac:BuyerCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
							        <b>&#160;&#160;&#160;&#160;&#160;&#160;Asıl Alıcı Ad Soyad: </b>
									<xsl:value-of select="n1:DespatchAdvice/cac:BuyerCustomerParty/cac:Party/cac:Person/cbc:FirstName"/>&#160;<xsl:value-of select="n1:DespatchAdvice/cac:BuyerCustomerParty/cac:Party/cac:Person/cbc:FamilyName"/><br/>
                                     </xsl:if>
                                  
								
								<xsl:for-each select="n1:DespatchAdvice/cac:OriginatorCustomerParty/cac:Party"> 
								<xsl:if test="./cac:PartyIdentification/cbc:ID/@schemeID = 'VKN'">
									...
									<xsl:if test="./cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
                                     <b>&#160;&#160;&#160;&#160;&#160;&#160;İşlemleri Başlatan Alıcı TCKN:</b>
									    <xsl:value-of select="./cac:PartyIdentification/cbc:ID"/><br/>
										 ...
										 <xsl:if test="n1:DespatchAdvice/cac:OriginatorCustomerParty/cac:Party/cac:PartyIdentification/cbc:ID/@schemeID ='TCKN'">
							        <b>&#160;&#160;&#160;&#160;&#160;&#160;İşlemleri Başlatan Alıcı Ad Soyad: </b>
									<xsl:value-of select="n1:DespatchAdvice/cac:OriginatorCustomerParty/cac:Party/cac:Person/cbc:FirstName"/>&#160;<xsl:value-of select="n1:DespatchAdvice/cac:OriginatorCustomerParty/cac:Party/cac:Person/cbc:FamilyName"/><br/>
                                     </xsl:if>
								...
								<b><xsl:text>&#160;&#160;&#160;&#160;&#160;&#160;Teslim Eden:</xsl:text></b>
								<xsl:value-of select="n1:DespatchAdvice/cac:DespatchSupplierParty/cac:DespatchContact/cbc:Name"/>
							</td>
							<td id="notesTableTd" height="100">
	...
	<xsl:template name='Party_Other'>
		<xsl:param name="PartyType" />
			<xsl:for-each select="cac:PhysicalLocation/cac:Address/cbc:StreetName">
				<tr align="left">
					<td>
						<span style="font-weight:bold; "><xsl:text>Sevk Adresi: </xsl:text></span>
						<xsl:apply-templates/>
					</td>
				</tr>
			</xsl:for-each>
