						...
						<tbody>
							<tr valign="top">
											...
											<tr>
												<td style="width:469px; " align="left">
													<span style="font-weight:bold; ">
														<xsl:text>DÜZENLEYEN</xsl:text>													</span>												</td>
											</tr>
											<tr align="left">
								...
								<td width="20%" align="center" valign="middle">
									...
									<h1 align="center">
										<span style="font-weight:bold; ">
											<xsl:text>e-Müstahsil Makbuzu</xsl:text>										</span>									</h1>								</td>
										...
										<tbody>
											<tr style="height:71px; ">
												...
												<tr>
													<td style="width:469px; " align="left">
														<span style="font-weight:bold; ">
															<xsl:text>MÜSTAHSİLİN BİLGİLERİ</xsl:text>														</span>													</td>
												</tr>
												<tr>
								 ...
								 <table border="1" id="despatchTable">
										<tbody>
											<tr>
												...
												<span style="font-weight:bold; ">
												<xsl:text>Özelleştirme No:</xsl:text>												</span>												</td>
											...
											<tr style="height:13px; ">
												<td align="left">
												<span style="font-weight:bold; ">
												<xsl:text>Düzenlenme Tarihi:</xsl:text>												</span>												</td>
												<td align="left">
											...
											<tr style="height:13px; ">
												<td align="left">
													<span style="font-weight:bold; ">
														<xsl:text>Düzenlenme Zamanı:</xsl:text>													</span>												</td>
												<td align="left">
