<?xml version="1.0" encoding="UTF-8"?><!-- DWXMLSource="../Downloads/d5029336-3fe9-420c-b0c8-47eb342d37e5_s (1) (1).xml" -->
...
<table align="center" width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><b>DÜZENLEYEN</b></td>
  </tr>
  <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/gercekKisi/adiSoyadi"/> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/tuzelKisi/unvan"/></td>
  </tr>
  <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/caddeSokak"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/binaAd"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/binaNo"/><xsl:text> </xsl:text>  <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/kapiNo"/></td>
  </tr>
  <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/semt"/> <xsl:text> </xsl:text><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/sehir"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/postaKod"/> <xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/ulke"/></td>
  </tr>
  <tr>
    <td>Vergi Dairesi: <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/adres/vDaire"/></td>
  </tr>
  <tr>
    <td>&#160;</td>
  </tr>
    ...
    <xsl:if test="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/gercekKisi/tckn">
  <tr>
    <td>TCKN :<xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/gercekKisi/tckn"/></td>
  </tr>
  </xsl:if>
  
      <xsl:if test="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/tuzelKisi/vkn">
  <tr>
    <td>VKN :<xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/gondericiBilgileri/tuzelKisi/vkn"/></td>
  </tr>
  </xsl:if>
  ...
  <tr>
	...
	<table width="270" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><b>ALICI BİLGİLERİ</b></td>
      </tr>
      <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/gercekKisi/adiSoyadi"/> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/tuzelKisi/unvan"/></td>
  </tr>
  <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/caddeSokak"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/binaAd"/> <xsl:text> </xsl:text><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/binaNo"/> <xsl:text> </xsl:text><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/kapiNo"/></td>
  </tr>
  <tr>
    <td><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/semt"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/sehir"/> <xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/postaKod"/><xsl:text> </xsl:text> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/ulke"/></td>
  </tr>
  <tr>
    <td>Vergi Dairesi: <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/adres/vDaire"/></td>
  </tr>
  <tr>
    <td>&#160;</td>
  </tr>
  <xsl:if test="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/gercekKisi/tckn">
  <tr>
    <td>TCKN :<xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/gercekKisi/tckn"/></td>
  </tr>
  </xsl:if>
    <xsl:if test="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/tuzelKisi/vkn">
  <tr>
    <td>VKN :<xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/aliciBilgileri/tuzelKisi/vkn"/></td>
  </tr>
  </xsl:if>
  <tr>
    <td><hr/></td>
	  ...
	  <td></td>
	<td>
	<table id="budgetContainerTable"  width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd"><b>Belge Numarası:</b> </td>
        <td align="right" id="lineTableBudgetTd"><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/makbuzNo"/></td>
      </tr>
	      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd"><b>Düzenleme Tarihi:</b> </td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/belgeTarihi"/></td>
      </tr>
      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd"><b>Düzenleme Saati:</b> </td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/belgeZamani"/></td>
      </tr>
    </table>
  ...
  <tr>
    <td><b>ETTN:</b> <xsl:value-of select="eArsivVeri/serbestMeslekMakbuz/ETTN"/></td>
    <td>&#160;</td>
    <td>&#160;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">
	<table id="lineTable" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr id="lineTableTr">
        <td id="lineTableTd">Sira No</td>
        <td id="lineTableTd">Ücretin Ne için Alındığı</td>
        <td id="lineTableTd">Brüt Ücret</td>
        <td id="lineTableTd">G. V. Stopaj Oranı %</td>
        <td id="lineTableTd">Net Ücret</td>
        <td id="lineTableTd">KDV Oranı %</td>
        <td id="lineTableTd">KDV Tevkifat Oranı %</td>
        <td id="lineTableTd">Net Tahsilat</td>
      </tr>
	  <xsl:for-each select="eArsivVeri/serbestMeslekMakbuz/malHizmetBilgisi/malHizmet">
	  
	  		<xsl:variable name="StopajUcret">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '0003']">
					<xsl:value-of select="number(vergiTutari)"/>
				</xsl:for-each>
			</xsl:variable>
			
			<xsl:variable name="StopajOran">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '0003']">
					<xsl:value-of select="number(vergiorani)"/>
				</xsl:for-each>
			</xsl:variable>
			
			<xsl:variable name="KDVUcret">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '0015']">
					<xsl:value-of select="number(vergiTutari)"/>
				</xsl:for-each>
			</xsl:variable>
			
			<xsl:variable name="KDVOran">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '0015']">
					<xsl:value-of select="number(vergiorani)"/>
				</xsl:for-each>
			</xsl:variable>
			
			<xsl:variable name="KDVTevkifatOran">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '9015']">
					<xsl:value-of select="number(vergiorani)"/>
				</xsl:for-each>
			</xsl:variable>

			<xsl:variable name="KDVTevkifatTutari">
				<xsl:for-each select="vergiBilgisi/vergi[vergiKodu = '9015']">
					<xsl:value-of select="number(vergiTutari)"/>
				</xsl:for-each>
			</xsl:variable>
      ...
      <tr>
        ...
        <td id="lineTableTd"><xsl:value-of select="ad"/></td>
        <td align="right" id="lineTableTd"><xsl:value-of select="format-number(burutUcret, '###.##0,00', 'european')"/> <xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
        <td align="center" id="lineTableTd"><xsl:value-of select="format-number($StopajOran, '###.##0,00', 'european')"/></td>
        <td align="right" id="lineTableTd"><xsl:value-of select="format-number(burutUcret -$StopajUcret, '###.##0,00', 'european')"/> <xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
        <td align="center" id="lineTableTd"><xsl:value-of select="$KDVOran"/>   </td>
        <td align="center" id="lineTableTd"><xsl:value-of select="$KDVTevkifatOran"/></td>
        <td align="right" id="lineTableTd">
		
		<xsl:value-of select=" format-number((burutUcret -$StopajUcret) + $KDVUcret - $KDVTevkifatTutari, '###.##0,00', 'european')"/>	<xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
      </tr>
	  </xsl:for-each>
    </table></td>
    </tr>
  <tr>
	...
	<table id="budgetContainerTable"  width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">Brüt Ücret </td>
        <td align="right" id="lineTableBudgetTd">
		
		<xsl:value-of select="format-number(sum(eArsivVeri/serbestMeslekMakbuz/malHizmetBilgisi/malHizmet/burutUcret), '###.##0,00', 'european')"/> <xsl:text> </xsl:text> <xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="eArsivVeri/serbestMeslekMakbuz/paraBirimi"/></xsl:call-template> </td>
      </tr>
	<xsl:for-each select="eArsivVeri/serbestMeslekMakbuz/vergiBilgisi/vergi[vergiKodu = '0003']">

      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">G.V.Stopaj Tutarı</td>
        <td align="right" id="lineTableBudgetTd"><xsl:value-of select="format-number(vergiTutari, '###.##0,00', 'european')"/><xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
      </tr>
	  </xsl:for-each>
	
      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">Net Ücret Tutarı</td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="format-number(sum(eArsivVeri/serbestMeslekMakbuz/malHizmetBilgisi/malHizmet/burutUcret) - sum(eArsivVeri/serbestMeslekMakbuz/malHizmetBilgisi/malHizmet/vergiBilgisi/vergi[vergiKodu = '0003']/vergiTutari), '###.##0,00', 'european') "/> <xsl:text> </xsl:text> <xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="eArsivVeri/serbestMeslekMakbuz/paraBirimi"/></xsl:call-template> </td>
      </tr>
	  <xsl:for-each select="eArsivVeri/serbestMeslekMakbuz/vergiBilgisi/vergi[vergiKodu = '0015']">
      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">KDV Tutarı</td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="format-number(vergiTutari, '###.##0,00', 'european')"/> <xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
      </tr>
	  </xsl:for-each>
	  
	  	  <xsl:for-each select="eArsivVeri/serbestMeslekMakbuz/vergiBilgisi/vergi[vergiKodu = '9015']">
      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">KDV Tevkifat Tutarı</td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="format-number(vergiTutari, '###.##0,00', 'european')"/> <xsl:text> </xsl:text><xsl:call-template name="CurrencyInfo"><xsl:with-param name="cid" select="../../paraBirimi"/></xsl:call-template></td>
      </tr>
	  </xsl:for-each>
	  
      <tr id="lineTableBudgetTd">
        <td id="lineTableBudgetTd">Ödenecek Tutar</td>
        <td align="right"  id="lineTableBudgetTd"><xsl:value-of select="format-number(eArsivVeri/serbestMeslekMakbuz/toplamTutar, '###.##0,00', 'european')"/> <xsl:text> </xsl:text> 
		<xsl:call-template name="CurrencyInfo">
		<xsl:with-param name="cid" select="eArsivVeri/serbestMeslekMakbuz/paraBirimi"/>
		</xsl:call-template>
		</td>
      </tr>
    </table></td>
...
<br/>
				<table id="notesTable" width="900px" align="center" height="100">
					<tbody>
						<tr align="left">
							<td valign="top" id="notesTableTd">
							
				
							  <b> &#160;&#160;&#160;&#160;&#160;Yalniz : </b><xsl:call-template name="NumberToWords">
    <xsl:with-param name="number" select="eArsivVeri/serbestMeslekMakbuz/odenecekTutar"/>
    <xsl:with-param name="currency" select="eArsivVeri/serbestMeslekMakbuz/paraBirimi"/>
  </xsl:call-template>
  <br/>
  
   <xsl:for-each select="eArsivVeri/serbestMeslekMakbuz/Aciklama">
    ...
    <xsl:choose>
      <xsl:when test="$currency">
        ...
        <xsl:if test="number(substring-after($numberstring,'.'))&gt;0">
          ...
          <xsl:choose>
            <xsl:when test="$currency='TRY' or $currency='TRL' or $currency='TL'">&#160;Krs</xsl:when>
      ...
      <xsl:when test="substring($numberstring,1,1)='.'">
        <xsl:if test="substring($numberstring,2,1)='0'">Sifir</xsl:if>
        <xsl:call-template name="NumberToWords">
          <xsl:with-param name="number">
            <xsl:choose>
      ...
      <xsl:when test="contains($numberstring,'.') and number(substring-after($numberstring,'.'))&gt;0">
        <xsl:if test="number(substring-before($numberstring,'.'))=0">Sifir</xsl:if>
        <xsl:call-template name="NumberToWords">
          <xsl:with-param name="number" select="substring-before($numberstring,'.')"/>
        </xsl:call-template>
        <xsl:text>&#160;Virg�l&#160;</xsl:text>
        <xsl:call-template name="NumberToWords">
      ...
      <xsl:when test="$numberstring='2'">Iki</xsl:when>
      <xsl:when test="$numberstring='3'">Üç</xsl:when>
      <xsl:when test="$numberstring='4'">Dört</xsl:when>
      <xsl:when test="$numberstring='5'">Bes</xsl:when>
      <xsl:when test="$numberstring='6'">Alti</xsl:when>
      ...
      <xsl:when test="string-length($numberstring)=2">
        <xsl:choose>
          ...
          <xsl:when test="substring($numberstring,1,1)='4'">Kirk</xsl:when>
          <xsl:when test="substring($numberstring,1,1)='5'">Elli</xsl:when>
          <xsl:when test="substring($numberstring,1,1)='6'">Altmis</xsl:when>
          <xsl:when test="substring($numberstring,1,1)='7'">Yetmis</xsl:when>
