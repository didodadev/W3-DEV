    ...
    <xsl:template match="/">
        <html>
            ...
            <body style="margin-left=0.6in; margin-right=0.6in; margin-top=0.79in; margin-bottom=0.79in">
                        ...
                        <tbody>
                            <tr valign="top">
                                ...
                                <td align="right" width="40%" valign="middle">
                                    <table id="despatchTable" align="right" border="1" width="80%">
                                        <tbody>
                                            <tr valign="top">
                                                ...
                                                <td align="left" width="60%">
                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                        <xsl:if test="cbc:DocumentTypeCode = 'WebURL'">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="//n1:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode = '1'">
                                                    <tr valign="top">
                                                        <td align="left">
                                                            <xsl:text>Ödeme Şekli: &#160;&#160;</xsl:text>
                                                        </td>
                                                        <td align="left"> ÖDEME ARACISI </td>
                                                    </tr>
                                                </xsl:when>
                                                <xsl:when test="//n1:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode = '97'">
                                                    <tr valign="top">
                                                        <td align="left">
                                                            <xsl:text>Ödeme Şekli: &#160;&#160;</xsl:text>
                                                        </td>
                                                        <td align="left"> DİĞER </td>
                                                    </tr>
                                                </xsl:when>
                                                <xsl:when test="//n1:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode = '10'">
                                                    <tr valign="top">
                                                        <td align="left">
                                                            <xsl:text>Ödeme Şekli: &#160;&#160;</xsl:text>
                                                        </td>
                                                        <td align="left"> KAPIDA ÖDEME </td>
                                                    </tr>
                                                </xsl:when>
                                                <xsl:when test="//n1:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode = '30'">
                                                    <tr valign="top">
                                                        <td align="left">
                                                            <xsl:text>Ödeme Şekli: &#160;&#160;</xsl:text>
                                                        </td>
                                                        <td align="left"> EFT HAVALE </td>
                                                    </tr>
                                                </xsl:when>
                                                <xsl:when test="//n1:Invoice/cac:PaymentMeans/cbc:PaymentMeansCode = '48'">
                                                    <tr valign="top">
                                                        <td align="left">
                                                            <xsl:text>Ödeme Şekli: &#160;&#160;</xsl:text>
                                                        </td>
                                                        <td align="left"> KREDİ KARTI / BANKA KARTI </td>
                                                    </tr>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <tr valign="top">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td align="left">
                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                        <xsl:if test="cbc:DocumentTypeCode = 'SendingDate'">
                                                            <xsl:value-of select="cbc:DocumentType"/>
                                                        </xsl:if>
                                                    </xsl:for-each>
                                                </td>
                                            ...
                                            <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                <xsl:choose>
                                                    <xsl:when test="cbc:DocumentTypeCode = 'IdentificationType'">
                                                        <xsl:if test="cbc:DocumentType = 'VKN'">
                                                            <tr valign="top">
                                                                <td align="left">
                                                                    <xsl:text>Gönderi Taşıyan VKN: </xsl:text>
                                                                </td>
                                                                <td align="left">
                                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                                        <xsl:if test="cbc:DocumentTypeCode = 'IdentificationValue'">
                                                                            <xsl:value-of select="cbc:DocumentType"/>
                                                                        </xsl:if>
                                                                    </xsl:for-each>
                                                                </td>
                                                            ...
                                                            <tr valign="top">
                                                                <td align="left">
                                                                    <xsl:text>Gönderi Taşıyan Ünvan :</xsl:text>
                                                                </td>
                                                                <td align="left">
                                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                                        <xsl:if test="cbc:DocumentTypeCode = 'PartyName'">
                                                                            <xsl:value-of select="cbc:DocumentType"/>
                                                                        </xsl:if>
                                                                    </xsl:for-each>
                                                                </td>
                                                        ...
                                                        <xsl:if test="cbc:DocumentType = 'TCKN'">
                                                            <tr valign="top">
                                                                <td align="left">
                                                                    <xsl:text>Gönderi Taşıyan TCKN: </xsl:text>
                                                                </td>
                                                                <td align="left">
                                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                                        <xsl:if test="cbc:DocumentTypeCode = 'IdentificationValue'">
                                                            ...
                                                            <tr valign="top">
                                                                <td align="left">
                                                                    <xsl:text>Gönderi Taşıyan Ad/Soyad: </xsl:text>
                                                                </td>
                                                                <td align="left">
                                                                    <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference">
                                                                        <xsl:if test="cbc:DocumentTypeCode = 'PartyName'">
                                            ...
                                            <xsl:if test="//n1:Invoice/cac:eCommerceInfo/cac:gonderiBilgileri/cac:gonderiTasiyan/cac:gercekKisi">
                                                <tr valign="top">
                                                    <td align="left">
                                                        <xsl:text>Gönderi Taşıyan TCKN: </xsl:text>
                                                    </td>
                                                    <td align="left">
                                                        <xsl:value-of select="//n1:Invoice/cac:eCommerceInfo/cac:ShipperInfo/cac:Identification/cbc:ID/@schemeID = 'TCKN' "/>
                                                    </td>
                                                </tr>
                                                <tr valign="top">
                                                    <td align="left">
                                                    ...
                                                    <td align="left">
                                                        <xsl:value-of select="//n1:Invoice/cac:eCommerceInfo/cac:ShipperInfo/cac:Identification/cbc:ID"/>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                        </tbody>
                            ...
                            <tr style="height:118px; " valign="top">
                                ...
                                <td width="40%" align="center" valign="bottom">
                                    <table border="1" height="13" id="despatchTable" width="80%">
                                        <tbody>
                ...
                <br/>
                <table id="notesTable" width="800px" align="left" height="100">
                    <tbody>
                        <tr align="left">
                            <td id="notesTableTd">
