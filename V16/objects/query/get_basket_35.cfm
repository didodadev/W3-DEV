...
<cfscript>
	...
	for (i = 1; i lte get_order_products.recordcount;i=i+1)
		...
		SQLString = "SELECT STOCKS.STOCK_CODE,STOCKS.STOCK_CODE_2,STOCKS.BARCOD FROM PRODUCT, STOCKS WHERE STOCKS.STOCK_ID = #get_order_products.stock_id[i]# AND PRODUCT.PRODUCT_ID = STOCKS.PRODUCT_ID";
