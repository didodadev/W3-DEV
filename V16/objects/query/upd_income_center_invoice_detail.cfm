			...
			<cfloop from="1" to="#attributes.record_num#" index="i">
				...
				<cfif evaluate("attributes.row_kontrol#i#")>
					<cfscript>
						...
						if(len(evaluate('attributes.subscription_name#i#')))
			...
			<cfloop from="1" to="#attributes.discount_record_num#" index="i">
				<cfif evaluate("attributes.discount_row_kontrol#i#")>
					<cfscript>
						...
						if(len(evaluate('attributes.discount_subscription_name#i#')))
						...
						form_net_total =  evaluate('attributes.discount_nettotal#i#');// form_gross_total;
						form_tax_total = 0;
						form_otv_total = 0;
						form_bsmv_total = 0;
                        form_oiv_total = 0;
						...
						//form_gross_total_  = (form_gross_total * form_expense_item_value)/100;
						form_net_total_ = form_net_total//(form_net_total * form_expense_item_value)/100;
						form_tax_total_ = 0;
						form_otv_total_ = 0;
						form_bsmv_total_ = 0;
                        form_oiv_total_ = 0;
