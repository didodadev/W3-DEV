...
<!--- Hatali gelebilecek formar icin ilk kontrol --->
...
<cfquery name="ADD_FILE" datasource="#DSN2#">
	...
	(
		...
		'#cgi.remote_addr#',
		#session.ep.userid#,
		<cfif isdefined('attributes.xml_template_id') and len(attributes.xml_template_id)>#attributes.xml_template_id#<cfelse>NULL</cfif>
	)
</cfquery>
<script type="text/javascript">
