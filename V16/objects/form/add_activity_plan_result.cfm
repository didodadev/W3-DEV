<cfquery name="GET_PLAN_ROW" datasource="#dsn#">
	...
	FROM
		...
		ACTIVITY_PLAN_ROW
	WHERE 
		ACTIVITY_PLAN_ROW.EVENT_PLAN_ROW_ID = #attributes.event_plan_row_id# AND 
        ...
        <cfform name="event_result" action="#request.self#?fuseaction=objects.emptypopup_add_activity_plan_result" method="post">
            ...
            <cf_box_elements>
                <div class="col col-8" type="column" index="1" sort="true">
                    <cfif get_plan_row.position_id eq session.ep.position_code>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                            <cfif len(get_plan_row.warning_id)>
                                ...
                                <cfinput type="text" name="cat_" value="#get_visit_type.activity_type#" readonly>
                            </cfif>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                            <cfif len(get_plan_row.analyse_id)>
                                ...
                                <cfoutput><a href="javascript://" onClick="windowopen('#request.self#?fuseaction=crm.popup_make_analysis&analysis_id=#get_plan_row.analyse_id#&member_type=partner&member_id=#get_plan_row.company_id#' ,'list');">#get_analyse.analysis_head#&nbsp;</a></cfoutput>
                            </cfif>
                        </div>
                    </div>
                    <div class="form-group">
