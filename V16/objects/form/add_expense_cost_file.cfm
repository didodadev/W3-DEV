...
<cfoutput>
	...
	<cf_box title="#getLang('','Dosya Ekle',57515)#" draggable="1" closable="1" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
		<cfform name="upload_form_page" enctype="multipart/form-data" action="#request.self#?fuseaction=objects.emptypopup_get_expense_row_from_file" target="import_file_frame">		
			...
			<div class="col col-8 col-md-8 col-sm-12 col-xs-12">
				<table border="0" align="left">
					...
					<tr>
						<td colspan="2">4 - <cf_get_lang dictionary_id='58551.Gider Kalemi'> <cf_get_lang dictionary_id='58527.ID'></td>
					</tr>
					<tr>
