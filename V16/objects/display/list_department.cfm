<cfquery name="GET_PARTNER_POSITIONS" datasource="#dsn#">
	SELECT PARTNER_DEPARTMENT,PARTNER_DEPARTMENT_ID FROM SETUP_PARTNER_DEPARTMENT WHERE PARTNER_DEPARTMENT_ID IS NOT NULL ORDER BY PARTNER_DEPARTMENT
</cfquery>
    ...
    <td>
      <table cellspacing="1" cellpadding="2" width="100%" border="0">
        <tr height="22" class="color-header">
          <td class="form-title" width="178"><cf_get_lang dictionary_id='57572.Departman'></td>
        </tr>
        <cfif get_partner_positions.recordcount>
          <cfoutput query="get_partner_positions">
            <tr id=#currentrow# height="20" class="color-row" onClick="this.bgColor='CCCCCC'">
              <td width="178"><a href="javascript://" class="tableyazi"  onClick="gonder(#partner_department_id#,'#partner_department#','#currentrow#')">#partner_department#</a></td>
            </tr>
          </cfoutput>
          <cfelse>
          <tr class="color-row">
