<!---
 	ilk giren ilk cikar yontemi (son giren ilk cikar ile ayni): 
...
<cfif not isdefined('stock_cost_system')>
	<cfset stock_cost_system=0>
	<cfset stock_cost_extra_system=0>
</cfif>
<cfset stock_cost = "#stock_cost#;#stock_cost_extra#;#stock_amount_total#;#stock_cost_system#;#stock_cost_extra_system#">
