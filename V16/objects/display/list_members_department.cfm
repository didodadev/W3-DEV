...
<cfquery name="GET_TITLE" datasource="#DSN#">
	...
	WHERE
		...
		AND DEPARTMENT LIKE '%#attributes.keyword#%' 
		</cfif>
</cfquery>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>	
   <td height="35" class="headbold"><cf_get_lang dictionary_id='55190.Departmanlar'></td>
    <td  valign="bottom" style="text-align:right;"> 
      <!--- Arama --->
      <table>
        <cfform action="#request.self#?fuseaction=objects.popup_list_members_department" method="post">
          <tr> 
...
<table cellSpacing="0" cellpadding="0" border="0" width="98%" align="center">
  <tr class="color-border"> 
    <td> 
      <table cellspacing="1" cellpadding="2" width="100%" border="0">
        <tr class="color-header" height="22"> 
		  <td class="form-title" width="75"><cf_get_lang dictionary_id='35449.Departman'></td>
		</tr>
	...
	<tr height="20" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
		<td><a href="javascript://" onClick="add_title('#partner_department_id#','#partner_department#');" class="tableyazi">#partner_department#</a></td>
	</tr>
	</cfoutput>
	<cfelse>
	<tr class="color-row">
...
<table width="98%" cellpadding="0" cellspacing="0" border="0" align="center" height="35">
	<tr> 
		...
		adres="objects.popup_list_members_department&keyword=#attributes.keyword#"></td>
