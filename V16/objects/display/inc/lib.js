...
function as_postbutton() {
	...
	// for testing //
	//as_upscript="http://ep.workcube/index.cfm?fuseaction=objects.imgup";
	// end for testing //
//	alert(as_upscript+", image,"+ imgName+", key,"+ PathKey+", , ");
	activescanctrl.SendImage(as_upscript, "image", imgName, "key", PathKey, "", "");
	alert("postbutton: " + activescanctrl.StatusString+ "----" + activescanctrl.StatusCode);
}
...
function activescanctrl_OnPostComplete() {
	alert("poscomp: " + activescanctrl.StatusString+ "----" + activescanctrl.StatusCode);
