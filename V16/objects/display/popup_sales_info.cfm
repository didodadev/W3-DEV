...
<cfquery name="GET_STOCK_ALL" datasource="#dsn2#">
	...
	WHERE 
		...
		AND PROCESS_TYPE IN (67,70,71,88) 
...
<cfif GET_STOCK_ALL.RECORDCOUNT>
	<cfquery name="get_stock_of_10" dbtype="query">
		SELECT 
			STOCK_ID,
			SUM(STOCK_OUT-STOCK_IN) AS AMOUNT,
			BRANCH_ID
		FROM
			GET_STOCK_ALL
		WHERE 
	...
	<cfquery name="get_stock_of_20" dbtype="query">
		SELECT 
			STOCK_ID,SUM(STOCK_OUT-STOCK_IN) AS AMOUNT,BRANCH_ID
		FROM
			GET_STOCK_ALL
		WHERE  
...
<cf_grid_list>
	<thead>
		<tr>
			<th height="25" colspan="4"><cf_get_lang dictionary_id='58036.Satış Durumları'> : <cfoutput>#GET_STOCK_NAME.PRODUCT_NAME#</cfoutput></th>
		</tr>
		<tr>
			<th><cf_get_lang dictionary_id='57453.Şube'></th>
			<th nowrap="nowrap">10 <cf_get_lang dictionary_id='57490.Gün'></th>
			<th nowrap="nowrap">20 <cf_get_lang dictionary_id='57490.Gün'></th>
			<th nowrap="nowrap">30 <cf_get_lang dictionary_id='57490.Gün'></th>
		</tr>
    </thead>
    <tbody>
