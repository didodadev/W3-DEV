...
<cfquery name="GET_TITLE" datasource="#DSN#">
	...
	FROM 
		SETUP_PARTNER_TITLE
	WHERE
		PARTNER_TITLE_ID IS NOT NULL
		<cfif len(attributes.keyword)>
		AND TITLE LIKE '%#attributes.keyword#%' 
		</cfif>
</cfquery>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>	
   <td height="35" class="headbold">Ünvanlar</td>
...
<table cellSpacing="0" cellpadding="0" border="0" width="98%" align="center">
  <tr class="color-border"> 
	...
	<tr height="20" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
		<td><a href="javascript://" onClick="add_title('#partner_title_id#','#partner_title#');" class="tableyazi">#partner_title#</a></td>
	</tr>
	</cfoutput>
	<cfelse>
	<tr class="color-row">
