<!--- 
	ilk alis fiyati yontemi (son alisla ayni direk maliyetbulur ve ekler):
...
<!--- bugun icinde ayni belge turunden baska yapilmis hareketler varsa onlarida maliyet eklerden stoktan dusmeli cunku bu belge ekledigindeki stok onemli bizm icin --->
...
<cfset stock_cost = "#stock_cost#;#stock_cost_extra#;#product_stock_#;#stock_cost_system#;#stock_cost_extra_system#">
