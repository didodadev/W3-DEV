<cf_xml_page_edit fuseact="objects.popup_list_all_cons">
...
<cfif not len(attributes.maxrows)>
...
<cfelse>
    ...
    <cfset get_consumers.query_count=0>
...
<script type="text/javascript">
	...
	<cfelse>
		...
		<cfif isDefined("attributes.func_LoadCity") and isDefined("attributes.field_city_id") and isDefined("attributes.field_county_id")>
			<cfif not isdefined("attributes.draggable")>window.opener.</cfif>LoadCity(country_id,<cfoutput>"#listlast(attributes.field_city_id,'.')#","#listlast(attributes.field_county_id,'.')#"</cfoutput>);
		</cfif>
		...
		<cfif isDefined("attributes.func_LoadCounty") and isDefined("attributes.field_county_id")>
			<cfif not isdefined("attributes.draggable")>window.opener.</cfif>LoadCounty(city_id,<cfoutput>"#listlast(attributes.field_county_id,'.')#"</cfoutput>);
		</cfif>
		...
		<cfif isdefined('attributes.function_name')>
			<cfif isdefined("attributes.draggable")><cfelse>window.opener.</cfif><cfoutput>#function_name#</cfoutput>(id,2);
		</cfif>
		}
		...
		<cfelseif not isdefined("attributes.window_close")>
			var get_note = wrk_query("SELECT * FROM NOTES WHERE ACTION_SECTION = 'CONSUMER_ID' AND IS_WARNING = 1 AND ACTION_ID = "+id+" ORDER BY ACTION_ID DESC","dsn");
			if(get_note.recordcount) openBoxDraggable('<cfoutput>#request.self#?fuseaction=objects.popup_detail_company_note&cons_id=</cfoutput>'+id,'','ui-draggable-box-small');
				...
				<select name="categories" id="categories" onChange="<cfif isdefined("attributes.draggable")>openBoxDraggable(this.value,#attributes.modal_id#);<cfelse>location.href=this.value;</cfif>">
					<cfif isdefined("url.come")>
						<cfif listcontainsnocase(select_list,3)>
							<option value="#request.self#?fuseaction=objects.popup_list_cons#url_string#"<cfif fusebox.fuseaction is "popup_list_cons"> selected</cfif>><cf_get_lang dictionary_id='32996.C Bireysel Üyeler'></option>
						</cfif>
						<cfif listcontainsnocase(select_list,2)>
							<option value="#request.self#?fuseaction=objects.popup_list_pars#url_string#&is_priority_off=1" <cfif fusebox.fuseaction is "popup_list_pars"> selected</cfif>><cfif isdefined("attributes.is_buyer_seller") and (attributes.is_buyer_seller eq 0)><cf_get_lang dictionary_id='33473.C Müşteriler'><cfelseif isdefined("attributes.is_buyer_seller") and (attributes.is_buyer_seller eq 1)><cf_get_lang dictionary_id='33472.C Tedarikciler'><cfelse><cf_get_lang dictionary_id='32995.C Kurumsal Üyeler'></cfif></option>
						</cfif>
						<cfif listcontainsnocase(select_list,5)>
							<option value="#request.self#?fuseaction=objects.popup_list_pot_cons#url_string#"<cfif fusebox.fuseaction is "popup_list_pot_cons"> selected</cfif>><cf_get_lang dictionary_id='32963.P Bireysel Üyeler'></option>
						</cfif>
						...
						<cfif listcontainsnocase(select_list,7)>
							<option value="#request.self#?fuseaction=objects.popup_list_all_pars#url_string#&is_priority_off=1"<cfif fusebox.fuseaction is "popup_list_all_pars"> selected</cfif>><cf_get_lang dictionary_id='29408.Kurumsal Üyeler'></option>
						</cfif>
						<cfif listcontainsnocase(select_list,8)>
							<option value="#request.self#?fuseaction=objects.popup_list_all_cons#url_string#" <cfif fusebox.fuseaction is "popup_list_all_cons"> selected</cfif>><cf_get_lang dictionary_id='29406.Bireysel Üyeler'></option>
						</cfif>
						<cfelse>
						<cfif listcontainsnocase(select_list,1)>
							<option value="#request.self#?fuseaction=objects.popup_list_positions#url_string#"><cf_get_lang dictionary_id='58875.Çalışanlar'></option>
						</cfif>
						<cfif listcontainsnocase(select_list,2)>
							<option value="#request.self#?fuseaction=objects.popup_list_pars#url_string#&is_priority_off=1" <cfif fusebox.fuseaction is "popup_list_pars"> selected</cfif>><cfif isdefined("attributes.is_buyer_seller") and (attributes.is_buyer_seller eq 0)><cf_get_lang dictionary_id='33473.C Müşteriler'><cfelseif isdefined("attributes.is_buyer_seller") and (attributes.is_buyer_seller eq 1)><cf_get_lang dictionary_id='33472.C Tedarikciler'><cfelse><cf_get_lang dictionary_id='32995.C Kurumsal Üyeler'></cfif></option>
						</cfif>
						<cfif listcontainsnocase(select_list,3)>
							<option value="#request.self#?fuseaction=objects.popup_list_cons#url_string#"<cfif fusebox.fuseaction is "popup_list_cons" or fusebox.fuseaction is "popup_list_all_cons"> selected</cfif>><cf_get_lang dictionary_id='32996.C Bireysel Üyeler'></option>
						</cfif>
						...
						<cfif listcontainsnocase(select_list,9)>
							<option value="#request.self#?fuseaction=objects.popup_list_all_positions#url_string#"><cf_get_lang dictionary_id='32409.Tum Calisanlar'></option>
						</cfif>
					</cfif>
				</select>
			</div>
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cf_box title="#getLang('','Bireysel Üyeler',29406)#" scroll="1" collapsable="0" resize="0" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
		...
		<cfform name="search_con" id="search_con" method="post" action="#request.self#?fuseaction=objects.#fusebox.fuseaction##url_string#">
			<input name="is_form_submitted" id="is_form_submitted" type="hidden" value="1">
			<cf_box_search>
				<div class="form-group" id="keyword">
					<cfsavecontent variable="message"><cf_get_lang dictionary_id='57460.Filtre'></cfsavecontent>
					<cfif isdefined("attributes.member_code") and len(attributes.member_code)>
						<cfinput type="text" name="keyword" placeholder="#message#" id="keyword" maxlength="50" value="#attributes.member_code#" >
					...
					<cfelse>
						<cfinput type="text" name="keyword" placeholder="#message#" id="keyword" maxlength="50" value="">
					</cfif>
				</div>		
				<div class="form-group" id="identity_no">
					<cfsavecontent variable="message"><cf_get_lang dictionary_id='58627.Kimlik No'></cfsavecontent>
					<input type="text" name="identity_no" placeholder="<cfoutput>#message#</cfoutput>" id="identity_no" value="<cfif isdefined("attributes.identity_no")><cfoutput>#attributes.identity_no#</cfoutput></cfif>" maxlength="11" onkeyup="isNumber(this);">
				</div>
				<div class="form-group" id="search_status">
				...
				<div class="form-group">
					<a class="ui-btn ui-btn-gray" href="<cfoutput>#request.self#?fuseaction=member.consumer_list&event=add</cfoutput>" target="_blank" title="<cf_get_lang dictionary_id='29407.Bireysel Üye Ekle'>"><i class="fa fa-plus"></i></a>
				</div>
			...
			<cf_box_search_detail search_function="#iif(isdefined("attributes.draggable"),DE("loadPopupBox('search_con' , #attributes.modal_id#)"),DE(""))#">
				<div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" name="ref_code_name" placeholder="<cfoutput>#message#</cfoutput>" id="ref_code_name" onFocus="AutoComplete_Create('ref_code_name','MEMBER_NAME,MEMBER_CODE','MEMBER_NAME,MEMBER_CODE','get_member_autocomplete','\'2\'','CONSUMER_ID','ref_code','search_con','3','250');" value="<cfif len(attributes.ref_code) and len(attributes.ref_code_name)><cfoutput>#attributes.ref_code_name#</cfoutput></cfif>" autocomplete="off">
							<span class="input-group-addon btnPointer icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_list_cons&field_id=search_con.ref_code&field_name=search_con.ref_code_name<cfif session.ep.isBranchAuthorization>&is_store_module=1</cfif>&select_list=3'</cfoutput>,'list')"></span>
						</div>
					</div>
				</div>
			...
			<thead>
				<tr>
					<cfif isDefined("session.ep.our_company_info.is_efatura") and session.ep.our_company_info.is_efatura eq 1>
						<th><img src="/images/icons/efatura_black.gif" align="absmiddle" title="<cf_get_lang dictionary_id='43184.E-Fatura Kullanılıyor mu'>?" /></th>
					</cfif>
					...
					<cfif x_address_information eq 1>
						<th><cf_get_lang dictionary_id='58723.Adres'></th>
					</cfif>
					<th><cf_get_lang dictionary_id='57486.kategori'></th>
					<cfif x_tc eq 1>
						<th><cf_get_lang dictionary_id ='58025.TC KİMLİK NO'></th>
					</cfif>
					<cfif x_father_name eq 1>
					...
					<cfif len(consumer_id_list) and isdefined("attributes.field_paymethod_id") and isdefined("attributes.field_paymethod")>
						...
						<cfquery name="GET_PAYMETHOD" datasource="#DSN#">
							...
							WHERE
								...
								CC.OUR_COMPANY_ID = #session.ep.company_id# AND
					...
					<tr>
						...
						<cfelse>
							...
							<cfif (isdefined("attributes.field_county") or isdefined("attributes.field_long_address")) and len(county_list)>
								<cfif x_adress_priority eq 0>
									<cfset county_ = '#get_county_name.county_name[listfind(county_list,get_consumers.work_county_id,',')]#'>
								<cfelse>
							...
							<cfif x_adress_priority eq 0><!--- birincil adres is adresi --->
								<cfif (isdefined("attributes.field_city") or isdefined("attributes.field_long_address")) and len(get_consumers.work_city_id)>
									<cfset city_ = '#get_city_name.city_name[listfind(city_id_list,get_consumers.work_city_id,',')]#'>
								</cfif>
								<cfif (isdefined("attributes.field_country") or isdefined("attributes.field_long_address")) and len(get_consumers.work_country_id)>
									<cfset country_ = '#get_country_name.country_name[listfind(country_list,get_consumers.work_country_id,',')]#'>
								</cfif>	
								<cfif len(district_list) and len(get_consumers.work_district_id)>	
									<cfset district_ = '#get_district_name.district_name[listfind(district_list,get_consumers.work_district_id,',')]#'>
								</cfif>
							<cfelse><!--- birincil adres ev adresi --->
							...
							<cfset RepListNew = " , , ">
							<cfif x_adress_priority eq 0><!--- birincil adres is adresi --->
								<cfset str_adres = ReplaceList("#workaddress#",RepList,RepListNew)>
								<cfset str_long_adres = ReplaceList("#district_##workaddress# #workpostcode# #county_# #city_# #country_#",RepList,RepListNew)>
								<cfset str_adres_id = -3>
							<cfelse><!--- birincil adres ev adresi --->
							...
							<cfif isdefined("attributes.is_county_related_company") and len(county_)>
								<cfquery name="get_related_" datasource="#dsn#">
									...
									WHERE 
										...
										<!--- <cfif x_adress_priority eq 0>
											SZTC.COUNTY_ID LIKE '%,#work_county_id#,%'
										<cfelse>
											SZTC.COUNTY_ID LIKE '%,#home_county_id#,%'
										</cfif> --->
								</cfquery>
							...
							<a href="javascript:add_user('#consumer_id_#','#consumer_name# #consumer_surname#','#company#','#str_long_adres#','#str_adres#','<cfif x_adress_priority eq 0>#workpostcode#<cfelse>#homepostcode#</cfif>','<cfif x_adress_priority eq 0>#worksemt#<cfelse>#homesemt#</cfif>','#county_#','<cfif x_adress_priority eq 0>#work_county_id#<cfelse>#home_county_id#</cfif>','#city_#','<cfif x_adress_priority eq 0>#work_city_id#<cfelse>#home_city_id#</cfif>','#country_#','<cfif x_adress_priority eq 0>#work_country_id#<cfelse>#home_country_id#</cfif>','<cfif fusebox.use_period>#get_consumer_period(consumer_id)#</cfif>','#CONSUMER_EMAIL#','<cfif x_adress_priority eq 0>#CONSUMER_WORKTELCODE##CONSUMER_WORKTEL#<cfelse>#CONSUMER_HOMETELCODE##CONSUMER_HOMETEL#</cfif>',<cfif len(CONSUMER_REFERENCE_CODE)>'#CONSUMER_REFERENCE_CODE#'<cfelse>''</cfif>,'#paymethod_id#','#paymethod_name#','#revmethod_id#','#revmethod_name#','#card_paymethod_id#','#card_revmethod_id#','#due_paymethod#','#due_revmethod#','#member_code#','#CONSUMER_WORKTELCODE#','#CONSUMER_WORKTEL#','#consumer_name#','#consumer_surname#','#str_home_adres#','#home_county_#','#home_county_id#','#home_city_id#','#consumer_hometelcode#','#consumer_hometel#','#MOBIL_CODE#','#MOBILTEL#','#temp_ozel_kod#','#tc_identy_no#','#vocation_type_id#','#consumer_username#','#imcat_id#','#im#','#title#','#mission#','#department#','#sex#','#consumer_tel_ext#','#consumer_faxcode#','#consumer_fax#','#homepage#','#tax_office#','#tax_no#','#related_company_id_#','#related_company_#','#ims_code_name_#','#ims_code_id#','#str_adres_id#','#mobil_code_2#','#mobiltel_2#');" class="tableyazi"> #consumer_name# #consumer_surname# </a>
						</cfif>
						</td>
						<cfif isdefined("x_add_multi_acc") and x_add_multi_acc eq 1 and isdefined("attributes.is_multi_act") and attributes.is_multi_act eq 1>
							<td>#ACC_TYPE#</td></cfif>
						<cfif x_address_information eq 1>
						<td>#str_long_adres#</td>
						</cfif>
						<td>#conscat#</td>
						<cfif x_tc eq 1>
							<td>#tc_identy_no#</td>
						...
						<cfif x_city eq 1>
							<td>
								<cfif x_adress_priority eq 0><!--- birincil adres is adresi --->
									<cfif len(work_city_id)>#get_city_name.city_name[listfindnocase(city_id_list,work_city_id,',')]#</cfif>
								<cfelse>
									<cfif len(home_city_id)>#get_city_name.city_name[listfindnocase(city_id_list,home_city_id,',')]#</cfif>
								</cfif>
							</td>
						</cfif>
						<td align="center" nowrap="nowrap"><cfif get_module_user(23)>
							<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=objects.popup_list_comp_extre&member_id=#consumer_id#&comp_name=#consumer_name# #consumer_surname#&date_control=1&form_submit=1&member_type=consumer','page');"><i class="fa fa-table" title="<cf_get_lang dictionary_id='57809.Hesap Ekstresi'>"></i></a></cfif> 
						</td>
						<td>
							<a href="javascript://" onClick="windowopen('#request.self#?fuseaction=objects.popup_con_det&con_id=#consumer_id#','medium')"><i class="icon-detail" title="<cf_get_lang dictionary_id='57771.Detay'>"></i></a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
...
<script type="text/javascript">
    ...
    $( "form[name=search_con] #keyword" ).focus();
});
