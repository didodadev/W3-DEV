...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	...
	<cf_box>
		<cfform name="order_form" action="#request.self#?fuseaction=#url.fuseaction#">
			<cf_box_search>
				...
				<div class="form-group">
					<div class="input-group">
						<input type="text" name="keyword_orderno" id="keyword_orderno" placeholder="<cf_get_lang dictionary_id='57487.No'>" value="#attributes.keyword_orderno#" maxlength="50">
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
			...
			<cf_box_search_detail>
					<div class="col col-3 col-md-8 col-sm-12" type="column" sort="true" index="1">
						...
						<div class="form-group" id="item-listing_type">	
							<label class="col col-12 col-md-12 col-sm-12 col-xs-12"><cf_get_lang dictionary_id='40170.Listeleme Seçenekleri'></label>		
							<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col col-3 col-md-8 col-sm-12" type="column" sort="true" index="2">
						...
						<div class="form-group" id="item-currency_id">	
							<label class="col col-12 col-md-12 col-sm-12 col-xs-12"><cf_get_lang dictionary_id='57482.Asama'></label>
							<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col col-3 col-md-8 col-sm-12" type="column" sort="true" index="4">
						...
						<div class="form-group" id="item-branch_id">
							...
							<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
								...
								<cf_wrkdepartmentbranch fieldid='branch_id' is_branch='1' width='135' selected_value='#attributes.branch_id#' option_value='#opt_value#'>
							</div>
						</div>
	...
	<cf_box title="#head#" uidrop="1" hide_table_column="1" woc_setting = "#{ checkbox_name : 'print_order_id', print_type : 73}#">
						...
						<td>
							...
							<td align="center">
								<cfif order_status eq 1>
									<a href="javascript://" onclick="mng_kargo('#order_number#');"><img src="/images/mng.png" title="MNG Kargo Bilgileri"></a> 
								</cfif>
							</td>							
							<td align="center">
		...
		<!---	</table>--->
			...
			<script language="javascript">
				function mng_kargo(o_number)
				{
					...
					{
						alert('<cf_get_lang dictionary_id='60881.Kargo Bilgisi Ulasmamistir'> !');
						return false;
					}
					else
					{
						alert("<cf_get_lang dictionary_id='60882.MNG Entegrasyonu Datasi ekildigi Iin Production Ortaminda Hata Verebilir. XML Tanimini Kontrol Ediniz.'>");
					}
				}
			</script>
		</div>
