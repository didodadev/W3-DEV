            ...
            <cf_box_search>
                ...
                <div class="form-group medium" id="form_ul_process_stage">
                    <cf_multiselect_check
                        ...
                        option_text="#getLang(1447,'Süreç',58859)#"
    ...
    <cf_box title="#getLang(1282,'Fırsatlar',58694)#" uidrop="1" hide_table_column="1">
        <cf_grid_list>
            ...
            <tbody>
                ...
                <cfelse>
                    <tr>
                        <td <cfif x_update_date eq 1>colspan="17"<cfelse>colspan="16"</cfif>><cfif isdefined("attributes.is_filtre")><cf_get_lang dictionary_id='57484.Kayıt Yok'>!<cfelse><cf_get_lang dictionary_id='57701.Filtre Ediniz'>!</cfif></td>
                    </tr>
                </cfif>
            </tbody>
        </cf_grid_list>
