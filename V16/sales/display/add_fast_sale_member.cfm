		...
		<cf_box_elements>
			...
			<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="true">
				<div class="form-group" id="item-country">
					<label for="" class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58219.Ülke'></label>
					<div class="col col-8 col-xs-12">
				...
				<div class="form-group" id="item-city">
					<label for="" class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58608.İl'></label>
					<div class="col col-8 col-xs-12">
				...
				<div class="form-group" id="item-county">
					<label for="" class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58638.İlçe'></label>
					<div class="col col-8 col-xs-12">
				...
				<div class="form-group" id="item-postcod">
					<label for="" class="col col-4 col-xs-12"><cf_get_lang dictionary_id='57472.Posta Kodu'></label>
					<div class="col col-8 col-xs-12">
							<input type="text" name="postcod" id="postcod" value="" maxlength="15">
					</div>
				</div>
				<div class="form-group" id="item-adress">
					<label for="" class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58723.Adres'></label>
					<div class="col col-8 col-xs-12">
