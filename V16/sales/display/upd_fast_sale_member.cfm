	...
	<cf_box_elements>
		<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
			<div class="form-group" id="item-member_name">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no ='158.Ad Soyad'></label>			
			...
			<div class="form-group" id="item-tc_num">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no ='613.TC Kimlik No'></label>
				<div class="col col-9 col-xs-12">
            ...
            <div class="form-group" id="item-comp_name">
				<label class="col col-3 col-xs-12"><cf_get_lang_main no ='1195.Firma'></label>
				<div class="col col-9 col-xs-12">
		...
		<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="3" sort="true">
			<cfif is_dsp_category eq 1>
				<div class="form-group" id="item-company_cat">
					<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no='1197.Üye Kategorisi'></label>
					<cfif len(GET_ORDER_DETAIL.COMPANY_ID)>
						<div class="col col-9 col-xs-12" id="is_company" >
					...
					<cfif len(GET_ORDER_DETAIL.CONSUMER_ID)>
						<div class="col col-9 col-xs-12" id="is_consumer" <cfif attributes.member_type neq 2> style="display:none;"</cfif> >
			...
			<div class="form-group" id="item-vocation_type">
				<label for="" class="col col-3 col-3 col-xs-12"><cf_get_lang no ='393.Meslek Tipi'></label>
				<div class="col col-9 col-xs-12">
			...
			<div class="form-group" id="item-tax_office">
				<label for="" class="col col-3 col-3 col-xs-12"><cf_get_lang_main no='1350.Vergi D'>./<cf_get_lang_main no='340.Vergi No'></label>
				<div class="col col-4 col-xs-5">
	...
	<cf_box_elements>
		<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="4" sort="true">
			<div class="form-group" id="item-order_date">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no='1704.Sipariş Tarihi'></label>
				<div class="col col-9 col-xs-12">
			...
			<div class="form-group" id="item-process">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no ='1447.Süreç'></label>
				<div class="col col-9 col-xs-12">	
					<cfif not listfindnocase(denied_pages,'#fusebox.circuit#.emptypopup_upd_fast_sale_deliverdate')>
						<div class="input-group">
					</cfif>	
			...
			<div class="form-group" id="item-order_employee">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang no ='101.Satış Yapan'></label>
				<div class="col col-9 col-xs-12">
		...
		<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="5" sort="true">
			...
			<cfif is_ims_code eq 1>
				<div class="form-group" id="item-ims_code_name">
					<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no='722.Mikro Bölge Kodu'></label>
					<div class="col col-9 col-xs-12">
						<div class="input-group">
		...
		<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="6" sort="true">
			<div class="form-group" id="item-order_detail">
				<label for="" class="col col-3 col-xs-12"><cf_get_lang_main no='217.Açıklama'></label>
				<div class="col col-9 col-xs-12">
			...
			<cfif x_branch_info eq 1>
				<div class="form-group" id="item-project_head">
					<label class="col col-3 col-xs-12 bold"><cf_get_lang dictionary_id='57453.Şube'></label>
					<div class="col col-9 col-xs-12">
