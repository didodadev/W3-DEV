<script type="text/javascript">
	...
	{
		openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=sales.emptypopup_add_offer_opp&opp_id=<cfoutput>#attributes.opp_id#</cfoutput>&offer_id=' + offer_id, <cfoutput>#attributes.modal_id#</cfoutput>) ;
	}
</script>
