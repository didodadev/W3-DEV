        ...
        <cfform name="subscription_list" id="subscription_list" method="post" action="#request.self#?fuseaction=sales.list_subscription_contract">
            ...
            <cf_box_search>
                ...
                <div class="form-group">
                    ...
                    <cf_wrk_search_button button_type="4" search_function="date_check(subscription_list.start_date,subscription_list.finish_date,'#message_date#')">
                </div>
                <div class="form-group">
                    <cfoutput><a class="ui-btn ui-btn-gray2" onclick="windowopen('#request.self#?fuseaction=sales.popup_add_multi_provision','page_horizantal');"><i class="icon-POS" title="<cf_get_lang dictionary_id='48865.Sanal Pos'>"></i></a></cfoutput>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group" id="form_ul_member_name">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_all_pars<cfoutput>#str_linke_ait#</cfoutput>&select_list=7,8&keyword='+encodeURIComponent(document.subscription_list.member_name.value),'list');"></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group" id="form_ul_sales_partner">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_pars&field_id=subscription_list.sales_partner_id&field_name=subscription_list.sales_partner&select_list=2,3','list');"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" id="form_ul_sales_emp">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=subscription_list.sales_emp_id&field_name=subscription_list.sales_emp&select_list=1','list');"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" id="form_ul_product_name">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_product_names&product_id=subscription_list.product_id&field_name=subscription_list.product_name&keyword='+encodeURIComponent(document.subscription_list.product_name.value),'list');"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" id="form_ul_employee_name">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=subscription_list.employee_id&field_name=subscription_list.employee_name&select_list=1','list');"></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group" id="form_ul_city">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_dsp_city&field_id=subscription_list.city_id&field_name=subscription_list.city','small');"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" id="form_ul_">
                        ...
                        <div class="col col-12">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_dsp_county&field_id=subscription_list.county_id&field_name=subscription_list.county&city_id=' + document.subscription_list.city_id.value,'small');"></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td><cfif len(get_subscriptions.consumer_id)>
                            ...
                            <cfelseif len(get_subscriptions.company_id)>
                                <a href="javascript://" class="tableyazi" onclick="windowopen('#request.self#?fuseaction=objects.popup_com_det&company_id=#get_subscriptions.COMPANY_ID#','medium');">#get_partner.nickname[listfind(main_partner_list,get_subscriptions.partner_id,',')]#</a> - 
                                <cfif len(get_subscriptions.partner_id)><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_par_det&par_id=#get_subscriptions.partner_id#','medium');" class="tableyazi">#get_partner.company_partner_name[listfind(main_partner_list,get_subscriptions.partner_id,',')]#&nbsp;#get_partner.company_partner_surname[listfind(main_partner_list,get_subscriptions.partner_id,',')]#</a></cfif>
                            </cfif>
                        </td>
                        <cfif xml_project eq 1>
                        <td><cfif len(get_subscriptions.project_id)>#get_project_name(get_subscriptions.project_id,0)#</cfif></td>
                        </cfif>
                        ...
                        <td><cfif len(sales_emp_id)>
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_subscriptions.sales_emp_id#','medium');" class="tableyazi">
                        ...
                        <td><cfif len(record_emp)>
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_subscriptions.record_emp#','medium');" class="tableyazi">#get_employee.employee_name[listfind(main_employee_list,get_subscriptions.record_emp,',')]#&nbsp;#get_employee.employee_surname[listfind(main_employee_list,get_subscriptions.record_emp,',')]#</a>
                            <cfelseif len(record_cons)>
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_con_det&con_id=#get_subscriptions.record_cons#','medium');" class="tableyazi">#get_consumer.consumer_name[listfind(consumer_list,record_cons,',')]# #get_consumer.consumer_surname[listfind(consumer_list,record_cons,',')]#</a>
                            </cfif>
                        </td>
