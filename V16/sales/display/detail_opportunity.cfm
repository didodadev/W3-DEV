<cfoutput>
        ...
        <div class="col col-9 col-md-9 col-sm-9 col-xs-12 uniqueRow">
            <cf_box title="#getLang('main','Fırsat',57612)# #getLang('main','Detay',57771)#" closable="0" id="BoxFırsat">
            ...
            <cfif get_module_user(11)>
                <cf_box
                    ...
                    add_href="openBoxDraggable('#request.self#?fuseaction=sales.popup_form_add_opp_plus&opp_id=#get_opportunity.opp_id#&header=upd_opp.opp_head&contact_mail=#get_contact_simple.email#&contact_person=#get_contact_simple.name# #get_contact_simple.surname#&contact_id=#get_contact_simple.id#&draggable=1')"
                    unload_body = "1"
