        ...
        <tbody>
            <cfif get_counter_types.recordcount>
                <cfoutput query="get_counter_types">
                    <tr>
                        <td>
                            <a href="javascript://" onClick="openBoxDraggable('#request.self#?fuseaction=sales.counter&event=upd&counter_id=#counter_id#','','ui-draggable-box-large');">#counter_type#</a><br/>
                        </td>
                        <td class="text-right">
