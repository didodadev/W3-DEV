...
<cf_box closable="0" id="get_internaldemands" title="#text#" add_href="#request.self#?fuseaction=correspondence.list_internaldemand&event=add&offer_id=#attributes.offer_id#">
<cf_ajax_list>
	<tbody>
            ...
            <tr>
                <td>
                    <cfoutput query="get_internals">
                        <a href="#request.self#?fuseaction=correspondence.list_internaldemand&event=upd&id=#internal_id#" class="tableyazi">#subject#</a> <br/>
                    </cfoutput>
                </td>
            </tr>
        <cfelse>
