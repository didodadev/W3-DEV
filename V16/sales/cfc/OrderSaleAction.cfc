...
<cfcomponent extends="cfc.sdFunctions">
    ...
    <cffunction name="add_order" access="public" output="false" returntype="struct" hint="Sipariş Ekleme İşlemleri">
        <cfset attributes = arguments>
        <cfset form = arguments>
        <cfset responseStruct = structNew()>
        ...
        <cflock name="#CREATEUUID()#" timeout="90">
            ...
            <cfcatch>
                ...
                <cfif isdefined('GET_MAX_ORDER.MAX_ID')>
                    ...
                    <cfset del_order = this.del_order(order_id : attributes.order_id, fuseaction: attributes.fuseaction)>
                </cfif>
