...
<!--- List Page --->
    <cffunction name="GET_SUBSCRIPTIONS" returntype="query">
        ...
        <cfquery name="GET_SUBSCRIPTIONS" datasource="#arguments.DSN3#">
            ...
            <cfif len(arguments.consumer_id)>
                <cfif isDefined("session.pp")>
                    AND (SC.CONSUMER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.consumer_id#"> OR SALES_CONSUMER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.consumer_id#">) 
                <cfelse>
    ...
    <cffunction name="GET_PROCESS_TYPE" returntype="query">
        ...
        <cfquery name="get_process_type" datasource="#dsn#">
            SELECT STAGE,PROCESS_ROW_ID,LINE_NUMBER FROM PROCESS_TYPE_ROWS WHERE PROCESS_ROW_ID IN (#arguments.process_list#) ORDER BY PROCESS_ROW_ID
        </cfquery>
...
<!--- --->
    ...
    <cffunction name="get_subscription_counter" returntype="query" access="public">
        ...
        <cfquery name="get_subscription_counter_query" datasource="#dsn2#">
            SELECT 
                P.PRODUCT_NAME,
                PU.MAIN_UNIT,
    ...
    <cffunction name="get_extre" returntype="query" access="public">
        ...
        <cfquery name="get_extre_query" datasource="#dsn2#">
            SELECT
