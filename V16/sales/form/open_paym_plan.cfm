...
<script type="text/javascript">
	...
	function change_rules()
	{
		...
		{
			get_camp_info=wrk_query('SELECT TOP 1 PAYMETHOD_ID,CARD_PAYMETHOD_ID,CURRENCY,PERIOD FROM CAMPAIGN_OPERATION WHERE (PAYMETHOD_ID IS NOT NULL OR CARD_PAYMETHOD_ID IS NOT NULL) AND CAMP_ID='+document.all.camp_id.value,'dsn3');
