                ...
                <cf_box_elements>
                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" index="2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12" id="item-pursuit_templates">
                    ...
                    <cfif xml_is_agenda eq 1>
                        <div class="col col-6 col-md-6 col-sm-6 col-xs-12" index="4">
                            <div class="form-group" id="item-response_date">
                                <label class="col col-4 col-md-4 col-sm-3 col-xs-12"><cf_get_lang dictionary_id='57742.Tarih'>*</label>
                        ...
                        <div class="form-group" id="item-is_agenda">    
