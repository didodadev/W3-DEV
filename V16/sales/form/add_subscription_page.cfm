...
<cf_popup_box title="#getLang('sales',138)#: #get_subscription_head.subscription_no#">
<cfform name="add_subscription_page" method="post" action="#request.self#?fuseaction=sales.emptypopup_add_subscription_page">
	<input type="hidden" name="subscription_id" id="subscription_id" value="<cfoutput>#subs_id#</cfoutput>"> 
		<cfif get_subscription_pg.recordcount> 
						<table width="99%" align="center">
							<tr class="color-list" height="22">
								<td><a href="<cfoutput>#request.self#?fuseaction=sales.popup_add_subscription_page&subs_id=#attributes.subs_id#</cfoutput>"><img src="/images/plus_list.gif" align="right" border="0" title="<cf_get_lang_main no ='170.Ekle'>"></a></td>
		...
		<div class="row form-inline">
            <div class="form-group" id="item-page_no">
                <label class="col col-2 col-md-2 col-xs-2"><cf_get_lang_main no='75.no'></label>
            ...
            <div class="form-group" id="item-page_type">
                <label class="col col-2 col-md-2 col-xs-2"><cf_get_lang_main no='218.tip'></label>
            ...
            <div class="form-group" id="item-page_name">
                <label class="col col-2 col-md-2 col-xs-2"><cf_get_lang_main no='68.Başlık'></label>
                <div class="col col-9 col-md-9 col-sm-9 col-xs-9">
