                        ...
                        <div class="form-group" id="item-form_ul_payment_type">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_paymethods&field_id=form_basket.payment_type_id&field_name=form_basket.payment_type&field_card_payment_id=form_basket.payment_type_creditcard_id&field_card_payment_name=form_basket.payment_type','list','popup_paymethods');"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    <cfoutput>
                                            ...
                                            <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('#request.self#?fuseaction=objects.popup_list_campaigns&field_id=form_basket.camp_id&field_name=form_basket.camp_name','list');"></span>
                                    </cfoutput>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col col-8  col-xs-12">
                                <div class="input-group">
                                    <cfoutput>
                                        ...
                                        <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('#request.self#?fuseaction=objects.popup_product_names&product_id=form_basket.subscription_product_id&field_name=form_basket.subscription_product_name&field_id=form_basket.subscription_stock_id&keyword='+encodeURIComponent(document.form_basket.subscription_product_name.value),'list');"></span>
                                    </cfoutput>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="item-sales_emp_id">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_basket.sales_emp_id&field_name=form_basket.sales_emp&select_list=1&keyword='+encodeURIComponent(form_basket.sales_emp.value),'list','popup_list_positions');"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="item-form_ul_sales_member">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon btn_Pointer icon-ellipsis"  onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_pars&field_partner=form_basket.sales_member_id&field_consumer=form_basket.sales_member_id&field_comp_id=form_basket.sales_company_id&field_name=form_basket.sales_member&field_type=form_basket.sales_member_type&select_list=7,8','list');"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="item-ref_company">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_all_pars&<cfoutput>#str_linke_ait1#</cfoutput>&select_list=1,7,8','list','popup_list_positions');"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="item-form_ul_montage_emp">
                            ...
                            <div class="col col-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon btn_Pointer icon-ellipsis" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_positions&field_emp_id=form_basket.montage_emp_id&field_name=form_basket.montage_emp&select_list=1','list','popup_list_positions');"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col col-8 col-xs-12">
                                <select name="subs_add_option" id="subs_add_option">
                                    ...
                                    <cfoutput query="get_subs_add_option">
                                        <option value="#subscrıptıon_add_option_id#" <cfif isDefined("attributes.subs_add_opt") and attributes.subs_add_opt eq subscrıptıon_add_option_id>selected</cfif>>#subscrıptıon_add_option_name#</option>
                                    </cfoutput>
                                </select>
                            </div>
                        </div>
		...
		if(!(form_basket.partner_id.value=="") || !(form_basket.consumer_id.value==""))
		{
			if(form_basket.partner_id.value!="")
			{
				if(adress_type==1)
				{
					...
					windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_member_address&is_comp=1&is_select=2&keyword='+encodeURIComponent(form_basket.company_name.value)+''+ str_adrlink , 'list');
					return true;
				}
			...
			else
			{
				...
				{
					str_adrlink = '&field_adres=form_basket.ship_address&field_city=form_basket.ship_city_id&field_county=form_basket.ship_county_id&field_country=form_basket.ship_country_id&field_postcode=form_basket.ship_postcode&field_semt=form_basket.ship_semt&coordinate_1=form_basket.ship_coordinate_1&coordinate_2=form_basket.ship_coordinate_2&sales_zone=form_basket.ship_sales_zone_id';
					windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_member_address&is_comp=0&is_select=2&keyword='+encodeURIComponent(form_basket.member_name.value)+''+ str_adrlink , 'list');
					return true;
				}
				else if(adress_type==2)
				{
