		...
		<cfoutput>
			...
			<div class="col col-3 col-md-4 col-sm-12" type="column" index="3" sort="true">
				<div class="form-group require" id="item-order_date">
					...
					<div class="col col-8 col-sm-12">
						<div class="input-group">
							<cfinput type="text" name="order_date" value="#dateformat(get_order_detail.order_date,dateformat_style)#" validate="#validate_style#" required="yes" message="#getLang('','Sipariş Tarihi Girmelisiniz',38654)# !" maxlength="10">
				...
				<div class="form-group require" id="item-ship_date">
					...
					<div class="col col-8 col-sm-12">
						<div class="input-group">
							<cfinput type="text" name="ship_date" value="#dateformat(get_order_detail.ship_date,dateformat_style)#" validate="#validate_style#" message="#getLang('','Sevk Tarihi Girmelisiniz',40895)# !" maxlength="10">
				...
				<div class="form-group require" id="item-deliverdate">
					...
					<div class="col col-8 col-sm-12">
						<div class="input-group">
							<cfinput type="text" name="deliverdate" value="#dateformat(get_order_detail.deliverdate,dateformat_style)#" validate="#validate_style#" maxlength="10" onblur="apply_deliver_date('deliverdate');">
			...
			<div class="col col-3 col-md-4 col-sm-12" type="column" index="4" sort="true">
				...
				<div class="form-group require" id="item-basket_due_value">
					...
					<div class="col col-5 col-sm-6 col-xs-12">
						<div class="input-group">
							<cfif xml_sales_delivery_date_calculated eq 0>
								<cfinput type="text" name="basket_due_value_date_" value="#dateformat(get_order_detail.due_date,dateformat_style)#" onChange="change_paper_duedate('order_date',1);" validate="#validate_style#" message="#getLang('','Vade Tarihi Girmelisiniz',33993)#" maxlength="10" readonly>
								<span class="input-group-addon"><cf_wrk_date_image date_field="basket_due_value_date_"></span>
							<cfelse>
								<cfinput type="text" name="basket_due_value_date_" value="#dateformat(get_order_detail.due_date,dateformat_style)#" onChange="change_paper_duedate('deliverdate',1);" validate="#validate_style#" message="#getLang('','Vade Tarihi Girmelisiniz',33993)#" maxlength="10" readonly>
								<span class="input-group-addon"><cf_wrk_date_image date_field="basket_due_value_date_" ></span>
							</cfif>
						</div>
					</div>
	...
	<cf_box_footer>
		...
		<div class="col col-4 col-xs-12">
					...
					<cfelse>
						<cf_workcube_buttons 
							is_upd = '1' 
							del_action= '/V16/sales/cfc/OrderSaleAction:del_order:order_id=#order_id#'
							del_next_page = '#request.self#?fuseaction=#attributes.fuseaction#'
							add_function = 'kontrol()'
							data_action = '/V16/sales/cfc/OrderSaleAction:upd_order'
							next_page = '#request.self#?fuseaction=#attributes.fuseaction#&event=upd&order_id=#order_id#'
						>
					</cfif>
		</div>
	</cf_box_footer>
	...
	function fill_country(member_id,type)
	{
			...
			if(type == 1)
			{
				<cfif isdefined("xml_emp_branch_adress") and xml_emp_branch_adress eq 1>
					var sql = "SELECT COUNTRY,'' SALES_COUNTY FROM COMPANY_PARTNER WHERE PARTNER_ID = " + member_id;
				<cfelse>
