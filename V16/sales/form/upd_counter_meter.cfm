            ...
            <cf_box_elements>
                <div class="col col-4 col-md-6 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="form-group" id="item-action_date">
                        ...
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                <input type="text" name="action_date" id="action_date" maxlength="10" value="<cfoutput>#dateformat(now(),dateformat_style)#</cfoutput>" validate="<cfoutput>#validate_style#</cfoutput>" required="yes" message="<cfoutput>#getLang('','İşlem Tarihi Girmelisiniz',57906)#</cfoutput>">
