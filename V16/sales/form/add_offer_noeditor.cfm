...
function calc_deliver_date()
{
	...
	if(row_c != 0)
	{
		...
		AjaxPageLoad(<cfoutput>'#request.self#?fuseaction=objects.popup_ajax_deliver_date_calc&offer_date='+document.getElementById('offer_date').value+'&stock_id_list='+stock_id_list+''</cfoutput>,'deliver_date_info',1,"<cf_get_lang dictionary_id ='41164.Teslim Tarihi Hesaplanıyor'>");
	}
	else
