...
<cfif xml_show_counter>
    ...
    <cf_box 
        add_href="openBoxDraggable('#request.self#?fuseaction=sales.counter&event=add&subscription_id=#attributes.subscription_id#&subscription_no=#get_subscription.subscription_no#','','ui-draggable-box-large')" 
...
<cfif ListContains(http.host,"pronet",".")><!--- add_options include function ı yapılana kadar geçici pronete belirli ürünlerle ilgili toplamlar gelsin diye yapıldı..Aysenur20070719 --->
