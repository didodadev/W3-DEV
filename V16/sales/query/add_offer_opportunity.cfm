...
<cfquery name="select_opp_off" datasource="#DSN3#">
	select WRK_ROW_ID,WRK_ROW_RELATION_ID,QUANTITY from workcube_dev_1.OFFER O ,workcube_dev_1.OFFER_ROW OP WHERE O.OFFER_ID = OP.OFFER_ID AND OP.OFFER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.offer_id#"> GROUP BY WRK_ROW_ID,WRK_ROW_RELATION_ID,QUANTITY
</cfquery>
<cfscript>
                    add_relation_rows(
                        action_type:'add',
