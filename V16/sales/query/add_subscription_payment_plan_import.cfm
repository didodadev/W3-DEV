<cfif isDefined("attributes.uploaded_file") and len(attributes.uploaded_file)>
		...
		<cfif listfind(blackList,assetTypeName,',')>
			<cffile action="delete" file="#upload_folder##file_name#.#cffile.serverfileext#" filefield="xlsfile">
...
<cfif result.actionResult>
	<cf_workcube_process 
		...
		warning_description = 'Abonelik Ödeme Planı Aktarım : #attributes.IMPORT_NAME#'>
<!--- <script type="text/javascript">
