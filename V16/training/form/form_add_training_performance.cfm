...
<table width="98%" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" cellspacing="1" cellpadding="2">
    <tr class="color-row">
      <td height="22" class="txtboldblue"><cf_get_lang no ='191.Bu değerlendirme formu, eğitimi değerlendirecek eğitime katılanlar tarafından yapılacaktır'>.</td>
    </tr>
    <tr>
      <td class="color-row">
      <table>
        <tr>
			<td width="100" class="txtbold"><cf_get_lang no ='192.Değerlendiren'> *</td>
			<td width="185">
		...
		<tr>
			<td class="txtbold"><cf_get_lang no ='142.Değerlendirme Tarihi'> *</td>
			<td>
				<cfsavecontent variable="message"><cf_get_lang_main no='782.girilmesi zorunlu alan'>:<cf_get_lang no ='142.değerlendirme tarihi'>!</cfsavecontent>
