...
<div class="protein-table training_items">
    <table style="table-layout: fixed;">
        ...
        <div style="display:none" class="ui-cfmodal ui-cfmodal__alert">
            ...
            <cfoutput query="get_training_class_group" group="TRAIN_GROUP_ID" maxrows="1">
                <cfset get_training_group_subjects = tg_cfc.get_training_group_subjects(train_group_id: get_training_class_group.train_group_id)>
                <cfloop query="get_training_group_subjects" group="TRAIN_ID">
                    ...
                    <cfif get_training_subject_quizs.recordcount>
                        <cfloop query="get_training_subject_quizs" group="QUIZ_TRAINING_SUBJECTS">
                            <tr>
