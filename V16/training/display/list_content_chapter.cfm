...
<cfif isDefined('session.ep.userid')>
	<cfset f_category = "training.content">
	<cfset f_chapter = "training.content">
<cfelse>
...
<cfoutput query="get_lit_names">
	<li><i class="fa fa-arrow-right"></i><a href="javascript://">#contentcat#</a></li>  
	...
	<ul class="submenu">
		<cfloop query="get_chapter_">
			<li><i class="fa fa-chevron-right"></i>
				<a href="#request.self#?fuseaction=#f_chapter#&chapter=#chapter_id#&cont_catid=#contentcat_id#">#chapter#</a>
			</li>
		</cfloop>	
	</ul>	
</cfoutput>
