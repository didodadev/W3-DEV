<cfif not isDefined("attributes.temp_dsn")><cfset attributes.temp_dsn = dsn2></cfif>
<cfscript>
	...
	if(len(attributes.interest_expense) and len(attributes.interest_expense_id) and attributes.interest_price gt 0)
	{
		butceci(
			action_id : attributes.credit_contract_payment_id,
			muhasebe_db : attributes.temp_dsn,
