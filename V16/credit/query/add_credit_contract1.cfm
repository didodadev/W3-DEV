...
<cfscript>
	...
	genel_fis_satir_detay = '#attributes.company# #full_paper_no# FİNANSAL KİRALAMA SÖZLEŞMESİ';
	...
	for(j=1;j lte attributes.payment_record_num;j=j+1)
	{
		if (isdefined("attributes.payment_row_kontrol#j#") and evaluate("attributes.payment_row_kontrol#j#"))
		{
			...
			str_borc_kod_list = ListAppend(str_borc_kod_list,'#evaluate("attributes.borrow_id#j#")#',",");
