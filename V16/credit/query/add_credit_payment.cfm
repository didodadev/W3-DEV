...
<cfquery name="GET_ACCOUNTS" datasource="#dsn3#">
	...
	FROM 
		ACCOUNTS 
	WHERE 
		ACCOUNT_ID = #listfirst(action_from_account_id,';')#
</cfquery>
<cfscript>
...
<cflock name="#createUUID()#" timeout="20">
	<cftransaction>
		...
		<cfquery name="ADD_BANK_ACTION" datasource="#dsn2#">
			...
			VALUES
				(
                	<cfif len(attributes.action_from_account_branch)>#attributes.action_from_account_branch#<cfelse>NULL</cfif>,
					'KREDİ ÖDEMESİ',
					#form.process_cat#,
					#process_type#,
					#action_from_account_id#,
					...
					#total_tax_price+total_expense_price#,
					#other_total_tax_price+other_total_expense_price#,
		...
		<cfquery name="ADD_CREDIT_PAYMENT" datasource="#DSN2#">
			INSERT INTO
				...
				(
					...
					<cfif len(attributes.capital_price)>#attributes.capital_price#<cfelse>0</cfif>,
		...
		<cfquery name="UPD_CREDIT_CONTRACT_ROW" datasource="#DSN2#">
			...
			(
				...
				TOTAL_PRICE,
				OTHER_MONEY,						
				IS_PAID,<!--- (ödenmiş veya tahsil edilmiş) sözleşme satırları  --->
				OUR_COMPANY_ID,
				PERIOD_ID,
				PROCESS_TYPE,
				ACTION_ID
		...
		<cfif len(paper_number)>
			...
			<cfquery name="UPD_GEN_PAP" datasource="#DSN2#">
				...
				SET
					CREDIT_PAYMENT_NUMBER = <cfqueryparam cfsqltype="cf_sql_integer" value="#paper_number#">
				WHERE
					CREDIT_PAYMENT_NUMBER IS NOT NULL
			</cfquery>
		</cfif>
