<cf_xml_page_edit fuseact="credit.securities_list_interest">
    ...
    <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <cf_box_search_detail>
                    ...
                    <div class="col col-4 col-md-4 col-sm-4 col-xs-12" type="column" index="3" sort="true" >
                        <div class="form-group" id="item-date2">
                            <label class="col col-12"><cf_get_lang dictionary_id='59787.Reeskont Değerleme Tarihi'></label>
                            <div class="col col-12">
                                <div class="input-group">
        ...
        <cfsavecontent variable="title"><cf_get_lang dictionary_id='59786.Menkul Kıymet Getiri Listesi'></cfsavecontent>
        <cf_box hide_table_column="1" uidrop="1" title="#title#">
            ...
            <cf_grid_list>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="header_icn_none text-center" style="width:20px;">
                            <i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464.Güncelle'>" alt="<cf_get_lang dictionary_id='57464.Güncelle'>"></i></i>
                        </th>
                        <th class="header_icn_none text-center" style="width:20px;">
                ...
                <tbody>
                    <cfif GET_YIELD_PLAN_ROWS.recordcount>
                        <cfoutput query="GET_YIELD_PLAN_ROWS" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                            <tr>
                                ...
                                <td>
                                    <cfif IS_PAYMENT EQ 1><i class="fa fa-bookmark" style="color:green;cursor:pointer;font-size:12px;" title="<cf_get_lang dictionary_id='49834.Tahsil Edilmiştir'>"></i><cfelse><i class="fa fa-bookmark" title="<cf_get_lang dictionary_id='59173.Tahsil Edilmedi'>" style="color:red;font-size:12px;"></i></cfif>
                                </td>
                                <td>
                                    <cfif len(attributes.current_value_date)>
                    ...
                    <cfelse>
                        <td colspan="18"><cfif attributes.is_form_submitted neq 1><cf_get_lang dictionary_id='57701.Filtre Ediniz'><cfelse><cf_get_lang dictionary_id='57484.Kayıt Yok'></cfif>!</td>
                    </cfif>
                </tbody>
                <cfif len(attributes.current_value_date)>
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="22" rowspan="3" style="text-align:right;">
                                <cfif xml_is_budget_income_cost eq 1>
                                    <input type="button" name="income_cost" id="income_cost" value="<cf_get_lang dictionary_id='59838.Gelir İşlemi Yap'>" onClick="CreateBudgetPlan(1);">
                                </cfif>
                                <cfif xml_is_create_budget_plan eq 1>
                                    <input type="button" name="budget_plan_rec" id="budget_plan_rec" value="<cf_get_lang dictionary_id='59839.Gelir ve Gelir Planlama Fişi Oluştur'>" onClick="CreateBudgetPlan(2);">
                                </cfif>
                            </td>
                        </tr>
                    </cfif>
