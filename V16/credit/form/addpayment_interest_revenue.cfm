...
<cfparam name="reeskont_values" default="">
...
<cfquery name="GET_PAYMENT_ROW" datasource="#dsn3#">
    SELECT
        *
    FROM
        STOCKBONDS_YIELD_PLAN_ROWS SYPR
        RIGHT JOIN STOCKBONDS AS ST ON ST.STOCKBOND_ID = SYPR.STOCKBOND_ID
        LEFT JOIN STOCKBONDS_SALEPURCHASE_ROW AS SSR ON SSR.STOCKBOND_ID = ST.STOCKBOND_ID 
        LEFT JOIN STOCKBONDS_SALEPURCHASE AS SS ON SS.ACTION_ID = SSR.SALES_PURCHASE_ID
    WHERE 
...
<cfquery name="get_acc_code_exp" datasource="#dsn2#">
    SELECT 
     ...
     FROM 
        EXPENSE_ITEMS 
    WHERE 
        EXPENSE_ITEM_ID = '#GET_PAYMENT_ROW.ROW_EXP_ITEM_ID#'
</cfquery>

<cfif isdefined("attributes.stockbond_id") and len(attributes.stockbond_id)> 
    <cfquery name="get_rows" datasource="#dsn3#">
        SELECT YIELD_PLAN_ROWS_ID FROM STOCKBONDS_YIELD_PLAN_ROWS WHERE STOCKBOND_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.stockbond_id#">
   </cfquery> 
...
<cfset pagehead="#getLang('','Menkul Kıymet Getiri Hesaba Geçiş',40997)#">
<cf_catalystHeader>
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cf_box>
        <cfform name="add_interest_revenue" method="post" action="">
            <input type="hidden" name="active_period" id="active_period" value="<cfoutput>#session.ep.company_id#</cfoutput>">
            ...
            <cf_box_elements>
                <div class="col col-4 col-md-5 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="form-group" id="item-paper_number">
                        ...
                        <div class="col col-7 col-xs-12">
                            <input type="text" name="paper_number" readonly="readonly" value="<cfif len(paper_code)><cfoutput>#paper_code & '-' & paper_number#</cfoutput></cfif>"  maxlength="50">
                        </div>
                    </div>
                    <div class="form-group" id="item-ACTION_DATE">
                        ...
                        <div class="col col-7 col-xs-12">
                            <div class="input-group">
                                <cfinput type="text" name="ACTION_DATE" required="yes" value="#dateformat(now(),dateformat_style)#" message="#getLang('','Hesaba Geçiş Tarihi Giriniz!',56313)#">
                    ...
                    <div class="form-group" id="item-to_account_id">
                        ...
                        <div class="col col-7 col-xs-12">
                            <input type="checkbox" name="yield_to_bank" id="yield_to_bank" onclick="showPrincipals()" value="1">
                        </div> 
                    </div>
                    <div class="form-group" id="item-from_account_id" style="display:none;">
                    ...
                    <div class="form-group" id="item-expense_item_id">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58234.Bütçe Kalemi'> <cf_get_lang dictionary_id='57845.Tahsilat'>* </label>
                        <div class="col col-7 col-xs-12">
                            <cf_wrkExpenseItem width_info="150" fieldId="expense_item_id" fieldName="expense_item_name" form_name="add_interest_revenue" income_type_info="1" expense_item_id="#GET_PAYMENT_ROW.ROW_EXP_TAHAKKUK_ITEM_ID#" img_info="plus_thin">
                        </div> 
                    </div>
                    ...
                    <div class="form-group" id="item-OTHER_CASH_ACT_VALUE">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="OTHER_CASH_ACT_VALUE" value="" readonly style="width:150px;" class="moneybox" onBlur="kur_ekle_f_hesapla('from_account_id',true);" onkeyup="return(FormatCurrency(this,event));">
                        </div> 
                    </div>
                    <div class="form-group" id="item-stopaj_rate">
                        ...
                        <div class="col col-7 col-xs-12">
                            <div class="input-group">
                                <cfinput type="hidden" name="field_stoppage_rate_id" id="field_stoppage_rate_id">
                                <cfinput type="text" name="stopaj_rate" id="stopaj_rate" value="" required="yes" class="moneybox" onkeyup="totalStopaj();return(FormatCurrency(this,event));">
                    ...
                    <div class="form-group" id="item-stopaj_total">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="stopaj_total" id="stopaj_total" value="#TLformat(0,2)#" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));">
                        </div> 
                    </div> 
                    <cfif xml_net_or_brut neq 1>
                        <div class="form-group" id="item-com_exp_center_id">
                            <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='50038.Stopaj Tutarı'><cf_get_lang dictionary_id='58460.Masraf Merkezi'> *</label>
                            <div class="col col-7 col-xs-12">
                                <cf_wrkExpenseCenter fieldId="stoppage_expense_center_id" fieldName="stoppage_expense_center_name" form_name="add_interest_revenue" expense_center_id="" img_info="plus_thin">
                            </div>
                        </div>
                        <div class="form-group" id="item-stoppage_exp_item_id">
                            <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='50038.Stopaj Tutarı'><cf_get_lang dictionary_id ='58551.Gider Kalemi'> *</label>
                            <div class="col col-7 col-xs-12">
                                <cf_wrkExpenseItem fieldId="stoppage_expense_item_id" fieldName="stoppage_expense_item_name" form_name="add_interest_revenue" income_type_info="0" expense_item_id="" img_info="plus_thin">
                            </div>
                        </div>
                    </cfif>
                    <div class="form-group" id="item-net_total">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="net_total" value="" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));" >
                        </div> 
                    </div>
                ...
                <div class="col col-4 col-md-5 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                    ...
                    <div class="form-group" id="item-commision_rate">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="commision_rate" id="commision_rate" value="" class="moneybox" onblur="comHesapla('rate')" onkeyup="return(FormatCurrency(this,event));">
                        </div> 
                    </div> 
                    <div class="form-group" id="item-stopaj_total">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='40325.Komisyon Tutari'></label>
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="commision_amount" id="commision_amount" value="" class="moneybox" onblur="comHesapla('amount')" onkeyup="return(FormatCurrency(this,event));">
                        </div> 
                    </div> 
                    <div class="form-group" id="item-com_exp_center_id">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58791.Komisyon'><cf_get_lang dictionary_id='58460.Masraf Merkezi'></label>
                        <div class="col col-7 col-xs-12">
                            <cf_wrkExpenseCenter fieldId="com_exp_center_id" fieldName="com_exp_center" form_name="add_interest_revenue" expense_center_id="" img_info="plus_thin">
                        </div>
                    </div>
                    <div class="form-group" id="item-com_exp_item_id">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='58791.Komisyon'><cf_get_lang dictionary_id ='58551.Gider Kalemi'></label>
                        <div class="col col-7 col-xs-12">
                        <cf_wrkExpenseItem fieldId="com_exp_item_id" fieldName="com_exp_item_name" form_name="add_interest_revenue" income_type_info="0" expense_item_id="" img_info="plus_thin">
                        </div>
                    </div>
                </div>
            </cf_box_elements>
    ...
    <script>
        ...
        {
            windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_expense_center&is_invoice=1&field_id=add_interest_revenue.expense_center_id&field_name=add_interest_revenue.expense_center','list');
        }
