...
<cfset str_linke_ait="&field_comp_id=upd_credit_revenue.company_id&field_partner=upd_credit_revenue.partner_id&field_comp_name=upd_credit_revenue.company&field_name=upd_credit_revenue.partner&select_list=2">
<cf_papers paper_type="credit_revenue">
<cf_catalystHeader>
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cfform name="upd_credit_revenue">
		<cf_box>
			...
			<input type="hidden" name="temp_year" id="temp_year" value="<cfoutput>#get_period.period_year#</cfoutput>">
					...
					<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
						<div class="form-group" id="item-process_cat">
							...
							<div class="col col-8 col-xs-12">
								<cf_workcube_process_cat process_type_info="292" process_cat=#get_credit_contract_payment.process_cat#>
							</div>
						</div>
						...
						<div class="form-group" id="item-partner">
							...
							<div class="col col-8 col-xs-12">
								<cfif len(get_credit_contract_payment.company_id)>
									<input type="hidden" name="partner_id" id="partner_id" value="<cfoutput>#get_credit_contract_payment.company_id#</cfoutput>">
									<input type="text" name="partner" id="partner" value="<cfif len(get_credit_contract_payment.partner_id)><cfoutput>#get_par_info(get_credit_contract_payment.partner_id ,0,-1,0)#</cfoutput></cfif>" readonly style="width:285px;">
								<cfelse>
									<input type="hidden" name="partner_id" id="partner_id" value="">
									<input type="text" name="partner" id="partner" value="" readonly style="width:285px;">
								</cfif>	
							</div>
						</div>
						...
						<div class="form-group" id="item-payment_date">
							...
							<div class="col col-8 col-xs-12">
								<cfsavecontent variable="message"><cf_get_lang_main no='1080.Tarihi Kontrol Ediniz'>:<cf_get_lang_main no='427.Kredi Tahsilati'>!</cfsavecontent>
								<div class="input-group">
									<cfinput type="text" name="revenue_date" id="revenue_date" value="#dateformat(get_credit_contract_payment.process_date,dateformat_style)#" required="yes" validate="#validate_style#" message="#message#" maxlength="10" onblur="change_money_info('upd_credit_revenue','revenue_date');">
					...
					<div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="false">
						...
						<div class="form-group">
							<div class="col col-12 scrollContent scroll-x2">
								<cfscript>f_kur_ekle(action_id:get_credit_contract_payment.credit_contract_payment_id,call_function:'write_total_amount',process_type:1,base_value:'cash_action_value',other_money_value:'other_cash_act_value',form_name:'upd_credit_revenue',action_table_name:'CREDIT_CONTRACT_PAYMENT_INCOME_MONEY',action_table_dsn:'#temp_dsn#',select_input:'action_from_account_id',selected_money='#credit_contract_money.MONEY_TYPE#',is_disable='1');</cfscript>
							</div>
						</div>
					</div>
				</div>
			...
			<cf_grid_list>
				...
				<tbody>
					<tr>
						...
						<td>
							<div class="form-group">
								<input type="text" name="capital_price" id="capital_price" value="<cfoutput>#TlFormat(get_credit_contract_payment.capital_price)#</cfoutput>" onkeyup="return(FormatCurrency(this,event));" onblur="write_total_amount(1);kur_ekle_f_hesapla('action_from_account_id');" class="moneybox">
							</div>
						</td>
						<td>
							<div class="form-group">
						...
						<td>
							<div class="form-group">
								<div class="input-group">
									<cfif isdefined ("get_credit_contract_payment.CAPITAL_EXPENSE_ITEM_ID_ACC") and  len(get_credit_contract_payment.CAPITAL_EXPENSE_ITEM_ID_ACC)>
										<input type="hidden" name="debt_account_id" id="debt_account_id" value="<cfoutput>#get_credit_contract_payment.CAPITAL_EXPENSE_ITEM_ID_ACC#</cfoutput>">
										<cfinput type="text" name="debt_account_code" id="debt_account_code" value="#get_credit_contract_payment.CAPITAL_EXPENSE_ITEM_ID_ACC#" onFocus="AutoComplete_Create('debt_account_code','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id','upd_credit_revenue','3','140');" autocomplete="off">
									<cfelse>
										<input type="hidden" name="debt_account_id" id="debt_account_id" value="">
										<cfinput type="text" name="debt_account_code" id="debt_account_code" value="" onFocus="AutoComplete_Create('debt_account_code','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id','upd_credit_revenue','3','140');" autocomplete="off">
									</cfif>
									<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_account_plan&field_id=upd_credit_revenue.debt_account_id&field_name=upd_credit_revenue.debt_account_code','list');"></span>
								</div>	
							</div>
						</td>
						<td>
								...
								<cfif is_capital_budget_act neq 0>
									<div class="input-group">
										<cfif len(get_credit_contract_payment.capital_expense_item_id)>
											...
											<cfinput type="text" name="capital_expense" id="capital_expense" value="#get_expense_capital.expense_item_name#" onFocus="AutoComplete_Create('capital_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','capital_expense_id,debt_account_code,debt_account_id','upd_credit_revenue',3);" autocomplete="off">
										<cfelse>
											<input type="hidden" name="capital_expense_id" id="capital_expense_id" value="">
											<cfinput type="text" name="capital_expense" id="capital_expense" value="" onFocus="AutoComplete_Create('capital_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','capital_expense_id,debt_account_code,debt_account_id','upd_credit_revenue',3);" autocomplete="off">
										</cfif>
										<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_exp_item&field_id=upd_credit_revenue.capital_expense_id&field_name=upd_credit_revenue.capital_expense&is_income=1&field_account_no=upd_credit_revenue.debt_account_id&field_account_no2=upd_credit_revenue.debt_account_code','list');"></span>
									</div>
								</cfif>
							</div>
						</td>
					...
					<tr>
						...
						<td>
							<div class="form-group">
								<input type="text" name="interest_price" id="interest_price" value="<cfoutput>#TlFormat(get_credit_contract_payment.interest_price)#</cfoutput>" onkeyup="return(FormatCurrency(this,event));" onblur="write_total_amount(1);kur_ekle_f_hesapla('action_from_account_id');" class="moneybox">
							</div>
						</td>
						<td>
							<div class="form-group">
						...
						<td>
							<div class="form-group">
								<div class="input-group">
									<cfif isdefined("get_credit_contract_payment.INTEREST_EXPENSE_ITEM_ID_ACC") and len(get_credit_contract_payment.INTEREST_EXPENSE_ITEM_ID_ACC)>
										<input type="hidden" name="debt_account_id2" id="debt_account_id2" value="<cfoutput>#get_credit_contract_payment.INTEREST_EXPENSE_ITEM_ID_ACC#</cfoutput>">
										<cfinput type="text" name="debt_account_code2" id="debt_account_code2" value="#get_credit_contract_payment.INTEREST_EXPENSE_ITEM_ID_ACC#" onFocus="AutoComplete_Create('debt_account_code2','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id2','upd_credit_revenue','3','140');" autocomplete="off">
									<cfelse>
										<input type="hidden" name="debt_account_id2" id="debt_account_id2" value="">
										<cfinput type="text" name="debt_account_code2" id="debt_account_code2" value="" onFocus="AutoComplete_Create('debt_account_code2','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id2','upd_credit_revenue','3','140');" autocomplete="off">
									</cfif>
									<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_account_plan&field_id=upd_credit_revenue.debt_account_id2&field_name=upd_credit_revenue.debt_account_code2','list');"></span>
								</div>
							</div>	
						</td>
						<td> 
							<div class="form-group">
								<div class="input-group">
									<cfif len(get_credit_contract_payment.interest_expense_item_id)>
										...
										<cfinput type="text" name="interest_expense" id="interest_expense" value="#get_expense_interest.expense_item_name#" onFocus="AutoComplete_Create('interest_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','interest_expense_id,debt_account_code2,debt_account_id2','upd_credit_revenue',3);" autocomplete="off">
									<cfelse>
										<input type="hidden" name="interest_expense_id" id="interest_expense_id" value="">
										<cfinput type="text" name="interest_expense" id="interest_expense" value="" onFocus="AutoComplete_Create('interest_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','interest_expense_id,debt_account_code2,debt_account_id2','upd_credit_revenue',3);" autocomplete="off">
									</cfif>
									<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_exp_item&field_id=upd_credit_revenue.interest_expense_id&field_name=upd_credit_revenue.interest_expense&is_income=1&field_account_no=upd_credit_revenue.debt_account_id2&field_account_no2=upd_credit_revenue.debt_account_code2','list');"></span>
								</div>   
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="form-group">
								<input type="text" name="delay_price" id="delay_price" value="<cfoutput>#TlFormat(get_credit_contract_payment.delay_price)#</cfoutput>" onkeyup="return(FormatCurrency(this,event));" onblur="write_total_amount(1);kur_ekle_f_hesapla('action_from_account_id');" class="moneybox">
							</div>
						</td>
						<td>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="input-group">
									<cfif isdefined("get_credit_contract_payment.DELAY_EXPENSE_ITEM_ID_ACC") and len(get_credit_contract_payment.DELAY_EXPENSE_ITEM_ID_ACC)>
										...
										<cfinput type="text" name="debt_account_code4" id="debt_account_code4" value="#get_credit_contract_payment.DELAY_EXPENSE_ITEM_ID_ACC#" onFocus="AutoComplete_Create('debt_account_code4','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id4','upd_credit_revenue','3','140');" autocomplete="off">
									<cfelse>
										<input type="hidden" name="debt_account_id4" id="debt_account_id4" value="">
										<cfinput type="text" name="debt_account_code4" id="debt_account_code4" value="" onFocus="AutoComplete_Create('debt_account_code4','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id4','upd_credit_revenue','3','140');" autocomplete="off">
									</cfif>
									<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_account_plan&field_id=upd_credit_revenue.debt_account_id4&field_name=upd_credit_revenue.debt_account_code4','list');"></span>
								</div>	
							</div>
						</td>
						<td>
							<div class="form-group">
								<div class="input-group">
									<cfif len(get_credit_contract_payment.delay_expense_item_id)>
										...
										<cfinput type="text" name="delay_expense" id="delay_expense" value="#get_expense_delay.expense_item_name#" onFocus="AutoComplete_Create('delay_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','delay_expense_id,debt_account_code4,debt_account_id4','upd_credit_revenue',3);" autocomplete="off">
									<cfelse>
										<input type="hidden" name="delay_expense_id" id="delay_expense_id" value="">
										<cfinput type="text" name="delay_expense" id="delay_expense" value="" onFocus="AutoComplete_Create('delay_expense','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','delay_expense_id,debt_account_code4,debt_account_id4','upd_credit_revenue',3);" autocomplete="off">
									</cfif>
									<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_exp_item&field_id=upd_credit_revenue.delay_expense_id&field_name=upd_credit_revenue.delay_expense&is_income=1&field_account_no=upd_credit_revenue.debt_account_id4&field_account_no2=upd_credit_revenue.debt_account_code4','list');"></span>
								</div>  
							</div>
						</td>
					</tr>
				...
				<tfoot>   
					<tr>
						...
						<td style="text-align:left;">
							<div class="form-group">
								<input type="text" name="cash_action_value" id="cash_action_value" value="<cfoutput>#TlFormat(get_credit_contract_payment.total_price)#</cfoutput>" onblur="kur_ekle_f_hesapla('action_from_account_id');" onkeyup="return(FormatCurrency(this,event));" class="moneybox" readonly>
							</div>
						</td>
						<td style="text-align:left;">
							<div class="form-group">
								<input type="text" name="other_cash_act_value" id="other_cash_act_value" value="<cfoutput>#TlFormat(get_credit_contract_payment.other_total_price)#</cfoutput>" onblur="kur_ekle_f_hesapla('action_from_account_id',true);" class="moneybox">
							...
							<tr id="frm_row#get_credit_contract_payment_tax.currentrow#">
								...
								<td>
									<div class="form-group">
										...
										<input type="text" name="tax_price_#get_credit_contract_payment_tax.currentrow#" id="tax_price_#get_credit_contract_payment_tax.currentrow#" value="#Tlformat(get_credit_contract_payment_tax.tax_price)#" onkeyup="return(FormatCurrency(this,event));" onblur="write_total_amount(1);kur_ekle_f_hesapla('action_from_account_id');" class="moneybox">
									</div>
								</td>
								<td>
									<div class="form-group">
						...
						<tr id="frm_row1">
							...
							<td>
								<div class="form-group">
									...
									<input type="text" name="tax_price_1" id="tax_price_1" value="<cfoutput>#Tlformat(0)#</cfoutput>" onkeyup="return(FormatCurrency(this,event));" onblur="write_total_amount(1);kur_ekle_f_hesapla('action_from_account_id');" class="moneybox">
								</div>
							</td>
							<td>
								<div class="form-group">
							...
							<td>
								<div class="form-group">
									<div class="input-group">
										...
										<cfinput type="text" name="debt_account_code3_1" id="debt_account_code3_1" value="" onFocus="AutoComplete_Create('debt_account_code3_1','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','ACCOUNT_CODE','debt_account_id3_1','upd_credit_revenue','3','140');" autocomplete="off">
										<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_account_plan&field_id=upd_credit_revenue.debt_account_id3_1&field_name=upd_credit_revenue.debt_account_code3_1','list');"></span>
									</div>
								</div>
							</td>
							<td>
								<div class="form-group">
									<div class="input-group">
										...
										<cfinput type="text" name="tax_expense_1" id="tax_expense_1" value="" onFocus="AutoComplete_Create('tax_expense_1','EXPENSE_ITEM_NAME','EXPENSE_ITEM_NAME','get_expense_item','','EXPENSE_ITEM_ID,ACCOUNT_CODE,ACCOUNT_CODE','tax_expense_id_1,debt_account_code3_1,debt_account_id3_1','upd_credit_revenue',3);" autocomplete="off">
										<span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_exp_item&field_id=upd_credit_revenue.tax_expense_id_1&field_name=upd_credit_revenue.tax_expense_1&field_account_no=upd_credit_revenue.debt_account_id3_1&field_account_no2=upd_credit_revenue.debt_account_code3_1','list');"></span>
									</div>
								</div>
							</td>
			...
			<cf_box_footer>
				...
				<cfif get_period.period_year eq session.ep.period_year>
					<cf_workcube_buttons is_upd='1' update_status='#get_credit_contract_payment.UPD_STATUS#' delete_page_url='#request.self#?fuseaction=credit.list_credit_contract&event=delPayment&credit_contract_payment_id=#get_credit_contract_payment.credit_contract_payment_id#&old_process_type=#get_credit_contract_payment.process_type#&bank_action_id=#get_credit_contract_payment.bank_action_id#&temp_dsn=#dsn#_#get_period.period_year#_#get_period.our_company_id#&period_id=#get_period.period_id#&company_id=#get_period.our_company_id#' del_function_for_submit="del_kontrol()" add_function='kontrol()'>
				<cfelse>
					<cf_workcube_buttons is_cancel='1' is_insert='0'>
				</cfif>
			</cf_box_footer>
		</cf_box>
	</cfform>
...
<script type="text/javascript">
	...
	function add_row()
	{
		...
		newCell = newRow.insertCell(newRow.cells.length);
		newCell.innerHTML = '<div class="input-group x-14"><input type="hidden" name="debt_account_id3_'+ row_count +'" id="debt_account_id3_'+ row_count +'" value=""><input type="text" style="width:140px;" name="debt_account_code3_'+ row_count +'" id="debt_account_code3_'+ row_count +'" value="" onFocus="auto_account('+ row_count +');">   <span class="input-group-addon icon-ellipsis btnPointer" onclick="pencere_ac_acc('+ row_count +');"></span></div>';
		newCell = newRow.insertCell(newRow.cells.length);
	...
	function kontrol()
	{
		...
		if(upd_credit_revenue.document_no != "")
		{
			if(!paper_control(upd_credit_revenue.document_no,'CREDIT_REVENUE','1',<cfoutput>'#get_credit_contract_payment.credit_contract_payment_id#'</cfoutput>,'','','','','<cfoutput>#dsn2#</cfoutput>')) return false;
		}
		if(upd_credit_revenue.document_no.value == "")
		{
	...
	function unformat_fields()
	{
		...
		document.upd_credit_revenue.capital_price_other.value = filterNum(document.upd_credit_revenue.capital_price_other.value,'<cfoutput>#session.ep.our_company_info.rate_round_num#</cfoutput>');
		document.upd_credit_revenue.interest_price_other.value = filterNum(document.upd_credit_revenue.interest_price_other.value,'<cfoutput>#session.ep.our_company_info.rate_round_num#</cfoutput>');
		document.upd_credit_revenue.delay_price_other.value = filterNum(document.upd_credit_revenue.delay_price_other.value,'<cfoutput>#session.ep.our_company_info.rate_round_num#</cfoutput>');
		for(r=1;r<=document.upd_credit_revenue.record_num.value;r++)
		{
			if(eval("document.upd_credit_revenue.row_kontrol"+r).value==1)
			{
				...
				if(eval('document.upd_credit_revenue.tax_price_other_'+r).value != "")
					eval('document.upd_credit_revenue.tax_price_other_'+r).value = filterNum(eval('document.upd_credit_revenue.tax_price_other_'+r).value,'<cfoutput>#session.ep.our_company_info.rate_round_num#</cfoutput>');
			}
		}
