...
<cfif GET_CARD_ID.recordcount>
	...
	<cfloop from="0" to="#pdf_sayisi#" index="k">
		...
		<table cellpadding="2" cellspacing="1" width="98%"  border="0" class="table">
			<tr>
				<td align="center" colspan="6"><big><strong><cf_get_lang dictionary_id='47363.YEVMİYE DEFTERİ'></strong></big></td>
			</tr>
			<tr>
			  <td nowrap>&nbsp;</td>
			...
			<cfoutput query="GET_CARD_ID" startrow="#start_row#" maxrows="#pdf_row_count#">
				...
				<cfset satir_sayisi = satir_sayisi + 1> <!--- fis satırı yazılacak,satır_sayisi arttırılıyor --->
					...
					<td align="right" style="text-align:right;">&nbsp;<cfif BA eq 0>#TLFormat(AMOUNT)#<cfset yevmiye_borc=yevmiye_borc+AMOUNT><cfset A_toplam = A_toplam + amount ></cfif></td>
					<td align="right" style="text-align:right;">&nbsp;<cfif BA eq 1>#TLFormat(AMOUNT)#<cfset yevmiye_alacak = yevmiye_alacak + AMOUNT><cfset B_toplam = B_toplam + amount></cfif></td>
				</tr>
				<cfif (satir_sayisi mod pdf_page_row) eq 1>
					<tr>
					<td>&nbsp;</td>
