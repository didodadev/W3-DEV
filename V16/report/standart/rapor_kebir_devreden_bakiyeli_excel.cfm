...
<cf_wrk_html_table cellpadding="2" cellspacing="1" border="0" width="98%" table_draw_type="1" filename="#filename#" is_auto_page_break="0" is_auto_sheet_break="0" font_size_1="#attributes.fontsize#" font_size_2="#attributes.bigfontsize#" font_style_1="#attributes.fontfamily#" font_style_2="#attributes.bigfontfamily#">
	<cf_wrk_html_tr>
		<cf_wrk_html_td align="center" colspan="9" class="headbold"><cf_get_lang dictionary_id ='39163.DEFTER-İ KEBİR'></cf_wrk_html_td>
	</cf_wrk_html_tr>
	<cfparam name="attributes.totalrecords" default="#get_account_id.recordcount#">
		<cfloop from="1" to="#attributes.totalrecords#" index="I">
			...
			<cfif get_acc_total.recordcount or get_account_card_rows.recordcount>
				...
				<cfif i neq 1 and (get_account_id.account_code[i] neq get_account_id.account_code[i-1])>
				...
				<cf_wrk_html_tr>
					...
					<cf_wrk_html_td colspan="9" class="txtbold" align="center">
						<cf_get_lang dictionary_id='39371.Ana Hesap Kodu'>:#get_account_id.account_code[i]#
						<cf_get_lang dictionary_id='39372.Ana Hesap Adı'>:<cfquery name="GET_ACCOUNT_NAME" dbtype="query">SELECT ACCOUNT_NAME FROM GET_ACCOUNT_NAME_ALL WHERE ACCOUNT_CODE = '#get_account_id.account_code[i]#'</cfquery>
				...
				<cf_wrk_html_tr>
					<cfset row_count = row_count+1>
					<cf_wrk_html_td width="60"><cf_get_lang dictionary_id='57742.Tarih'></cf_wrk_html_td>
					<cf_wrk_html_td width="50"><cf_get_lang dictionary_id='39373.Yev No'></cf_wrk_html_td>
					<cf_wrk_html_td width="70"><cfif attributes.acc_code_type eq 1><cf_get_lang dictionary_id='38848.UFRS Hesap Kodu'><cfelse><cf_get_lang dictionary_id='38889.Hesap Kodu'></cfif></cf_wrk_html_td>
					...
					<cf_wrk_html_td align="right" style="text-align:right;" width="90"><cf_get_lang dictionary_id='57587.Borç'></cf_wrk_html_td>
					<cf_wrk_html_td align="right" style="text-align:right;" width="120"><cf_get_lang dictionary_id='57588.Alacak'></cf_wrk_html_td>
					<cf_wrk_html_td align="right" style="text-align:right;"><cf_get_lang dictionary_id='57587.Borç'><cf_get_lang dictionary_id='57589.Bakiye'></cf_wrk_html_td>
					<cf_wrk_html_td align="right" style="text-align:right;" width="120"><cf_get_lang dictionary_id='57588.Alacak'><cf_get_lang dictionary_id='57589.Bakiye'></cf_wrk_html_td>
				</cf_wrk_html_tr>
				<cfscript>
					alacak_bakiye = 0;
					borc_bakiye = 0;
				...
				<cfif get_acc_total.recordcount><!--- hesabın, baslangıc tarihinden onceki doneme ait bakiyesi varsa --->
					<cf_wrk_html_tr>
						<cfset row_count = row_count+1>
						<cf_wrk_html_td colspan="5" align="center"><cf_get_lang dictionary_id='38878.Devreden Toplam'></cf_wrk_html_td>
						...
						<cf_wrk_html_td align="right" style="text-align:right;"><cfif devir_borc neq 0><cfset borc_bakiye = borc_bakiye + devir_borc><cfoutput>#TLFormat(devir_borc)#</cfoutput><cfelse></cfif></cf_wrk_html_td>
						<cf_wrk_html_td align="right" style="text-align:right;"><cfif devir_alacak neq 0><cfset alacak_bakiye = alacak_bakiye + devir_alacak><cfoutput>#TLFormat(devir_alacak)#</cfoutput><cfelse></cfif></cf_wrk_html_td>
