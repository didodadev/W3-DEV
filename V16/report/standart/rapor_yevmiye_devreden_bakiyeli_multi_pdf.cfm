...
<cfif GET_CARD_ID.recordcount>
	...
	<cfloop from="0" to="#pdf_sayisi#" index="index_pdf">
		...
		<th class="th">
			<td colspan="<cfif x_show_detail_info eq 1>8<cfelse>7</cfif>" align="center"><cf_get_lang dictionary_id='47363.YEVMİYE DEFTERİ'></td>
		</tr>
		<tr class="tr">
		  ...
		  <cfif isdefined("attributes.is_detail")>
			<td align="right" style="text-align:right;"><cf_get_lang dictionary_id='57629.Detay'></td>		  
		  <cfelse>
			<td></td>
		  </cfif>		  
		...
		<tr class="tr">
			<td>&nbsp;</td>
			<td colspan="<cfif x_show_detail_info eq 1>4<cfelse>3</cfif>"><cf_get_lang dictionary_id='57189.Devreden Toplam'></td>
		...
		<tr class="tr">
			...
			<cfoutput query="GET_CARD_ID" startrow="#start_row#" maxrows="#pdf_row_count#"> 
				...
				<cfif currentrow eq 1 or GET_CARD_ID.CARD_ID[currentrow] neq GET_CARD_ID.CARD_ID[currentrow-1]>
					...
					<tr class="tr">
						<td colspan="3"><cf_get_lang dictionary_id='45271.Fiş Tipi'> : #TYPE#&nbsp;&nbsp;&nbsp;<cf_get_lang dictionary_id='57946.Fiş No'> : #TYPE_NO#</td>
				...
				<cfif ((satir_sayisi mod pdf_page_row) eq 1) or ((satir_sayisi mod pdf_page_row) eq 2) or (GET_CARD_ID.currentrow eq GET_CARD_ID.recordcount) or (GET_CARD_ID.currentrow gte temp_pdf_row)>
						<tr class="tr">
							<td colspan="<cfif x_show_detail_info eq 1>5<cfelse>4</cfif>"><cf_get_lang dictionary_id='60797.Küm. Toplam'></td>
						...
						<cfif (GET_CARD_ID.currentrow neq GET_CARD_ID.recordcount) and (GET_CARD_ID.currentrow lt temp_pdf_row)>
							...
							<tr class="tr">
								<td colspan="<cfif x_show_detail_info eq 1>5<cfelse>4</cfif>"><cf_get_lang dictionary_id='60797.Devreden Küm. Toplam'></td>
								<td align="right" style="text-align:right;">#TLFormat(yevmiye_borc)#&nbsp;</td>
								<td align="right" style="text-align:right;">#TLFormat(yevmiye_alacak)#&nbsp;</td>
							</tr>
							<cfset satir_sayisi = satir_sayisi + 2>			
				...
				<tr class="tr">
					...
					<cfif x_show_detail_info eq 1><td>&nbsp;</td></cfif>
				...
				<cfif x_show_voucher_total eq 1>
					...
					<cfif GET_CARD_ID.CARD_TYPE_NO[currentrow] neq GET_CARD_ID.CARD_TYPE_NO[currentrow+1]>
						<tr class="tr">
							<td colspan="3">&nbsp;</td>
							<td>-----#GET_CARD_ID.CARD_TYPE_NO# NOLU #TYPE# FİŞİNDEN-----</td>
							<td>&nbsp;</td>
							<td align="right" style="text-align:right;">#TLFormat(fis_toplami_borc)#</td>
							<td align="right" style="text-align:right;">#TLFormat(fis_toplami_alacak)#</td>
						</tr>
						<cfset satir_sayisi = satir_sayisi + 1>
						<cfset fis_toplami_borc = 0>
						<cfset fis_toplami_alacak = 0>
