		...
		<cf_wrk_html_table cellpadding="2" cellspacing="1" width="98%"  border="0" class="table" table_draw_type="1" filename="#filename#" is_auto_page_break="0" is_auto_sheet_break="0" font_size_1="#attributes.fontsize#" font_size_2="#attributes.bigfontsize#" font_style_1="#attributes.fontfamily#" font_style_2="#attributes.bigfontfamily#">
			...
			<cfoutput query="GET_CARD_ID">
				...
				<cfset satir_sayisi = satir_sayisi + 1> <!--- fis satırı yazılacak,satır_sayisi arttırılıyor --->
					...
					<cf_wrk_html_td align="right"> <cfif BA eq 0>#TLFormat(AMOUNT)#<cfset yevmiye_borc=yevmiye_borc+AMOUNT><cfset A_toplam = A_toplam + amount ></cfif></cf_wrk_html_td>
					<cf_wrk_html_td align="right"> <cfif BA eq 1>#TLFormat(AMOUNT)#<cfset yevmiye_alacak = yevmiye_alacak + AMOUNT><cfset B_toplam = B_toplam + amount></cfif></cf_wrk_html_td>
				</cf_wrk_html_tr>
			...
			<cfif GET_CARD_ID.CARD_ID[currentrow] neq GET_CARD_ID.CARD_ID[currentrow+1]>
				<cfset satir_sayisi = satir_sayisi + 1>
				<cf_wrk_html_tr>
				  <cf_wrk_html_td colspan="4"><cf_get_lang_main no='80.Toplam'>:</cf_wrk_html_td>
				  <cf_wrk_html_td align="right">#TLFormat(A_toplam)#</cf_wrk_html_td>
				  <cf_wrk_html_td align="right">#TLFormat(B_toplam)#</cf_wrk_html_td>
				</cf_wrk_html_tr>
				<cfset A_toplam =0>
