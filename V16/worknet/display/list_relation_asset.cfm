		...
		<cfoutput query="getRelationAsset">
			<tr>
				...
				<td style="float:right;">
					<a href="javascript://"
					 onClick="AjaxPageLoad('#request.self#?fuseaction=worknet.form_relation_asset&asset_id=#asset_id#&asset_cat_id=#assetcat_id#&action_id=#attributes.action_id#&action_section=#attributes.action_section#','body_relation_assets',1,'Loading..')">
