    ...
    <tbody>
		<cfif get_company_branch.recordcount>
           <cfoutput query="get_company_branch">
            <tr>
                <td><a href="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_upd_branch&brid=#get_company_branch.compbranch_id#&cpid=#url.cpid#" class="tableyazi">#compbranch__name#</a></td>
                <td>#county_name#</td>
                <td>#city_name#</td>
                <td>#country_name#</td>
                <td>
