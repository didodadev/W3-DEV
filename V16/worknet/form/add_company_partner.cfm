...
<table border="0" width="98%" class="headbold" cellpadding="0" cellspacing="0" align="center">
	<cfoutput>
		<input type="hidden" name="company_id" id="company_id" value="#attributes.compid#">
	</cfoutput>
  	<tr>
		<td height="35">
			<cf_get_lang no='52.Kişi Ekle'>:
			<cfif getCompany.company_id is attributes.compid><cfoutput><a href="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.detail_company&cpid=#attributes.compid#">#getCompany.fullname#</a></cfoutput></cfif>
		</td>
	</tr>
</table>
<table cellpadding="2" cellspacing="1" border="0" width="98%" align="center">
	<tr>
		<td>
			<cf_box id="add_partner_1" closable="0" collapsable="0">
			<table>
				<tr>
				...
				<tr>
					...
					<td style="width:175px;">
						...
						<cfinput type="text" name="name" id="name" required="yes" message="#message#" maxlength="20" style="width:150px;">
					</td>
				...
				<tr>
					...
					<td><cfinput type="text" name="birthdate" id="birthdate" maxlength="10" validate="#validate_style#" style="width:65px;" tabindex="5">
				...
				<tr>
					...
					<td><select name="mission" id="mission" style="width:155px;">
				...
				<tr>
					...
					<td><input type="text" name="username" id="username" maxlength="50" style="width:150px;"></td>
				...
				<tr>
					...
					<td><input type="file" name="photo" id="photo" style="width:155px;"></td>
				</tr>
			</table>
			</cf_box>
			<cf_box id="add_partner_2" closable="0" collapsable="0">
			<table>
				<tr>
					<td class="txtboldblue" colspan="4" height="20"><cf_get_lang_main no='731.İletişim'></td>
				</tr>
				<tr> 
					<td valign="baseline"><cf_get_lang_main no='41.Şube'></td>
					<td valign="baseline">
				...
				<tr>
					<td width="100"><cf_get_lang no='36. Kod/ Telefon'></td>
					<td width="175">
			...
			<cf_box id="add_partner_3" closable="0" collapsable="0">
			<table>
				<tr>
