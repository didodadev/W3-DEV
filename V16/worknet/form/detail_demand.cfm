...
<cf_catalystHeader>
	<cfform name="upd_demand" enctype="multipart/form-data" method="post" action="#WOStruct['#attributes.fuseaction#']['upd']['formAction']#">
<!--- Sayfa ana kısım  --->
<div class="row">
			        ...
			        <div class="col col-8 col-md-6 col-sm-6 col-xs-12" type="column" index="1" sort="true">
			            ...
			            <div class="form-group" id="item-project_id">
			                ...
			                <div class="col col-8 col-xs-12">
			                	...
			                	<span class="input-group-addon icon-ellipsis btnPointer" onClick="openBoxDraggable('<cfoutput>#request.self#?fuseaction=objects.popup_list_projects&project_id=upd_demand.project_id&project_head=upd_demand.project_head&select_list=2</cfoutput>&keyword='+encodeURIComponent(upd_demand.project_head.value));"></span>
			                	</div>
			                </div>
			            </div>
			            ...
			            <div class="form-group" id="item-date">
			                <label class="col col-4 col-xs-12"><cf_get_lang no='84.Yayın Tarihi'> *</label>
			                    <div class="col col-4 col-sm-12">
			                    	<div class="input-group">
										<input type="text" name="start_date" id="start_date" value="<cfoutput>#dateformat(getDemand.start_date,dateformat_style)#</cfoutput>" maxlength="10" style="width:70px;" placeholder="Başlangıç Tarihi">
										<span class="input-group-addon"><cf_wrk_date_image date_field="start_date"></span>
			                    	</div>
			                    </div>
			                    <div class="col col-4 col-sm-12">  
			                    	<div class="input-group">                      
			                        <input type="text" name="finish_date" id="finish_date" value="<cfoutput>#dateformat(getDemand.finish_date,dateformat_style)#</cfoutput>" maxlength="10" style="width:70px;" placeholder="Bitiş Tarihi">
			            ...
			            <div class="form-group" id="item-deliver_date">
			                ...
			                <div class="col col-8 col-xs-12">
			                	<div class="input-group">
			                    <input type="text" name="deliver_date" id="deliver_date" value="<cfoutput>#dateformat(getDemand.deliver_date,dateformat_style)#</cfoutput>" maxlength="10" style="width:70px;">
			    ...
			    <div class="row formContentFooter">
			        ...
			        <div class="col col-6 col-xs-12">
			            <cfif session.ep.admin eq 1 >
							<cf_workcube_buttons is_upd='1' is_delete="1" delete_page_url='#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,".")#.del_demand&demand_id=#attributes.demand_id#' add_function="kontrol()">
						<cfelse>
   ...
   <div class="col col-3 col-xs-12 uniqueRow">
        <div class="row">
			...
			<cf_box id="relation_assets" title="#text#" closable="0" style="width:98%;" box_page="#request.self#?fuseaction=worknet.emptypopup_list_relation_asset&action_id=#attributes.demand_id#&action_section=DEMAND_ID&asset_cat_id=-11"
				add_href="AjaxPageLoad('#request.self#?fuseaction=worknet.form_relation_asset&action_id=#attributes.demand_id#&action_section=DEMAND_ID&asset_cat_id=-11','body_relation_assets',0,'Loading..')">
			</cf_box>
        </div>
    </div>
</div>	
<div class="row">
	<div class="col col-9 col-xs-12">
		<cfsavecontent variable="teklif"><cf_get_lang no ='90.Teklifler'></cfsavecontent>
			<cf_box id="offer" title="#teklif#" closable="0" add_href="#request.self#?fuseaction=worknet.popup_add_demand_offer&demand_id=#attributes.demand_id#">
				<cfinclude template="../display/detail_demand_offers.cfm">
			</cf_box>
	</div>
</div>	
