...
<cfform name="upd_company_branch" method="post" action="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.emptypopup_upd_branch">
...
<input type="hidden" name="COMPBRANCH_ID" id="COMPBRANCH_ID" value="<cfoutput>#url.brid#</cfoutput>">
	...
	<tr>
		<td height="35" class="headbold">
			<cf_get_lang_main no='41.Şube'><cfoutput>:#getBranch.compbranch__name# /<a href="#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.detail_company&cpid=#getcompany.company_id#">#getcompany.fullname#</a></cfoutput>
		</td>
	</tr>
	</cfif>
</table>
<table width="98%" align="center" cellpadding="2" cellspacing="1" border="0">
	<tr>
		<td> 
		<cf_box id="upd_branch_1" closable="0" collapsable="0">
			<table>
				<tr>
					<td><cf_get_lang_main no='81.Aktif'></td>
					<td><input type="checkbox" name="compbranch_status" id="compbranch_status" <cfif getBranch.compbranch_status eq 1>checked</cfif>></td>
				</tr>	
				<tr> 
				...
				<tr> 
					...
					<td><input type="text" name="compbranch_tel2" id="compbranch_tel2" value="<cfoutput>#getBranch.compbranch_tel2#</cfoutput>" maxlength="10" style="width:97px;"></td>
				...
				<tr> 
					...
					<td><input type="text" name="compbranch_tel3" id="compbranch_tel3" value="<cfoutput>#getBranch.compbranch_tel3#</cfoutput>" maxlength="10" style="width:97px;"></td>
					<td><cf_get_lang_main no='559.Şehir'></td>
					<td><cfif len(getBranch.city_id)>
				...
				<tr> 
					...
					<td><input type="text" name="compbranch_fax" id="compbranch_fax" value="<cfoutput>#getBranch.compbranch_fax#</cfoutput>" maxlength="10" style="width:97px;"></td>
				...
				<tr> 
					...
					<td>
						<!---<select name="mobilcat_id" id="mobilcat_id" style="width:60px;">
                            ...
                            <cfoutput query="getMobilCat">
                                <option value="#mobilcat#" <cfif getBranch.compbranch_mobil_code eq mobilcat>selected</cfif>>#mobilcat#</option>
                            </cfoutput>
						</select>--->
					...
					<td><input type="text" name="semt" id="semt" value="<cfoutput>#getBranch.semt#</cfoutput>" maxlength="50" style="width:160px;"></td>
				</tr>
				<tr>
					...
					<td><cfsavecontent variable="mesaj"><cf_get_lang_main no='65.hatalı veri'>:<cf_get_lang_main no='16.E-mail'></cfsavecontent>
						<cfinput type="text" name="compbranch_email" id="compbranch_email" validate="email" message="#mesaj#" value="#getBranch.compbranch_email#" maxlength="100" style="width:160px;"></td>
 					<td><cf_get_lang_main no='60.Posta Kodu'></td>
					<td><input type="text" name="compbranch_postcode" id="compbranch_postcode" value="<cfoutput>#getBranch.compbranch_postcode#</cfoutput>" maxlength="5" style="width:160px;"></td>
 				</tr>
				<tr> 
					<td><cf_get_lang no='41.İnternet'></td>
					<td class="formbold"><input type="text" name="homepage" id="homepage" value="<cfoutput>#getBranch.homepage#</cfoutput>" maxlength="50" style="width:160px;"></td>
					<td><cf_get_lang_main no='1137.Koordinatlar'></td><!---koordinat--->
					<td colspan="2">
						<cf_get_lang_main no='1141.E'><cfinput type="text" maxlength="10" name="coordinate_1" id="coordinate_1" range="-90,90" message="Lütfen enlem değerini -90 ile 90 arasında giriniz!" value="#getBranch.coordinate_1#" style="width:59px;"> 
						<cf_get_lang_main no='1179.B'><cfinput type="text" maxlength="10" name="coordinate_2" id="coordinate_2" range="-180,180" message="Lütfen boylam değerini -180 ile 180 arasında giriniz!" value="#getBranch.coordinate_2#" style="width:59px;">
				...
				<tr>
					...
					<td  valign="top"><textarea name="compbranch__nickname" id="compbranch__nickname" style="width:160px;height:70px;"><cfoutput>#getBranch.compbranch__nickname#</cfoutput></textarea></td>
					<td valign="top"><cf_get_lang_main no='1311.Adres'></td>
					<td valign="top"><textarea name="compbranch_address" id="compbranch_address" style="width:160px;height:70px;"><cfoutput>#getBranch.compbranch_address#</cfoutput></textarea></td>
				</tr>
			</table>
		</cf_box>
		<cf_box id="upd_branch_2" closable="0" collapsable="0">
			<table>
				<tr>
					<td valign="top" style="width:200px;">
						...
						#dateformat(getBranch.record_date,dateformat_style)#
						<cfif len(getBranch.update_member) or len(getBranch.update_par)>
							...
							#dateformat(getBranch.update_date,dateformat_style)#
						</cfif>
						</cfoutput>
					</td>
					<td width="150">&nbsp;</td>
					<td valign="top" style=" width:150px;"><cf_workcube_buttons is_upd='1' is_delete='0' add_function='kontrol()'></td>
				</tr>
			</table>
		</cf_box>
		</td>
