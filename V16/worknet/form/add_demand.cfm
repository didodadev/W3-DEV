...
<div class="row">
	<div class="col col-8 col-xs-12 uniqueRow">
	    <div class="row formContent">
			<!---Geniş alan: içerik---> 
			<cfform name="add_demand" enctype="multipart/form-data" method="post" action="#WOStruct['#attributes.fuseaction#']['add']['formAction']#">
			        ...
			        <div class="col col-8 col-md-6 col-sm-6 col-xs-12" type="column" index="1" sort="true">
			            ...
			            <div class="form-group" id="item-project_id">
			                ...
			                <div class="col col-8 col-xs-12">
			                	...
			                	<span class="input-group-addon icon-ellipsis btnPointer" onClick="openBoxDraggable('<cfoutput>#request.self#?fuseaction=objects.popup_list_projects&project_id=add_demand.project_id&project_head=add_demand.project_head&select_list=2</cfoutput>&keyword='+encodeURIComponent(add_demand.project_head.value));"></span>
			                	</div>
			                </div>
			            </div>
