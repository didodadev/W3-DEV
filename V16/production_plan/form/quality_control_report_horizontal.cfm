<cfset get_product_quality_types = createObject("component","V16.product.cfc.product_quality_control_types").getProductCatQualityTypes(dsn3:dsn3,product_id:attributes.pid)>
<cfset current_row = 0>
<cfset rowcount_ = 0>
<cfloop query="get_product_quality_types">
	<cfset control_type_id = get_product_quality_types.QUALITY_TYPE_ID>
	<cfset get_quality_sub_cat= createObject("component","V16.product.cfc.product_quality_control_types").getProductSubCatQualityTypes(dsn3:dsn3,product_id:attributes.pid,control_type:control_type_id)>
	...
	<div class="ui-info-right">
		<div class="checkbox checbox-switch">
			<label>
				<cfinput type="checkbox" name="accepted_#currentrow#" id="accepted_#currentrow#" value="1" onchange="change_val('#currentrow#')"/>
				<span></span>
			</label>
		</div>
	</div>
					...
					<cfset get_quality_id= createObject("component","V16.product.cfc.product_quality_control_types").get_quality_id(dsn3:dsn3,q_ids:q_ids,product_id:attributes.pid,product_q_id:product_q_id)>
						<tr>
							...
							<td>
								<div class="checkbox checbox-switch">
									<label>
										<input type="checkbox" name="accept_#current_row#" id="accept_#current_row#" value="1" <!--- <cfif get_hr_detail.use_cigarette eq 1>checked</cfif> --->/>
										<span></span>
									</label>
								</div>
							</td>
