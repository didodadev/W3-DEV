<!--- Talep tahminleme Ağırlıklı Hareketli Ortalama (3 AY),Ağırlıklı Hareketli Ortalama (4 AY),Ağırlıklı Hareketli Ortalama (5 AY),Ağırlıklı Hareketli Ortalama (6 AY) hesaplama sayfası --->
...
<cfif attributes.method_type eq 5>
	<cfset month_count = 3>
<cfelseif attributes.method_type eq 6>
	<cfset month_count = 4>
<cfelseif attributes.method_type eq 7>
	<cfset month_count = 5>
<cfelseif attributes.method_type eq 8>
	<cfset month_count = 6>
</cfif>
		...
		<table>
			<cfoutput query="get_product">
				...
				<cfloop query="get_actions">
					<cfif isdefined("rate_#attributes.method_type#_#month#")>
						<cfset rate_ = evaluate("rate_#attributes.method_type#_#month#")>
					<cfelse>
						<cfset rate_ = 0>
					</cfif>
					<cfset "kontrol_#month#_#year#_#get_product.stock_id#" = 0>
					<cfset "total_amount_#month#_#year#_#get_product.stock_id#" = amount*rate_>
					...
					<cfloop from="1" to="#month_count-1#" index="jj">
						<cfif month-jj gt 0 and isdefined("sale_amount_#month-jj#_#year#_#get_product.stock_id#")>
							<cfif isdefined("rate_#attributes.method_type#_#month-jj#")>
								<cfset rate_ = evaluate("rate_#attributes.method_type#_#month-jj#")>
							<cfelse>
								<cfset rate_ = 0>
							</cfif>
							<cfset "total_amount_#month#_#year#_#get_product.stock_id#" = evaluate("total_amount_#month#_#year#_#get_product.stock_id#") + (evaluate("sale_amount_#month-jj#_#year#_#get_product.stock_id#")*rate_)>
