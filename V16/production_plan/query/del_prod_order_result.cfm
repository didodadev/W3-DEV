	...
	<cflock name="#CreateUUID()#" timeout="60">
      	...
      	<cfif isDefined('session.ep.userid')>
			<cfscript>
                ...
                muhasebe_sil(action_id:attributes.pr_order_id, process_type:171,muhasebe_db : '#dsn3#');
        ...
        <cfelseif isDefined('session.pda.userid')>
			<cfscript>
                ...
                del_serial_no(
                    process_id : attributes.pr_order_id,
                    process_cat : get_process_type.process_type, 
                    period_id : session.pda.period_id,
                    is_dsn3 : 1
                    );
            </cfscript>        
        </cfif>
		...
		<cfloop query="GET_FIS">
			...
			<!---depo sevk siliniyor--->
				...
				<cf_add_log  log_type="-1" action_id="#attributes.pr_order_id#" action_name="#attributes.production_order_no#" paper_no="#attributes.production_order_no#" data_source="#dsn3#" process_stage="#attributes.process_stage#">
			<!---//depo sevk siliniyor--->
		</cftransaction>
	</cflock>
</cfif>
