...
<cfelseif isdefined('attributes.UPD_ROW_ID') and isdefined('attributes.SELECTED_ROW_ID')>
	<cfquery name="upd_product" datasource="#dsn3#">
		 ...
		 SET 
			...
			<cfif isdefined('attributes.asset#SELECTED_ROW_ID#') and len(Evaluate("attributes.asset#SELECTED_ROW_ID#")) and isdefined('attributes.asset_id#SELECTED_ROW_ID#') and len(Evaluate("attributes.asset_id#SELECTED_ROW_ID#")) and len(Evaluate("attributes.asset#SELECTED_ROW_ID#"))>,ASSET_ID = #Evaluate("attributes.asset_id#SELECTED_ROW_ID#")#<cfelse>,ASSET_ID = NULL</cfif>
		 WHERE
