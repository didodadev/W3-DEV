...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
	<cf_box title="#getLang('','Mikro Bölge Kodları',34808)#" scroll="1" resize="0" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
		<cfform name="search" method="post" action="#request.self#?fuseaction=salesplan.popup_list_ims_codes">
			<input type="hidden" name="field_name" id="field_name" value="<cfoutput>#attributes.field_name#</cfoutput>">
			<cf_box_search>
				<input type="hidden" name="form_submitted" id="form_submitted" value="1">
				<div class="form-group" id="item-keyword">
					<cfinput type="text" name="keyword" placeholder="#getLang('main','Filtre',57460)#" style="width:100px;" value="#attributes.keyword#" maxlength="255">
				</div>	
		...
		<cf_grid_list>
			<thead>
				<tr>
					...
					<th><cf_get_lang dictionary_id='41548.IMS Bölge Adı'> 1001</th>
					<th><cf_get_lang dictionary_id='58134.Mikro Bölge Kodu'> 501</th>
					<th><cf_get_lang dictionary_id='41548.IMS Bölge Adı'> 501</th>
				</tr>
			</thead>
			<tbody>
				<cfif len(attributes.form_submitted)>
		...
		<cfif attributes.totalrecords gt attributes.maxrows>
			...
			<cf_paging 
				...
				adres="salesplan.popup_list_ims_codes#url_str#"
