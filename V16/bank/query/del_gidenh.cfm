<cflock name="#createUUID()#" timeout="20">
	<cftransaction>
		<cfquery name="CONTROL_BANK_ORDER" datasource="#dsn2#">
			SELECT BANK_ORDER_ID,PAPER_NO FROM BANK_ACTIONS WHERE ACTION_ID = #attributes.id#
		</cfquery>
		...
		<cf_add_log log_type="-1" action_id="#attributes.id#" action_name="#attributes.head#" process_type="#attributes.old_process_type#"  paper_no="#control_bank_order.paper_no#" data_source="#dsn2#">
	</cftransaction>
</cflock>
