...
<cfquery name="GET_PAYMENT_ROW" datasource="#dsn2#">
    ...
    FROM
        ...
        RIGHT JOIN INTEREST_YIELD_PLAN IYP ON IYP.YIELD_ID = IYPR.YIELD_ID
        LEFT JOIN BANK_ACTIONS BA ON IYP.BANK_ACTION_ID = BA.ACTION_ID
    WHERE 
        YIELD_ROWS_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.id#">
</cfquery>

<cfif isdefined("attributes.yield_id") and len(attributes.yield_id)>
   <cfquery name="get_rows" datasource="#dsn2#">
        SELECT YIELD_ROWS_ID FROM INTEREST_YIELD_PLAN_ROWS WHERE YIELD_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.yield_id#">
   </cfquery>     
...
<cfparam name="attributes.is_principal" default="0">
<cfset ADD_PAYMENT = createObject("component", "V16.bank.cfc.vadeliMevduat")>
<cfset get_acc_code_expense_item = ADD_PAYMENT.get_acc_code_exp( expense_item_id : GET_PAYMENT_ROW.EXPENSE_ITEM_TAHAKKUK_ID )>
...
<div class="col col-12 col-xs-12">
    <cf_box>
        ...
        <cfform name="add_interest_revenue" method="post" action="">
            ...
            <cf_box_elements>
                <div class="col col-4 col-md-4 col-sm-7 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="form-group" id="item-ACTION_DATE">
                        ...
                        <div class="col col-7 col-xs-12">
                            <div class="input-group">
                                <cfinput type="text" name="ACTION_DATE" required="yes" value="#dateformat(now(),dateformat_style)#" message="Hesaba Geçiş Tarihi Giriniz!" onBlur="dateDiffHesapla('action_date')" onchange="dateDiffHesapla('action_date')">
                    ...
                    <div class="form-group" id="item-diff-day" style="display:none;">
                        ...
                        <label class="col col-1 col-xs-12" id="day_diff"><cfoutput>#DateDiff("d",now(),GET_PAYMENT_ROW.BANK_ACTION_DATE)#</cfoutput> </label>
                        <cfif DateDiff("d",now(),GET_PAYMENT_ROW.BANK_ACTION_DATE) gt 0>
                    ...
                    <div class="form-group" id="item-from_account_id">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cf_wrkBankAccounts fieldId='from_account_id' call_function='kur_ekle_f_hesapla' width='285' selected_value='#attributes.bank_action_id#'>
                        </div> 
                    </div> 
                    <div class="form-group" id="item-to_account_id">
                        <label class="col col-4 col-xs-12"><cfoutput>#getLang('bank',65)#</cfoutput>*</label>
                        <div class="col col-7 col-xs-12">
                            <cf_wrkBankAccounts fieldId='to_account_id' call_function='kur_ekle_f_hesapla;change_currency_info' line_info='2'>
                        </div> 
                    </div>
                    <div class="form-group" id="item-show_principal">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id="60887.Anaparayı Çek"></label>
                        <div class="col col-7 col-xs-12">
                            <input type="checkbox" name="showPrincipal" onclick="showPrincipals()" value="1" <cfif attributes.is_principal eq 1>checked</cfif>>
                        </div> 
                    </div>
                    <div class="form-group" id="item-to_new_rate">
                        ...
                        <div class="col col-5 col-xs-12" id="newRate">
                            ...
                            <cfinput type="hidden" name="hiddenRate" value="#GET_PAYMENT_ROW.YIELD_RATE#">
                            <div class="input-group">
                                <cfinput type="text" name="newYieldRate" value="#TLFormat(GET_PAYMENT_ROW.YIELD_RATE)#" id="newYieldRate" onblur="changeAmount()" class="moneybox" onkeyup="return(FormatCurrency(this,event));">
                    ...
                    <div class="form-group" id="item-principal" style="display:none;">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='51344.Anapara'></label>
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="principal" value="#TLFormat(GET_PAYMENT_ROW.ACTION_VALUE)#" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));" readonly>
                        </div> 
                    </div>
                    ...
                    <div class="form-group" id="item-ACTION_VALUE">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="ACTION_VALUE" value="#TLFormat(GET_PAYMENT_ROW.AMOUNT)#" required="yes" readonly class="moneybox" onkeyup="return(FormatCurrency(this,event));">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="item-yield_loss">
                        ...
                        <div class="col col-7 col-xs-12">
                            <input type="text" id="yield_loss" name="yield_loss" value="<cfif reeskont_values gt 0><cfoutput>#TLFormat(0)#</cfoutput><cfelse><cfoutput>#TLFormat((DateDiff("d",now(),GET_PAYMENT_ROW.BANK_ACTION_DATE) * GET_PAYMENT_ROW.AMOUNT / GET_PAYMENT_ROW.DUE_VALUE ))#</cfoutput></cfif>" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));" readonly>
                        </div> 
                    </div>
                    ...
                    <div class="form-group" id="item-stopaj_rate">
                        ...
                        <div class="col col-7 col-xs-12">
                            <div class="input-group">
                                <cfinput type="text" name="stopaj_rate" id="stopaj_rate" value="" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));" readonly>
                    ...
                    <div class="form-group" id="item-stopaj_total">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="stopaj_total" id="stopaj_total" value="#TLformat(0,2)#" readonly required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));">
                        </div> 
                    </div> 
                    <div class="form-group" id="item-net_total">
                        <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id="57642.Net Toplam"></label>
                        <div class="col col-7 col-xs-12">
                            <cfinput type="text" name="net_total" value="" required="yes" class="moneybox" onkeyup="return(FormatCurrency(this,event));" readonly>
                        </div> 
                    </div>
                    ...
                    <div class="form-group" id="item-expense_center_id">
                        ...
                        <div class="col col-7 col-xs-12">
                            <cf_wrkExpenseCenter width_info="150" fieldId="expense_center_id" fieldName="expense_center_name" form_name="add_interest_revenue"  img_info="plus_thin">
                        </div> 
                    </div>
                </div>
                <div class="col col-4 col-md-5 col-sm-5 col-xs-12" type="column" index="2" sort="true">
                    <div class="form-group">
                        <label class="bold"><cf_get_lang dictionary_id='48714.İşlem Para Br'></label>
                    </div>
                    <div class="form-group">
                        <div class="col col-12 col-xs-12">
                            <cfscript>f_kur_ekle(process_type:0,base_value:'ACTION_VALUE',other_money_value:'OTHER_CASH_ACT_VALUE',form_name:'add_interest_revenue',select_input:'from_account_id',is_disable='1');</cfscript>
                        </div>
                    </div>
                </div>
            </cf_box_elements>
...
<script>
    <cfif attributes.is_principal eq 1>
        $("div#item-principal").show();
    </cfif>
    ...
    {
        document.getElementById(field_name).value = commaSplit(document.getElementById(field_name).value,'2');
    }
    ...
    function kontrol(){
        ...
        if( $("#stopaj_rate").val() == '' || $("#stopaj_rate").val() == 0){
