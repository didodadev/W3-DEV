...
<cfset pageHead = #getLang('bank',266)# >
<cf_catalystHeader>
<div class="col col-12 col-xs-12">
    <cf_box>
        <cfform name="add_entry" action="#request.self#?fuseaction=bank.emptypopup_add_incoming_bank_order" method="post">
            ...
            <cf_box_elements>
                <div class="col col-4 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    <div class="form-group" id="item-process_cat">
                        ...
                        <div class="col col-8 col-xs-12">
                            <cf_workcube_process_cat slct_width="250" process_type_info="251">
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="item-company_name">
                        ...
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                ...
                                <cfinput type="text" name="company_name" id="company_name" onfocus="AutoComplete_Create('company_name','MEMBER_NAME,MEMBER_PARTNER_NAME','MEMBER_NAME,MEMBER_PARTNER_NAME','get_member_autocomplete','\'1,2,3\',\'\',\'\',\'\',\'\',\'\',\'\',\'1\'','COMPANY_ID,CONSUMER_ID,EMPLOYEE_ID','company_id,consumer_id,employee_id','','3','250','account_load()');" value="#comp_name#" required="yes">
                    ...
                    <div class="form-group" id="item-project_name">
                        ...
                        <div class="col col-8 col-xs-12">
                            <cf_wrkProject fieldName='project_name' AgreementNo="1" Customer="2" Employee="3" Priority="4" Stage="5" width="150" boxwidth="600" boxheight="400" buttontype="2">
                        </div>
                    </div>
                    <cfif session.ep.our_company_info.asset_followup eq 1>
                        <div class="form-group" id="item-asset_id">
                            ...
                            <div class="col col-8 col-xs-12">
                                <cf_wrkAssetp fieldId='asset_id' fieldName='asset_name' form_name='add_entry'>
                            </div>
                        </div>
                    </cfif>
                    <div class="form-group" id="item-order_amount">
                        ...
                        <div class="col col-8 col-xs-12">
                            <cfinput type="text" name="ORDER_AMOUNT" id="ORDER_AMOUNT" class="moneybox" required="yes" onBlur="kur_ekle_f_hesapla('account_id');" onkeyup="return(FormatCurrency(this,event));">
                        </div>
                    </div>
                    <div class="form-group" id="item-other_cash_act_value">
                        ...
                        <div class="col col-8 col-xs-12">
                            <cfinput type="text" name="OTHER_CASH_ACT_VALUE" id="OTHER_CASH_ACT_VALUE" value="" class="moneybox" onBlur="kur_ekle_f_hesapla('account_id',true);" onkeyup="return(FormatCurrency(this,event));">
                        </div>
                    </div>                           
                    <div class="form-group" id="item-payment_date">
                        <cfif not (isdefined("attributes.date2") and isdate(attributes.date2))>
                            <cfset attributes.date2="#dateformat(now(),dateformat_style)#">
                        </cfif>
                        <label class="col col-4 col-xs-12"><cfoutput>#getLang('main', 1439)#</cfoutput> *</label>
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                <input value="<cfif isdefined("attributes.date2") and isdate(attributes.date2)><cfoutput>#attributes.date2#</cfoutput></cfif>" required message="#message#" type="text" name="PAYMENT_DATE" id="PAYMENT_DATE" style="width:150px;" validate="#validate_style#" <cfif isdefined("attributes.valor_date")>readonly</cfif> onBlur="change_money_info('add_entry','PAYMENT_DATE');">
                    ...
                    <div class="form-group" id="item-action_date">
                        <cfif not (isdefined("attributes.date1") and isdate(attributes.date1))>
                            <cfset attributes.date1="#dateformat(now(),dateformat_style)#">
                        </cfif>
                        <label class="col col-4 col-xs-12"><cfoutput>#getLang('main', 467)#</cfoutput> *</label>
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                <input value="<cfif isdefined("attributes.date1") and isdate(attributes.date1)><cfoutput>#attributes.date1#</cfoutput></cfif>" required message="#message#" type="text" name="ACTION_DATE" id="ACTION_DATE" style="width:150px;" validate="#validate_style#" <cfif isdefined("attributes.process_date")>readonly</cfif>>
                ...
                <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="2" sort="false">
                    <div class="form-group">
                        <label for="" class="bold"><cfoutput>#getLang('bank', 53)#</cfoutput></label>
                    </div>
                    <div class="form-group">
