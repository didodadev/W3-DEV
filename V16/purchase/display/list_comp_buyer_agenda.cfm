...
<cfsavecontent variable="title"><cf_get_lang dictionary_id='38639.Olaylar'></cfsavecontent>
        ...
        <cfform name="search" method="post" action="#request.self#?fuseaction=myhome.popup_list_comp_buyer_agenda&company_id=#attributes.company_id#">
            <tr>
                ...
                <td>
                    ...
                    <cfelse>
                  	  <cfsavecontent variable="message"><cf_get_lang dictionary_id='58053.başlama girmelisiniz'></cfsavecontent>
...
<cf_medium_list>
    <thead>
        ...
        <tr>
            ...
            <th width="150" class="form-title"><cf_get_lang dictionary_id='38638.Olay Kategorisi'></th>
...
<cfif attributes.totalrecords gt attributes.maxrows>
	<table width="99%" align="center">
	  <tr> 
	    ...
	    <!-- sil --><td class="label" style="text-align:right;"><cf_get_lang dictionary_id='57540.Toplam Kayıt'>:<cfoutput>#attributes.totalrecords#-&nbsp;<cf_get_lang dictionary_id='57581.Sayfa'>:#attributes.page#/#lastpage#</cfoutput></td><!-- sil -->
	  </tr>
	</table>
</cfif>
