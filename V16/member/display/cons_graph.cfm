...
<cf_box closable="0" title="#message# #Dateformat(date_add("h",session.ep.time_zone,now()),dateformat_style)# #timeformat(date_add("h",session.ep.time_zone,now()),timeformat_style)#">
