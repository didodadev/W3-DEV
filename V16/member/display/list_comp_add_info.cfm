<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" height="35">
  <tr>
    <td class="headbold"><cf_get_lang dictionary_id='30414.Şirket Ek Bilgileri'></td>
  </tr>
</table>
        ...
        <tr>
          <td class="color-row" valign="top">
            <cfform action="#request.self#?fuseaction=onjects.add_info_plus" method="post">
              <table>
                <tr>
                  <td><cf_get_lang dictionary_id='30415.Özellik Sahibi'></td>
                  <td>
                ...
                <cfloop index="i" from="1" to="5">
                  <tr>
                    <td><cf_get_lang dictionary_id='57632.Özellik'><cfoutput>#i#</cfoutput></td>
                    <td>
