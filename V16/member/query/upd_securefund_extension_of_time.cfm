...
<cflock timeout="60" name="#CreateUUID()#">
    <cftransaction>
        <cfscript>
            ...
            extension_time.dsn3 = dsn3;
            extension_time.dsn2 = dsn2;
            dsn2_alias = dsn2;
            rd_money = listfirst(attributes.rd_money,',');
            upd_securefund_extension_time= extension_time.UPD_SECUREFUND_EXTENSION_TIME(
                                            extension_securefund_time_id : '#IIf(IsDefined("attributes.extension_securefund_id"),"attributes.extension_securefund_id",DE(""))#',
