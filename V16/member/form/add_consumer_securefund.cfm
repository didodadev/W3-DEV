...
<cfform name="add_secure" method="post" enctype="multipart/form-data" action="#request.self#?fuseaction=member.emptypopup_add_consumer_securefund">
    ...
    <tr class="color-border">
      <td>
        <table width="100%" cellpadding="2" cellspacing="1" border="0" height="100%">
          <tr class="color-list">
            <td class="headbold" colspan="2" height="35">&nbsp;<cf_get_lang dictionary_id='30455.Teminat Ekle'></td>
          </tr>
          <tr class="color-row">
            <td valign="top">
...
<table>
  <tr>
    ...
    <td>
        ...
        <cfinput type="text" name="expense_total" validate="float" range="0.01," style="width:95px;" value="" passThrough="onkeyup=""return(FormatCurrency(this,event));""">
	</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<cfinput type="text" name="SECUREFUND_TOTAL" validate="float" range="0.01," required="yes" message="#message#" style="width:95px;" value="" passThrough="onkeyup=""return(FormatCurrency(this,event));""">
	</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    <td><cf_get_lang dictionary_id='51614.Uyarı Tarihi'>*</td>
    <td>
    ...
    <td><input  type="file" name="SECUREFUND_FILE" id="SECUREFUND_FILE" style="width:150px;"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td> </td>
