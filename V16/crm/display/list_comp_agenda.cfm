...
<table cellpadding="0" cellspacing="0" border="0" width="98%" height="35" align="center">
  <tr>
    <td class="headbold"><cf_get_lang no='1044.Olaylar'></td>
    <td  style="text-align:right;">
      <!-- Filtre -->
      <cfinclude template="../query/get_event_cats.cfm">
      <table>
        <cfform name="search" method="post" action="#request.self#?fuseaction=crm.popup_list_comp_agenda&company_id=#attributes.company_id#">
          <tr>
            <td><cf_get_lang_main no='48.Filtre'> :</td>
            <td><cfinput type="text" name="keyword" maxlength="100" value="#attributes.keyword#" style="width:100px;"></td>
            <td>
            ...
            <td>
			<cfsavecontent variable="message"><cf_get_lang no='1045.Başlangıç Tarih Formatını Doğru Girmelisiniz'> !</cfsavecontent>
            ...
            <td>
			<cfsavecontent variable="message"><cf_get_lang no='1046.Bitiş Tarih Formatını Doğru Girmelisiniz'> !</cfsavecontent>
  ...
  <tr>
    <td class="color-border">
      <table cellpadding="2" cellspacing="1" border="0" width="100%">
        <tr class="color-list">
          <td height="25" colspan="4" class="txtboldblue"><cf_get_lang_main no='162.Şirket'> : <cfoutput>#get_company_partners.fullname#</cfoutput></td>
        </tr>
        <tr class="color-header" height="22">
          <td width="50" class="form-title"><cf_get_lang_main no='75.No'></td>
          <td class="form-title"><cf_get_lang no='1408.Başlık'></td>
          <td width="150" class="form-title"><cf_get_lang no='1047.Olay Kategorisi'></td>
        ...
        <cfif get_event_search.recordcount>
          <cfoutput query="get_event_search" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
            <tr height="20" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
              <td>#event_id#</td>
              <td> <a href="javascript://" onClick="window.opener.location.href='#request.self#?fuseaction=agenda.view_daily&event=upd&event_id=#event_id#';self.close();" class="tableyazi">#event_head#</a> </td>
              <td>#eventcat#</td>
  ...
  <table width="98%" cellpadding="0" cellspacing="0" border="0" align="center" height="35">
    <tr>
      <td> <cf_pages page="#attributes.page#"
					  ...
					  adres="crm.popup_list_comp_agenda#url_str#"> </td>
      <!-- sil --><td  style="text-align:right;"><cf_get_lang_main no='128.Toplam Kayıt'> :<cfoutput>#attributes.totalrecords#-&nbsp; Sayfa:#attributes.page#/#lastpage#</cfoutput></td><!-- sil -->
    </tr>
  </table>
  <br/>
</cfif>
