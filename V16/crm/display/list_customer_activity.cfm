...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td height="35" class="headbold"><cf_get_lang no='1058.Alımı Artırılması Hedeflenen Müşteri Etkinlik Planı'></td>
	  <!-- sil -->
    ...
    <td> 
      <table cellspacing="1" cellpadding="2" width="100%" border="0">
		...
		<td class="form-title" width="30" height="22"><cf_get_lang_main no='75.No'></td> 
		  ...
		  <td class="form-title"><cf_get_lang no='853.Aylık Hedeflenen Ciro'></td>
           <td width="15" align="center"><a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=crm.popup_add_customer_activity</cfoutput>','page');"><img src="/images/plus_square.gif" title="<cf_get_lang_main no='170.Ekle'>" border="0"></a></td>
        </tr>
		...
		<td colspan="7"><cf_get_lang no='289.Filtre Ediniz'></td>
		</tr>
		</cfif>
      </table>
    </td>
