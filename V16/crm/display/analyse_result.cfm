<cfif len(attributes.date_1) and len(attributes.date_2) and len(attributes.service_company_id)>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td height="35" class="headbold"><cfoutput>#get_par_info(attributes.service_company_id,1,1,0)#</cfoutput></td>
    </tr>
  </table>
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
            ...
            <td>
              <table width="100%" border="0" cellspacing="1" cellpadding="2">
                <tr class="color-header" >
                  <td class="form-title" height="22" colspan="4"><cfif attributes.category eq 1><cf_get_lang_main no='36.Satış'>
                      <cfelseif attributes.category eq 2><cf_get_lang_main no='37.Satınalma'>
                      <cfelseif attributes.category eq 3><cf_get_lang no='1.Ciro'>
                      <cfelseif attributes.category eq 4><cf_get_lang_main no='640.Özet'>
                    </cfif></td>
                </tr>
                <tr class="color-list">
                  <td width="70" height="22" class="txtboldblue"><cf_get_lang_main no='75.No'></td>
                  <td class="txtboldblue"width="120"><cf_get_lang_main no='245.Ürün'></td>
                  <td class="txtboldblue"width="70"><cf_get_lang_main no='261.Tutar'></td>
                </tr>
                    ...
                    <table cellspacing="1" cellpadding="2" border="0" width="100%">
                      <tr class="color-header">
                        <td height="20">
                          <table>
                            <tr>
                              <td class="form-title"><cf_get_lang no='3.Müşteri Analiz'></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
