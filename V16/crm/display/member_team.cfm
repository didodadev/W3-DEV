	...
	<td> 
	  <table cellspacing="1" cellpadding="2" width="100%" border="0">
		<tr class="color-header" height="22" > 
		  ...
		  <td width="15">
			<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=crm.popup_form_add_worker&c_id=#url.cpid#&cp_id=#url.cpid#</cfoutput>','medium');"><img src="/images/plus_square.gif" border="0" title="<cf_get_lang no='307.Kurumsal Üye Temsilcileri'>" align="absmiddle"></a>
		  </td>
		</tr>
		<cfset CCS = "">
		<tr class="color-row"> 
		 ...
		 <table width="100%" cellpadding="0" cellspacing="0">
		   <tr>
			  <td>
			   ...
			   <td width="15">
			  <a href="javascript://" onClick="windowopen('#request.self#?fuseaction=crm.emptypopup_member_del_emp&position_code=#position_code#&cp_id=#attributes.CPID#','small');"><img src="/images/delete_list.gif" border="0"></a>
			  </td>
			</tr>
		 </table>
		 </cfoutput>				 
		  ...
		  <table width="100%" cellpadding="0" cellspacing="0">
			<tr>
			  ...
			  <td  width="15"  style="text-align:right;">
			   <a href="javascript://" onClick="windowopen('#request.self#?fuseaction=crm.emptypopup_member_del_par&partner_id=#partner_id#&cp_id=#attributes.CPID#','small');"><img src="/images/delete_list.gif" border="0"></a>
			  </td>				   
		     </tr>
		  </table>
		  </cfoutput>
