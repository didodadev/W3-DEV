...
<cfquery name="Get_Company_Info" datasource="#dsn#">
	SELECT
		...
		CI.CITY_NAME,
		CO.COUNTY_NAME,
		(SELECT COMPANY_PARTNER_NAME +' '+ COMPANY_PARTNER_SURNAME FROM COMPANY_PARTNER WHERE PARTNER_ID = C.MANAGER_PARTNER_ID) MANAGER_PARTNER
	FROM
		COMPANY C,
		SETUP_CITY CI,
		SETUP_COUNTY CO
	WHERE
		...
		C.CITY = CI.CITY_ID AND
		C.COUNTY = CO.COUNTY_ID AND
		CI.CITY_ID = CO.CITY
</cfquery>
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="1">
	<tr valign="middle" height="50">
		<td class="headbold">
			<cfoutput>
				#Get_Company_Info.fullname# - #Get_Company_Info.Manager_Partner# /
				#Get_Company_Info.City_Name# - #Get_Company_Info.County_Name#
				<br/>
				#ListGetAt(aylar,attributes.start_month)# / #attributes.start_year# - #ListGetAt(aylar,attributes.finish_month)# / #attributes.finish_year#
			</cfoutput>
		</td>
	</tr>
	<tr class="color-row">
		...
		<table width="100%" cellpadding="0" cellspacing="1" border="0">
			...
			<cfoutput query="get_branch_related">
				...
				<cfif get_company_boyut.deha eq 1>
					<!--- <cfset get_invoice_info = convertDotNetDataset1(get_invoice_info)>
				...
				<tr height="22">
					<td class="txtboldblue" bgcolor="#listgetat(color_list,comp_id,',')#">
						#branch_name#
						<!--- <cfif get_company_boyut.deha eq 1>
							<cfdump var="Lütfen Dikkat Deha Depolarındaki Veriler Test Aşamasındadır;">
						</cfif> --->
					</td>
				</tr>
				<tr>
							...
							<table cellspacing="0" cellpadding="0" border="0">
								<tr class="color-list">
									...
									<table cellspacing="1" cellpadding="2" width="100%" border="0">
										...
										<tr class="color-row">
											<td class="txtboldblue"><cffunction dictionary_id="30575. M F İskontosu"></td>
				...
				<cfcatch type="any">
					...
					<tr class="color-list" height="22">
						<td class="txtboldblue">#branch_name#</td>
					</tr>
					<tr>
