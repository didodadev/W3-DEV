	...
	<table width="98%" cellspacing="0" cellpadding="0">
	 ...
	 <td><table style="text-align:right;">
		...
		<cfif get_quiz_chapters.recordcount>
		  ...
		  <tr>
			<td>
			  <table width="100%" border="0">
				<tr>
					<td class="txtboldblue" width="40"><cf_get_lang dictionary_id="36199.AÇIKLAMA"></td>
	  ...
	  <tr>
		<td >
			<table >
				<tr>
					...
					<td>
					  <cfif get_app_perf_detail.other_position_code eq GET_POSITION_CATS.POSITION_CAT_ID><cfoutput>#GET_POSITION_CATS.POSITION_CAT#</cfoutput></cfif>
					</td>
				</tr>
			</table>
		</td>
        ...
        <tr height="22">
          <td height="22"><cf_get_lang dictionary_id="30995.Genel Değerlendirme (İK Departmanı)"></td>
        </tr>
        <tr height="22">
          <td valign="top" >
			<table width="320">
