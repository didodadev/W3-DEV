...
<cffunction name="draw_div" returntype="string">
	...
	<cfargument name="upper_step_no" type="numeric" required="false" default="0">
	...
	<cfif arguments.query_row lte get_all_workgroup_roles2.recordcount>
		...
		<cfelse>
			<cfset my_kademe = my_grup_uzunlugu-1>
			<cfset my_asama = 1>
			...
			<cfif arguments.step_no gt my_grup_uzunlugu>
				<cfset kademe_eklentisi = (arguments.step_no - my_grup_uzunlugu) * (kutu_yuksekligi + (cizgi_yuksekligi/2))>
			<cfelse>
				<cfset kademe_eklentisi = 0>
			</cfif>
	...
	<cfscript>
		...
		deger = '<div id="cizim_#arguments.position_id#">';
		
		if((isdefined("attributes.is_empty_pos") and arguments.EMPLOYEE_ID eq 0) or arguments.EMPLOYEE_ID gt 0)
				{
				deger = deger & '<table width="50%" cellpadding="0" cellspacing="0" style="width: 200px; height: 100px;margin: auto;">';
				...
				if(isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim") and len(evaluate("my_resim_#position_id#")))
					deger = deger & '<tr><td align="center" height="#resim_yuksekligi#"><img src="/documents/hr/#evaluate("my_resim_#position_id#")#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td></tr>';
				...
				if(isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim") and len(evaluate("my_resim_#position_id#")))
					deger = deger & '<td width="#resim_genisligi#"><img src="/documents/hr/#evaluate("my_resim_#position_id#")#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td>';
				...
				deger = deger & '<tr><td align="center"><a href="javascript://" onclick="openBoxDraggable(''#request.self#?fuseaction=objects.popup_emp_det&emp_id=#arguments.EMPLOYEE_ID#'',''medium'',''popup_emp_det'');" class="tableyazi">#arguments.EMPLOYEE_NAME# #arguments.EMPLOYEE_SURNAME#</a> #my_vekil#</td></tr>';
				//deger = deger & "<tr><td align=""center""><a href=""javascript://"" onclick=""openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#arguments.EMPLOYEE_ID#','medium','popup_emp_det');"" class=""tableyazi"">#arguments.EMPLOYEE_NAME# #arguments.EMPLOYEE_SURNAME#</a> #my_vekil#</td></tr>";
				...
				deger = deger & '<tr><td style="text-align:center;" height="15"><img src="/images/cizgi_dik_1pix.gif" height="#(cizgi_yuksekligi/2)+kademe_eklentisi+3#" width="3"></td></tr>';
				deger = deger & '<tr><td align="center" height="#kutu_yuksekligi#"><img src="/images/cizgi_dik_1pix.gif" height="#kutu_yuksekligi#" width="3"></td></tr>';
				if(is_alt eq 1)
					{
...
<cfset attributes.is_kademe = 2>
<cfset attributes.ust_cizim_sayisi = 0>
<cfquery name="get_all_position" datasource="#dsn#">
	SELECT 
		EMPLOYEE_POSITIONS.POSITION_ID,
		'M' + ORGANIZATION_SIMULATION_ROWS.HIERARCHY AS HIERARCHY,
		ORGANIZATION_SIMULATION_ROWS.ROW_ID,
		ORGANIZATION_SIMULATION_ROWS.POSITION_TYPE,
		ORGANIZATION_SIMULATION_ROWS.STAGE_ID,
		ISNULL(EMPLOYEE_POSITIONS.IS_VEKALETEN,0) IS_VEKALETEN,
		EMPLOYEE_POSITIONS.IS_CRITICAL,
		EMPLOYEE_POSITIONS.POSITION_NAME,
		EMPLOYEE_POSITIONS.EMPLOYEE_NAME,
		EMPLOYEE_POSITIONS.EMPLOYEE_SURNAME,
		ISNULL(EMPLOYEE_POSITIONS.EMPLOYEE_ID,0) AS EMPLOYEE_ID,
		EMPLOYEE_POSITIONS.POSITION_ID,
	...
	WHERE 
		...
		ORGANIZATION_SIMULATION_ROWS.EMPLOYEE_ID = EMPLOYEES.EMPLOYEE_ID AND
...
<cfset ilk_hier_list = ''>
<cfloop query="get_all_position">
	<cfif listlen(hierarchy,'.') eq 2>
		<cfset ilk_hier_list = listappend(ilk_hier_list,POSITION_ID)>
	</cfif>
</cfloop>

<cfif not listlen(ilk_hier_list)>
...
<cfquery name="get_pos_ilk" dbtype="query">
	SELECT * FROM get_all_position WHERE POSITION_ID IN (#ilk_hier_list#)
</cfquery>
...
<cfset position_all_hierarchy_list = valuelist(get_pos_ilk.hierarchy)>
...
<cfset pos_upper_add_list = "">
	...
	<cfscript>
			position_all_hierarchy_list_new = '';
			position_all_list_new = '';
			position_control_list_new = '';
			my_sira = 1;
						...
						for (k=1; k lte my_dongu_sayisi; k=k+1)
							{
								...
								aktif_hierarchy = listgetat(position_all_hierarchy_list,listfindnocase(position_all_list,aktif_position),',');
								
									{
									position_all_list_new = listappend(position_all_list_new,aktif_position);
									position_all_hierarchy_list_new = listappend(position_all_hierarchy_list_new,aktif_hierarchy);
									get_alts = cfquery(dbtype:"query",datasource:"#dsn#",sqlstring:"SELECT * FROM  get_all_position WHERE HIERARCHY LIKE '#aktif_hierarchy#.%'");
									if(get_alts.recordcount)
										{
											for(m=1;m lte get_alts.recordcount;m=m+1)
												{
													position_control_list_new = listappend(position_control_list_new,get_alts.position_code[#m#]);
													if(my_sira neq attributes.alt_cizim_sayisi) 
														{
														position_all_list_new = listappend(position_all_list_new,get_alts.position_code[#m#]);
														...
														position_all_hierarchy_list_new = listappend(position_all_hierarchy_list_new,ust_code);
														}
												}
			...
			position_all_hierarchy_list = position_all_hierarchy_list_new;
			position_all_list = position_all_list_new;
			position_control_list = position_control_list_new;
	</cfscript>
...
<cfloop list="#position_all_list#" index="mk">
	...
	<cfscript>
		...
		get_upper_ = cfquery(dbtype:"query",datasource:"#dsn#",sqlstring:"SELECT * FROM get_pos_bilgiler WHERE HIERARCHY = '#up_pos_code#'");
		my_upper_ = evaluate("get_upper_.position_code");
		...
		if(attributes.tasarim_tipi neq 3 or (attributes.tasarim_tipi eq 3 and listlen(up_pos_code,'.') lte attributes.alt_cizim_sayisi))
			{
		...
		else if(attributes.tasarim_tipi eq 3 and listlen(up_pos_code,'.') lte attributes.alt_cizim_sayisi)
			{
...
<cfset my_employee_list = valuelist(get_pos_bilgiler.employee_id)>
...
<cfset my_employee_list = listsort(my_employee_list,'numeric','ASC',',')>
<cfquery name="get_resimler" datasource="#dsn#">
	SELECT PHOTO,EMPLOYEE_ID FROM EMPLOYEES WHERE EMPLOYEE_ID IN (#my_employee_list#) ORDER BY EMPLOYEE_ID
</cfquery>
...
<cfoutput query="get_all_workgroup_roles2">
	...
	<cfif currentrow lt recordcount and attributes.alt_cizim_sayisi gte 1>
...
<cf_box title="#getLang('','Çalışanlar',30370)#" scroll="1" collapsable="1" resize="1" popup_box="#iif(isdefined("attributes.draggable"),1,0)#" style="margin:auto;">
	...
	<cfif len(evaluate("get_upper.#amir_tipi#")) and attributes.ust_cizim_sayisi gt 0>
		<cfquery name="get_upper_1" datasource="#dsn#">
			...
			WHERE 
				...
				<cfif get_upper_1.recordcount and attributes.ust_cizim_sayisi eq 2>
						<cfif len(evaluate("get_upper_1.#amir_tipi#"))>
								...
								<cfoutput>
										<div id="main_group_2" align="center">
											<table width="50%" cellpadding="0" cellspacing="0">
													...
													<td style="border: 1px solid ##666666;">
														<table cellpadding="2" cellspacing="0" width="100%">
															<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim") and len(get_upper_2.photo)>
																	<tr><td align="center" height="#resim_yuksekligi#"><img src="/documents/hr/#get_upper_2.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td></tr>
															<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim")>
															...
															<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim") and len(get_upper_2.photo)>
																	<td width="#resim_genisligi#"><img src="/documents/hr/#get_upper_2.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td>
															<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim")> 
																...
																<td style="height:#kutu_yuksekligi_ilk#px;" align="center">
																	<table cellpadding="0" cellspacing="0">
																		<tr>
																			<td align="center">
																				<cfif isdefined("attributes.is_pozisyon")>#get_upper_2.position_name#<br/></cfif>
																				<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_upper_2.EMPLOYEE_ID#','medium','popup_emp_det');" class="tableyazi">#get_upper_2.employee_name# #get_upper_2.employee_surname#</a><br/>
												...
												<tr><td align="center" height="15"><img src="/images/cizgi_dik_1pix.gif" height="15" width="3"></td></tr>
											</table>
										</div>
			...
			<cfoutput>
			<div id="main_group_1" align="center">
				<table width="50%" cellpadding="0" cellspacing="0">
				<tr><td style="border: 1px solid ##666666;">
							...
							<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim") and len(get_upper_1.photo)>
									<tr><td align="center" height="#resim_yuksekligi#"><img src="/documents/hr/#get_upper_1.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td></tr>
							<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim")>
									<tr><td align="center" height="#resim_yuksekligi#">&nbsp;</td></tr>
							</cfif>
							<tr>
							<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim") and len(get_upper_1.photo)>
									<td width="#resim_genisligi#"><img src="/documents/hr/#get_upper_1.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td>
							<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim")> 
									<td width="#resim_genisligi#">&nbsp;</td>
							</cfif>
								<td style="height:#kutu_yuksekligi_ilk#px;" align="center">
									<table cellpadding="0" cellspacing="0">
										<tr>
											<td align="center">
												...
												<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_upper_1.EMPLOYEE_ID#','medium','popup_emp_det');" class="tableyazi">#get_upper_1.employee_name# #get_upper_1.employee_surname#</a><br/>
					...
					<tr><td style="text-align:center;" height="15"><img src="/images/cizgi_dik_1pix.gif" height="110" width="3"></td></tr>
				</table>
			</div>
			<cfset my_top_eklenti = my_top_eklenti + kutu_yuksekligi - 14>
			</cfoutput>
	...
	<cfoutput>
	<div id="main_group" align="center">
		<table width="50%" cellpadding="0" cellspacing="0">
		<tr><td style="border: 1px solid ##666666;">
					<table cellpadding="2" cellspacing="0" width="100%">
					<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim") and len(get_upper.photo)>
							<tr><td align="center" height="#resim_yuksekligi#"><img src="/documents/hr/#get_upper.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td></tr>
					<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi eq 2 and isdefined("attributes.is_resim")>
							<tr><td align="center" height="#resim_yuksekligi#">&nbsp;</td></tr>
					</cfif>
					<tr>
					<cfif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim") and len(get_upper.photo)>
							<td width="#resim_genisligi#"><img src="/documents/hr/#get_upper.photo#" height="#resim_yuksekligi#" width="#resim_genisligi#"></td>
					<cfelseif isdefined("attributes.tasarim_tipi") and attributes.tasarim_tipi neq 2 and isdefined("attributes.is_resim")> 
							<td width="#resim_genisligi#">&nbsp;</td>
					</cfif>
							...
							<table cellpadding="0" cellspacing="0" align="center">
								<tr>
									<td style="text-align:center;">
										...
										<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_upper.EMPLOYEE_ID#','medium','popup_emp_det');" class="tableyazi">#get_upper.employee_name# #get_upper.employee_surname#</a><br/>
	...
	<cfif attributes.tasarim_tipi neq 3 or (attributes.alt_cizim_sayisi neq 1 and attributes.tasarim_tipi eq 3)>
		<div id="yatay_cizgi_top"><img src="/images/cizgi_yan_1pix.gif" width="100%" height="3"></div>
	</cfif>
	<cfset last_hie = 0>
	...
	<cfoutput query="get_all_workgroup_roles2">
		#draw_div(position_id,last_hie,currentrow,yeni_hierarchy,employee_id,POSITION_NAME,title,position_cat,employee_name,employee_surname,position_code,is_critical,is_vekaleten,step_no,0)#
	...
	<cfloop list="#fonksiyoneli_olanlar#" index="kk">
			...
			<cfif get_alt_eleman_fonk.recordcount>
				<div id="fonksiyonel_#my_upper_#" align="center" style="z-index:2;width:#kutu_genisligi+30#;height:#kutu_yuksekligi#px;left:250px;top:10px;">
								...
								<table cellpadding="0" cellspacing="0" width="100%">
									<cfloop query="get_alt_eleman_fonk">
										<cfif isdefined("attributes.is_resim")>
											...
											<td nowrap="nowrap" bgcolor="cccccc" style="#div_spe#;" align="center" width="#kutu_genisligi#">
												<table width="100%">
													<tr>
														...
														<td align="center" height="#kutu_yuksekligi - cizgi_yuksekligi + 15#">
														<cfif isdefined("attributes.is_pozisyon")>#get_alt_eleman_fonk.position_name#<br/></cfif>
														<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_alt_eleman_fonk.EMPLOYEE_ID#','medium','popup_emp_det');" class="tableyazi">#get_alt_eleman_fonk.employee_name# #get_alt_eleman_fonk.employee_surname#</a><br/>
	...
	<cfloop query="get_all_workgroup_roles_ters">
			...
			<cfif (listlen(get_group_ozel.YENI_HIERARCHY,'.') - group_hie) eq 1>
				<cfif ozel_list eq 0>
					<cfif attributes.tasarim_tipi eq 3 and listlen(get_group_ozel.YENI_HIERARCHY,'.') eq attributes.alt_cizim_sayisi>
						<div id="yatay_cizgi_<cfoutput>#ust_id#</cfoutput>"></div>
					<cfelse>
						<div id="yatay_cizgi_<cfoutput>#ust_id#</cfoutput>"><img src="/images/cizgi_yan_1pix.gif" width="100%" height="3"></div>
					</cfif>
		...
		<cfif ozel_list>
			<script type="text/javascript">
				...
				cizim_<cfoutput>#ust_id#</cfoutput>.style.left = my_orta;
				...
				if(my_yeni_sayi>1)
					...
					document.getElementById('yatay_cizgi_<cfoutput>#ust_id#</cfoutput>').style.width = '1px';
		...
		<cfif get_all_workgroup_roles_ters.currentrow eq 1>
			<cfset son_hie = get_all_workgroup_roles_ters.yeni_hierarchy>
		...
		<cfif get_all_workgroup_roles_ters.currentrow eq get_all_workgroup_roles_ters.recordcount>
			...
			<cfif attributes.tasarim_tipi neq 3 or (attributes.alt_cizim_sayisi neq 1 and attributes.tasarim_tipi eq 3)>
				...
				<cfif listlen(ilk_alt_kademeler) gte 1>
	...
	<cfif listlen(position_agac_list)>
		<cfloop list="#upper_list#" index="uk">
			<cfoutput>
				...
				<div id="agac_#uk#" align="center" style="z-index:2;width:#kutu_genisligi * 2#;height:#get_alt_eleman.recordcount * kutu_yuksekligi#px;left:250px;top:10px;">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td valign="top" align="center">
								<table cellpadding="0" cellspacing="0" width="100%">
									<tr>
										<td colspan="2"></td>
										<td align="center"><img src="/images/cizgi_yan_1pix.gif" width="3" height="#cizgi_yuksekligi#"></td>
									...
									<cfloop query="get_alt_eleman">
										...
										<cfif (mck mod 2) eq 1 or mck eq 1>
											...
											<td nowrap="nowrap" style="#div_spe#;" align="center" width="#kutu_genisligi#">
												<table width="100%">
													<tr>
														...
														<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#get_alt_eleman.EMPLOYEE_ID#','medium','popup_emp_det');" class="tableyazi">#get_alt_eleman.employee_name# #get_alt_eleman.employee_surname#</a><br/>
											...
											<cfif (mck mod 2) eq 1>
												...
												<td align="center" width="1"><img src="/images/cizgi_yan_1pix.gif" width="3" height="#kutu_yuksekligi - cizgi_yuksekligi + 22#"></td>
											</cfif>
			...
			<script type="text/javascript">
				<cfoutput>
					<cfif attributes.alt_cizim_sayisi gte 1>
						<cfset baz_layer = "cizim_#uk#">
	...
	<cfif listlen(position_kademe_list)>
		<cfoutput>
			...
			<cfif get_alt_eleman.recordcount>
				<div id="kademe_#kk#" align="center" style="z-index:2;width:#kutu_genisligi * 2#;height:#ceiling(get_alt_eleman.recordcount/2) * kutu_yuksekligi#px;left:250px;top:10px;">
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td valign="top" align="center">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<cfloop query="get_alt_eleman">
									...
									<cfif (mck mod 2) eq 1 or mck eq 1>
										...
										<td nowrap="nowrap" bgcolor="f5f5f5" style="#div_spe#;" align="center" width="#kutu_genisligi#">
											<table width="100%">
									...
									<cfif (mck mod 2) eq 0 or get_alt_eleman.recordcount eq mck>
										...
										<cfif get_alt_eleman.recordcount neq mck>
											<tr>
											<td colspan="2"></td>
											<td align="center" height="5"><img src="/images/cizgi_yan_1pix.gif" width="3" height="5"></td>
											<td colspan="2"></td>
											</tr>
										</cfif>
									</cfif>
		...
		<cfform action="#request.self#?fuseaction=hr.emptypopup_sve_hierrchy_drwing">
			<cf_box_search more="0">  
				<div class="form-group" id="item-keyword">
					<cfsavecontent variable="message"><cf_get_lang dictionary_id='59021.Şema Adı'></cfsavecontent>
					<cfinput type="text" value="" name="draw_name" required="yes" message="Çizim Adı Girmelisiniz!" placeholder="#message#">
				</div>
				<div class="form-group" id="item-keyword">
					<input type="text" value="<cfoutput>#dateformat(now(),dateformat_style)#</cfoutput> Tarihli Pozisyon Şeması" style="width:250px;" name="draw_detail" id="draw_detail" maxlength="500">
				</div>
				<!--- <div class="form-group" id="item-keyword" style="display:none;">
					<cfsavecontent variable="message"><cf_get_lang dictionary_id='59021.Şema Adı'></cfsavecontent>
					<textarea name="draw_icerik" id="draw_icerik" style="width:0px;height:0px;"><cfoutput>#ToBase64(sema_icerik)#</cfoutput></textarea>
				</div> --->
