...
<cfparam name="attributes.witness_statement_id" default="">
<cfset witness_statement_=witness_statement.GET_WITNESS_STATEMENT(event_id : get_event.event_id,witness_statement_id:attributes.witness_statement_id) />
<cfif witness_statement_.recordcount>
	<cflocation url="#request.self#?fuseaction=ehesap.popup_upd_witness_statement&event_id=#get_event.event_id#&witness_statement_id=#witness_statement_.witness_statement_id#" addtoken="no">
</cfif>
<cfsavecontent variable="message"><cf_get_lang dictionary_id="61152.Tanık İfadesi Ekle"></cfsavecontent>
<cf_box title="#message#">
	<cfform name="add_witness_report" action="" method="post">
            ...
            <div class="col col-6 col-md-6 col-sm-12 col-xs-12" type="column" index="1" sort="true">
                ...
                <div id="tanik_1">
                    ...
                    <div class="form-group">
                        <div class="col col-12 col-xs-12">
                            <textarea name="witness1_detail" id="witness1_detail"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="tanik_2">
                    ...
                    <div class="form-group">
                        <div class="col col-12 col-xs-12">
                            <textarea name="witness2_detail" id="witness2_detail"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div id="tanik_3">
                    ...
                    <div class="form-group">
                        <div class="col col-12 col-xs-12" >
                            <textarea name="witness3_detail" id="witness3_detail"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function save_form(){  
        ...
        $.ajax({ 
            type:'POST',  
            url:'V16/hr/ehesap/cfc/witness_statement.cfc?method=ADD_WITNESS_STATEMENT',
            data: { 
