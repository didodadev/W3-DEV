<!---
    ...
    Date: 2021-09-07
    Description: Kesenek katkı oranları güncelleme widget
...
<cfset get_dcr = get_component.GET_DEDUCTIBLE_CONTRIBUTION_RATE(deductible_contribution_rate_id: attributes.dcr_id)>
...
<cf_box title="#message#" scroll="1" closable="1" collapsable="1" resize="1" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
	<cfform name="form_add_ratio" method="post">
        <input type="hidden" name="deductible_contribution_rate_id" id="deductible_contribution_rate_id" value="<cfoutput>#attributes.dcr_id#</cfoutput>">
		<cf_box_elements>
				...
				<div class="col col-12 col-md-12 col-sm-12 col-xs-12" type="column" sort="true" index="1">
					<div class="form-group" id="item-name">
						...
						<div class="col col-8 col-xs-12">
							<cfinput type="text" name="title" id="title" value="#get_dcr.title#">
						</div>
					</div>
					<div class="form-group" id="item-date">
						...
						<div class="col col-8 col-xs-12">
							<div class="input-group">
								<cfinput type="text" name="startdate" id="startdate" validate="#validate_style#" value="#dateformat(get_dcr.startdate,dateformat_style)#">
								<span class="input-group-addon btnPointer"><cf_wrk_date_image date_field="startdate"></span>
								<span class="input-group-addon no-bg"></span>
								<cfinput type="text" name="finishdate" validate="#validate_style#" id="finishdate" value="#dateformat(get_dcr.finishdate,dateformat_style)#">
                                ...
                                <cfloop index="i" from="1" to="7">
                                    <cfoutput>
                                        <tr>
                                            ...
                                            <td><input type="text" name="min_payment_#i#" id="min_payment_#i#" style="width:100%;" value="#tlformat(evaluate("get_dcr.min_payment_#i#"))#" onkeyup="return(formatcurrency(this,event));" class="moneybox"></td> 
                                            <td><input type="text" name="max_payment_#i#" id="max_payment_#i#" style="width:100%;" value="#tlformat(evaluate("get_dcr.max_payment_#i#"))#" onkeyup="return(formatcurrency(this,event));" class="moneybox"></td>
                                            <td><input type="text" name="ratio_#i#" id="ratio_#i#" style="width:100%;" value="#tlformat(evaluate("get_dcr.ratio_#i#"))#" onkeyup="return(formatcurrency(this,event));"></td>
                                        </tr>
                                    </cfoutput>
                                </cfloop>
                            </tbody>
        ...
        <cf_box_footer>
            <cf_workcube_buttons 
                ...
                data_action = "V16/hr/ehesap/cfc/deductible_contribution_rate:UPD_DEDUCTIBLE_CONTRIBUTION_RATE" 
                next_page="#request.self#?fuseaction=ehesap.personal_payment"
                del_action= 'V16/hr/ehesap/cfc/deductible_contribution_rate:DEL_DEDUCTIBLE_CONTRIBUTION_RATE:deductible_contribution_rate_id=#attributes.dcr_id#'
...
<script>
    function control()
    {
        ...
        data.append('dcr_id',$("#deductible_contribution_rate_id").val());
    ...
    {
        $('#DeductibleContributionRate .catalyst-refresh').click();
        return false;
    }
</script>