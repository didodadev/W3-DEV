<cfif not isdefined("attributes.in_out_ids")>
	<script type="text/javascript">
		alert("<cf_get_lang dictionary_id='45469.Giriş Kaydı Seçmelisiniz'>!");
		window.history.go(-2);		
	</script>
	<cfabort>
</cfif>
...
<cfsavecontent variable="message"><cf_get_lang dictionary_id="38409.İşe Giriş Mail"></cfsavecontent>
<cf_box title="#message#" closable="0" collapsed="0">	
	<cfform name="sgk_ins_mail" action="index.cfm?fuseaction=ehesap.list_ins_mail_send" method="post">
		<div class="row">
				...
				<div class="col col-6 col-md-4 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<div class="col col-12 col-xs-12">
							<cfinput type="text" name="to" value="" required="yes" message="Alıcı kişiyi girin!" />
						</div>
					</div>
					<div class="form-group">
						<label class="col col-12 col-xs-12"><cf_get_lang dictionary_id='58820.Başlık'></label>
						<div class="col col-12 col-xs-12">
							<cfinput type="text" name="subject" value="#getLang('hr',13)#" maxlength="256"/>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<cfsavecontent variable = "mail_content">
						<p><cfoutput><cf_get_lang dictionary_id="49699.Sayın Yetkili"> <cf_get_lang dictionary_id="49479.Aşağıda bilgileri bulunan kişilerin işe girişi yapılmıştır"><br><br></cfoutput></p>	  	 
