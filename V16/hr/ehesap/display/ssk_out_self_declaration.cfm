<cfsavecontent variable="message"><cf_get_lang dictionary_id="47128.İşten Ayrılma Bildirgesi(SGK)"></cfsavecontent>
	...
	<cfform name="form_job_declaration" method="post" action="#request.self#?fuseaction=ehesap.popup_new_ssk_worker_out_self">
		<cf_box_elements>
			<div class="form-group" id="item-employee">
				...
				<cfinput type="text" name="employee" id="employee" value="" style="width:150px;" required="Yes" message="#message#" autocomplete="off" onFocus="AutoComplete_Create('employee','EMPLOYEE_NAME,EMPLOYEE_SURNAME,TC_IDENTY_NO,SOCIALSECURITY_NO,RETIRED_SGDP_NUMBER','FULLNAME,BRANCH_NAME','get_in_outs_autocomplete','','FULLNAME,EMPLOYEE_ID,IN_OUT_ID','employee,employee_id,in_out_id','form_job_declaration','3','300');">
