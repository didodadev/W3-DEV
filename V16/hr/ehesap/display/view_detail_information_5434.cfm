<!---
    ...
    Date: 2022-02-12
    Description: Kesenek Detay Bilgileri 5434
    History:
    To Do:
                ...
                <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                    <cfoutput>
                        <table id="tablo_ust_baslik">
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='53806.İşyeri'>:<td> #get_personal.related_company#</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='58608.İl'>/<cf_get_lang dictionary_id='58638.İlçe'>:<td> #get_personal.BRANCH_CITY# / #get_personal.BRANCH_COUNTY#</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='46695.İşyeri Numarası'>:<td> ?</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='64462.Saymanlık Numarası'>:<td> ?</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='65177.Bildirge No'>:<td> ?</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='58472.Dönem'>:<td> #attributes.sal_year# - #attributes.sal_mon#</td></td></tr>
                            <tr class="bold text-left"><td><cf_get_lang dictionary_id='65178.İşlem Zamanı'>:<td> #dateFormat(now(), 'YYYY-MM-DD HH:DD')#</td></td></tr>
                        </table>
                    </cfoutput>
                    ...
                    <table id="tablo_alt_baslik">
                        <tr>
                            <th colspan="4"></th>
                            <th colspan="3" title="<cf_get_lang dictionary_id='63979.Emekliye Esas'>">E.K. Esas</th>
                            <th colspan="2"><cf_get_lang dictionary_id='65176.Ödemeye Esas'></th>
                            <th></th>
                            <th colspan="2"><cf_get_lang dictionary_id='30118.Şahıs'></th>
                            <th colspan="2"><cf_get_lang dictionary_id='57712.Kurum'></th>
                            <th colspan="4"></th>
                        </tr>
                        <tr>
                            ...
                            <th><cf_get_lang dictionary_id='58567.Terfi'><cf_get_lang dictionary_id='58593.Tarihi'></th>
                            <th title="<cf_get_lang dictionary_id='34749.Derece-Kademe'>">D. / K.</th>
                            <th><cf_get_lang dictionary_id='63743.Ek Göstergesi'></th>
                            <th title="<cf_get_lang dictionary_id='34749.Derece-Kademe'>">D. / K.</th>
                            <th><cf_get_lang dictionary_id='63743.Ek Göstergesi'></th>
                            <th><cf_get_lang dictionary_id='65134.Kıdem Hizmeti'></th>
                            <th title="<cf_get_lang dictionary_id='32191.Kesinti'>">% 16 KES</th>
                            <th>% 100 <cf_get_lang dictionary_id='48315.Artış'></th>
                            <th>
                                % 20 KAR
                            </th>
                            <th>% 100 <cf_get_lang dictionary_id='48315.Artış'></th>
                            <th title="<cf_get_lang dictionary_id='53191.Genel Sağlık Sigortası'>">% 12 GSS</th>
                            <th>GHB</th>
                            <th>İPC</th>
                            <th>İNT. TAH.</th>
                        </tr>
                        <cfoutput query="get_personal">
                            ...
                            <cfif get_personal.SSK_STATUTE eq 33>
                                <tr style="border:1px solid ##000;">
                                    <td>#TC_IDENTY_NO#</td>
                                    <td>#RETIRED_REGISTRY_NO#</td> <!--- Emekli Sicil No --->
                                    <td>#EMPLOYEE_NAME# #EMPLOYEE_SURNAME#</td>
                                    <td>0</td> <!--- durum kodu --->
                                    <td>0000</td> <!--- terfi tarihi --->
                                    <td>#GRADE#/#STEP#</td> <!--- emekliye esas derece/kademe --->
                                    <td>#ADDITIONAL_SCORE#</td> <!--- ek gösterge --->
                                    <td>#NORMAL_GRADE# / #NORMAL_STEP#</td> <!--- ödemeye esas derece/kademe --->
                                    <td>#NORMAL_ADDITIONAL_SCORE#</td> <!--- emeklilik ek gösterge --->
                                    ...
                                    <td>#tlformat(RETIREMENT_ALLOWANCE_PERSONAL_INTERRUPTION)#</td><!--- %16 (Puantajdaki Emekli Keseneği Kişi) --->
                                    <td>#tlformat(PLUS_RETIRED)#</td><!--- % 100 Artış (Puantajdaki Artış %100) --->
                                    <td>#tlformat(RETIREMENT_ALLOWANCE)#</td><!--- % 20 (Puantajdaki Emekli Keseneği Devlet)--->
                                    <td>#tlformat(PLUS_RETIRED_PERSONAL)#</td><!--- % 100 Artış (Puantajdaki Kişi Devlet %100) --->
                                    <td>#tlformat(GENERAL_HEALTH_INSURANCE)#</td><!--- % 12 GSS (Puantajda Genel Sağlık Sigortası) --->
                                    <td>0</td>
                                    <td>0</td>
                                    <td>0</td>
                                </tr>
