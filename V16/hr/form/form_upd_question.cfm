...
<cfsavecontent variable="message"><cf_get_lang dictionary_id="55852.Soru Güncelle"></cfsavecontent>
<cf_box title="#GET_QUIZ_CHAPTER.CHAPTER# - #message#"  popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
    <cfform enctype="multipart/form-data" name="upd_question" method="post" action="#request.self#?fuseaction=hr.upd_question">
        ...
        <cf_box_elements>
          <div class="col col-8 col-md-8 col-sm-8 col-xs-12" type="column" index="1" sort="true">
			...
			<div class="form-group" id="item-open_ended">
				...
				<div class="col col-8 col-xs-12">
					<input type="checkbox" name="open_ended" id="open_ended" value="1" <cfif get_question.open_ended eq 1>checked</cfif>  onclick="answershow()">
				</div>
			</div>
					...
					<div class="col col-12 col-md-12 col-sm-12  col-xs-12">
						<div class="form-group" id="item-_photo">
							...
							<div class="col col-8 col-xs-12">
								...
								<!---  <img src="#file_web_path#hr/<cfoutput>#evaluate('get_question.answer'&i+1&'_photo')#</cfoutput>" border="0"> --->
								...
								<cf_get_lang dictionary_id='56325.Resmi sil'> <br/>
								</cfif>
		...
		<cf_box_footer>
            ...
            <cf_workcube_buttons is_upd='0' insert_info='#message#' add_function="(document.upd_question.more.value=1)" is_cancel='0'>
...
function answershow()
            {
            var checked = upd_question.open_ended.checked;
                if(checked ==1)
                {
                
					upd_question.answer_number.disabled=true;
                return true;
                }
                    
                if(checked =="")
                {
					upd_question.answer_number.disabled=false;
