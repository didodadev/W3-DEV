...
<cfform name="search_cv_ajax" method="post" action="#request.self#?fuseaction=hr.upd_cv_ajax">
	<!--- Kişisel bilgiler--->
    <table id="gizli0">
        <tr>
            <td colspan="2">
                <input type="radio" value="0" name="cv_type" id="cv_type" <cfif get_app.cv_type eq 0>checked</cfif> onclick="referans_calistir();"> Güncel Cv
                <input type="radio" value="1" name="cv_type" id="cv_type" <cfif get_app.cv_type eq 1>checked</cfif> onclick="referans_calistir();"> Referanslı Cv
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><cfinput type="text" name="email" value="#get_app.email#" validate="email" style="width:150px;" maxlength="100" message="Mail Adresini Giriniz!"></td>
    ...
    <table style="display:none;" id="gizli2">
        ...
        <tr height="22">
            ...
            <td>
                <cfsavecontent variable="message"><cf_get_lang dictionary_id='55659.veriliş tarihi'></cfsavecontent>
    ...
    <table style="display:none;" id="gizli3">
        <tr>
            ...
            <cf_form_list>
                ...
                <tfoot>
                    <tr>
                        <td colspan="8"><cf_get_lang dictionary_id='252.Eğitim Seviyesi'>
            ...
            <thead>
                <tr>
                    ...
                    <th style="width:100px;"><cf_get_lang dictionary_id='1584.Dil'></th>
                    <th style="width:100px;"><cf_get_lang dictionary_id='1073.Konuşma'></th>
                    <th style="width:100px;"><cf_get_lang dictionary_id='1074.Anlama'></th>
                    <th style="width:100px;"><cf_get_lang dictionary_id='1075.Yazma'></th>
                    <th><cf_get_lang dictionary_id='1076.Öğrenildiği Yer'></th>
                </tr>
            </thead>
                    ...
                    <tr id="lang_info_#currentrow#">
                        ...
                        <td>
                            <select name="lang#currentrow#" id="lang#currentrow#" style="width:100px;">
                                <option value=""><cf_get_lang dictionary_id='1584.Dil'></option>
            ...
            <table>
                <tr>
                    <td class="txtbold" colspan="6"><cf_get_lang dictionary_id='1077.Kurs - Seminer ve Akademik Olmayan Programlar'></td>
                </tr>
            </table>
            <cf_form_list>
                <thead>
    ...
    <!---Referans Bilgileri --->
    <table style="display:none;" id="gizli5">
        <tr>    
            <td>
                <table>
                    <tr>
                ...
                <cf_form_list>
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width="75"><cf_get_lang dictionary_id="31063.Referans Tipi"></th>
                            <th width="100"><cf_get_lang dictionary_id="57570.Ad Soyad"></th>
                            <th width="100"><cf_get_lang dictionary_id="57574.Şirket"></th>
                            <th width="100"><cf_get_lang dictionary_id="30316.Tel.Kod"></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <cfif isdefined("get_app.related_ref_name") and len(get_app.related_ref_name)>
                                <cfinput type="text" name="related_ref_name" style="width:200px;" maxlength="100" value="#get_app.related_ref_name#">
                            <cfelse>
                                <cfinput type="text" name="related_ref_name" style="width:200px;" maxlength="100" value="">
                            </cfif>
                        </td>
                        ...
                        <td>
                            <cfif isdefined("get_app.related_ref_company") and len(get_app.related_ref_company)>
                                <cfinput type="text" name="related_ref_company" style="width:200px;" maxlength="100" value="#get_app.related_ref_company#">
                            <cfelse>
                                <cfinput type="text" name="related_ref_company" style="width:200px;" maxlength="100" value="">
                            </cfif>
                        </td>
                    </tr>
                </table>
    ...
    <!---Özel İlgi Alanları --->
    <table style="display:none;"  id="gizli6">
        <tr>
            <td valign="top"><cf_get_lang dictionary_id='56168.Özel İlgi Alanları'></td>
            <td valign="top" colspan="2"><textarea name="hobby" id="hobby" style="width:250px;" message="<cfoutput>#textmessage#</cfoutput>" maxlength="150" onkeyup="return ismaxlength(this);" onBlur="return ismaxlength(this);"><cfoutput>#get_app.hobby#</cfoutput></textarea></td>
        </tr>
        <tr>
            <td><cf_get_lang dictionary_id='56169.Üye Olunan Klüp Ve Dernekler'></td>
            <td><textarea name="club" id="club" style="width:250px;" message="<cfoutput>#textmessage#</cfoutput>" maxlength="250" onkeyup="return ismaxlength(this);" onBlur="return ismaxlength(this);"><cfoutput>#get_app.club#</cfoutput></textarea></td>
        </tr>
    </table>
    <!---Aile Bilgileri --->
                ...
                <cfoutput query="get_relatives">
                    ...
                    <tr id="frm_row#currentrow#">
                        ...
                        <td nowrap="nowrap">
                            ...
                            <input type="checkbox" name="education_status_relative#currentrow#" id="education_status_relative#currentrow#" value="1" <cfif get_relatives.education_status eq 1>checked</cfif>><cf_get_lang dictionary_id="398.Okuyor">
                        </td>
    ...
    <table style="display:none;" id="gizli8">
        <tr>
            <td colspan="2">(<cf_get_lang dictionary_id='56173.Öncelik sıralarını yandaki kutulara yazınız'>...)</td>
        </tr>
    ...
    <!---Ek Bilgiler --->
    <table style="display:none;" id="gizli10">
        <tr>
            <td height="25"><STRONG><cf_get_lang dictionary_id='55329.Çalışmak İstediğiniz Şehir'></STRONG></td>
        </tr>
        <tr>
            <td valign="top">
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                        <td><strong><cf_get_lang dictionary_id ='56489.İstenilen Ücret (Net)'></strong></td>
                        <td>
                            <cfinput type="text" name="expected_price" style="width:120px;"  value="#TLFormat(get_app.expected_price)#" onkeyup="return(FormatCurrency(this,event));" class="moneybox">
        ...
        <tr>
            <td colspan="2"><textarea name="applicant_notes" id="applicant_notes" message="<cfoutput>#textmessage#</cfoutput>" maxlength="300" onkeyup="return ismaxlength(this);" onBlur="return ismaxlength(this);" rows="4"  style="width:530px;"><cfoutput>#GET_APP.APPLICANT_NOTES#</cfoutput></textarea></td>
        </tr>
        <tr>
            <td><STRONG><cf_get_lang dictionary_id="55785.Mulakat Görüşü"></STRONG></td>
        </tr>
        <tr>
            <td colspan="2"><textarea name="interview_result" id="interview_result" style="width:530px;" message="<cfoutput>#textmessage#</cfoutput>" maxlength="500" onkeyup="return ismaxlength(this);" onBlur="return ismaxlength(this);" rows="5"><cfif isdefined("get_app.interview_result") and len(get_app.interview_result)><cfoutput>#get_app.interview_result#</cfoutput></cfif></textarea></td>
        </tr>
    </table>
    <!---Ek Bilgiler --->
</cfform>
