<cfset target_date=dateformat(now(),dateformat_style)>
<cfset pos_code_list= "">
...
<cfif GET_TARGET.recordcount>
	<cfoutput query="GET_TARGET">
		<cfif get_all_mails.recordcount>
			...
			<cfmail from="#session.ep.company#<#session.ep.company_email#>" to="#get_employee_mail.EMPLOYEE_EMAIL#" cc="#get_record_mail.EMPLOYEE_EMAIL#" subject="Hedef Bildirimi" type="html">
					...
					<td>
					  <table cellspacing="1" cellpadding="2" width="100%" border="0">
						...
						<tr bgcolor="##FFFFFF">
						  ...
						  <table align="left">
							<tr>
								<td style="font-size:11px;font-family: Geneva,  tahoma, arial,Helvetica, sans-serif;"><cf_get_lang dictionary_id="41084.İyi Çalışmalar">. #GET_TARGET.TARGET_HEAD# <cf_get_lang dictionary_id="41083.Adınıza Kayıtlı  Hedef Kaydının Yarın Son Günüdür">...<cf_get_lang dictionary_id="41082.İlgili Hedef Bilgilerine Aşağıdaki Linki Tıklayarak Ulaşabilirsiniz">!</td>
							</tr>
							</tr>
								<td style="font-size:11px;font-family: Geneva,  tahoma, arial,Helvetica, sans-serif;"><br/><b><a href="http://ep.workcube/index.cfm?fuseaction=myhome.my_targets" class="tableyazi"><cf_get_lang dictionary_id="41079.İlgili Hedef Kaydı"></b></a></td>
							<tr>
								<td>&nbsp;</td>
							</tr>
						  </table>
