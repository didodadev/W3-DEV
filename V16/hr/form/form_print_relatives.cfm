...
<cfsavecontent variable="right">
	<cf_workcube_file_action pdf='1' mail='1' doc='1' print='1' trail='0' simple="1" tag_module="relatives_div" is_ajax="1">
</cfsavecontent>
<!-- sil -->
</cfif>
...
<cfsavecontent variable="title"><cf_get_lang dictionary_id="30884.AİLE DURUMU BİLDİRİMİ"></cfsavecontent>
<div class="col col-12 col-xs-12">
	<cf_box title="#title#"  right_images="#right#"  collapsable="0" resize="0">
	<div id="relatives_div">
	<cfoutput query="get_in_outs">
		<table style="width:275mm;" class="book">
			<tr>
	...
	<table border="1" style="width:275mm;" cellpadding="3" cellspacing="0" bordercolor="000000" class="book">
		<tr height="22">
