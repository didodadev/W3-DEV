...
<!--- <cfif not GET_PERFORMANCE.RECORDCOUNT>
	<script type="text/javascript">
		alert('Görüntülemek istediğiniz forma yetkiniz yok veya silinmiş!');
		window.close();
	</script>
	<cfabort>
</cfif> --->
...
<!---eğer form kaydedeildi ise yetkinlik idler tabolodan alınıyor değilse querylerle--->
...
<div id="add_req_type_div">
	<!---<cf_popup_box title="#lang_array.item[18]#" id="yetkinlikler">--->
  	<cfform name="add_quiz" method="post" action="#request.self#?fuseaction=hr.emptypopup_add_req_type_quiz">
        ...
        <input type="hidden" name="get_quiz_chapters_rec" id="get_quiz_chapters_rec" value="<cfoutput>#get_quiz_chapters.recordcount#</cfoutput>">
        <cfif get_quiz_chapters.recordcount>
            ...
            <cfsavecontent variable="message"><cf_get_lang dictionary_id="57907.Yetkinlik"></cfsavecontent>
			...
			<table id="b_#get_quiz_chapters.currentrow#">
            	...
            	<input type="hidden" name="get_quiz_questions_rec_#get_quiz_chapters.currentrow#" id="get_quiz_questions_rec_#get_quiz_chapters.currentrow#" value="<cfoutput>#get_quiz_questions.recordcount#</cfoutput>">
                        ...
                        <td>
                            <table>
                                ...
                                <cfloop query="get_quiz_questions">
                                    ...
                                    <tr class="color-row">
                                        <td class="txtboldblue"> #get_quiz_questions.question# </td>
            ...
            <table>
                <tr>
                	<td valign="top" nowrap><cf_get_lang dictionary_id='57629.Acıklama'><textarea name="expl_#get_quiz_chapters.currentrow#" id="expl_#get_quiz_chapters.currentrow#" value="" cols="70" rows="2">#EVALUATE("chapter_exp_#get_quiz_chapters.currentrow#.EXPLANATION")#</textarea></td>
                </tr>
            </table>
			</cfoutput>
        <cfelse>
        ...
        <table width="99%">
            <tr>
                <td><cf_record_info query_name="GET_EMP_QUIZ_ANSWERS"></td>
				<cfif not (IsDefined('attributes.is_closed') and attributes.is_closed eq 1)>
