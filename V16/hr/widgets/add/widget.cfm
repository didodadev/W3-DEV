...
<cfform method="POST" action="#strUrl#" name="hr_add">
<input type="hidden" name="submited" value="1">
<input type="hidden" name="is_mandate" value="<cfoutput>#attributes.is_mandate#</cfoutput>">
<cf_box_elements>
     <div class="col col-6 col-xs-12" type="row" index="1" sort="true" data-formulacontainer="mandate">
          <cfif 1 eq 1 >
               <div class="form-group" id="item-process_stage">
                    <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='36841.Süreç'>*</label>
                         ...
                         <div class="col col-8 col-xs-12">
                              ...
                              <cfelse>
                                   <div class="input-group">
                                        ...
                                        <cfoutput><input type="text" name="employee_name" id="mandate_employee_name_" value="#iif(isDefined("attributes.is_mandate") and attributes.is_mandate eq 1, "get_emp_info(session.ep.userid,0,0)", DE(''))#"></cfoutput>
                                        <span class="input-group-addon btnPointer icon-ellipsis" onclick="windowopen('index.cfm?fuseaction=objects.popup_list_emps&field_id=mandate_employee_id_&field_name=mandate_employee_name_&select_list=1', 'list')"></span>                                 
                                   </div>
                              </cfif>
                         </div>
                    </div>
                         ...
                         <div class="col col-8 col-xs-12">
                              ...
                              <cfelse>
                                   ...
                                   <cfoutput><input type="hidden" name="mandate_id" id="mandate_mandate_id_" value="#iif(isDefined("mandate_query"), "mandate_query.mandate_id", DE(session.ep.userid))#"></cfoutput>
                                        <cfoutput><input type="text" name="mandate_name" id="mandate_mandate_name_" value="#iif(isDefined("attributes.is_mandate") and attributes.is_mandate eq 0, "get_emp_info(session.ep.userid,0,0)", DE(''))#"></cfoutput>
                                        <span class="input-group-addon btnPointer icon-ellipsis" onclick="windowopen('index.cfm?fuseaction=objects.popup_list_emps&field_id=mandate_mandate_id_&field_name=mandate_mandate_name_&select_list=1', 'list')"></span>
                                   </div>
                              </cfif>
                         </div>
                    </div>
          ...
          <cfelse>
               <cfoutput><input type="hidden" name="startdate" id="mandate_startdate" value="#iif(isDefined("mandate_query"), "mandate_query.startdate", DE(''))#"></cfoutput>
          </cfif>
          <cfif 1 eq 1 >
          ...
          <cfelse>
               <cfoutput><input type="hidden" name="finishdate" id="mandate_finishdate" value="#iif(isDefined("mandate_query"), "mandate_query.finishdate", DE(''))#"></cfoutput>
          </cfif>
          <cfif 1 eq 1 >
               <div class="form-group" id="item-detail">
                    <label class="col col-4 col-xs-12"><cf_get_lang dictionary_id='36199.Açıklana'></label>
                    <div class="col col-8 col-xs-12">
                         <cfif isDefined("attributes.is_mandate") and attributes.is_mandate eq 1>
                         ...
                         <cfelse>
                              <cfoutput><input type="text" name="detail" id="mandate_detail_" value="#iif(isDefined("mandate_query"), "mandate_query.detail", DE(''))#"    ></cfoutput>
                         </cfif>
                    </div>
               </div>
          <cfelse>
