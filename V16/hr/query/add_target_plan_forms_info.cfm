...
<script>
	window.location.href = "<cfoutput>#request.self#?fuseaction=hr.list_target_perf&event=upd&per_id=#get_perform.max_per_id#&pos_code=#attributes.position_code#</cfoutput>";
</script>