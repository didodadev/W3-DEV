...
<cfif not session.ep.ehesap>
	<cfquery name="get_kontrol" datasource="#dsn#">
		...
		WHERE
            ...
            E.EMPLOYEE_ID = EP.EMP_ID AND
            (E.UPPER_POSITION_CODE IN (#position_list#) OR E.UPPER_POSITION_CODE2 IN (#position_list#) OR EP.EMP_ID = #session.ep.userid#)
			<!---(	
	...
	<cfif not get_kontrol.recordcount>
		<script type="text/javascript">
			alert("<cf_get_lang no ='1748.Bu formu görüntülemeye yetkiniz yok'>!");
