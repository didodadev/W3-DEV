<cfif isdefined("attributes.start_date") and isdefined("attributes.finish_date")>
	...
	<cfif get_per_form.recordcount>
		<script type="text/javascript">
			alert("<cf_get_lang no ='1741.Tarih aralığında çalışan için form eklenmiştir'>");
			history.back(-1);
		</script>
		<cfabort>
	</cfif>
...
<cflocation url="#request.self#?fuseaction=hr.popup_form_add_req_type_result&position_code=#attributes.position_code#&result_id=#attributes.result_id#&per_id=#attributes.per_id#" addtoken="no">
