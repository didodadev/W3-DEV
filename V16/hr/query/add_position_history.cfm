...
<cfquery name="GET_NEW_POS_ROW" datasource="#DSN#">
	SELECT 
    	POSITION_ID, 
        POSITION_CAT_ID, 
        T_ID, 
    ...
    FROM 
	    EMPLOYEE_POSITIONS 
    WHERE 
    	POSITION_ID = #history_position_id#
</cfquery>
<cfquery name="ADD_TO_HISTORY" datasource="#DSN#">
	INSERT INTO
	...
	(
		...
		<cfif len(GET_NEW_POS_ROW.POSITION_STAGE)>#GET_NEW_POS_ROW.POSITION_STAGE#<cfelse>NULL</cfif>,
		#now()#
	)
</cfquery>
