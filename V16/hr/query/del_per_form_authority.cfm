<cfif isdefined("attributes.per_req_id")>
	...
	<cflocation url="#request.self#?fuseaction=hr.popup_upd_per_form_autority&per_req_id=#attributes.per_req_id#" addtoken="no">
<cfelseif isdefined("attributes.per_rot_id")>
	...
	<cflocation url="#request.self#?fuseaction=hr.popup_upd_per_form_autority&per_rot_id=#attributes.per_rot_id#" addtoken="no">
</cfif>
