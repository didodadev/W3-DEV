...
<cfquery name="CHECK_TABLE" datasource="#dsn2#">
	IF EXISTS (SELECT * FROM tempdb.sys.tables where name='####GET_EXPENSE_PROJECT_#session.ep.userid#')
    DROP TABLE ####GET_EXPENSE_PROJECT_#session.ep.userid#
</cfquery>
<cfquery name="GET_EXPENSE_ITEM" datasource="#dsn2#">
    ...
    INTO ####GET_EXPENSE_PROJECT_#session.ep.userid#
    FROM
    (
	SELECT 
			PROJECT_ID,
...
<cfquery name="GET_EXPENSE_BUDGET" datasource="#dsn2#">
    ...
    FROM
    	####GET_EXPENSE_PROJECT_#session.ep.userid# AS GEC
...
<cfelse>
	...
	<thead>	
		...
		<tr>
			...
			<th nowrap><cf_get_lang dictionary_id='58234.Bütçe Kalemi'></th>
			<cfif isdefined("attributes.is_income")>
