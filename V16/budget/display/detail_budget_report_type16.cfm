...
<thead>	
    <tr>
        ...
        <cfif isdefined("attributes.ei_diff")>				
            <th colspan="16" align="center" nowrap><cf_get_lang dictionary_id='60912.Gelir-Gider Farkı'></th>
        </cfif>
    </tr>
    <tr>
        ...
        <cfif isdefined("attributes.is_income")>
            ...
            <cfif isdefined("attributes.transfer")>				
                <th width="110" align="center" nowrap><cf_get_lang dictionary_id='61517.Aktarılan Tutar'> </th>
                <th nowrap><cf_get_lang dictionary_id='57489.Para Birimi'></th>
