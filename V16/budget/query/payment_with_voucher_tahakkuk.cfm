...
<cfif isdefined ("attributes.paper_table_") and (attributes.paper_table_ is 'TAHAKKUK_PLAN')>
	<cfscript>
			...
			<cfloop from="1" to="#attributes.record_num#" index="i">
				<cfif isdefined("attributes.row_kontrol#i#") and evaluate("attributes.row_kontrol#i#") eq 1>
					...
					<cfif attributes.db_type neq 1 and not isdefined("attributes.act_row_id#i#")>
						<cfquery name="add_invoice_payment_plan" datasource="#dsn2#">
							INSERT INTO
								#dsn3_alias#.TAHAKKUK_PAYMENT_PLAN
							(
								TAHAKKUK_ID,
								PERIOD_ID,
								COMPANY_ID,
                    ...
                    <cfelseif attributes.db_type neq 1 and isdefined("attributes.act_row_id#i#") and len(evaluate("attributes.act_row_id#i#"))>
                    	<cfquery name="upd_invoice_payment_plan" datasource="#dsn2#">
                        	...
                        	WHERE
                            	TAHAKKUK_PAYMENT_PLAN_ID = #evaluate("attributes.act_row_id#i#")#
                        </cfquery>
                    </cfif>
                <cfelseif isdefined("attributes.act_row_id#i#") and len(evaluate("attributes.act_row_id#i#"))>
                    <cfquery name="del_invoice_payment_plan" datasource="#dsn2#">
                        DELETE FROM #dsn3_alias#.TAHAKKUK_PAYMENT_PLAN WHERE TAHAKKUK_PAYMENT_PLAN_ID = #evaluate("attributes.act_row_id#i#")#
                    </cfquery>
				</cfif>
			</cfloop>			
			<cfif attributes.paper_table_ is 'TAHAKKUK_PLAN'>
				...
				<cfquery name="UPD_INV" datasource="#dsn2#"> <!--- parcalı cari işlem yapıldıgı tutuluyor --->
					UPDATE 
                    	#dsn3_alias#.TAHAKKUK_PLAN 
                    SET 
                    	CARI_ACTION_TYPE = 5,
                        DUE_DATE = #attributes.average_due_date# <!--- vade ortalama vade ile update ediliyor --->
                    WHERE 
                    	TAHAKKUK_PLAN_ID = #attributes.paper_action_id#
				</cfquery>                
                <cfquery name="UPD_INV_ROW" datasource="#dsn2#"> <!--- satirlardaki vade günü update ediliyor --->
					UPDATE 
                    	#dsn3_alias#.TAHAKKUK_PLAN_ROW
                    SET 
                        ROW_DUE_VALUE = #abs(datediff('d',attributes.paper_action_date,attributes.average_due_date))# 
                    WHERE 
                    	TAHAKKUK_PLAN_ID = #attributes.paper_action_id#
				</cfquery>
			</cfif>
