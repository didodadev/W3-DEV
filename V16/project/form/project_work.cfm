...
<cfif not ((isdefined("attributes.project_id") and len(attributes.project_id)) or (isdefined("attributes.uploaded_file") and len(attributes.uploaded_file)))>
    <cfsavecontent variable="title"><cf_get_lang dictionary_id='38439.İş Kopyala'></cfsavecontent>
        ...
        <table>
            <tr valign="top">
                <td>
                    <table border="0">
                        <tr>
							<td width="70"><cf_get_lang dictionary_id='36068.Import Tipi'></td>
                            <td>
                            <select name="import_type" id="import_type" style="width:130px;" onchange="imp_type();">
                        ...
                        <tr id="form_ul_no_id_type" style="display:none">
                        	<td width="70">
                            	Tip
                            </td>
                        	<td>
                ...
                <td>
                    <table>
                        ...
                        <tr id="form_ul_help_file_related_work" style="display:none">
                            <td>
                                <cftry>
            ...
            <cfif row_error_flag eq 0>
                ...
                <cfquery name="ADD_WORK_HISTORY" datasource="#DSN#">
                    ...
                    ( 
                        ...
                        <cfif len(gorevli) and gorevli neq 0>#gorevli#<cfelse>#xml_project_emp_id#</cfif>,
                        <cfif len(isno)>'#isno#'<cfelse>NULL</cfif>,
                        <cfif len(konu) gt 100>'#left(konu,100)#'<cfelse>'#konu#'</cfif>,
                        <cfif isdefined("pbskodu") and isdefined("get_pbs_code_id.pbs_id") and len(get_pbs_code_id.pbs_id)>#get_pbs_code_id.pbs_id#<cfelse>NULL</cfif>,
                        '<P>#aciklama#</P>',
...
<cfelse>	
	...
	<table width="98%" align="center">
		<tr>
			<td height="35" class="headbold" colspan="6"><cf_get_lang dictionary_id='38213.Is'> <cf_get_lang dictionary_id='57476.Kopyala'>(<cf_get_lang dictionary_id='57416.Proje'> : <cfoutput>#get_project.project_head#</cfoutput>)</td>
		</tr>
	</table>
	...
	<cfform name="add_project_work" method="post" action="#request.self#?fuseaction=project.emptypopup_add_project_work">
		<tr class="color-header" height="22">
			<td class="form-title" style="width:30px;">
				...
				<cfif get_pro_works.recordcount><input type="checkbox" name="all_work" id="all_work" value="1" onclick="hepsini_sec();" checked></cfif>
            </td>
			<td class="form-title" style="width:20px;"><cf_get_lang dictionary_id='57487.No'></td>
			<td class="form-title"><cf_get_lang dictionary_id='57480.Başlık'></td>
			<td class="form-title" style="width:112px;"><cf_get_lang dictionary_id='57569.Görevli'></td>
			<td class="form-title" style="width:100px;"><cf_get_lang dictionary_id='57485.Öncelik'></td>
			<td class="form-title" style="width:170px;"><cf_get_lang dictionary_id='57501.Baslangıc'></td>
			<td class="form-title" style="width:170px;"><cf_get_lang dictionary_id='57502.Bitiş'></td>
			<td class="form-title" style="width:100px;"><cf_get_lang dictionary_id='57482.Aşama'></td>
			<td class="form-title" style="width:100px;"><cf_get_lang dictionary_id='57486.Kategori'></td>
			<td class="form-title" style="width:150px;">Milestone</td>
            <td class="form-title" style="width:50px;">CC <cf_get_lang dictionary_id='57476.Kopyala'></td>
            <td class="form-title" style="width:30px;"><cf_get_lang dictionary_id='36212.Mail'></td>
		</tr>
	<cfif get_pro_works.recordcount>
	  <cfoutput query="get_pro_works">
		...
		<tr id="frm_row#currentrow#" onmouseover="this.className='color-light';" onmouseout="this.className='color-row';" class="color-row">
			...
			<td>#currentrow#</td>
			<td><input type="text" class="boxtext" name="work_head#currentrow#" id="work_head#currentrow#" <cfif type eq 0>style="color:red;font-weight:bold;width:250px;"<cfelse>style="width:250px;"</cfif> maxlength="100" value='<cfif type eq 0>(M) #work_head#<cfelse>&nbsp;&nbsp;&nbsp;#work_head#</cfif>'></td>
			<td>
			...
			<td>
				<input type="text" name="work_h_start#currentrow#" id="work_h_start#currentrow#" value="#dateformat(row_sdate,dateformat_style)#" maxlength="10" style="width:65px;">
				<cf_wrk_date_image date_field="work_h_start#currentrow#">
			...
			<td>
				<input type="text" name="work_h_finish#currentrow#" id="work_h_finish#currentrow#" value="#dateformat(row_fdate,dateformat_style)#" maxlength="10" style="width:65px;">
				<cf_wrk_date_image date_field="work_h_finish#currentrow#">
				<select name="finish_hour#currentrow#" id="finish_hour#currentrow#" >
					<cfloop from="0" to="23" index="i">
			...
			<td><select name="pro_work_cat#currentrow#" id="pro_work_cat#currentrow#" style="width:100px;">
            ...
            <td style="text-align:right;"><input type="checkbox" value="1" name="copy_cc#currentrow#" id="copy_cc#currentrow#"></td>
            <td style="text-align:right;"><input type="checkbox" value="1" name="mail#currentrow#" id="mail#currentrow#"></td>
		</tr>
	  </cfoutput>
		<tr class="color-row">
