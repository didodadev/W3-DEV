    ...
    <div class="row">
        <div class="col col-8 col-xs-12 uniqueRow"><!---content sağ--->
            ...
            <cf_box id="comments"               
                    ...
                    closable="0"
                    add_href_size="wide"
                    box_page="#request.self#?fuseaction=project.emptypopup_work_comment&id=#attributes.id#">					
            </cf_box>		
        </div>        
        <div class="col col-4 col-xs-12 uniqueRow"><!--- content sol--->
            ...
            <cfinclude  template="../display/Work_TimeGetAdd.cfm"><!--- Zaman Harcamaları --->
                ...
                <cfif PROC_TYPE eq "pullrequest">
                    <div>
                        ...
                        <cfif qbitbucket_hooks.STATE eq 'MERGED'>
                            <cfif len(qbitbucket_hooks.NOTE_ROW_ID)><i class="fa fa-book fa-1-3x text-success" title="<cf_get_lang dictionary_id = '61189.Release Notu'>" style="position: relative;top: 2px;" onclick="cfmodal('#request.self#?fuseaction=objects.release_notes_row&note_row_id=#qbitbucket_hooks.NOTE_ROW_ID#','warning_modal')"></i>
                            <cfelse><i class="fa fa-book fa-1-3x text-danger" title="<cf_get_lang dictionary_id = '61189.Release Notu'>" style="position: relative;top: 2px;" onclick="cfmodal('#request.self#?fuseaction=objects.release_notes_row&task_id=#attributes.id#&hook_id=#qbitbucket_hooks.HOOKID#','warning_modal')"></i></cfif>
                        </cfif>
                ...
                <cfif get_release_note_row.recordcount>
                    ...
                    <div id="release_notes">
                        <cfoutput query = "get_release_note_row">
                            <div>
                                <a href="javascript://" onclick="cfmodal('#request.self#?fuseaction=objects.release_notes_row&event=upd&note_row_id=#NOTE_ROW_ID#','warning_modal')"><h3>#NOTE_ROW_TITLE#</h3></a>
