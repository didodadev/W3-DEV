...
<cfform action="#request.self#?fuseaction=project.popup_ajax_project_graph&iframe=1" method="post" name="form_work">
    <cf_ajax_list_search>
        ...
        <script src="JS/Chart.min.js"></script>
            ...
            <cfsavecontent variable="durum"><cf_get_lang dictionary_id ='57756.Durum'></cfsavecontent>
                ...
                <cfif not get_projects.recordcount>
                    <cf_get_lang dictionary_id='57484.Proje Kaydı Bulunamadı'>
