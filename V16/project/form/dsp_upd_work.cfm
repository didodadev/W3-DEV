...
<cf_xml_page_edit fuseact="project.addwork">
        ...
        <cf_box>
            <cfform name="upd_work" id="upd_work" method="post" action="#request.self#?fuseaction=project.emptypopup_upd_work">
                ...
                <cf_box_elements id="genel_bilgiler" vertical="1">
                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="6" sort="true">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <cfif isdefined('xml_is_work_finishdate') and xml_is_work_finishdate eq 1>
                                        <cfinput type="text" name="estimated_time" id="estimated_time" validate="integer" message="#message#" value="#saat#" onKeyUp="isNumber(this);"  onBlur="estimated_finishdate(this.value,'hour')">
                                        ...
                                        <cfinput type="text" name="estimated_time_minute" id="estimated_time_minute" value="#dak#"  onKeyUp="isNumber(this);" range="0,59" onBlur="estimated_finishdate(this.value,'minute')" message="#message#">
                                        <span class="input-group-addon no-bg "><cf_get_lang dictionary_id='58827.Dk'></span>
                                    <cfelse>
                                        <cfinput type="text" name="estimated_time" id="estimated_time" validate="integer" message="#message#" value="#saat#" onKeyUp="isNumber(this);" >
                                        <span class="input-group-addon no-bg"><cf_get_lang dictionary_id ='57491.Saat'></span>
                                            <cfsavecontent variable="message"><cf_get_lang dictionary_id='60617.Lütfen 60dan Küçük Bir Değer Giriniz'></cfsavecontent>
                                        <cfinput type="text" name="estimated_time_minute" id="estimated_time_minute" value="#dak#"  onKeyUp="isNumber(this);" range="0,59" message="#message#">
                                        <span class="input-group-addon no-bg "><cf_get_lang dictionary_id='58827.Dk'></span>
                                    </cfif>
                        ...
                        <div class="form-group" id="item-form_ul_expected_budget">
                            ...
                            <div class="col col-6 col-md-6 col-sm-6 col-xs-12">
                                    <cfinput type="text" name="expected_budget"  value="#TLFormat(upd_work.expected_budget)#" passthrough="onkeyup=""return(formatcurrency(this,event));""" class="moneybox">
                            </div>
                            <div class="col col-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <div class="form-group" id="item-form_ul_purchase_contract_amount">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                <cfinput type="text" name="purchase_contract_amount" value="#TLFormat(upd_work.purchase_contract_amount)#" passthrough="onkeyup=""return(formatcurrency(this,event));"""  class="moneybox">
                            </div>
                        </div>
                        <div class="form-group" id="item-form_ul_sale_contract_amount">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                <cfinput type="text" name="sale_contract_amount" value="#TLFormat(upd_work.sale_contract_amount)#" passthrough="onkeyup=""return(formatcurrency(this,event));"""  class="moneybox">
                            </div>
                        </div>
                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="7" sort="true">
                        ...
                        <div class="form-group" id="item-form_ul_work_status">
                            <!--- <label class="hide"><cf_get_lang dictionary_id='57493.Aktif'>/<cf_get_lang dictionary_id="57475.Mail Gönder">/<cf_get_lang dictionary_id='38134.Rework'></label> --->
                ...
                <div class="ui-form-list-btn">	<!---/// footer alanı record info ve submit butonu--->
                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12"><cf_workcube_buttons is_upd='1' add_function='chk_work(#upd_work.project_id#)' delete_page_url='#request.self#?fuseaction=project.emptypopup_delwork&id=#upd_work.work_id#&head=#work_head_#'></div> <!---///butonlar--->
                </div>   
                        <!---<cf_seperator id="tarihce" header="#getLang('main',61)#">
                        <cfsavecontent variable="head"><cfoutput>#getLang('main',61)#</cfoutput></cfsavecontent>
                        <cf_box 
                            title="#head#"
                            id="box_followup"
                            closable="0"
                            ...
                            <cfoutput>
                                <cfif get_work_history.recordcount>
                                    <cfif len(upd_work.work_circuit) and workcube_mode eq 0>
                                        <div class="row" style="background-color: ##E6E6E6;">
                                            <div class="col col-12">
                                                <label>#user_domain##request.self#?fuseaction=#upd_work.work_circuit#.#upd_work.work_fuseaction#</label>
                                            </div>
                                        </div>
                                    </cfif>
                                        <div class="row">
                                            <div class="col col-12" id="works_history">
                                                <div id="_works_history_"></div>
                                            </div>
                                        </div>
                                    <script type="text/javascript">
                                        <cfoutput>
...
<script type="text/javascript">
	...
	function kontrol()
	{
        ...
        if(gelen>100){
            alert("<cf_get_lang dictionary_id='38276.Tamamlanma % si 0-100 arasında olmalıdır!'>");
            return false;
        }else if (gelen<0) {
            alert("<cf_get_lang dictionary_id='38276.Tamamlanma % si 0-100 arasında olmalıdır!'>");           
        }else if (gelen == ''){
		...
		{
			alert (" <cf_get_lang dictionary_id='38201.Görevli Secmelisiniz'> !");
			return false;
		}	
		
		if (document.getElementById('priority_cat').value == "")
		{ 
			alert ("<cf_get_lang dictionary_id='58194.Zorunlu Alan'> : <cf_get_lang dictionary_id='57485.Öncelik'>");
			return false;
		}
		
		if (document.getElementById('pro_work_cat').value == "")
		{ 
			alert ("<cf_get_lang dictionary_id='58194.Zorunlu Alan'> : <cf_get_lang dictionary_id='38177.Is Kategorisi'>");
			return false;
		}
		...
		<cfif isDefined('xml_pro_work_date') and xml_pro_work_date eq 1>
			if(document.getElementById('project_id').value != "")
			{
				...
				{
					alert("<cf_get_lang dictionary_id ='38314.Girdiginiz Isin Hedef Baslangiç Tarihi Bagli Oldugu Projenin Hedef Baslangiç Tarihinden Önce Görünüyor Lütfen Düzeltin '>!");
				}
				if(tarih3_ != '' && tarih3_ > tarih4_)
				{
					alert("<cf_get_lang dictionary_id ='38315.Girdiginiz Isin Hedef Bitis Tarihi Projesinin Hedef Bitis Tarihinden Sonra Gözüküyor Lütfen Düzeltin'>!");
				} 
			}
		</cfif>
		unformat_fields();
	...
	function open_related_works()
	{
		if(document.getElementById('project_id').value == '')
		{
			alert("<cf_get_lang dictionary_id='60618.Iliskili Is Seçmek Için Proje Seçiniz'>!");
			return false;
		}
		else
		{
