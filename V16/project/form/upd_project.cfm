...
<cfsavecontent variable="message"><cf_get_lang dictionary_id='57416.proje'>: <cfoutput>#attributes.id#</cfoutput></cfsavecontent> 
    <cf_box id="FormAddProject" <!--- closable="0" collapsable="0" title="#message#"  --->> 
        ...
        <cfform method="post" name="UPD_PRO">
            <cf_box_elements addcol="1">
                ...
                <cfif len(data_project.company_id)>
                    <cf_duxi name="company_name" id="company_name" type="text" data="data_project.fullname" hint="şirket" label="57574" threepoint="#request.self#?fuseaction=objects.popup_list_pars&field_comp_id=UPD_PRO.company_id&field_comp_name=UPD_PRO.company_name&field_partner=UPD_PRO.partner_id&field_consumer=UPD_PRO.consumer_id&field_partner_name_surname=UPD_PRO.partner_name&select_list=2,3">
                ...
                <cfelse>
                    <cf_duxi name="company_name" id="company_name" type="text" data="" hint="şirket" label="57574" threepoint="#request.self#?fuseaction=objects.popup_list_pars&field_comp_id=all.company_id&field_comp_name=all.company_name&field_partner=all.partner_id&field_consumer=all.consumer_id&field_partner_name_surname=all.partner_name&par_con=1&select_list=2,3">
                ...
                <cf_duxi name="project_head" type="text" icon="icon-book btnPointer" onchange="dictionary_id.value='';" value="#project_head#" hint="proje adı" icon_boxhref="#request.self#?fuseaction=settings.popup_list_lang_settings&is_use_send&lang_dictionary_id=UPD_PRO.dictionary_id&lang_item_name=UPD_PRO.project_head" label="38244">   
                <cf_duxi name="project_detail" type="textarea" data="data_project.project_detail" hint="açıklama"  label="57629">  
                ...
                <cfif len(data_project.related_project_id) > 
                    <cf_duxi name="related_project_head" type="text" data="data_project.related_project_head" hint="ilişkili proje"  label="34997" threepoint= "#request.self#?fuseaction=objects.popup_list_projects&project_head=UPD_PRO.related_project_head&project_id=UPD_PRO.related_project_id">   
                <cfelse>  
                    <cf_duxi name="related_project_head" type="text" data="" placeholder="58459" label="34997" threepoint= "#request.self#?fuseaction=objects.popup_list_projects&project_head=UPD_PRO.related_project_head&project_id=UPD_PRO.related_project_id">  
                </cfif>     
                <cf_duxi name="expected_budget" type="text" data_control="money" currencyname="BUDGET_CURRENCY" currencyvalue="data_project.BUDGET_CURRENCY"  data="data_project.expected_budget" hint="Tahmini Bütçe"  label="38175"> 
                <cf_duxi name="expected_cost" type="text" data_control="money" currencyname="COST_CURRENCY" currencyvalue="data_project.COST_CURRENCY"   data="data_project.expected_cost" hint="Tahmini Maliyet" label="38300">
                ...
                <cf_duxi name="product_name" type="text" data="data_project.product_name" hint="ilişkili ürün" label="38484" threepoint="#request.self#?fuseaction=objects.popup_product_names&product_id=UPD_PRO.product_id&field_name=UPD_PRO.product_name"> 
                ...
                <div class="form-group" id="form_ul_project_folder">
                    ...
                    <cfif len(GET_GOOGLE_PROJECT_FOLDER_ID.GOOGLE_PROJECT_FOLDER_ID)>
                ...
                <cf_duxi name="expense_code_name" id="expense_code_name" type="text" value="#data_project.expense_code#- #data_project.expense#" hint="masraf gelir merekezi" label="58235" threepoint="#request.self#?fuseaction=objects.popup_expense_center&field_code=UPD_PRO.expense_code&field_name=UPD_PRO.expense_code_name">
                ...
                <cfif  len(data_project.PROJECT_EMP_ID)>
                    <cf_duxi name="employee_name" label="57569" hint="Görevli" value="#data_project.employee_name# #data_project.EMPLOYEE_SURNAME#" threepoint="#request.self#?fuseaction=objects.popup_list_positions&field_partner=all.outsrc_partner_id&field_emp_id=UPD_PRO.project_emp_id&field_code=all.project_pos_code&field_comp_id=all.outsrc_cmp_id&field_name=all.employee_name&select_list=1,2" > 
                <cfelseif  len(data_project.outsrc_cmp_id)>
                    <cf_duxi name="employee_name" label="57569" hint="Görevli" value="#get_par_info(data_project.outsrc_partner_id,0,2,0)#-#get_par_info(data_project.outsrc_partner_id,0,1,0)#" threepoint="#request.self#?fuseaction=objects.popup_list_positions&field_partner=all.outsrc_partner_id&field_emp_id=UPD_PRO.project_emp_id&field_code=all.project_pos_code&field_comp_id=all.outsrc_cmp_id&field_name=all.employee_name&select_list=1,2" > 
                <cfelse>
                    <cf_duxi name="employee_name" label="57569" hint="Görevli" value="" threepoint="#request.self#?fuseaction=objects.popup_list_positions&field_partner=all.outsrc_partner_id&field_emp_id=UPD_PRO.project_emp_id&field_code=all.project_pos_code&field_comp_id=all.outsrc_cmp_id&field_name=all.employee_name&select_list=1,2" >    
                </cfif> 
                <cfif xml_coordinate>
                ...
                <div class="form-group" id="form_ul_sales_zone_id">
            ...
            <cf_box_footer>   
                ...
                <cf_workcube_buttons is_upd='1'  delete_page_url='#request.self#?fuseaction=project.emptypopup_del_pro&id=#attributes.id#' add_function='kontrol()'>
            </cf_box_footer>
        </cfform>
    </cf_box>
    ...
    <script type="text/javascript">
        ...
        /* function listFiles() {
            ...
            "corpus": "user"
                ...
                var file = response.result.files;
                listFolders();
            },
