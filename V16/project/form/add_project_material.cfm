...
<cf_box title="#getLang('','Proje Malzeme Planı','38284')#" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
    <div id="basket_main_div">
        <cfform name="form_basket_material" method="post" action="#request.self#?fuseaction=project.emptypopup_add_project_material">
            <cf_basket_form id="pro_material">
                            ...
                            <div class="form-group" id="item-no">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <cfif isDefined('system_paper_no')>
                                        <cfinput type="text" maxlength="50" name="pro_number" value="#system_paper_no#" required="Yes" message="">
                                    <cfelse>
                                        <cfinput type="text" maxlength="50" name="pro_number" value="" required="Yes" message="">
                                    </cfif>
                                </div>
                            </div>
                            <div class="form-group" id="item-action_date">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <div class="input-group">
                                        <cfinput type="text" name="action_date" required="Yes" message="" value="#dateformat(now(),dateformat_style)#" validate="#validate_style#" maxlength="10" passThrough="onblur=""change_money_info('form_basket_material','action_date');""">
                            ...
                            <div class="form-group" id="item-budget_id">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon btnPointer icon-ellipsis" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_list_budget&field_id=form_basket_material.budget_id&field_name=form_basket_material.budget_name&select_list=2');"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="item-planner_emp_id">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon btnPointer icon-ellipsis" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_list_positions&field_emp_id=form_basket_material.planner_emp_id&field_name=form_basket_material.planner_emp_name&select_list=1');"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="item-work_id">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon btnPointer icon-ellipsis" onclick="openBoxDraggable('#request.self#?fuseaction=objects.popup_add_work&field_id=form_basket_material.work_id&field_name=form_basket_material.work_head');"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" id="item-Proje">
                                ...
                                <div class="col col-9 col-xs-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="project_head" id="project_head" value="<cfif Len(attributes.project_id)>#get_project_name(attributes.project_id)#</cfif>" onFocus="AutoComplete_Create('project_head','PROJECT_HEAD','PROJECT_HEAD','get_project','','PROJECT_ID','project_id','form_basket_material','3','135')" autocomplete="off">
                ...
                <cf_box_footer>
                   <cf_workcube_buttons is_upd='0' 
                    data_action ="/V16/project/cfc/get_project_works:ADD_PROJECT_WORK"
                      next_page="#request.self#?fuseaction=project.popup_upd_project_material&event=upd&PRO_MATERIAL_ID="
...
function kontrol()
{
	if(form_basket_material.company_id.value == "" )
	{ 
