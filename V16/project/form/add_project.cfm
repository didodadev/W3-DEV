    ...
    <cfform name="add_project_form" method="post" action="#request.self#?fuseaction=project.emptypopup_add_pro">
        ...
        <cf_box_elements>
            <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                ...
                <div class="form-group" id="form_ul_pro_h_start" >
                ...
                <div class="form-group" id="form_ul_pro_h_finish" >
            ...
            <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="2" sort="true">
                ...
                <div class="form-group" id="form_ul_about_par_name">
                ...
                <div class="form-group" id="form_ul_country_id">
                ...
                <div class="form-group" id="form_ul_coordinate">
