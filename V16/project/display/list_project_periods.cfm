...
<div class="col col-12 col-md-12col-sm-12 col-xs-12">
	<cf_box title="#title#">   
		<cfform name="add_period" method="post" action="#request.self#?fuseaction=project.emptypopup_add_periods_to_project&id=#attributes.id#">
					...
					<cf_box_elements>
						<div class="col col-5 col-md-5 col-sm-6 col-xs-12" type="column" index="1" sort="true">	
							...
							<div class="form-group" id="item-PROMOTION_CODE">
								<label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id ='38403.Promosyon Hesabı'></label>
								<div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
									<div class="input-group">
			...
			<div class="ui-form-list-btn">
				...
				<div class="col col-6 col-md-6 col-sm-6 col-xs-6">
					...
					<cf_workcube_buttons type_format="1" is_upd='0' insert_info='#message#' add_function='kontrol_et()'>
				</div>
			</div>
		</cfform>
	</cf_box>
