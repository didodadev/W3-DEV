<cf_xml_page_edit fuseact="project.projects">
    ...
    <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
        <cf_box>
            <cfform name="search" id="search" method="post" action="#request.self#?fuseaction=project.projects">
                ...
                <cf_box_search>
                    ...
                    <div class="form-group" id="form_ul_project_status">
                ...
                <cf_box_search_detail>
                    <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                        <div class="form-group" id="form_ul_expense_code">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_expense_center&field_code=search.expense_code&field_name=search.expense_code_name</cfoutput>','list');"></span>
                            </div>
                        </div>
                        <div class="form-group" id="form_ul_pro_employee_id">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('#request.self#?fuseaction=objects.popup_list_positions&field_partner=search.pro_partner_id&field_emp_id=search.pro_employee_id&field_code=search.project_pos_code&field_comp_id=search.pro_company_id&field_name=search.pro_employee&select_list=1,2','list');"></span>
                        ...
                        <div class="form-group" id="form_ul_consumer_id">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon icon-ellipsis btnPointer" onclick="windowopen('<cfoutput>#request.self#?fuseaction=objects.popup_list_pars&select_list=2,3&field_comp_name=search.company&field_comp_id=search.company_id&field_consumer=search.consumer_id&field_member_name=search.company</cfoutput>','list')"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-3 col-md-4 col-sm-6 col-xs-12" type="column" index="3" sort="true">
                        ...
                        <div class="form-group" id="form_ul_currency">
                        ...
                        <cfoutput query="get_projects">
                            <tr>
                                ...
                                <td><cfif len(company_id)>
                                        ...
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_par_det&par_id=#PARTNER_ID#','medium');" class="tableyazi">#company_partner_name# #company_partner_surname#</a>
                                    <cfelseif len(consumer_id)>
                                        <a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_con_det&con_id=#consumer_id#','medium');" class="tableyazi">#consumer_name# #consumer_surname#</a>
                                    </cfif>
                                </td>
                                <td><cfif len(project_emp_id)>
                                        <a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#project_emp_id#','medium');" class="tableyazi">#employee_name# #employee_surname#</a>
                                    </cfif>
                                    <cfif len(outsrc_partner_id)>
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_com_det&company_id=#outsrc_cmp_id#','medium');" class="tableyazi">#nickname_outsrc#</a>-
                                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_par_det&par_id=#outsrc_partner_id#','medium');" class="tableyazi">#company_partner_name_outsrc# #company_partner_surname_outsrc#</a>
                                    </cfif>
                                </td>
