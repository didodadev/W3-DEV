...
<cfif len(GET_GOOGLE_PROJECT_FOLDER_ID.GOOGLE_PROJECT_FOLDER_ID)>
    <cf_box title="#getLang('','Google Drive',64435)##getLang('','Belgeler',57568)#">
        <div style="cursor:pointer;" onClick="window.open('https://drive.google.com/drive/u/0/folders/<cfoutput>#GET_GOOGLE_PROJECT_FOLDER_ID.GOOGLE_PROJECT_FOLDER_ID#</cfoutput>')" data-toggle="tooltip" title="<cf_get_lang dictionary_id='61793.Projenin Google Drive klasörüne erişmek için tıklayınız.'>">
