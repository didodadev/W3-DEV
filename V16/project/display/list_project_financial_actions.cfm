...
<cfform name="action_year_form" method="post" action="#request.self#?fuseaction=project.popup_list_project_financial_actions&id=#URL.ID#">
    <cfsavecontent variable="right_">
        ...
        <cf_box title="#title#" right_images="#right_#" resize="0" collapsable="0">
        ...
        <cfsavecontent variable="title"><cf_get_lang dictionary_id='38305.İlişkili Bütçeler'></cfsavecontent>
        <cf_box title="#title#" resize="0" collapsable="0">
