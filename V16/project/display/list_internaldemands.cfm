            ...
            <tr>
                ...
                <cfif len(from_position_code)>
                    <cfset emp_id1= get_from_detail.employee_id[listfind(main_from_position_list,get_list_internaldemand.from_position_code,',')]>
                        <a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#emp_id1#','medium');" >  
                ...
                <td>
                    <cfif len(to_position_code)>
                        ...
                        <a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#emp_id2#','medium');" > 
