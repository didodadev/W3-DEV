...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cf_box title="#head#" resize="0" collapsable="0" popup_box="#iif(isdefined("attributes.draggable"),1,0)#">
            ...
            <cf_box_search more="0">
                ...
                <cf_get_lang_set module_name="project">
                    ...
                    <cfif  not listfindnocase(denied_pages,'prod.add_prod_order')>
                        <div class="form-group">
                            <a href="<cfoutput>#request.self#?fuseaction=prod.order&event=add<cfif not isdefined("attributes.is_from_product")>&pj_id=#URL.ID#</cfif></cfoutput>" target="_blank"><img src="css/assets/icons/catalyst-icon-svg/ctl-044-gear.svg"  width="20px" title="<cf_get_lang dictionary_id='30049.Üretim Emri'>" border="0"></a>
                        </div>
                    </cfif>
                ...
                <cfif xml_is_show_production_order>
                    <cfsavecontent  variable="head_"><cf_get_lang dictionary_id='30049.Üretim Emri'></cfsavecontent>
