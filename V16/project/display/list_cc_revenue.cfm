                ...
                <tr>
                    ...
                    <td>
                        <cfif len(ACTION_FROM_COMPANY_ID)>
                            <a class="tableyazi" href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_com_det&company_id=#ACTION_FROM_COMPANY_ID#','medium');">#get_company_detail.FULLNAME[listfind(company_id_list,ACTION_FROM_COMPANY_ID,',')]#</a>
