	...
	<thead>
		<tr>
			...
			<cfif attributes.line_based neq 1>
				...
				<th width="15">
				<cfif not listfindnocase(denied_pages,'project.popup_add_project_material')>
					<a href="javascript://" onClick="openBoxDraggable('<cfoutput>#request.self#?fuseaction=project.popup_add_project_material&event=add&project_id=#attributes.id#</cfoutput>','','ui-draggable-box-large');"> <i class="fa fa-plus" title="<cf_get_lang dictionary_id='37330.Malzeme Listesi'> <cf_get_lang dictionary_id='44630.Ekle'>"></i></a>
				</cfif>
				</th>
			<cfelse>
    ...
    <tbody>
		<cfif GET_PRO_MATERIAL.recordcount>
            ...
            <tr>
                ...
                <td><cfif not listfindnocase(denied_pages,'project.popup_upd_project_material')><a href="javascript://" onClick="windowopen('#request.self#?fuseaction=project.popup_upd_project_material&upd_id=#get_pro_material.PRO_MATERIAL_ID#','longpage');">#PRO_MATERIAL_NO#</a><cfelse>#PRO_MATERIAL_NO#</cfif></td>
                <cfif attributes.line_based neq 1>
                    ...
                    <td><cfif len(PLANNER_EMP_ID)><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&EMP_ID=#PLANNER_EMP_ID#','medium');">#GET_EMP_ID.EMPLOYEE_NAME[listfind(emp_id_list,PLANNER_EMP_ID,',')]# #GET_EMP_ID.EMPLOYEE_SURNAME[listfind(emp_id_list,PLANNER_EMP_ID,',')]#</cfif></td>
                    <td><cfif not listfindnocase(denied_pages,'project.popup_upd_project_material')>
                            <a href="javascript://" onClick="openBoxDraggable('#request.self#?fuseaction=project.popup_upd_project_material&event=upd&upd_id=#get_pro_material.PRO_MATERIAL_ID#');"> <i class="fa fa-pencil" title="<cf_get_lang dictionary_id='37330.Malzeme Listesi'> <cf_get_lang dictionary_id='58718.Düzenle'>"></i></a>
                        </cfif>
                    </td>
                <cfelse>
