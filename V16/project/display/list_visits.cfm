...
<cf_grid_list>
	<thead>
        <tr>
            ...
            <th width="30">
                <a href="javascript://" onClick="windowopen('<cfoutput>#request.self#?fuseaction=sales.list_visit&event=add&project_id=#attributes.id#</cfoutput>','longpage');"> <i class="fa fa-plus" alt="<cf_get_lang dictionary_id='57582.Ekle'>" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a>
            </th>
        </tr>
    </thead>
    <tbody>
		<cfif get_visits.recordcount>
            <cfoutput query="get_visits">
                <tr>
                    ...
                    <td><a href="javascript://" onClick="windowopen('#request.self#?fuseaction=sales.list_visit&event=upd&visit_id=#EVENT_PLAN_ID#','longpage');"> <i class="fa fa-pencil" alt="<cf_get_lang dictionary_id='58718.Düzenle'>" title="<cf_get_lang dictionary_id='58718.Düzenle'>"></i></a></td>
                </tr>
            </cfoutput>
        <cfelse>
            <tr>
