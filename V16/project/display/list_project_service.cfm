...
<cf_grid_list>
	<thead>
        <tr>
            ...
            <th width="20"><a href="<cfoutput>#request.self#?fuseaction=service.list_service&event=add&project_id=#url.id#</cfoutput>" target="_blank" class="tableyazi"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a></th>
        </tr>
    </thead>
    <tbody>
		<cfif get_project_service.recordcount>
            ...
            <tr>
                ...
                <td width="15" style="text-align:right;"><a href="#request.self#?fuseaction=service.list_service&event=upd&service_id=#service_id#" target="_blank" class="tableyazi"><img src="/images/update_list.gif" border="0" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></a></td>
            </tr>
            </cfoutput>
