...
<cf_grid_list>
   <thead>
       <tr>
		   ...
		   <th width="20" style="text-align:right;"><a href="<cfoutput>#request.self#?fuseaction=invent.add_invent_stock_fis&project_id=#URL.ID#</cfoutput>" target="_blank" class="tableyazi"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.Ekle'>"></i></a></th>
       </tr>
	</thead>
	<tbody>
		<cfif get_all_actions.recordcount>
