			...
			<cfform name="works_#this_div_id_#" method="post" action="">
				<cf_box_search more="0">							
					<cfif not (isdefined("attributes.work_detail_id") and len(attributes.work_detail_id))>
						...
						<div class="form-group">
							<a href="javascript://" onclick="openBoxDraggable('index.cfm?fuseaction=project.works&event=add&id=<cfoutput>#attributes.project_detail_id#</cfoutput>&work_fuse=project.emptypopup_ajax_project_works')" class="ui-btn ui-btn-gray"><i class="fa fa-plus"></i></a>
						</div>
					</cfif>
				</cf_box_search>
			</cfform>
							...
							<td>
								...
								<cfif not listfindnocase(denied_pages,'project.popup_add_project_material') and isDefined("attributes.related_project_info")>
									<cfif len(pro_material_id)>
										<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=project.popup_upd_project_material&upd_id=#pro_material_id#');"><i class="fa fa-file-text-o" style="color:grey;" title="<cf_get_lang dictionary_id ='38326.Malzeme'>"></i></a>
									<cfelse>
										<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=project.popup_add_project_material<cfif isdefined("attributes.project_id") and len(attributes.project_id)>&project_id=#attributes.project_id#</cfif>&work_id=#work_id#');"> <i class="fa fa-file-text-o" style="color:grey;" title="<cf_get_lang dictionary_id ='38326.Malzeme'>"></i></a>
									</cfif>
								</cfif>
							</td>
							<td>
								...
								<cfif not len(emp_del_buttons.is_delete) and emp_del_buttons.is_delete neq 1>
									<cfif  not len(employee_denied.is_delete) and employee_denied.is_delete neq 1>
										<cfif isdefined("attributes.service_id") and len(attributes.service_id)>
												...
												<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&service_id=#attributes.service_id#&type=1','small'); else return false;" >
										...
										<cfelseif isdefined("attributes.assetp_id") and len(attributes.assetp_id)>
												<input type="hidden" name="work_id#currentrow#" id="work_id#currentrow#" value="#GET_PRO_WORK.work_id#">
												<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&assetp_id=#attributes.assetp_id#&type=2','small'); else return false;" >
												<i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" style="color:grey"></i></a>
										<cfelseif  isdefined("attributes.g_service_id") and len(attributes.g_service_id)>
												<input type="hidden" name="work_id#currentrow#" id="work_id#currentrow#" value="#GET_PRO_WORK.work_id#">
												<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&g_service_id=#attributes.g_service_id#&type=3','small'); else return false;" >
												<i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" style="color:grey"></i></a>
										<cfelseif isdefined("attributes.project_id") and len(attributes.project_id) or isdefined("attributes.work_id") and len(attributes.work_id)>
												<input type="hidden" name="work_id#currentrow#" id="work_id#currentrow#" value="#GET_PRO_WORK.work_id#">
												<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&project_id=#attributes.project_id#&type=4','small'); else return false;" >
												<i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" style="color:grey"></i></a>
										<cfelseif isdefined("attributes.opp_id") and len(attributes.opp_id)>
												<input type="hidden" name="work_id#currentrow#" id="work_id#currentrow#" value="#GET_PRO_WORK.work_id#">
												<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&opp_id=#attributes.opp_id#&type=5','small'); else return false;" >
												<i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" style="color:grey"></i></a>
										<cfelseif isdefined("attributes.product_sample_id") and len(attributes.product_sample_id)>
											<input type="hidden" name="work_id#currentrow#" id="work_id#currentrow#" value="#GET_PRO_WORK.work_id#">
											<a href="javascript://" onclick="javascript:if (confirm('<cf_get_lang dictionary_id='845.İş İlişkisini Silmek İstediğinizden Emin Misiniz?'>')) windowopen('#request.self#?fuseaction=project.emptypopup_del_work_relation&work_id=#GET_PRO_WORK.work_id#&product_sample_id=#attributes.product_sample_id#&type=7','small'); else return false;" >
											<i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" style="color:grey"></i></a>
	...
	<cf_grid_list>
		<thead>
			<tr>
				...
				<cfif not listfindnocase(denied_pages,'project.popup_add_project_material') and isDefined("attributes.related_project_info")><th style="width:15px;"><!--- Malzeme ---></th></cfif>
			...
			<cfoutput query="GET_PRO_WORK" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#"> 
				<tr>
					...
					<cfif not listfindnocase(denied_pages,'project.popup_add_project_material') and isDefined("attributes.related_project_info")>
						<td><!--- Malzeme --->
							<cfif len(pro_material_id)>
								<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=project.popup_upd_project_material&upd_id=#pro_material_id#');"> <img src="/images/list_ship.gif" border="0" title="<cf_get_lang dictionary_id ='38326.Malzeme'>"></a>
							<cfelse>
								<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=project.popup_add_project_material&project_id=#attributes.project_id#&work_id=#work_id#');"> <img src="/images/list_ship.gif" border="0" title="<cf_get_lang dictionary_id ='38326.Malzeme'>"></a>
							</cfif>
						</td>
					</cfif>
					<cfif isdefined("attributes.ajax")>
