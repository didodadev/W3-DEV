...
<cfset get_work_cat = getComponent.GET_WORK_CAT(work_cat_id:work_detail.work_cat_id,proces_cat:iif(isdefined("get_pro_cat.process_cat") and len(get_pro_cat.process_cat),"get_pro_cat.process_cat",DE("")),xml_is_project_cat:xml_is_project_cat)>
