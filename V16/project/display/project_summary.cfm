            ...
            <div class="ui-info-text">
                <cfoutput query ="project_detail">
                   ...
                   <p>
                        ...
                        <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#project_detail.PROJECT_EMP_ID#')">#get_emp_info(project_detail.PROJECT_EMP_ID,0,0)# </a>
                   </p>
                </cfoutput>
            </div>
