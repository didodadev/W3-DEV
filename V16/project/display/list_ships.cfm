        ...
        <tr>
            ...
            <cfif attributes.line_based neq 1>
                ...
                <cfif len(get_purchases_ship.company_id)>
                    <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_com_det&company_id=#company_id#','medium');">#COMPANY_NAME.fullname[listfind(company_id_list,company_id,',')]#</a>
