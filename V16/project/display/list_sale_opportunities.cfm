	 ...
	 <cfif get_sale_opportunities.recordcount>
          <cfoutput query="get_sale_opportunities">
           <tr>
              ...
              <td><cfif len(sales_emp_id)><a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_emp_det&emp_id=#sales_emp_id#','medium');">#get_emp_id.employee_name[listfind(emp_id_list,sales_emp_id,',')]# #get_emp_id.employee_surname[listfind(emp_id_list,sales_emp_id,',')]#</cfif></td>
