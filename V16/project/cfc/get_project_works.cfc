<cfcomponent extends="cfc.sdFunctions">
    ...
    <cffunction  name="ADD_PROJECT_WORK"  access="public" returntype="any"> 
    ...
    <cffunction  name="DET_PROJECT_WORK"  access="public" returntype="any">
        <cfset attributes = arguments>
        <cfset responseStruct = structNew()>
        <cf_get_lang_set module_name="project">
    ...
    <cffunction name="DEL_PRO_WORK"  access="remote" returntype="any">
        <cfset attributes = arguments>
        <cfset responseStruct = structNew()>
        <cf_get_lang_set module_name="project">
            ...
            <cflock name="#CreateUUID()#" timeout="20">
                <cftransaction>
                    <cfquery name="DEL_PRO_MONEY" datasource="#dsn#">
                        DELETE FROM PRO_MATERIAL_MONEY WHERE ACTION_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.pro_material_id#">
                    </cfquery>
                    <cfquery name="DEL_PRO_MAT_ROW" datasource="#dsn#">
                        DELETE FROM	PRO_MATERIAL_ROW WHERE PRO_MATERIAL_ID=<cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.pro_material_id#">
                    </cfquery>
                    <cfquery name="DEL_PRO_MATERIAL" datasource="#dsn#">
                        DELETE FROM	PRO_MATERIAL WHERE PRO_MATERIAL_ID=<cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.pro_material_id#">
                    </cfquery>
                </cftransaction>
            </cflock>
           <cfset responseStruct.message = "İşlem Başarılı">
