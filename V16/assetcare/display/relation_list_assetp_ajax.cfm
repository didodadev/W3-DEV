...
<table cellspacing="1" cellpadding="1" border="0" width="100%" style="text-align:right;" >
    <cfoutput query="get_relations_physical_asset">
     <tr height="20" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
            <td width="10"></td>
            <td width="15" align="center" id="asset_row2#currentrow#" class="color-row" onClick="gizle_goster(document.getElementById('asset_detail2#assetp_id#_#currentrow#'));connectAjax2('#assetp_id#_#currentrow#','#assetp_id#');gizle_goster(document.getElementById('asset_goster2#assetp_id#_#currentrow#'));gizle_goster(document.getElementById('asset_gizle2#assetp_id#_#currentrow#'));">
               <img id="asset_goster2#assetp_id#_#currentrow#" style="cursor:pointer;" src="/images/kapa.gif" border="0" alt="<cf_get_lang_main no ='1184.Göster'>" title="<cf_get_lang_main no ='1184.Göster'>">
               <img id="asset_gizle2#assetp_id#_#currentrow#" style="cursor:pointer;" src="/images/asagi.gif" border="0" alt="<cf_get_lang_main no ='1216.Gizle'>" title="<cf_get_lang_main no ='1216.Gizle'>">
            </td>
            <td><cfset assetp_ = replace(assetp,"'","","all")>
				<a href="javascript://" onClick="asset_care_realation2('#assetp_id#','#assetp_#','#motorized_vehicle#','#PHYSICAL_ASSETS_WIDTH#','#PHYSICAL_ASSETS_SIZE#','#PHYSICAL_ASSETS_HEIGHT#','#position_code#','#employee_name# #employee_surname#','#employee_id#');" class="tableyazi">#assetp#</a>
			</td>
        ...
        <tr id="asset_detail2#assetp_id#_#currentrow#" class="color-list" style="display:none">
            <td colspan="7">
                <div align="left" id="RELATION_PHYSICAL_ASSET#assetp_id#_#currentrow#"></div>
            </td>
        </tr>
      </cfoutput>
</table>
<script type="text/javascript">
function asset_care_realation2(id,assetp,motorized_vehicle,width,length,height,position_code,position_name,employee_id)
{
