          ...
          <td colspan="7" align="center">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr class="formbold"> <cfoutput>
                  <td width="20" align="left"> <a href="#yer#&ay=#ay#&yil=#oncekiyil#"><img src="/images/previous20.gif" alt="Tarih" width="15" height="20" border="0"></a></td>
                  <td align="center">#Year(tarih)#</td>
                  <td width="20" style="text-align:right;"><a href="#yer#&ay=#ay#&yil=#sonrakiyil#"><img src="/images/next20.gif" alt="" width="15" height="20" border="0"></a></td>
                  <td width="20" align="left"><a href="#yer#&ay=#oncekiay#&yil=<cfif ay eq 1>#oncekiyil#<cfelse>#yil#</cfif>"><img src="/images/previous20.gif" alt="" width="15" height="20" border="0"></a></td>
                  <td align="center">#ListGetAt(aylar,Month(tarih))#</td>
                  <td width="20" style="text-align:right;"><a href="#yer#&ay=#sonrakiay#&yil=<cfif ay eq 12>#sonrakiyil#<cfelse>#yil#</cfif>"><img src="/images/next20.gif" alt="" width="15" height="20" border="0"></a></td>
                </cfoutput> </tr>
            </table>
          </td>
        </tr>
        ...
        <tr class="color-row">
          ...
          <cfloop index=x from=#bas# to=7>
		  		<cfif isdefined('attributes.view_agenda') and len(attributes.view_agenda)>
					<td class="tableyazi"><cfoutput><A class="tableyazi" href="#yer#&yil=#yil#&ay=#ay#&gun=#gun#&view_agenda=#view_agenda#"><cfif dateformat(now(),'d') eq gun and dateformat(now(),'mm') eq ay and dateformat(now(),'yyyy') eq yil><font class="color-light">#gun#</font><cfelse>#gun#</cfif></a></cfoutput></td>
				<cfelse>
					<td class="tableyazi"><cfoutput><A class="tableyazi" href="#yer#&yil=#yil#&ay=#ay#&gun=#gun#"><cfif dateformat(now(),'d') eq gun and dateformat(now(),'mm') eq ay><font class="color-light">#gun#</font><cfelse>#gun#</cfif></a></cfoutput></td>
				</cfif>
            <cfset gun = gun +1>
          </cfloop>
        </tr>
            ...
            <cfloop index=x from=1 to=7>
              <cfif gun LTE son>
			  		<cfif isdefined('attributes.view_agenda') and len(attributes.view_agenda)>
						<td class="tableyazi"><cfoutput><A class="tableyazi" href="#yer#&yil=#yil#&ay=#ay#&gun=#gun#&view_agenda=#view_agenda#"><cfif dateformat(now(),'d') eq gun and dateformat(now(),'mm') eq ay and dateformat(now(),'yyyy') eq yil><font class="color-light">#gun#</font><cfelse>#gun#</cfif></a></cfoutput></td>
					<cfelse>
						<td class="tableyazi"><cfoutput><A class="tableyazi" href="#yer#&yil=#yil#&ay=#ay#&gun=#gun#"><cfif dateformat(now(),'d') eq gun and dateformat(now(),'mm') eq ay and dateformat(now(),'yyyy') eq yil><font class="color-light">#gun#</font><cfelse>#gun#</cfif></a></cfoutput></td>
					</cfif>
			<cfelse>
                <td class="tableyazi">&nbsp;</td>
              </cfif>
