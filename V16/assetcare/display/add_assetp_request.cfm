          ...
          <td>
            <table width="100%" cellpadding="2" cellspacing="1" border="0" height="100%">
              <tr class="color-list" valign="middle">
                <td height="35" class="headbold"><cf_get_lang no='160.Alış Talebi'></td>
              </tr>
              <tr>
                <td class="color-row" valign="top">
                  <cfform name="add_assetp_request" method="post" action="#request.self#?fuseaction=assetcare.emptypopup_add_assetp_request">
                    <table>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><input type="hidden" name="department_id" id="department_id" value="">
                        	<cfsavecontent variable="message"><cf_get_lang_main no="59.Eksik Veri"> : <cf_get_lang_main no='160.Departman'></cfsavecontent>
                          	<cfinput type="text" name="department" value="" required="yes" message="#message#" readonly style="width:150px;">
                          	<a href="javascript://" onClick="windowopen('<cfoutput>#request.self#</cfoutput>?fuseaction=objects.popup_list_departments&field_id=add_assetp_request.department_id&field_name=add_assetp_request.department','list');">
                        ...
                        <td><select name="usage_purpose_id" id="usage_purpose_id" style="width:150px;">
                            ...
                            <cfoutput query="get_usage_purpose">
                              <option value="#usage_purpose_id#">#usage_purpose#
                            </cfoutput>
                          </select></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="4"><cfinclude template="../form/add_vehicle_request.cfm"></td>
                      </tr>
                      <tr>
                        <td colspan="3"></td>
