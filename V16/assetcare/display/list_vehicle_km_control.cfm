...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr class="color-list">
    <td class="headbold"><cf_get_lang no='132.KM Kontrol'></td>
     <!-- sil -->
	...
	<!-- sil -->
		...
		<tr class="color-header">
		   <td width="180" height="22" class="form-title"><cf_get_lang_main no='75.No'></td>
		   <td width="180" class="form-title"><cf_get_lang_main no='1656.Plaka'></td>
           <td width="180" class="form-title"><cf_get_lang_main no='132.Sorumlu'></td>
           <td width="155" class="form-title"><cf_get_lang_main no='243.Baş.Tarihi'></td>
           <td width="270" class="form-title"><cf_get_lang_main no='288.Bit.Tarihi'></td>
           <td width="273" class="form-title" style="text-align:right;"><cf_get_lang no='219.Son Km'></td>
		   <td width="273" class="form-title" style="text-align:right;"><cf_get_lang no='218.İlk Km'></td>
		   <td width="273" class="form-title" style="text-align:right;"><cf_get_lang_main no='1171.Fark'></td>
        </tr>
