			...
			<cfloop from="1" to="#attributes.record_num#" index="i">
				<cfif evaluate("attributes.row_kontrol#i#")>
					...
					<cf_workcube_process 
						...
						action_page='#request.self#?fuseaction=assetcare.upd_vehicle_sales_request&request_row_id=#MAX_ID.IDENTITYCOL#&request_id=#get_request_id.request_id#' 
						warning_description='Satış Talebi : #MAX_ID.IDENTITYCOL# Talep Tarihi : #dateformat(attributes.request_date,dateformat_style)# Şube : #attributes.branch# Talep Eden : #attributes.employee#'>
				</cfif>
			</cfloop>
		</cfif>
	</cftransaction>
...
<script>
	location.href = '<cfoutput>#request.self#?fuseaction=assetcare.upd_vehicle_sales_request&event=upd&request_id=#get_request_id.request_id#&request_row_id=#MAX_ID.IDENTITYCOL#</cfoutput>';
</script>
