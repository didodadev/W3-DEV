			...
			<cfloop from="1" to="#attributes.record_num#" index="i">
				<cfif evaluate("attributes.row_kontrol#i#")>
					...
					<cfscript>
						...
						if(isdefined("attributes.station_id#i#") and len(evaluate("attributes.station_id#i#")))
							form_station_id=evaluate("attributes.station_id#i#");
						else 
							form_station_id='';					
					...
					<cfquery name="ADD_CARE_PERIODS" datasource="#DSN#">
						...
						(
							...
							<cfif attributes.is_motorized>
								<cfif len(form_km)>#form_km#,<cfelse>NULL,</cfif>
							<cfelse>
								NULL,							
							</cfif>
							#session.ep.userid#,
							...
							<cfqueryparam cfsqltype="cf_sql_integer" value="#form_station_id#">
						)
					</cfquery>
...
<!--- <cflocation url="#request.self#?fuseaction=assetcare.form_upd_assetp&assetp_id=#attributes.asset_id#" addtoken="no"> --->
