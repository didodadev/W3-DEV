...
<cf_workcube_process 
	...
	action_page='#request.self#?fuseaction=assetcare.upd_vehicle_return_request&request_row_id=#attributes.request_row_id#&request_id=#attributes.request_id#' 
	warning_description='İade Talebi : #attributes.request_row_id# Güncelleme : #dateformat(now(),dateformat_style)# Şube : #attributes.branch# Talep Eden : #attributes.employee#'>
