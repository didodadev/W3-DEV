			...
			<cfloop from="1" to="#attributes.record_num#" index="i">
				<cfif evaluate("attributes.row_kontrol#i#")>
					...
					<cf_workcube_process 
						...
						warning_description='Alış Talebi : #MAX_ID.IDENTITYCOL# Talep Tarihi : #dateformat(attributes.request_date,dateformat_style)# Şube : #attributes.branch# Talep Eden : #attributes.employee#'>
				</cfif>
			</cfloop>
		</cfif>
	</cftransaction>
