  ...
  <tr class="color-list">
	...
	<!-- sil -->
		...
		<tr class="color-header">
		   <td width="180" height="22" class="form-title">No</td>
           ...
           <td width="155" class="form-title"><cf_get_lang_main no='641.Baş Tarihi'></td>
           <td width="270" class="form-title"><cf_get_lang_main no ='288.BitTarihi'></td>
