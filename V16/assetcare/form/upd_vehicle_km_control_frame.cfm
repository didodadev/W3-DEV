...
<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td  height="35" class="headbold"><cf_get_lang no='132.KM Kontrol'></td>
     <td class="headbold"><cf_get_lang_main no='215.Kayıt Tarihi'><cfoutput>#dateFormat(get_km_kontrol.SUP_COMPANY_DATE,dateformat_style)#</cfoutput></td>
     <td class="headbold"><cf_get_lang no='218.İlk KM'><cfoutput>
         <cfif get_km_kontrol.first_km neq "">
           #get_km_kontrol.first_km#
             <cfelse>
      0
         </cfif>
     </cfoutput></td>
     <td class="headbold"><cf_get_lang no='219.Son KM'><cfoutput>#get_km.km_finish#</cfoutput></td>
     <td class="headbold"><cf_get_lang no='220.Yapılan KM'><cfoutput>
         <cfif get_km_kontrol.first_km neq "">
           #(get_km.km_finish - get_km_kontrol.first_km)#
             <cfelse>
             #(get_km.km_finish - 0)#
         </cfif>
     </cfoutput></td>
    ...
    <td>
	  <table cellspacing="1" cellpadding="2" border="0" align="center" width="100%">
		<tr class="color-header">
		   ...
		   <td width="100" class="form-title" style="text-align:right;"><cf_get_lang no='218.İlk Km'></td>
		   <td width="100" class="form-title" style="text-align:right;"><cf_get_lang_main no='1171.Fark'></td>
        </tr>
