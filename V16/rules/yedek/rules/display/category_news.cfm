...
<cfif get_category_news.recordcount>
	<cfoutput query="get_category_news">
        ...
        <table border="0" align="center" style="width:99%">
            ...
            <tr>
                <td style="vertical-align:top;"><img src="images/arrow.gif">&nbsp;&nbsp;<a href="#request.self#?fuseaction=rule.dsp_rule&cntid=#get_category_news.content_id#"><cf_get_lang_main no='714.Devam'></a>
                </td>
            </tr>
