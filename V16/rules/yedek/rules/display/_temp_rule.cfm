        ...
        <td>
			<cfoutput>
                ...
                <cfif len(get_content.record_date)>
                	<cf_get_lang_main no='772.Yazım Tarihi'>:#dateformat(date_add('h',session.ep.time_zone,get_content.record_date),'dd/mm/yy')# #timeformat(date_add('h',session.ep.time_zone,get_content.record_date),timeformat_style)#
                </cfif>
            </cfoutput>
        </td>
    </tr>
