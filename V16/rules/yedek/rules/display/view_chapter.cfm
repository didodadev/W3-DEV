	...
	<tr>
  		...
  		<td valign="top">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td id="search_menu_new" style="display:none; vertical-align:top;">
     		...
     		<cf_box><cfinclude template="chapter_news.cfm"></cf_box>
  		</td>
  		<td valign="top" width="200">
			...
			<cf_box title="#duyurutitle#" closable="1"><cfinclude template="last_chapter_news.cfm"></cf_box>
  		</td>
	</tr>
</table>
