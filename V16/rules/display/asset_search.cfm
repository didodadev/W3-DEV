...
<cfform name="search_asset" id="search_asset" action="#request.self#?fuseaction=asset.list_asset" method="post">
    ...
    <cf_box_search id="list_asset" btn_id="asset_btn" extra="1">
        ...
        <div class="form-group" id="asset_btn">
            <cf_wrk_search_button button_type="4" search_function='submitControl()'>
        </div>
        <div class="form-group">
            <a href="<cfoutput>#request.self#?fuseaction=asset.list_asset&event=add</cfoutput>" class="ui-btn ui-btn-gray"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a>
        </div>
    </cf_box_search>
