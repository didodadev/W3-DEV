...
<cfparam name="attributes.upd_id" default="">
...
<div id="wiki" class="col col-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <cf_box_search id="rule_welcome" plus="0" more="0" extra="1" btn_id="intranet-button">
                        <div class="form-group">
                            <div class="blog_title" style="margin:5px;color:#13be54;">
                                <cf_get_lang dictionary_id='57418.Literatür'>
                            </div>
                        </div>
    ...
    <div class="col col-10 col-xs-12">
        <cfif get_content.recordcount>
            <cfif isDefined("attributes.keyword1")>
                <cfoutput query="get_content">
                    <div class="forum_item flex-col">
                        <div class="reply_item">
                            <p class="name">
                                <a href="#request.self#?fuseaction=rule.dsp_rule&cntid=#CONTENT_ID#" title="#cont_head#">#cont_head#</a>
                            </p>
                            <p class="text">
                                #cont_summary#
                            </p>
                            ...
                            <div>
                                <div class="portHeadLight" style="border-bottom:none!important;">
                                    <div class="portHeadLightTitle" style="margin:-10px 0px 0px 0px;">
                                        <span>
                                            <a class="title blog_detail_content_title" href="#request.self#?fuseaction=rule.dsp_rule&cntid=#get_content.CONTENT_ID#" title="#get_content.cont_head#">#get_content.cont_head#</a>
                                        </span>
                                    </div>
                                </div>
                                <div style="background-color:none; border-radius:none;">
