...
<cfsavecontent variable="img_">
	<a href="<cfoutput>#request.self#</cfoutput>?fuseaction=settings.list_oiv"><img src="/images/plus1.gif" border="0" alt="<cf_get_lang dictionary_id='57582.Ekle'>"></a>
</cfsavecontent>
<cfset goiv = createObject("component","V16.settings.cfc.oiv")/>
<cfset category= goiv.SelectID(attributes.oid)/>
                ...
                <div class="col col-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col col-8 col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="oid" id="oid" value="<cfoutput>#attributes.oid#</cfoutput>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col col-8 col-xs-12">
                            ...
                            <cfinput type="text" name="tax_" value="#tlformat(category.tax)#" maxlength="4" required="yes" message="#message#" onKeyUp="return(FormatCurrency(this,event,3));">
                        </div>
                    </div>
                    <div class="form-group">
