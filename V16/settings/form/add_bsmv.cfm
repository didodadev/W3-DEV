                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" index="1" type="column" sort="true">
                        ...
                        <div class="form-group" id="item-tax_">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <cfinput type="text" name="tax_" value="" maxlength="5" required="yes" message="#message#" onKeyUp="return(FormatCurrency(this,event,3));">
                            </div>
                        </div>
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12">
                                <select name="tax_code" id="tax_code">
                                    ...
                                    <cfoutput query="TAX_CODES">
                                        <option value="#TAX_CODE_ID#,#TAX_CODE_NAME#" title="#TAX_CODE_NAME#">#TAX_CODE_NAME#</option>
                                    </cfoutput>
                                </select>
                            </div>
                        </div>
