<cfquery name="get_return_cat" datasource="#dsn3#">
	...
	WHERE
		RETURN_CAT_ID=#URL.ID#
</cfquery>
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center" height="35">
  <tr>
    <td  class="headbold"><cf_get_lang no='1202.Ürün İade Kategorisi'></td>
    <td align="right" style="text-align:right;"><a href="<cfoutput>#request.self#</cfoutput>?fuseaction=settings.form_add_prod_return_cats"><img src="/images/plus1.gif" border="0" alt="<cf_get_lang_main no='170.Ekle'>"></a></td>
  </tr>
</table>
  <table border="0" cellspacing="1" cellpadding="2" width="98%" class="color-border" align="center">
	<tr class="color-row" valign="">
	  <td width="200"><cfinclude template="../display/list_prod_return_cats.cfm">
	  </td>
	  <td>
		<table border="0">
		  <cfform name="return_cat" method="post" action="#request.self#?fuseaction=settings.emptypopup_upd_prod_return_cat">
			<input type="Hidden" name="RETURN_CAT_ID" id="RETURN_CAT_ID" value="<cfoutput>#URL.ID#</cfoutput>">
			<tr>
			  ...
			  <td>
				...
				<cfinput type="Text" name="returncat" size="60" value="#get_return_cat.RETURN_CAT#" maxlength="50" required="Yes" message="#message#" style="width:150px;">
			  </td>
			</tr>
			<tr height="35">
