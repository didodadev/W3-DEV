<cf_wrk_grid search_header = "#getLang('stock',192)#" table_name="WAREHOUSE_TASK_TYPES" left_menu="1"  sort_column="WAREHOUSE_TASK_TYPE" u_id="WAREHOUSE_TASK_TYPE_ID" datasource="#dsn#" search_areas = "WAREHOUSE_TASK_TYPE" dictionary_count="2">
