...
<cfset category= gotv.SelectID(attributes.oid)/>
<cfparam name="attributes.tax_type" default="">
<script>
    ...
    <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <cf_box title="#title#" add_href="#request.self#?fuseaction=settings.list_otv" is_blank="0">
            ...
            <div class="col col-9 col-md-9 col-sm-9 col-xs-12">
                ...
                <cfinput type="hidden" name="oid" value="#attributes.oid#">
                    <cf_box_elements>
                        <div class="col col-6 col-md-6 col-sm-6 col-xs-12" index="1" type="column" sort="true">
                        <div class="form-group" id="item-sales-account-code">
                            <label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='42531.Satış Muhasebe Kodu'><cfif session.ep.period_is_integrated eq 1> <font color=black>*</font></cfif></label>
                        ...
                        <div class="form-group" id="item-sales-account-code-iade">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <div class="input-group">
                                    ...
                                    <cfinput type="text" required="yes" message="#message#" name="Account_Code_iade" value="#category.account_code_iade#" onFocus="AutoComplete_Create('Account_Code_iade','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','','','tax','3','150');">
                        ...
                        <div class="form-group" id="item-account-code-iade">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <div class="input-group">
                                    ...
                                    <cfinput type="text" required="yes" message="#message#" name="Account_Code_p_iade" value="#category.purchase_code_iade#" onFocus="AutoComplete_Create('Account_Code_p_iade','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','','','tax','3','150');">
                        ...
                        <div class="form-group" id="item-sales-account-code-discount">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <div class="input-group">
                                    <cfinput type="text" name="account_code_discount" value="#category.ACCOUNT_CODE_DISCOUNT#" onFocus="AutoComplete_Create('account_code_discount','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','','','tax','3','150');">
                        ...
                        <div class="form-group" id="item-account-code-discount">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <div class="input-group">
                                    <cfinput type="text" name="account_code_p_discount" value="#category.ACCOUNT_CODE_P_DISCOUNT#" onFocus="AutoComplete_Create('account_code_p_discount','ACCOUNT_CODE','ACCOUNT_CODE,ACCOUNT_NAME','get_account_code','\'0\',0','','','tax','3','150');">
                        ...
                        <div class="form-group" id="item-type">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <select name="tax_type" id="tax_type" onchange="show2()">
                                    <option value="" ><cf_get_lang dictionary_id='57734.Seçiniz'></option>
                                    <option value="1" <cfif category.tax_type eq 1> selected</cfif>><cf_get_lang dictionary_id='62479.Sabit Tutar'></option>
                                    <option value="2" <cfif category.tax_type eq 2> selected</cfif>><cf_get_lang dictionary_id='62480.Oransal'></option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group" id="item-tax_">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <cfoutput>
                                <input type="text" name="tax_" id="tax_" class="moneybox" <cfif category.tax_type eq 1 >value="#tlformat(category.tax,4)#"</cfif>  onkeyup="return(FormatCurrency(this,event,4));">
                                </cfoutput>
                            </div>
                        </div>
                        <div class="form-group" id="item-tax_2">
                            <label class="col col-4 col-md-4 col-sm-4 col-xs-12"><cf_get_lang dictionary_id='58021.ÖtV'><cf_get_lang dictionary_id='58671.Oranı'>% *</label>
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <div class="input-group">
                                    <cfoutput>
                                <input type="text" name="tax_" id="tax_2" <cfif category.tax_type eq 2> value="#TLFormat(category.tax,4)#"</cfif> onkeyup="return(FormatCurrency(this,event,4));">
                            ...
                            <div class="col col-8 col-md-8 col-sm-8 col-xs-12"> 
                                <select name="tax_code" id="tax_code">
                                    ...
                                    <cfoutput query="TAX_CODES">
                                        <option value="#TAX_CODE_ID#,#TAX_CODE_NAME#" title="#detail#" <cfif tax_codes.tax_code_id eq CATEGORY.tax_code>selected="selected"</cfif>>#TAX_CODE_NAME#</option>
                                    </cfoutput>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
                        <cf_box_footer>
                           <cf_record_info query_name="CATEGORY">
                            ...
                            delete_page_url='#request.self#?fuseaction=settings.list_otv&event=del&oid=#attributes.oid#'
...
<script type="text/javascript">
    function show2()
        {
            var option = document.getElementById("tax_type").value;
                ...
                if(option == "2")
                {
                    document.getElementById("item-tax_2").style.display="block";
                    document.getElementById("item-tax_").style.display="none";
                    document.getElementById('tax_').value = "";
                    return true;
                }
                else
                {
	...
	function kontrol()
	{
		...
		if ( x < 0)
		{ 
			alert ("<cf_get_lang no ='1843.Bölümüne En Fazla 50 Karakter Girmelisiniz'>");
			return false;
		}
		if (document.getElementById('period_is_integrated').value == 1)
		{
			...
			{
				alert("<cf_get_lang no ='1194.Lütfen Satış Muhasebe Kodu Seçiniz'>!");
				return false;
			}
           
			if (document.tax.Account_Code_p =='')
			{
				alert("<cf_get_lang no ='1195.Lütfen Alış Muhasebe Kodu Seçiniz'>!");
				return false;
			}
            
		}
        
            if(document.getElementById('tax_type').value == 0)
                {
                    alert("<cf_get_lang dictionary_id='57471.Eksik Veri'>: <cf_get_lang dictionary_id='57630.Tip'>!")
                    return false;
                }
