<cf_xml_page_edit fuseact="settings.form_close_cari_employee">
...
<cfsavecontent variable = "title">
	<cf_get_lang no='344.Çalışan Dönem Açılışı'>
</cfsavecontent>
<cf_form_box title="#title#">
	<cf_area width="50%">
		<cfform name="close_ch" method="post" action="" enctype="multipart/form-data">
			<input type="hidden" value="1" name="is_employee" id="is_employee">
			<cfset select_list_ = 1>
			<cfset select_list_2 = 3>
			<cfset url_ = 'popup_list_positions'>
			...
			<table id="from_period" style="display:none">
				...
				<tr>
					<td width="275"><cf_get_lang no='1064.Ödenmemiş Çek\Senetleri Aktarma (Satır Bazında Çek\Senetleri Carileştiren Firmalar İçindir)'></td>
					<td><input type="checkbox" name="is_cheque_voucher_transfer" id="is_cheque_voucher_transfer" value="1"></td></tr>
				<tr>
			...
			<table id="from_file" style="display:none">
				<tr>
					<td width="275"><cf_get_lang no='1030.Fiş Tarihi'></td>
					<td>
			...
			<table id="general_options" style="display:none">
				<tr>
					<td width="275"><cf_get_lang no='1288.Muhasebe Dönemi'></td>
					<td>
				...
				<tr>
					...
					<td><cf_workcube_process_cat slct_width="200" module_id='23'></td>
				</tr>
						...
						<tr>
							<td>
								<br/>1-<cf_get_lang no='2888.Eğer dönemden aktar seçerseniz'>; <cf_get_lang no='2890.seçtiğiniz dönemin mevcut bakiyeleri seçtiğiniz koşullarla ilgili şirketin o dönemden sonraki ilk dönemine aktarılır'>.<br/>
									<br/>a- <cf_get_lang dictionary_id="29539.Satır Bazında">
