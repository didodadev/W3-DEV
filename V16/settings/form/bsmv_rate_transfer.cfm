<!--- File:V16\settings\form\bsmv_rate_transfer.cfm
Author: Fatma zehra Dere
Date:30/12/2020
Description:
Bsmv oranlarının aktarıldığı sayfadır
History:
To Do: ---> 
<cfparam  name="attributes.form_submitted" default="">
<cfparam  name="attributes.status" default="">
<cfset comp  = createObject("component","V16.settings.cfc.bsmv_rate") />
<cfset get_companies = comp.get_companies()/>
<cf_box title="#getLang(dictionary_id:61515)#"  >    
        ...
        <cfform name="form_" id= "form_" action="" method="post">
                ...
                <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="2" sort="false">
                        ...
                        <label class="col col-12 bold"><td class="headbold" valign="top"><cf_get_lang dictionary_id="57433.Yardım"></label>
                            <cftry>
                                <cfinclude template="#file_web_path#templates/period_help/bsmvRateTransfer_#session.ep.language#.html">
                                <cfcatch>
            ...
            <cf_box_footer>
                <div class="col col-12 text-right ">
                    <cfsavecontent variable="bsmv"><cf_get_lang dictionary_id="61543.BSMV Oranı Aktar"></cfsavecontent>
                    <cf_workcube_buttons extraButton="1"  extraButtonText="#bsmv#"  extraFunction=" basamak_1()" update_status="0">
                    </div>               
            </cf_box_footer>         
...
<script type="text/javascript">
    function basamak_1(){
            ...
            if($('#form_submitted').val())	{
                ...
                $('.ui-cfmodal__alert .required_list').append('BSMV Oranı Aktarım İşlemi Gerçekleştir');	
    ...
    function basamak_2() {
            ...
            $.ajax({ 
                type:'POST',  
                url:'V16/settings/cfc/bsmv_rate.cfc?method=bsmv_aktarim',  
                data: { 
                ...
                error: function () 
                {
                    console.log('Bir sorun olustu. Yeniden deneyin!');
                    $('.ui-cfmodal__alert').fadeOut();
                }
            });
            return true;
