...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<cfif get_duty_unit_cats.recordcount>
        <cfoutput query="get_duty_unit_cats">
        <tr>
            <td width="20" align="right" valign="baseline" style="text-align:right;"><img src="/images/tree_1.gif" width="13"></td>
            <td width="200"><a href="#request.self#?fuseaction=settings.upd_duty_unit_cat&id=#duty_unit_cat_id#" class="tableyazi">#duty_unit_cat#</a></td>
        </tr>
        </cfoutput>
    <cfelse>
        <tr>
