...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <cf_box title="#getlang('','Depo Fiyatları','45375')#" uidrop="1" hide_table_column="1">
	<cf_grid_list>
		<thead>
			<tr>
		...
		<tbody>
			...
			<cfoutput query="get_warehouse_rates" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
				<tr>
					...
					<td>#NICKNAME#</td>
					<td>#ACTION_MAN#</td>
					<cfif get_warehouse_rates.BRANCH_ID neq 0 AND get_warehouse_rates.BRANCH_ID neq ''><!-- önceki kayıtlarda branch_id null gidiyor -->
					...
					<cfelse>
						<td><cf_get_lang dictionary_id="63989.Tüm Şubelerde Hizmet Veriliyor"></td>
					</cfif>
					<td>#dateformat(ACTION_DATE,dateformat_style)#</td>
					<!-- sil --><td class="header_icn_none"><a href="#request.self#?fuseaction=settings.list_warehouse_rates&event=upd&rate_id=#rate_id#"><i class="fa fa-pencil" title="<cf_get_lang dictionary_id='57464. Güncelle'>"></i></a></td><!-- sil -->
				</tr>
			</cfoutput>
			<cfelse>
				<tr>
