...
<cfif isdefined("attributes.is_submit")>
   <cfset get_medicine_list = createObject("component","V16.settings.cfc.setupDecisionmedicine").getDecisionmedicine(is_default:attributes.status,keyword:attributes.keyword)>
<cfelse>
	<cfset get_medicine_list.recordcount = 0>
</cfif>
<cfparam name="attributes.totalrecords" default="#get_medicine_list.recordcount#">
<cfform name="list_decisionmedicine" action="#request.self#?fuseaction=settings.list_decisionmedicine" method="post">
<input type="hidden" name="is_submit" id="is_submit" value="1">
<cf_big_list_search title="#getLang('settings',91)#"> 
...
<cf_big_list>
	<thead>
		<tr>
			...
			<th><cf_get_lang no='91.İlaç İsimleri'></th>
			<th class="header_icn_none"><a href="<cfoutput>#request.self#</cfoutput>?fuseaction=settings.form_add_decisionmedicine"><img src="/images/plus_list.gif" title="<cf_get_lang no='116.İlaç İsimleri'> <cf_get_lang_main no='170.İlaç İsimleri'>"></a></th><!-- sil -->
		</tr>
	</thead>
	<tbody>
		<cfif get_medicine_list.recordcount>
			...
			<tr class="color-row">
				...
				<td><a href="#request.self#?fuseaction=settings.form_upd_decisionmedicine&decision_medicine_id=#decision_medicine_id#" class="tableyazi">#decision_medicine#</a></td>
			<!-- sil --><td width="15"><a href="#request.self#?fuseaction=settings.form_upd_decisionmedicine&decision_medicine_id=#DECISION_MEDICINE_ID#" class="tableyazi"><img src="/images/update_list.gif" title="<cf_get_lang_main no='52.Güncelle'>"></a></td><!-- sil -->
			</tr>
			</cfoutput>
		<cfelse>
			<tr>
		...
		<tr> 
			<td><cfset url_str = "">
			  ...
			  <cf_pages page="#attributes.page#"
				  ...
				  adres="settings.list_decisionmedicine#URL_STR#"></td>
