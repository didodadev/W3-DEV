...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <cfif get_zone.RecordCount >
    <cfoutput query="get_zone">
      <tr>
        <td>&nbsp;
		  ...
		  <a href="javascript://" onclick="gizle_goster_img('img#currentrow#bolge1','img#currentrow#bolge2','bolge#currentrow#');"><img src="/images/listele_down.gif"  border="0" align="absmiddle" id="img#currentrow#bolge1" style="cursor:pointer;"></a>
		  <a href="javascript://" onclick="gizle_goster_img('img#currentrow#bolge1','img#currentrow#bolge2','bolge#currentrow#');"><img src="/images/listele.gif" border="0" align="absmiddle" id="img#currentrow#bolge2" style="cursor:pointer;display:none;"></a>
		  <cfelse>
		  <a href="javascript://" onclick="gizle_goster_img('img#currentrow#bolge1','img#currentrow#bolge2','bolge#currentrow#');"><img src="/images/listele_down.gif"  border="0" align="absmiddle" id="img#currentrow#bolge1" style="display:none;cursor:pointer;"></a>
		  <a href="javascript://" onclick="gizle_goster_img('img#currentrow#bolge1','img#currentrow#bolge2','bolge#currentrow#');"><img src="/images/listele.gif" border="0" align="absmiddle" id="img#currentrow#bolge2" style="cursor:pointer;"></a>
		  </cfif>		  
    ...
    <cfelse>
    <tr>
      <td width="20" align="right" valign="baseline" style="text-align:right;">
