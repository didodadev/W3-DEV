...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr> 
    <td class="txtbold" height="20" colspan="2">&nbsp;&nbsp;<cf_get_lang no='83.Basket Modülleri'></td>
  </tr>
<cfif GET_BASKET.RecordCount>
  ...
  <tr>
    <td width="20" align="right" valign="baseline" style="text-align:right;"><img src="/images/tree_1.gif" width="13"></td>
      <td>
	  	<a href="#request.self#?fuseaction=settings.form_upd_bskt_temp_detail&id=#ID#" class="tableyazi"><!--- #MODULE_NAME# --->
