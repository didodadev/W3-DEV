...
<tr>
	...
	<tr>
		...
		<td align="left" valign="top">
			<table border="0" cellspacing="0" cellpadding="2" width="100%">
			<cfform action="#request.self#?fuseaction=settings.#XFA.submit_zone#" method="post" name="order_status" onSubmit="_CF_this.action=_CF_this.action+_CF_this.clicked.value;">
			<input type="Hidden" ID="clicked" name="clicked" value="">
				<cfquery name="CATEGORY" datasource="#dsn#">
					SELECT * FROM ORDER_STATUS WHERE ORDERSTATUS_ID=#URL.ID#
				</cfquery>
				<input type="Hidden" name="orderStatus_ID" id="orderStatus_ID" value="<cfoutput>#URL.ID#</cfoutput>">
				<tr>
					...
					<cfinput type="Text" name="orderStatus" size="30" value="#category.orderStatus#" maxlength="20" required="Yes" message="#message#"></td>
				</tr>
				<tr>
					<td align="left">
