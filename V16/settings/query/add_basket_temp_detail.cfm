	...
	<cfswitch expression="#attributes.basket_id#">
		...
		<cfcase value="47"><cfset bit_sale_purchase=0></cfcase>	
		<cfcase value="48"><cfset bit_sale_purchase=1></cfcase>			
	</cfswitch>
	...
	<!--- <cfif not isdefined("attributes.module_content") or not ListFind(attributes.module_content,'prom_stock_id') >
		<cfset module_str=module_str & ",prom_stock_id"><cfelse><cfset module_str_display=ListAppend(module_str_display,"prom_stock_id",",")>
	</cfif> --->
 ...
 <cflocation addtoken="no" url="#request.self#?fuseaction=settings.form_upd_bskt_temp_detail&id=#attributes.BASKET_ID#"> 
