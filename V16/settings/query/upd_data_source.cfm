...
<cftry>
	...
	<cfset cmpDsn.updDataSource(
 	...
 	<cfif attributes.data_source_name neq attributes.old_data_source_name>
...
<script type="text/javascript">
	window.location.href = '<cfoutput>#request.self#?fuseaction=settings.data_source&event=upd&data_source_id=#attributes.data_source_id#</cfoutput>';
</script>