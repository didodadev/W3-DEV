	...
	<cfloop from="1" to="10" index="i">
		<cfif isdefined("form.column#i#") and listfindnocase("text,textarea",ListGetAt(Evaluate("column#i#"),3))>
            ...
            <cfquery name="get_langs" datasource="#dsn#">
                SELECT LANGUAGE_SHORT FROM SETUP_LANGUAGE WHERE LANGUAGE_SHORT <> <cfqueryparam cfsqltype="cf_sql_varchar" value="#lang_list#">
            </cfquery>
					...
					<cfif eof.recordcount gt 0>
						<cfquery datasource="#dsn#" name="add_">
							...
							WHERE
            					...
            					PERIOD_ID = #session.ep.period_id# AND
                                UNIQUE_COLUMN_ID = #form.taskId# AND
								LANGUAGE = <cfqueryparam cfsqltype="cf_sql_varchar" value="#lang#"> AND
								COLUMN_NAME = <cfqueryparam cfsqltype="cf_sql_varchar" value="#column_name#"> AND
								TABLE_NAME = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.tableNames#">
						</cfquery>
					<cfelse>
						<cfquery datasource="#dsn#" name="add_">
							INSERT INTO
								...
								VALUES(
                                    ...
                                    <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.tableNames#">,
									<cfqueryparam cfsqltype="cf_sql_varchar" value="#column_name#">,
									<cfqueryparam cfsqltype="cf_sql_varchar" value="#lang#">,
             ...
             <cfloop from="1" to="10" index="i">
               <cfif isdefined("form.column#i#") and ListGetAt(Evaluate("form.column#i#"),3) neq 'static'>
                    ...
                    <cfelseif ListGetAt(Evaluate("form.column#i#"),4) eq "string">
                            <cfset values = "task"&#ListGetAt(Evaluate("form.column#i#"),1)#>
                            <cfqueryparam cfsqltype="cf_sql_varchar" value='#Evaluate("form.#values#")#'><cfif isdefined("form.column#i+1#")>,</cfif>
