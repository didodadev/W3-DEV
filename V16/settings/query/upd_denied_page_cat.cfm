...
<cfquery name="del_faction" datasource="#dsn#">
	DELETE FROM EMPLOYEE_POSITIONS_DENIED WHERE DENIED_PAGE = '#attributes.faction_old#' AND (POSITION_CAT_ID IS NOT NULL OR USER_GROUP_ID IS NOT NULL)
</cfquery>
...
<script type="text/javascript">
	location.href= '<cfoutput>#request.self#?fuseaction=settings.denied_pages&event=upd&faction=#faction#&id=#max_id#</cfoutput>';
</script>