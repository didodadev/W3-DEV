<cfcomponent>
	...
	<cffunction name="getDecisionmedicine" access="public" returntype="query">
		...
		<cfargument name="sortfield" type="string" required="no" default="DRUG_MEDICINE">
		<cfquery name="get_medicine_list" datasource="#dsn#">
			...
			WHERE
				...
				<cfif isDefined("arguments.keyword") and len(arguments.keyword)>AND DRUG_MEDICINE LIKE '%#arguments.keyword#%'</cfif>
			ORDER BY 
