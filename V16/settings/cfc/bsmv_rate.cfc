<cfcomponent>
    ...
    <cffunction  name="get_kaynak_period"  access="remote" returntype="any">
        ...
        <cfquery name="get_kaynak_period" datasource="#dsn#">
            ...
            FROM 
                SETUP_PERIOD 
            WHERE 
                OUR_COMPANY_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.OUR_COMPANY_ID#"> AND PERIOD_YEAR = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.PERIOD_YEAR-1#">
        </cfquery>
    ...
    <cffunction  name="select_bsmv_hedef" access="remote" returntype="any">
        <cfargument  name="hedef_period_1"default="">         
       <cfquery name="select_bsmv_hedef" datasource="#dsn#_#get_hedef_period.OUR_COMPANY_ID#">
			SELECT * FROM SETUP_BSMV where PERIOD_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.hedef_period_1#">
        </cfquery>
        <cfreturn select_bsmv_hedef>        
    </cffunction>
    <cffunction  name="bsmv_aktarim" access="remote"  returnFormat="json" returntype="any">  
        <cftry>
            <cfset get_hedef_period = get_hedef_period(hedef_period_1 : arguments.hedef_period_1)/>
            <cfset get_kaynak_period = get_kaynak_period( OUR_COMPANY_ID: get_hedef_period.OUR_COMPANY_ID, PERIOD_YEAR: get_hedef_period.PERIOD_YEAR)/>
            <cfset select_bsmv_hedef=select_bsmv_hedef(hedef_period_1 : arguments.hedef_period_1)/>
            <cfset result = StructNew()>
            <cflock name="#CREATEUUID()#" timeout="70">
                <cftransaction> 
                    <cfif select_bsmv_hedef.recordcount or (not get_kaynak_period.recordcount)>
                    ...
                    <cfelse>
                        ...
                        <cfquery name="bsmv_aktarim" datasource="#dsn#_#get_hedef_period.OUR_COMPANY_ID#">    
                            INSERT INTO SETUP_BSMV
                                (TAX
                                ,DETAIL
                                ,ACCOUNT_CODE
                                ,PURCHASE_CODE
