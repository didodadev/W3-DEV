...
<cfoutput>
	...
	<cfif Isdefined("attributes.more") AND attributes.more>
		<cfif IsDefined("attributes.answertype")>
			window.location="#request.self#?fuseaction=training_management.popup_form_add_CHAPTER&quiz_id=#quiz_id#&CHAPTER_ID=#attributes.CHAPTER_ID#&answertype=1";
		<cfelse>
			window.location="#request.self#?fuseaction=training_management.popup_form_add_CHAPTER&quiz_id=#quiz_id#&CHAPTER_ID=#attributes.CHAPTER_ID#";
		</cfif>
	<cfelse>
		<cfif IsDefined("attributes.answertype")>
			window.close();
