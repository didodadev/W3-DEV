        ...
        <cfloop query="get_quiz_questions">
          <tr class="color-list">
            ...
            <td class="txtboldblue">
				<input type="checkbox" name="gd_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#" id="gd_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#" value="1" onClick="change_gd('#get_quiz_chapters.currentrow#','#get_quiz_questions.currentrow#');">
			</td>
          <cfif answer_number_gelen neq 0>
            <cfloop from="1" to="20" index="i">
			  <cfif len(evaluate("b#i#")) or len(evaluate("a#i#"))>
                <td align="center" width="75">
                  <input type="Radio" name="user_answer_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#" id="user_answer_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#" value="#i#" onClick="change_gd_radio('#get_quiz_chapters.currentrow#','#get_quiz_questions.currentrow#');"><!--- calc_user_point('#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#',#i#,#evaluate('c#i#')#); --->
