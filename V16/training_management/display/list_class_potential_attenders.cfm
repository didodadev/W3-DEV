...
<cfinclude template="view_class.cfm">
	...
	<td class="headbold"><cf_get_lang no='160.Potansiyel Katılımcılar'></td>
          ...
          <td> 		  
              ...
              <!--- <cfform name="form1" method="post" action="#request.self#?fuseaction=training_management.popup_list_class_potential_attenders&class_id=#attributes.class_id#&training_id=#attributes.training_id#"> --->
				...
				<tr>
					<td colspan="10" style="text-align:right;">
				  	 Katılmadı<input type="checkbox" name="is_attended" id="is_attended" value="1" <cfif isdefined("attributes.is_attended")>checked</cfif>>
					  <select name="IS_POTENTIAL" id="IS_POTENTIAL">
						<option value="0"<cfif attributes.IS_POTENTIAL is 0>selected</cfif>><cf_get_lang no='102.Konuya Bağlı'></option>
						<option value="1"<cfif attributes.IS_POTENTIAL is 1>selected</cfif>><cf_get_lang_main no='296.Tümü'></option>
					  </select></td>
				</tr>
            </table>		    
			  </td>
			...
			<!-- sil -->
			  <tr class="color-header" height="22">                 
				...
				<td class="form-title"><cf_get_lang no='161.Potansiyel Katılımcı'></td>
			 ...
			 <cfelse>
			  <tr class="color-list">
				<td colspan="7"><cfif isdefined("is_submit")><cf_get_lang_main no='72.Kayıt Bulunamadı'>!<cfelse><cf_get_lang_main no='289.Filtre Ediniz'>!</cfif></td> 
			  </tr>
			 </cfif> 
            </table>
          </td>
...
/*hepsi işaretlendiğinde diğer sayfalara taşınmıyor.. DÜZELTİLECEK. A.SELAM*/
function hepsi()
{
