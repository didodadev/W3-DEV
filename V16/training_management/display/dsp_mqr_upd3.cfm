                ...
                <td>
                  <cfswitch expression="#right_number#">
                    ...
                    <input type="Radio" name="user_answer_#attributes.question_row#" id="user_answer_#attributes.question_row#" value="#i#"
						<cfif isdefined("GET_EMP_QUIZ_ANSWERS") and isdefined("GET_EMP_QUIZ_ANSWERS.RESULT_ID") and GET_EMP_QUIZ_ANSWERS.QUESTION_ID is QUESTION_ID and listlast(GET_EMP_QUIZ_ANSWERS.QUESTION_USER_ANSWERS) is i>
							checked
						</cfif>
					>
                    </cfcase>
