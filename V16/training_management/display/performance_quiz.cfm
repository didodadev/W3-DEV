          ...
          <cfoutput query="get_emp_att">
            <cfquery name="GET_UNNAMED" datasource="#dsn#">
				...
				FROM 
					TRAINING_CLASS_EVAL
				WHERE 
					TRAINING_CLASS_EVAL.EMP_ID=#EMP_ID# 
				AND
        ...
        <cfif get_quiz_questions.RecordCount>
          ...
          <tr>
            ...
            <cfloop query="get_emp_att">
              ...
              <cfif FUSEACTION CONTAINS "popup_form_upd_class_eval">
              ...
              <td  align="center">
                <cfinput tabindex="#attributes.emp_id_currentrow##get_quiz_chapters.currentrow##get_quiz_questions.currentrow#" type="text" name="user_answer_#get_quiz_chapters.currentrow#_#get_quiz_questions.currentrow#_#emp_id#" value="#point_found#" style="width:20px;" range="1,5" message="Not 1 ile 5 arasında olmalıdır!">
              </td>
            </cfloop>
          </tr>
          <cfelse>
