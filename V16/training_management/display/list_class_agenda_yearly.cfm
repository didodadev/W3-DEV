...
<table cellSpacing="1" cellpadding="2" border="0" width="99%" align="center" class="color-border">
	<tr class="color-header" height="22"> 
    	<td width="60"><cf_get_lang_main no='1260.Aylar'></td>
    	<td valign="middle">
    		<div style="float:left">
        		<cf_get_lang_main no='7.Eğitim'>(<cfoutput><cfif isdefined("attributes.yil_src")>#attributes.yil_src#<cfelse>#Year(Now())#</cfif></cfoutput>)
	        </div>
			<!-- sil -->
    	    <div style="float:right">
        	    <cfloop from="-2" to="2" index="i">
                	...
                	<cfoutput>
                    	<a href="#request.self#?fuseaction=training_management.list_class_agenda#url_str#&yil_src=#year_k#&page_type=#page_type#">
...
<cfloop from="1" to="12" index="attributes.month_id">  
	<tr height="35" onMouseOver="this.className='color-light';" onMouseOut="this.className='color-row';" class="color-row">
		<td>
			<cfif attributes.month_id eq 1><a class="tableyazi" href="#request.self#?fuseaction=training_management.list_class_agenda&page_type=1&ay=1"><cf_get_lang_main no='180.Ocak'></a></cfif>
			...
			<cfif attributes.month_id eq 12><a class="tableyazi" href="#request.self#?fuseaction=training_management.list_class_agenda&page_type=1&ay=12"><cf_get_lang_main no='191.Aralık'></a></cfif>																																																													
		</td>
		<td colspan="2">
			...
			<cfloop query="get_class">
				...
				<a href="#request.self#?fuseaction=training_management.form_upd_class&class_id=#get_class.class_id#" class="tableyazi" title="Başlangıç / Bitiş Tarihleri:#Chr(13)#<cfif isdefined('start_tarih')>#start_tarih#</cfif> / #DateFormat(finish_date, 'yyyy-mm-dd')#"><font color="#color_#">#get_class.class_name#</font></a>
