          ...
          <td colspan="7" align="center">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr class="formbold"> <cfoutput>
                  <td width="20" align="left"> <a href="#yer#&ay=#ay#&yil=#oncekiyil#"><img src="/images/previous20.gif" width="15" height="20" border="0"></a></td>
                  <td align="center">#Year(tarih)#</td>
                  <td width="20" style="text-align:right;"><a href="#yer#&ay=#ay#&yil=#sonrakiyil#"><img src="/images/next20.gif" width="15" height="20" border="0"></a></td>
                  <td width="20" align="left"><a href="#yer#&ay=#oncekiay#&yil=<cfif ay eq 1>#oncekiyil#<cfelse>#yil#</cfif>"><img src="/images/previous20.gif" width="15" height="20" border="0"></a></td>
                  <cfif ( isdefined("session.ep.language") and  (session.ep.language is 'tr') )  or ( isdefined("session.pp.language") and  (session.pp.language is '_tr') )>
                    ...
                    <td align="center">#dateformat(tarih, 'mmmm')#</td>
                  </cfif>
                  <td width="20" style="text-align:right;"><a href="#yer#&ay=#sonrakiay#&yil=<cfif ay eq 12>#sonrakiyil#<cfelse>#yil#</cfif>"><img src="/images/next20.gif" width="15" height="20" border="0"></a></td>
                </cfoutput> </tr>
            </table>
          </td>
        </tr>
