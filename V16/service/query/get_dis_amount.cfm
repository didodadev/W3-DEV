...
<cfif isdefined('attributes.row_ship_id#i#')><cfset order_id = evaluate('attributes.row_ship_id#i#')><cfelse><cfset order_id = 0></cfif><!--- irs coklu siparis cekme. row_ship_id degiskeninde irsaliyeye siparis cekerken order_id'ler tutuluyor--->
