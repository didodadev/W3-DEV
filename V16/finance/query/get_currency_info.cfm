...
<cfquery name="GET_CURRENCY" datasource="#DSN#">
	...
	<cfif isdefined("attributes.keyword") and len(attributes.keyword)>
		AND (E.EMPLOYEE_NAME LIKE '%#attributes.keyword#%' COLLATE SQL_Latin1_General_CP1_CI_AI OR E.EMPLOYEE_SURNAME LIKE '%#attributes.keyword#%' COLLATE SQL_Latin1_General_CP1_CI_AI)
	</cfif>
	ORDER BY
		MH.RECORD_DATE DESC
</cfquery>
