<cfquery name="UPD_INVOICE" datasource="#dsn2#">
	...
	SET
		...
		SALE_EMP = <cfif isDefined("attributes.employee_id") and len(attributes.employee_name)>#attributes.employee_id#,<cfelse>NULL,</cfif>
		...
		POS_CASH_ID = #attributes.pos_cash_id#,
		...
		EXPENSE_CENTER_ID = <cfif isdefined("attributes.expense_center") and len(attributes.expense_center) and len(attributes.expense_center_id)>#attributes.expense_center_id#<cfelse>NULL</cfif>,
