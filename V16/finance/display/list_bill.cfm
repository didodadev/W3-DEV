    ...
    <td>
      <table width="100%" border="0" cellspacing="1" cellpadding="2">
        <tr class="color-list" height="22">
		  ...
		  <a href="javascript://" onclick="gizle_goster_img('list_bill_img1','list_bill_img2','list_bill_menu');"><img src="/images/listele_down.gif" alt="<cf_get_lang no='132.Ayrıntıları Gizle'>" title="<cf_get_lang no='132.Ayrıntıları Gizle'>" width="12" height="7" border="0" align="absmiddle" id="list_bill_img1" style="display:;cursor:pointer;"></a>
		  <a href="javascript://" onclick="gizle_goster_img('list_bill_img1','list_bill_img2','list_bill_menu');"><img src="/images/listele.gif" alt="<cf_get_lang no='89.Ayrıntıları Göster'>" title="<cf_get_lang no='89.Ayrıntıları Göster'>" width="7" height="12" border="0" align="absmiddle" id="list_bill_img2" style="display:none;cursor:pointer;"></a>
		  <cf_get_lang no='5.Bugünkü Alış Faturaları'></td>
        </tr>
			  ...
			  <cfset company_id_list=''>
				...
				<cfoutput query="get_bill" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#">
                    ...
                    <td>#dateformat(INVOICE_DATE,dateformat_style)#</td>
					 <td width="70">
                      <cfif INVENTORY_ID eq "">
                        <a href="#request.self#?fuseaction=invoice.form_add_bill_purchas&event=upd&iid=#get_bill.invoice_id#" class="tableyazi">#GET_BILL.INVOICE_NUMBER#</a>
                        <cfelse>
                  ...
                  <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_com_det&company_id=#COMPANY_ID#','medium');" class="tableyazi"> #get_company_detail.FULLNAME[listfind(company_id_list,COMPANY_ID,',')]# </a>
					<cfelseif len(get_bill.PARTNER_ID)>#get_par_info(get_bill.PARTNER_ID,0,0,1)#
                    <cfelse>#get_cons_info(get_bill.CON_ID,1,1)#</cfif>
                    </td>
