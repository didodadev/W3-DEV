...
encryption="128-bit">
<!---<cfdump var="#GET_COMPANY.recordcount#"><cfabort> --->
 <link rel='stylesheet' href='/css/win_ie_5.css' type='text/css'>
<cfoutput query="GET_COMPANY">
	<table style="width:195mm;height:260mm;" border="0" cellpadding="0" cellspacing="0">
		<tr align="left">
			<td style="width:7mm;">&nbsp;</td>
			<td colspan="2" align="left" style="height:40mm;width:188mm;">
		...
		<tr>
			...
			<table width="100%" border="0" style="height:50mm;" cellspacing="0" cellpadding="0">
				<!--- <tr valign="top">
				...
				<tr>
					<td><cfset myNumber = abs(filterNum(tlformat(bakiye)))>
						<cf_n2txt number="myNumber">
						Nezdimizdeki Cari Hesabınız <strong>&nbsp;#DateFormat(tarih_,dateformat_style)#&nbsp;</strong> tarihi itibari ile <strong>#TLFormat(abs(bakiye))#
						#session.ep.money# <cfif len(bakiye) and bakiye neq 0>(#myNumber#)</cfif>&nbsp;&nbsp;<cfif BORC gt ALACAK>Borç<cfelseif BORC lt ALACAK>Alacak</cfif>&nbsp;&nbsp;</strong> bakiye göstermektedir.
					</td>
				</tr>
				<tr><td>Mutabık olup olmadığımızı bildirmenizi rica ederiz.</td></tr>
				<tr align="left">
					<td valign="top">
