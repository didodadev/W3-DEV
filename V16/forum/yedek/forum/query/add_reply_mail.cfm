...
<table width="590" border="0" align="center">
	<tr>
		<td height="30" class="headbold"><cf_get_lang no='14.WorkCube Forum'></td>
	</tr>
	<tr>
		<td><cf_get_lang no='13.Forumda cevapları göreyim seçeneğini seçtiğiniz bir konuya cevap yazıldı'>.</td>
	</tr>
	<tr>
		<td><br/><strong><cf_get_lang no='12.İlgili Konu'>:</strong></td>
	</tr>
</table> 
</cfoutput>
