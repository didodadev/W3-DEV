                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <cfif head_topic.locked neq 1>
                                         ...
                                         <a href="javascript:window.print();" ><img src="/images/messenger3.gif" title="<cf_get_lang_main no='62.Yazdır'>"></a>
                                    </td>
                                </tr>
                            </table>
                        </cf_area>
		...
		<cfoutput>
            ...
            <table>
                <tr>
                    <td>
                        <cf_form_box_footer>
                            <cf_workcube_buttons is_upd='0' is_cancel='0' insert_alert=''><!---  add_function='OnFormSubmit()' --->
                        </cf_form_box_footer>
                    </td>
                </tr>
            </table>
        ...
        <tr>
            <td> 
                <cf_pages 
                    ...
                    adres="forum.view_reply&topicid=#topicid#&is_form_submitted=1&special_definition=#attributes.special_definition#"></td>
