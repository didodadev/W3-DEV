...
<cfquery name="GET_CONSUMER_INFO" datasource="#DSN#">
	...
	FROM
		CONSUMER
	WHERE
		CONSUMER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.consid#">
</cfquery>
<table cellpadding="0" cellspacing="0" align="center" style="width:98%">
	<tr style="height:35px;">
		<td class="headbold">Bireysel Üye Güncelle</td>
	</tr>
</table>
				...
				<table align="center" style="width:99%">
					<tr>
						...
						<td>
							...
							<cfelse>
								<cfinput type="text" name="consumer_name" id="consumer_name" required="yes" message="#message#" maxlength="30" style="width:70px;" value="#get_consumer_info.consumer_name#">				  
							</cfif>  
							...
							<cfelse>
								<cfinput type="text" name="consumer_surname" id="consumer_surname" required="yes" message="#message#" maxlength="30" style="width:112px;" value="#get_consumer_info.consumer_surname#">				  
							</cfif>
						</td>
					</tr>
					<tr>
						<td class="infotag"><cf_get_lang_main no="1197.Üye Kategorisi">*</td>
						<td>
							<select name="consumer_cat_id" id="consumer_cat_id" style="width:200px;">
								<option value=""><cf_get_lang_main no='322.Seçiniz'></option>
								<cfoutput query="get_consumer_cat">
									<option value="#conscat_id#" <cfif get_consumer_info.consumer_cat_id eq conscat_id>selected</cfif>>#conscat#</option>
								</cfoutput>
							</select>
						</td>
					</tr>
						...
						<tr>
							...
							<td>
								<cf_wrk_combo 
									...
									value="#get_consumer_info.resource_id#"
					...
					<cfif isdefined('xml_is_customer_value') and xml_is_customer_value neq 0>
						<tr>
							<td class="infotag"><cf_get_lang_main no="1140.Müşteri Değeri"> <cfif isdefined('xml_is_customer_value') and xml_is_customer_value eq 2> * </cfif></td>
							<td>
								<select name="customer_value" id="customer_value" style="width:200px;">
									<option value=""><cf_get_lang_main no='322.seçiniz'></option>
									<cfoutput query="get_customer_value">
										<option value="#customer_value_id#" <cfif get_consumer_info.customer_value_id eq customer_value_id>selected</cfif>>#customer_value#</option>
									</cfoutput>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<cf_wrk_saleszone
									 ...
									 width="200"
									 tabindex="7"
									 value="#get_consumer_info.sales_county#">	
							</td>
						</tr>
					</cfif>
						...
						<tr>
							...
							<td>
								<cfquery name="GET_IMS" datasource="#DSN#">
									SELECT IMS_CODE_NAME FROM SETUP_IMS_CODE WHERE IMS_CODE_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#get_consumer_info.ims_code_id#">
								</cfquery>
								<input type="hidden" name="ims_code_id" id="ims_code_id" value="<cfoutput>#get_consumer_info.ims_code_id#</cfoutput>">
								<input type="text" name="ims_code_name" id="ims_code_name" value="<cfoutput>#get_ims.ims_code_name#</cfoutput>" style="width:162px;" readonly="readonly">
					...
					<tr>
						...
						<td>
							<input type="text" name="homepage" id="homepage" value="<cfoutput>#get_consumer_info.homepage#</cfoutput>" style="width:193px;" maxlength="50">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="tax_no" id="tax_no" value="<cfoutput>#get_consumer_info.tax_no#</cfoutput>" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="10" style="width:193px;">
						</td> 
					</tr>
					<tr>
						...
						<td>
							...
							<cfinput type="text" name="consumer_email" id="consumer_email" value="#get_consumer_info.consumer_email#" maxlength="40" validate="email" message="#message#" style="width:193px;">				
						</td>
					</tr>
					<tr>
						<td class="infotag"><cf_get_lang_main no='87.Telefon'></td>
						<td>
							<input text="text" name="home_telcode" id="home_telcode" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="5" style="width:64px;" value="<cfoutput><cfif isdefined("attributes.home_telcode")>#attributes.home_telcode#<cfelse>#get_consumer_info.consumer_hometelcode#</cfif></cfoutput>">
							<input type="text" name="home_tel" id="home_tel" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="9" style="width:118px;" value="<cfoutput><cfif isdefined("attributes.home_tel")>#attributes.home_tel#<cfelse>#get_consumer_info.consumer_hometel#</cfif></cfoutput>">
						</td>
					</tr>
					<tr>
						<td class="infotag"><cf_get_lang_main no='76.Fax'></td>
						<td>
							<input type="text" name="work_faxcode" id="work_faxcode" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="5" style="width:64px;" value="<cfoutput><cfif isdefined("attributes.work_faxcode")>#attributes.work_faxcode#<cfelse>#get_consumer_info.consumer_faxcode#</cfif></cfoutput>">		  
							<input type="text" name="work_fax" id="work_fax" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="9" style="width:118px;" value="<cfoutput><cfif isdefined("attributes.work_fax")>#attributes.work_fax#<cfelse>#get_consumer_info.consumer_fax#</cfif></cfoutput>">
						</td>
					</tr>
					<tr>
						...
						<td>
							<select name="mobilcat_id" id="mobilcat_id" style="width:71px;">
								...
								<cfoutput query="get_mobilcat">
									<option value="#mobilcat#" <cfif isdefined("attributes.mobilcat_id") and attributes.mobilcat_id eq mobilcat>selected<cfelseif len(get_consumer_info.mobiltel) and get_consumer_info.mobiltel eq mobilcat>selected</cfif>>#mobilcat#</option>
								</cfoutput>
							</select>
							<input type="text" name="mobiltel" id="mobiltel" onKeyup="isNumber(this);" onblur="isNumber(this);" maxlength="9" style="width:118px; vertical-align:top" value="<cfoutput><cfif isdefined("attributes.mobiltel")>#attributes.mobiltel#<cfelse>#get_consumer_info.mobiltel#</cfif></cfoutput>">
						</td>
					</tr>
					<tr>
