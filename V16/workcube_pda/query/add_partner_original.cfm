		...
		<cfquery name="ADD_PARTNER" datasource="#DSN#">
			INSERT INTO 
                ...
                (
                    ...
                    <cfif isDefined("attributes.telcode") and len(attributes.telcode)>'#attributes.telcode#'<cfelse>NULL</cfif>,
                    <cfif isDefined("attributes.telno") and len(attributes.telno)>'#attributes.telno#'<cfelse>NULL</cfif>,
