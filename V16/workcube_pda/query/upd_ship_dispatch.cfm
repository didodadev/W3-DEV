	...
	*/
	...
	for(row_i=1;row_i lte attributes.row_count;row_i=row_i+1)
	{
		...
		{*/
			...
			//writeoutput('attributes.price#row_i#'&evaluate("attributes.price#row_i#"));
...
<!--- <cfif isDefined('attributes.kur_say') and len(attributes.kur_say)>
	...
	<!--- <cftry> --->
		<cfinclude template="../../sales/query/upd_order.cfm">
		<!--- <cfcatch>
...
<script type="text/javascript">
	alert('Siparişiniz başarıyla güncellenmiştir !');
