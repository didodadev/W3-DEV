...
<cftry>
	...
	<cfinclude template="../../production_plan/query/add_prod_order_result.cfm">
	...
	<cfquery name="GET_PRODUCTION_RESULT_DETAIL" datasource="#DSN3#">
		...
		WHERE
			...
			PRODUCTION_ORDER_RESULTS.PR_ORDER_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#get_max2.max_id#"> AND
    ...
    <cfset is_demontaj = get_production_result_detail.is_demontaj>
	...
	<script language="javascript" type="text/javascript">
		...
		window.location.href="<cfoutput>#request.self#?fuseaction=pda.form_upd_production_result&p_order_id=#attributes.p_order_id#&pr_order_id=#get_max2.max_id#</cfoutput>";
	</script>
	
	<cfcatch>
		<script language="javascript" type="text/javascript">
			alert("Üretim Sonucu Kaydedilirken Sorun Oluştu!");
			window.history.back();
		</script>
	</cfcatch>
</cftry>
