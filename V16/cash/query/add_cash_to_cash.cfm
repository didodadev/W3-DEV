...
<cftransaction>
	...
	<cf_workcube_process_cat 
		...
		action_page='#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_add_cash_to_cash&event=upd&id=#CASH_ACT_ID#'
		action_db_type = '#dsn2#'
		is_template_action_file = '#get_process_type.action_file_from_template#'>
	</cftransaction>
    <cf_add_log log_type="1" action_id="#CASH_ACT_ID#" action_name="#attributes.paper_number# Eklendi" paper_no="#attributes.paper_number#" period_id="#session.ep.period_id#" process_type="#get_process_type.PROCESS_TYPE#" data_source="#dsn2#">
</cflock>
...
<cfelse>
	<cfset attributes.actionId=CASH_ACT_ID />
	<script type="text/javascript">	
		window.location.href='<cfoutput>#request.self#?fuseaction=#listgetat(attributes.fuseaction,1,'.')#.form_add_cash_to_cash&event=upd&id=#CASH_ACT_ID#</cfoutput>';
	</script>
</cfif> 
