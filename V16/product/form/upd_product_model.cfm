...
<cfif isdefined('attributes.model_id') and len(attributes.model_id)>
	<cfquery name="get_model_det" datasource="#dsn1#">
		SELECT * FROM PRODUCT_BRANDS_MODEL WHERE MODEL_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#attributes.model_id#"> 
	</cfquery>
</cfif>
...
<div class="col col-12 col-md-12 col-sm-12 col-xs-12">
    <cfsavecontent variable="head"><cf_get_lang dictionary_id='58225.Model'></cfsavecontent>
    <cf_box title="#head#:#attributes.model_id#" popup_box="1" >
        ...
        <input type="hidden" name="model_id" id="model_id" value="<cfoutput>#model_id#</cfoutput>">
            <cf_box_elements vertical="1">
                <div class="col col-6 col-md-6 col-sm-6 col-xs-12" type="column" index="1" sort="true">
                    ...
                    <div class="form-group" id="item-model_code">
                        <label class="col col-3 col-xs-12"><cf_get_lang dictionary_id='58585.Kod'>*</label>
                        <div class="col col-9 col-xs-12">
                            <div <cfif isdefined('attributes.model_id') and len(attributes.model_id)>class="input-group"</cfif>>
            ...
            <div class="ui-form-list-btn">
                <div class="col col-6 col-md-8 col-sm-8 col-xs-12">
                    <cf_record_info query_name="get_model_det">
                </div>
