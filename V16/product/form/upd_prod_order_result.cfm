...
<table class="dph">
    <tr>
        <td class="dpht"><a href="javascript:gizle_goster_ikili('order_result','order_result_bask');">&raquo;</a><cf_get_lang dictionary_id='29651.Üretim Sonucu'>:<cfoutput>#get_detail.p_order_no#</cfoutput></td>
        <cfform name="other_po_result" method="post" action="#request.self#?fuseaction=prod.emptypopup_locat_production_orders_detail">
            <td class="dphb">
                <table align="right">
                    <tr>
                        <td>
                            <cfsavecontent variable="aler_prod_ord"><cf_get_lang dictionary_id='36762.Sonuç No'> <cf_get_lang dictionary_id='58546.Yok'></cfsavecontent>
                        ...
                        <td>
                            <cfoutput>
                                ...
                                <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=service.popup_add_timecost&p_order_result_id=#attributes.pr_order_id#&is_p_order_result=1</cfoutput>','page_horizantal');"><img src="/images/kum.gif" border="0"  align="absbottom"  title="<cf_get_lang dictionary_id='41922.Zaman Harcaması Ekle'>" /></a>
                                <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=prod.popup_add_prod_result_asset&id=#attributes.pr_order_id#</cfoutput>','list');" ><img src="/images/asset.gif"  title="<cf_get_lang dictionary_id ='30004.Fiziki Varlıklar'>" border="0"  align="absbottom"  /></a>
                                <cfif get_module_user(22)>
                                    <a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=account.popup_list_card_rows&action_id=#attributes.pr_order_id#&process_cat='+form_basket.old_process_type.value</cfoutput>,'page','upd_prod_order_result');"><img src="/images/extre.gif" align="absbottom"   border="0" title="<cf_get_lang dictionary_id='58452.Mahsup Fişi'>" /></a>
                                </cfif>
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_page_warnings&action=prod.upd_prod_order_result&action_name=p_order_id&action_id=#attributes.p_order_id#&action_name2=pr_order_id&action_id2=#attributes.pr_order_id#&relation_papers_type=P_ORDER_ID','list');"><img src="/images/uyar.gif" align="absbottom" title="<cf_get_lang dictionary_id='57757.Uyarılar'>" border="0" /></a>
                                <a href="javascript://"  onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=#attributes.pr_order_id#&iid=#attributes.p_order_id#&print_type=280','page');"><img src="/images/barcode_print.gif" align="absbottom" title="<cf_get_lang dictionary_id='57474.Yazdır'>" border="0"></a><!--- |#get_detail.lot_no# --->
                                <a href="#request.self#?fuseaction=prod.form_upd_prod_order&upd=#get_detail.p_order_id#"><img src="/images/action_plus.gif" border="0" align="absbottom"  title="<cf_get_lang dictionary_id='30049.Üretim Emri'>" /></a>
                            </cfoutput>
                        </td>
                    </tr>
                </table>
...
<cfform name="form_basket" method="post" action="#request.self#?fuseaction=prod.emptypopup_upd_prod_order_result_act&is_changed_spec_main=#is_changed_spec_main#">
...
<cf_basket_form id="order_result">
	<cf_object_main_table>
		<cf_object_table column_width_list="100,170">
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36760.İşlem Kategorisi'></cfsavecontent>
			<cf_object_tr id="form_ul_process_cat" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36760.İşlem Kategorisi'> *</cf_object_td>
				<cf_object_td>
					<cf_workcube_process_cat slct_width="135" process_cat='#get_detail.process_id#'>
				</cf_object_td>
			</cf_object_tr>
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36346.Üretim Emir No'></cfsavecontent>
			<cf_object_tr id="form_ul_production_order_no" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36346.Üretim Emir No'> *</cf_object_td>
				<cf_object_td>
			...
			<cf_object_tr id="form_ul_order_no" title="#header_#">
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36765.İşlemi Yapan'></cfsavecontent>
			<cf_object_tr id="form_ul_expense_employee_id" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36765.İşlemi Yapan'></cf_object_td>
				<cf_object_td>
		...
		<cf_object_table column_width_list="90,175">
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='57655.Başlama'></cfsavecontent>
			<cf_object_tr id="form_ul_start_date" extra_select="start_h,start_m" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='57655.Başlama'> *</cf_object_td>
				<cf_object_td>
					...
					<cf_wrk_date_image date_field="start_date" control_date="#dateformat(get_detail.start_date,dateformat_style)#">
					<cfoutput>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='57700.Bitiş'></cfsavecontent>
			<cf_object_tr id="form_ul_finish_date" extra_select="finish_h,finish_m" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='57700.Bitiş'> *</cf_object_td>
				<cf_object_td>
					...
					<cf_wrk_date_image date_field="finish_date" call_function="change_money_info" control_date="#dateformat(get_detail.finish_date,dateformat_style)#">
					<cfoutput>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36762.Sonuç No'></cfsavecontent>
			<cf_object_tr id="form_ul_production_result_no" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36762.Sonuç No'></cf_object_td>
				<cf_object_td>
			...
			<cf_object_tr id="form_ul_project_name" title="#header_#">
		...
		<cf_object_table column_width_list="60,165">
			...
			<cf_object_tr id="form_ul_start_date" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='58859.Süreç'></cf_object_td>
				<cf_object_td>
					<cf_workcube_process is_upd='0' select_value='#get_detail.prod_ord_result_stage#' process_cat_width='135' is_detail=','>
				</cf_object_td>
			</cf_object_tr>   
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36698.Lot No'></cfsavecontent>
			<cf_object_tr id="form_ul_lot_no" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36698.Lot No'></cf_object_td>
				<cf_object_td>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='58834.İstasyon'></cfsavecontent>
			<cf_object_tr id="form_ul_station_name" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='58834.İstasyon'> *</cf_object_td>
				<cf_object_td>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='58784.Referans'></cfsavecontent>
			<cf_object_tr id="form_ul_ref_no" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='58784.Referans'></cf_object_td>
				<cf_object_td>
					<input type="text" name="ref_no" id="ref_no" value="<cfoutput>#get_detail.REFERANS#</cfoutput>" style="width:135px;">                   
				</cf_object_td>
			</cf_object_tr>
		</cf_object_table> 
		<cf_object_table column_width_list="75,170">
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36761.Sarf Depo'></cfsavecontent>
			<cf_object_tr id="form_ul_exit_department" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36761.Sarf Depo'></cf_object_td>
				<cf_object_td>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36763.Üretim Depo'></cfsavecontent>
			<cf_object_tr id="form_ul_production_department" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36763.Üretim Depo'></cf_object_td>
				<cf_object_td>
			...
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='36764.Sevkiyat Depo'></cfsavecontent>
			<cf_object_tr id="form_ul_enter_department" title="#header_#">
				<cf_object_td type="text"><cf_get_lang dictionary_id='36764.Sevkiyat Depo'></cf_object_td>
				<cf_object_td>
		...
		<cf_object_table column_width_list="50,220">
			<cfsavecontent variable="header_"><cf_get_lang dictionary_id='57629.Açıklama'></cfsavecontent>
			<cf_object_tr id="form_ul_reference_no" title="#header_#">
				<cf_object_td td_style="vertical-align:top" type="text"><cf_get_lang dictionary_id='57629.Açıklama'></cf_object_td>
				<cf_object_td>
	...
	<table>
		...
		<tr>
			<td colspan="8">
				<cfif get_fis.recordcount><cf_get_lang dictionary_id='36778.Üretimden Çıkış Fişi'>:
					<cfoutput>
						<b><a href="#request.self#?fuseaction=stock.form_add_fis&event=upd&upd_id=#get_fis.FIS_ID#" class="tableyazi" target="_blank">#get_fis.fis_number#</a></b>
					</cfoutput>
				</cfif>
				<cfif get_fis2.recordcount><cf_get_lang dictionary_id='45267.Üretimden Giriş Fişi'>:
					<cfoutput>
						<b><a href="#request.self#?fuseaction=stock.form_add_fis&event=upd&upd_id=#get_fis2.FIS_ID#" class="tableyazi" target="_blank">#get_fis2.fis_number#</a></b>
					</cfoutput>
				</cfif>
				<cfif get_fis_sarf.recordcount>
					<cf_get_lang dictionary_id='29628.Sarf Fişi'>:
					<cfoutput>
						<b><a href="#request.self#?fuseaction=stock.form_add_fis&event=upd&upd_id=#get_fis_sarf.FIS_ID#" class="tableyazi" target="_blank">#get_fis_sarf.fis_number#</a></b>
					</cfoutput>
				</cfif>
				<cfif get_fis_ambar.recordcount or GET_STOK_FIS.recordcount>
					...
					<cfoutput>
					<b><a href="#request.self#?fuseaction=stock.add_ship_dispatch&event=upd&ship_id=#GET_STOK_FIS.SHIP_ID#" class="tableyazi" target="_blank">#get_fis_ambar.fis_number# #GET_STOK_FIS.ship_number# </a></b>
					</cfoutput>
				</cfif>
				<cfif GET_FIS_FIRE.RECORDCOUNT>
					<cf_get_lang dictionary_id='29629.Fire Fişi'>:
					<cfoutput>
						<b><a href="#request.self#?fuseaction=stock.form_add_fis&event=upd&upd_id=#GET_FIS_FIRE.FIS_ID#" class="tableyazi" target="_blank">#GET_FIS_FIRE.fis_number#</a></b>
					</cfoutput>
				</cfif>
			</td>
		</tr>
        ...
        <cf_basket_form_button>
			...
			<cfif get_fis.recordcount or get_fis_sarf.recordcount><input type="checkbox" name="is_delstock" id="is_delstock" value="1"><cf_get_lang dictionary_id='36777.Stok Fişleri Silinsin'>&nbsp;</cfif>
	...
	<cf_basket id="order_result_bask">
		<cfsavecontent variable="head"><cf_get_lang dictionary_id='29651.Üretim Sonucu'></cfsavecontent>
		<cf_seperator header="#head#" id="table1">
		    <table id="table1" name="id1" class="basket_list" style="margin-bottom:50px; display:none;">
				...
				<thead>
				<tr>
					<th width="15"><input type="hidden" name="record_num" id="record_num" value="<cfoutput>#get_row_enter.recordcount#</cfoutput>"><a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=prod.popup_add_product#xml_str#&p_order_id=#attributes.p_order_id#&pr_order_id=#attributes.pr_order_id#</cfoutput>&type=1&record_num=' + form_basket.record_num.value,'list')"><img id="add_row_image" src="/images/plus_list.gif" align="absbottom" border="0"></a></th>
					...
					<th width="175"><cf_get_lang dictionary_id='57452.Stok'></th>
					<th width="220" style="display:<cfoutput>#spec_img_display#</cfoutput>"><cf_get_lang dictionary_id='57647.spect'></th>
					...
					<cfif get_module_user(5) and session.ep.COST_DISPLAY_VALID neq 1>
						...
						<cfif x_is_show_labor_cost eq 1 and GET_DETAIL.IS_DEMONTAJ eq 0>
							<th width="90" id="labor_cost" style="text-align:right;"><cf_get_lang dictionary_id='47560.İşçilik Maliyeti'></th>
						</cfif>													
						<cfif x_is_show_refl_cost eq 1 and GET_DETAIL.IS_DEMONTAJ eq 0>
							<th width="90" id="refl_cost" style="text-align:right;"><cf_get_lang dictionary_id='36983.Yansıyan Maliyet'></th>
						</cfif>
						...
						<cfif x_is_show_labor_cost eq 1 and GET_DETAIL.IS_DEMONTAJ eq 0>
							<th width="90" id="labor_cost" style="text-align:right;"><cf_get_lang dictionary_id='47560.İşçilik Maliyeti'> (<cfoutput>#session.ep.money2#</cfoutput>)</th>
						</cfif>													
						<cfif x_is_show_refl_cost eq 1 and GET_DETAIL.IS_DEMONTAJ eq 0>
							<th width="90" id="refl_cost" style="text-align:right;"><cf_get_lang dictionary_id='36983.Yansıyan Maliyet'> (<cfoutput>#session.ep.money2#</cfoutput>)</th>
						</cfif>
						<cfif isdefined("x_is_cost_price_2") and x_is_cost_price_2 eq 1>
							<th width="50"><cf_get_lang dictionary_id='57489.Para Br'></th>
                        </cfif>
			...
			<tbody>
				<cfoutput query="get_row_enter">
					...
					<!--- Ana Ürün --->
					<tr id="frm_row#currentrow#" <cfif TREE_TYPE is 'P'>class="phantom" title="Phantom Ağaçtan Ürünler"<cfelseif TREE_TYPE is 'O'>class="operasyon" title="<cf_get_lang dictionary_id='60507.Operasyondan Gelen Ürünler'>"</cfif>>
						<td>
							...
							<a style="cursor:pointer" onclick="sil('#currentrow#');"><img  src="images/delete_list.gif" border="0" align="absbottom" title="<cf_get_lang dictionary_id='57463.Sil'>"></a>
						</td>
						...
						<td nowrap>
							...
							<a href="javascript://" onclick="get_stok_spec_detail_ajax('#product_id#');"><img src="/images/plus_thin_p.gif" style="cursor:pointer;" align="absbottom" border="0" title="<cf_get_lang dictionary_id ='36369.Stok Detay'>"></a>&nbsp;&nbsp;&nbsp;
						</td>
						...
						<td style="display:#spec_img_display#;" nowrap>
							<cfif len(spect_id) or len(SPEC_MAIN_ID)>
								...
								<a href="javascript://" onclick="pencere_ac_spect('#currentrow#',4);"><img src="/images/plus_thin_p.gif" align="absbottom" border="0" title="<cf_get_lang dictionary_id='36794.Spect Detay'>"></a>
							<cfelse>
						...
						<td><input type="text" name="amount#currentrow#" id="amount#currentrow#" value="#TlFormat(_AMOUNT_,round_number)#" onkeyup="return(FormatCurrency(this,event,8));" onblur="hesapla_deger(#currentrow#,1);<cfif GET_DETAIL.IS_DEMONTAJ eq 0 and isdefined('GET_SUM_AMOUNT')>aktar();</cfif>"<cfif is_change_amount_demontaj eq 0 or GET_FIS.RECORDCOUNT>readonly</cfif> class="moneybox" style="width:70px;"></td>
				...
				<cfoutput query="get_row_exit">
					...
					<tr id="frm_row_exit#currentrow#" <cfif TREE_TYPE is 'P'>class="phantom" title="Phantom Ağaçtan Ürünler"<cfelseif TREE_TYPE is 'O'>class="operasyon" title="Operasyondan Gelen Ürünler"</cfif>>
						<td nowrap="nowrap">
							...
							<a style="cursor:pointer" onclick="copy_row_exit('#currentrow#');" title="<cf_get_lang dictionary_id='58972.Satır Kopyala'>"><img  src="images/copy_list.gif" border="0"></a>
                            <a style="cursor:pointer" onclick="sil_exit('#currentrow#');"><img  src="images/delete_list.gif" border="0" align="absbottom" title="<cf_get_lang dictionary_id='57463.Sil'>"></a>
						</td>
						...
						<cfif x_is_barkod_col eq 1><td><input type="text" name="barcode_exit#currentrow#" id="barcode_exit#currentrow#" value="#get_product.barcod#" readonly style="width:90px;"></td></cfif>
						<td nowrap>
							...
							<a href="javascript://" onclick="pencere_ac_alternative('#currentrow#',document.form_basket.product_id_exit#currentrow#.value,document.form_basket.stock_id_exit#currentrow#.value);"><img src="/images/plus_thin.gif" style="cursor:pointer;" align="absbottom" border="0" title="<cf_get_lang dictionary_id ='36839.Alternatif Ürünler'>"></a>
							<a href="javascript://" onclick="get_stok_spec_detail_ajax('#product_id#');"><img src="/images/plus_thin_p.gif" style="cursor:pointer;" align="absbottom" border="0" title="<cf_get_lang dictionary_id ='36369.Stok Detay'>"></a>
						</td>
						<td style="display:#spec_img_display#;" nowrap>
		...
		<cfsavecontent variable="message"><cf_get_lang dictionary_id='29471.Fire'></cfsavecontent>
		<cf_seperator header="#message#" id="table3">
		<table id="table3" name="table3" class="basket_list" style="margin-bottom:50px; display:none;">
            <cfif x_pro_add_barkod_and_seri_no eq 1>
			...
			<thead>
				<tr>
					<th width="15"><input type="hidden" name="record_num_outage" id="record_num_outage" value="<cfoutput>#get_row_outage.recordcount#</cfoutput>"><a href="javascript://" onclick="windowopen('<cfoutput>#request.self#?fuseaction=prod.popup_add_product#xml_str#</cfoutput>&type=2&record_num_outage=' + form_basket.record_num_outage.value,'list')"><img id="add_row_outage_image" src="/images/plus_list.gif" align="absbottom" border="0"></a></th>
					<th width="70"><cf_get_lang dictionary_id='57518.Stok Kodu'></th>
					<cfif x_is_barkod_col eq 1><th width="90"><cf_get_lang dictionary_id='57633.Barkod'></th></cfif>
					<th width="170"><cf_get_lang dictionary_id='57452.Stok'></th>
					<th width="150" style="display:<cfoutput>#spec_img_display#</cfoutput>"><cf_get_lang dictionary_id='57647.spect'></th>
					<th width="75"><cf_get_lang dictionary_id='36698.Lot No'></th>
					<th width="60"><cf_get_lang dictionary_id='57635.Miktar'></th>
					<th width="60"><cf_get_lang dictionary_id='57636.Birim'></th>
					<cfif x_is_show_abh eq 1><th width="60">a*b*h</th></cfif>
				...
				<cfoutput query="get_row_outage">
					...
					<tr id="frm_row_outage#currentrow#">
						<td nowrap="nowrap">
                            ...
                            <a style="cursor:pointer" onclick="sil_outage('#currentrow#');"><img  src="images/delete_list.gif" border="0" align="absbottom" title="<cf_get_lang dictionary_id='57463.Sil'>"></a>
						</td>
						...
						<td nowrap="nowrap">
							...
							<a href="javascript://" onclick="pencere_ac_alternative('#currentrow#',document.form_basket.product_id_outage#currentrow#.value,document.form_basket.stock_id_outage#currentrow#.value);"><img src="/images/plus_thin.gif" style="cursor:pointer;" align="absbottom" border="0" title="<cf_get_lang dictionary_id ='36839.Alternatif Ürünler'>"></a>
							<a href="javascript://" onclick="get_stok_spec_detail_ajax('#product_id#');"><img src="/images/plus_thin_p.gif" style="cursor:pointer;" align="absbottom" border="0" title="<cf_get_lang dictionary_id ='36369.Stok Detay'>"></a>
						</td>
                        ...
                        <td nowrap="nowrap">
                       		<input type="text" name="lot_no_outage#currentrow#" id="lot_no_outage#currentrow#" value="#get_row_outage.lot_no#" style="width:75px;" />
...
<script language="javascript">
...

	{
		...
		newCell.innerHTML +='<a style="cursor:pointer" onclick="copy_row_outage('+row_count_outage+');" title="<cf_get_lang dictionary_id="1560.Satır Kopyala">"><img src="images/copy_list.gif" border="0"></a>';
		newCell.innerHTML +='<a style="cursor:pointer" onclick="sil_outage(' + row_count_outage + ');"><img src="images/delete_list.gif" border="0" align="absbottom" alt="<cf_get_lang dictionary_id="51.Sil">"></a>';
