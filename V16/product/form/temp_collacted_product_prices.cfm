...
<!-- sil --> 
<cfsavecontent variable="message"><cf_get_lang dictionary_id='29411.Fiyatlar'></cfsavecontent>
<cf_big_list_search title="#message# : #title#"> 
...
<cf_big_list>
	...
	<cfquery name="GET_PRODUCT" datasource="#DSN3#">
		...
		<cfif len(product_cat) and len(attributes.product_cat)>
