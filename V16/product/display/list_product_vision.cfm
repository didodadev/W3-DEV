...
<cf_big_list>
	<thead>
		<tr>
			...
			<th nowrap="nowrap"><cf_get_lang dictionary_id='57655.Başlama'></th>
			<th nowrap="nowrap"><cf_get_lang dictionary_id='57700.Bitiş'></th>
		...
		<cfif GET_VISIONS.recordcount>
			<cfoutput query="GET_VISIONS" startrow="#attributes.startrow#" maxrows="#attributes.maxrows#"> 
				<tr>
					...
					<!-- sil --><td width="15"><a href="javascript://" onClick="windowopen('#request.self#?fuseaction=product.popup_upd_product_vision&vision_id=#vision_id#','medium');"><img src="/images/update_list.gif" title="<cf_get_lang dictionary_id='57464.Güncelle'>"></a></td><!-- sil -->
				</tr>
			</cfoutput> 
		<cfelse>
			<tr> 
