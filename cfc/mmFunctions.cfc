...
<cffunction name="specer" returntype="any" output="false">	
    ...
    <cfargument name="process_stage" type="any" required="false" default="">
    <cfargument name="employee_id" type="any" required="false" default="">
    <cfargument name="save_date" type="any" required="false" default="">
    <cfargument name="is_quality_tpye_list" type="any" required="false" default=""><!--- Test parametresi olmup olmadığını belirler --->
    <cfargument name="quality_tpye_id_list" type="any" required="false" default=""><!--- Test parametreleri type id --->
    <cfargument name="quality_standart_value_list" type="any" required="false" default=""><!--- Test parametreleri standart değer --->
    <cfargument name="quality_quality_measure_list" type="any" required="false" default=""><!--- Test parametreleri ölçü --->
    <cfargument name="quality_tolerance_list" type="any" required="false" default=""><!--- Test parametreleri tolerans --->
    <cfargument name="is_mix_product" type="any" required="false" default="0"><!--- 0: Ürün ağacından kayıt yapılıyor, 1: Karma koliden kayıt yapılıyor. --->
    <cfargument name="get_message" required="false" default="0">
    <cfargument name="product_configurator_id" type="string" default="">
    <cfargument name="is_tree" type="numeric" default="1">
...
<cfelseif isdefined("dsn3")>
	...
	<cfif not isdefined('arguments.main_spec_id') or not len(arguments.main_spec_id)>
        <cfif arguments.spec_row_count eq 0 and  arguments.is_tree eq 1><!--- Main Spec Oluşturmak İçin Üründe hiçbir sarf olmadığı durumlarda. --->
			<script type="text/javascript">
        ...
        <cfquery name="GET_SPECT" datasource="#arguments.dsn_type#">
	        <cfif get_product_info_spec.IS_PROTOTYPE eq 1 and not len(arguments.is_product_tree_import)>
				...
				WHERE
                    ...
                    <cfif arguments.spec_row_count gt 0>
                    AND
					(
						<cfloop from="1" to="#arguments.spec_row_count#" index="ii">
							(
								...
								<cfif isdefined('arguments.related_spect_id_list') and listlen(arguments.related_spect_id_list) and listgetat(arguments.related_spect_id_list,ii,',') gt 0>
								...
								<cfif isdefined('arguments.property_id_list') and listlen(arguments.property_id_list) and listgetat(arguments.property_id_list,ii,',') gt 0>
								...
								<cfif isdefined('arguments.variation_id_list') and listlen(arguments.variation_id_list) and listgetat(arguments.variation_id_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.VARIATION_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#listgetat(variation_id_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.total_min_list') and listlen(arguments.total_min_list) and listgetat(arguments.total_min_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.TOTAL_MIN = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.total_min_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.total_max_list') and listlen(arguments.total_max_list) and listgetat(arguments.total_max_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.TOTAL_MAX = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.total_max_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.tolerance_list') and listlen(arguments.tolerance_list) and listgetat(arguments.tolerance_list,ii,',') neq '-'>
									AND SPECT_MAIN_ROW.TOLERANCE = <cfqueryparam cfsqltype="cf_sql_integer" value="#listgetat(arguments.tolerance_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.product_space_list') and listlen(arguments.product_space_list) and listgetat(arguments.product_space_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.PRODUCT_SPACE = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.product_space_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.product_display_list') and listlen(arguments.product_display_list) and listgetat(arguments.product_display_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.PRODUCT_DISPLAY = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.product_display_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.product_rate_list') and listlen(arguments.product_rate_list) and listgetat(arguments.product_rate_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.PRODUCT_RATE = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.product_rate_list,ii,',')#">
								</cfif>
								<cfif isdefined('arguments.question_id_list') and listlen(arguments.question_id_list) and listgetat(arguments.question_id_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.QUESTION_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#listgetat(arguments.question_id_list,ii,',')#">
								</cfif>
                                <cfif isdefined('arguments.quality_tpye_id_list') and listlen(arguments.quality_tpye_id_list) and listgetat(arguments.quality_tpye_id_list,ii,',') gt 0>
									AND SPECT_MAIN_ROW.IS_QUALITY_TYPE = <cfqueryparam cfsqltype="cf_sql_integer" value="#listgetat(arguments.quality_tpye_id_list,ii,',')#">
								</cfif>
                                <cfif isdefined('arguments.quality_standart_value_list') and listlen(arguments.quality_standart_value_list) and listgetat(arguments.quality_standart_value_list,ii,',') neq '-'>
									AND SPECT_MAIN_ROW.QUALITY_STANDART_VALUE = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.quality_standart_value_list,ii,',')#">
								</cfif>
                                <cfif isdefined('arguments.quality_quality_measure_list') and listlen(arguments.quality_quality_measure_list) and listgetat(arguments.quality_quality_measure_list,ii,',') neq '-'>
									AND SPECT_MAIN_ROW.QUALITY_MEASURE = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.quality_quality_measure_list,ii,',')#">
								</cfif>
                                <cfif isdefined('arguments.quality_tolerance_list') and listlen(arguments.quality_tolerance_list) and listgetat(arguments.quality_tolerance_list,ii,',') neq '-'>
									AND SPECT_MAIN_ROW.QUALITY_TOLERANCE = <cfqueryparam cfsqltype="cf_sql_float" value="#listgetat(arguments.quality_tolerance_list,ii,',')#">
								</cfif>
								<!--- <cfif isdefined('arguments.calculate_type_list') and listlen(arguments.calculate_type_list) and listgetat(arguments.calculate_type_list,ii,',') gt 0 >
			...
			<cfquery name="ADD_VAR_SPECT" datasource="#arguments.dsn_type#">
				INSERT INTO
					...
					(
                        ...
                        <cfif isdefined('arguments.employee_id') and len(arguments.employee_id)><cfqueryparam value = "#arguments.employee_id#" CFSQLType = "cf_sql_integer"><cfelse>NULL</cfif>,
                        <cfif isdefined('arguments.save_date') and len(arguments.save_date)><cfqueryparam value = "#arguments.save_date#" CFSQLType = "cf_sql_timestamp"><cfelse>NULL</cfif>,
                        <cfif isdefined('arguments.is_mix_product') and len(arguments.is_mix_product)><cfqueryparam value = "#arguments.is_mix_product#" CFSQLType = "cf_sql_bit"><cfelse>0</cfif>
					)
			</cfquery>
	...
	<cfif arguments.only_main_spec eq 0>
		...
		<cfif len(main_spec_id) and (isdefined('arguments.add_to_main_spec') and arguments.add_to_main_spec) or (listlen(arguments.product_price_list,',') eq 0 and listlen(arguments.product_money_list,',') eq 0)>
			...
			<cfif isdefined('arguments.add_to_main_spec') and arguments.add_to_main_spec eq 1><!--- main_specden ekleniyorsa urunler aliniyor listeye atiliyor--->
				<cfquery name="GET_MAIN_SPEC" datasource="#arguments.dsn_type#">
					SELECT 
						...
						SPECT_MAIN.IS_TREE,
                        SPECT_MAIN.STAGE,
                        SPECT_MAIN.EMPLOYEE_ID,
                        SPECT_MAIN.SAVE_DATE,
                        SPECT_MAIN.IS_MIX_PRODUCT,
						SPECT_MAIN_ROW.* 
					FROM 
						#new_dsn3#.SPECT_MAIN SPECT_MAIN,
						#new_dsn3#.SPECT_MAIN_ROW SPECT_MAIN_ROW
				...
				<cfif not GET_MAIN_SPEC.RECORDCOUNT>
                    <cfif arguments.get_message eq 0>
                        <script type="text/javascript">
                        ...
                        <cfabort>
                    <cfelse>
                        <cfreturn { mistake : true, mistakeMessage : "#arguments.main_spec_id# ID Numarasına Sahip Spec'in Satirlari yok! Ağacı Kontrol ediniz"}>
                    </cfif>
				<cfelse>
				...
				<cfif isdefined("attributes.price_catid") and len(attributes.price_catid)>
					<cfquery name="GET_PRICE" datasource="#arguments.dsn_type#">
						...
						WHERE
                            ...
                            <cfif len(product_id_list_2)>	
                            PRICE_STANDART.PRODUCT_ID IN (#listsort(product_id_list_2,"numeric","ASC",",")#) AND 
                            <cfelse>
                            PRICE_STANDART.PRODUCT_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#main_product#"> AND 
                            </cfif>
			...
			<cfquery name="GET_PRICE_STANDART" datasource="#arguments.dsn_type#">
				...
				WHERE
                    ...
                    <cfif len(product_id_list_2)>
                    AND PRODUCT.PRODUCT_ID IN (#listsort(product_id_list_2,"numeric","ASC",",")#)
                    <cfelse>
                    AND PRODUCT.PRODUCT_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#main_product#">
                    </cfif>
			</cfquery>
			<cfif isdefined("attributes.price_catid") and len(attributes.price_catid)>
		...
		<cfif len(main_spec_id) and isdefined('arguments.add_to_main_spec') and arguments.add_to_main_spec><!--- spec main spec den eklenecekse listeler oluşturulacak --->		
			<cfscript>
                ...
                arguments.is_quality_tpye_list='';
                arguments.quality_tpye_id_list ='';
                arguments.quality_standart_value_list ='';
                arguments.quality_quality_measure_list ='';
                arguments.quality_tolerance_list ='';
                ...
                arguments.process_stage=GET_MAIN_SPEC.STAGE;
                arguments.employee_id=GET_MAIN_SPEC.EMPLOYEE_ID;
                arguments.save_date=GET_MAIN_SPEC.SAVE_DATE;
                arguments.is_mix_product=GET_MAIN_SPEC.IS_MIX_PRODUCT;
				...
				for(s=1;s lte GET_MAIN_SPEC.RECORDCOUNT;s=s+1)
				{
					...
					*/	
                    ...
                    arguments.is_quality_tpye_list = listappend(arguments.is_quality_tpye_list, len(GET_MAIN_SPEC.IS_QUALITY_TYPE[s]) ? GET_MAIN_SPEC.IS_QUALITY_TYPE[s] : 0, ',');
                    arguments.quality_tpye_id_list = listappend(arguments.quality_tpye_id_list, len(GET_MAIN_SPEC.QUALITY_TYPE_ID[s]) ? GET_MAIN_SPEC.QUALITY_TYPE_ID[s] : 0, ',');
                    arguments.quality_standart_value_list = listappend(arguments.quality_standart_value_list, len(GET_MAIN_SPEC.QUALITY_STANDART_VALUE[s]) ? GET_MAIN_SPEC.QUALITY_STANDART_VALUE[s] : '-', ',');
                    arguments.quality_quality_measure_list = listappend(arguments.quality_quality_measure_list, len(GET_MAIN_SPEC.QUALITY_MEASURE[s]) ? GET_MAIN_SPEC.QUALITY_MEASURE[s] : '-', ',');
                    arguments.quality_tolerance_list = listappend(arguments.quality_tolerance_list, len(GET_MAIN_SPEC.QUALITY_TOLERANCE[s]) ? GET_MAIN_SPEC.QUALITY_TOLERANCE[s] : '-', ',');
				}
			</cfscript>
		</cfif>
	</cfif>
	...
	<cfif len(main_spec_id) and arguments.only_main_spec eq 0>
			...
			<cfquery name="ADD_VAR_SPECT" datasource="#arguments.dsn_type#">
				...
				INTO
					...
					(
                        ...
                        <cfif isdefined('arguments.save_date') and len(arguments.save_date)><cfqueryparam value = "#arguments.save_date#" CFSQLType = "cf_sql_timestamp"><cfelse>NULL</cfif>,
                        <cfif isdefined('arguments.is_mix_product') and len(arguments.is_mix_product)><cfqueryparam value = "#arguments.is_mix_product#" CFSQLType = "cf_sql_bit"><cfelse>0</cfif>,
                        <cfif isdefined('arguments.product_configurator_id') and len(arguments.product_configurator_id)><cfqueryparam value = "#arguments.product_configurator_id#" CFSQLType = "cf_sql_integer"><cfelse>NULL</cfif>
                    )
			</cfquery>
		...
		<cfelseif isdefined('arguments.spec_id') and len(arguments.spec_id)>
			<cfquery name="UPD_VAR_SPECT" datasource="#arguments.dsn_type#">
				...
				SET
                    ...
                    STAGE = <cfif isdefined('arguments.process_stage') and len(arguments.process_stage)><cfqueryparam value = "#arguments.process_stage#" CFSQLType = "cf_sql_integer"><cfelse>NULL</cfif>,
                    EMPLOYEE_ID = <cfif isdefined('arguments.employee_id') and len(arguments.employee_id)><cfqueryparam value = "#arguments.employee_id#" CFSQLType = "cf_sql_integer"><cfelse>NULL</cfif>,
                    SAVE_DATE = <cfif isdefined('arguments.save_date') and len(arguments.save_date)><cfqueryparam value = "#arguments.employee_id#" CFSQLType = "cf_sql_timestamp"><cfelse>NULL</cfif>,
                    IS_MIX_PRODUCT = <cfif isdefined('arguments.is_mix_product') and len(arguments.is_mix_product)><cfqueryparam value = "#arguments.is_mix_product#" CFSQLType = "cf_sql_bit"><cfelse>0</cfif>	
                    WHERE
					SPECT_VAR_ID=#arguments.spec_id#
			</cfquery>		
		...
		<cfloop from="1" to="#arguments.spec_row_count#" index="zz">
			<cfscript>
				...
				if (isdefined('arguments.line_number_list') and len(arguments.line_number_list) and listlen(arguments.line_number_list) gte zz ) form_line_number = listgetat(arguments.line_number_list,zz,',');
                if (isdefined('arguments.is_quality_tpye_list') and listlen(arguments.is_quality_tpye_list)) arg_is_quality_tpye = listgetat(arguments.is_quality_tpye_list,zz,',');
                if (isdefined('arguments.quality_tpye_id_list') and listlen(arguments.quality_tpye_id_list)) arg_quality_tpye_id = listgetat(arguments.quality_tpye_id_list,zz,',');
                if (isdefined('arguments.quality_standart_value_list') and listlen(arguments.quality_standart_value_list)) arg_standart_value = listgetat(arguments.quality_standart_value_list,zz,',');
                if (isdefined('arguments.quality_quality_measure_list') and listlen(arguments.quality_quality_measure_list)) arg_quality_measure = listgetat(arguments.quality_quality_measure_list,zz,',');
                if (isdefined('arguments.quality_tolerance_list') and listlen(arguments.quality_tolerance_list)) arg_quality_tolerance = listgetat(arguments.quality_tolerance_list,zz,',');
			</cfscript>
			...
			<cfquery name="ADD_ROW" datasource="#arguments.dsn_type#">
				...
				INTO
					...
					(
                        ...
                        <cfif isdefined('arg_quality_tpye_id') and arg_quality_tpye_id gt 0>#arg_quality_tpye_id#<cfelse>NULL</cfif>,
                        <cfif isdefined('arg_standart_value') and arg_standart_value neq '-'>#arg_standart_value#<cfelse>NULL</cfif>,
                        <cfif isdefined('arg_quality_measure') and arg_quality_measure neq '-'>#arg_quality_measure#<cfelse>NULL</cfif>,
                        <cfif isdefined('arg_quality_tolerance') and arg_quality_tolerance neq '-'>#arg_quality_tolerance#<cfelse>NULL</cfif>
					)
			</cfquery>
		</cfloop>
	</cfif>
	...
	<cffunction name="add_serial_no" output="false">
           ...
           <cfset letters = "a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,r,s,t,u,v,y,z,1,2,3,4,5,6,7,8,9,0" />
            ...
            <!--- 
                ...
                my_is_sale = 1 (satış)
            --->
            <cfif listfindnocase('59,73,74,75,76,77,80,82,84,86,87,110,115,140,119',arguments.process_type,',')><!--- Alış ve giriş --->
                <cfset my_is_purchase = 1 />
                <cfset my_is_sale = 0 />
                <cfset my_in_out = 1 />
                <cfset my_seri_sonu = 0 />
            <cfelseif listfindnocase('70,71,72,78,79,88,83,111,112,141',arguments.process_type,',')><!--- Satış ve çıkış --->
            ...
            <cfelseif listfindnocase('118,116',arguments.process_type,',')><!--- satış alış yok giriş (116-stok virman giriş) --->
                ...
                <cfset my_seri_sonu = 0 />
            <cfelseif listfindnocase('85,1182',arguments.process_type,',')>
                <cfset my_is_purchase = 0 />
                <cfset my_is_sale = 0 />
                <cfset my_in_out = 0 />
                <cfset my_seri_sonu = 0 />
                    ...
                    <cfquery name="add_guaranty" datasource="#dsn3#" result="xxx"> 
                        ...
                        <cfloop from="#baslangic_degeri#" to="#blok_sayisi#" index="j">
                            ...
                            SELECT 
                                ...
                                #unit#,
                                <cfif isdefined('attributes.unit_row_quantity#arguments.session_row#')>
                                    <cfif listgetat(evaluate('attributes.unit_row_quantity#arguments.session_row#'),j) is not '*_*'>
                                        <cfqueryparam cfsqltype="cf_sql_float" value="#trim(listgetat(evaluate('attributes.unit_row_quantity#arguments.session_row#'),j))#">
                                    <cfelse>
                                        NULL
                                    </cfif>
                                <cfelseif len(arguments.unit_row_quantity)>
                                    <cfqueryparam cfsqltype="cf_sql_float" value="#arguments.unit_row_quantity#">
                                <cfelse>
                                    NULL
                                </cfif>,
                                <cfif isDefined('session.ep.userid')>
