<cfcomponent>
    ...
    <cffunction name="GET_CONSUMER_PERIOD" output="false">
        ...
        <cfswitch expression = "#arguments.acc_type_id#">
            <cfcase value="-1">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.ACCOUNT_CODE>
            </cfcase>
            <cfcase value="-2">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.SALES_ACCOUNT>
            </cfcase>
            <cfcase value="-3">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.PURCHASE_ACCOUNT>
            </cfcase>
            <cfcase value="-4">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.RECEIVED_ADVANCE_ACCOUNT>
            </cfcase>
            <cfcase value="-5">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.ADVANCE_PAYMENT_CODE>
            </cfcase>
            <cfcase value="-6">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.RECEIVED_GUARANTEE_ACCOUNT>
            </cfcase>
            <cfcase value="-7>">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.GIVEN_GUARANTEE_ACCOUNT>
            </cfcase>
            <cfcase value="-8">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.KONSINYE_CODE>
            </cfcase>
            <cfcase value="-9">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.EXPORT_REGISTERED_SALES_ACCOUNT>
            </cfcase>
            <cfcase value="-10">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.EXPORT_REGISTERED_BUY_ACCOUNT>
            </cfcase>
            <cfdefaultcase>
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.ACCOUNT_CODE>
            </cfdefaultcase>
    ...
    <cffunction name="GET_COMPANY_PERIOD" output="false">
        ...
        <cfswitch expression = "#arguments.acc_type_id#">
            ...
            <cfcase value="-2">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.SALES_ACCOUNT>
            </cfcase>
            <cfcase value="-3">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.PURCHASE_ACCOUNT>
            </cfcase>
            <cfcase value="-4">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.RECEIVED_ADVANCE_ACCOUNT>
            </cfcase>
            <cfcase value="-5">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.ADVANCE_PAYMENT_CODE>
            </cfcase>
            <cfcase value="-6">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.RECEIVED_GUARANTEE_ACCOUNT>
            </cfcase>
            <cfcase value="-7>">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.GIVEN_GUARANTEE_ACCOUNT>
            </cfcase>
            <cfcase value="-8">
                <cfreturn GET_COMPANY_ACCOUNT_CODE.KONSINYE_CODE>
            </cfcase>
            <cfcase value="-9">
                <cfreturn GET_CONSUMER_ACCOUNT_CODE.EXPORT_REGISTERED_SALES_ACCOUNT>
            </cfcase>
