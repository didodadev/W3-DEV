...
<cfelseif isdefined("attributes.event") and attributes.event is 'add'>
	<cfif listgetat(attributes.fuseaction,2,'.') eq 'add_purchasedemand'>
		<cfset is_demand = 1>
    <cfelse>
        <cfset is_demand = 0>
    </cfif>
    ...
    <cfif get_internaldemand.recordcount>
        ...
        <cfif len(get_internaldemand.ship_method)>
           <cfinclude template="../correspondence/query/get_ship_method.cfm">
...
<cfelseif isdefined("attributes.event") and attributes.event is 'upd'>
    ...
    <cfif listgetat(attributes.fuseaction,2,'.') eq 'upd_purchasedemand'>
        <cfset is_demand = 1>
    <cfelse>
        <cfset is_demand = 0>
    </cfif>
    <!---<cfif listlast(fuseaction,'.') eq "upd_internaldemand">--->
        <cf_xml_page_edit fuseact ="correspondence.add_internaldemand">
    <!---<cfelseif listlast(fuseaction,'.') eq "upd_purchasedemand"> 
        <cf_xml_page_edit fuseact ="correspondence.add_purchasedemand">
    </cfif>--->
    <cfif isdefined("attributes.id") and len(attributes.id)>
    ...
    <cfset mesaj = lang_array_main.item[1034]>	
    ...
    <cfelse>
        ...
        <cfset mesaj=lang_array_main.item[1035]>
    </cfif>
...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'purchase.list_internaldemand';
	WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'correspondence/display/list_internaldemand.cfm';
	
	WOStruct['#attributes.fuseaction#']['add'] = structNew();
	WOStruct['#attributes.fuseaction#']['add']['window'] = 'normal';
	WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'purchase.add_internaldemand';
	...
	WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'purchase.list_internaldemand&event=upd';
	
	WOStruct['#attributes.fuseaction#']['upd'] = structNew();
	WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
	WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = '#listfirst(attributes.fuseaction,'.')#.upd_internaldemand';
	...
	WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'purchase.list_internaldemand&event=upd';
	...
	if(isdefined("attributes.event") and attributes.event is 'upd')
	{
		...
		if(is_demand eq 0 and isDefined('xml_purchase_demand_button') and xml_purchase_demand_button eq 1)
		{
			...
			{
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][0]['text'] = '#lang_array_main.item[2603]#';//Satın Alma Talebinen Dönüştür
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][0]['href'] = "#request.self#?fuseaction=store.list_purchasedemand&event=add&internaldemand_id=#attributes.id#&is_from_internaldemand=1&internal_row_info=1";
			}
			else
			{
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][0]['text'] = '#lang_array_main.item[2603]# '; //Satın Alma Talebinen Dönüştür
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][0]['href'] = "#request.self#?fuseaction=purchase.list_purchasedemand&event=add&internaldemand_id=#attributes.id#&is_from_internaldemand=1&internal_row_info=1";
			}	
		}
		...
		{
			tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][3]['text'] = '#lang_array_main.item[1034]#';//Sarfişi Dönüştür
		...
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=purchase.list_internaldemand&event=add";
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['target'] = "_blank";
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['copy']['text'] = '#lang_array_main.item[64]#';
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['copy']['href'] = "#request.self#?fuseaction=purchase.list_internaldemand&event=add&id=#attributes.id#";
	...
	WOStruct['#attributes.fuseaction#']['extendedForm']['controllerFileName'] = 'listInternaldemandController';
