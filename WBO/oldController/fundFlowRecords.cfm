...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'account.list_fund_flow_records';
	WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'account/display/list_fintab.cfm';
	
	WOStruct['#attributes.fuseaction#']['del'] = structNew();
	WOStruct['#attributes.fuseaction#']['del']['window'] = 'emptypopup';
	WOStruct['#attributes.fuseaction#']['del']['fuseaction'] = 'account.list_fund_flow_records';
	...
	WOStruct['#attributes.fuseaction#']['del']['nextEvent'] = 'account.list_fund_flow_records';
	/*
