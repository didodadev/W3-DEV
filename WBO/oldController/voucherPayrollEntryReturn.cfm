...
<cf_xml_page_edit page_control_list="#xml_page_control_list#" default_value="1" fuseact="cheque.add_voucher_payroll_entry_return">
...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'cheque/form/add_voucher_payroll_entry_return.cfm';
	WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'cheque/query/add_voucher_payroll_entry_return.cfm';
	WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.add_voucher_payroll_entry_return&event=upd';
	...
	WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.add_voucher_payroll_entry_return';
	WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'cheque/form/upd_voucher_payroll_entry_return.cfm';
	WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'cheque/query/upd_voucher_payroll_entry_return.cfm';
	WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.add_voucher_payroll_entry_return&event=upd';
	...
	{		
		...
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=cheque.add_voucher_payroll_entry_return";
