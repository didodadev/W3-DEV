...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'myhome.list_purchasedemand';
	WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'correspondence/display/list_internaldemand.cfm';
	
	WOStruct['#attributes.fuseaction#']['add'] = structNew();
	WOStruct['#attributes.fuseaction#']['add']['window'] = 'normal';
	WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'myhome.list_purchasedemand';
	...
	WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'myhome.list_purchasedemand&event=upd';
	
	WOStruct['#attributes.fuseaction#']['upd'] = structNew();
	WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
	WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'myhome.list_purchasedemand';
	...
	WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'myhome.list_purchasedemand&event=upd';
	...
	if(isdefined("attributes.event") and attributes.event is 'upd')
	{
		...
		WOStruct['#attributes.fuseaction#']['del']['nextEvent'] = 'myhome.list_purchasedemand';
	}
	...
	if(isdefined("attributes.event") and attributes.event is 'upd')
	{
		...
		if(fusebox.circuit neq 'store')
		{
			if(isDefined('xml_purch_order_button') and xml_purch_order_button eq 1)
			{
				...
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][3]['href'] = "#request.self#?fuseaction=store.form_add_internaldemand_order&id=#attributes.id#&project_id=#get_internaldemand.project_id#&is_demand=#is_demand#";
			}  
		}
		else
		{
			...
			{
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][3]['text'] = '#lang_array_main.item[1034]#';//Sarfişi Dönüştür
				tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][3]['href'] = "#request.self#?fuseaction=purchase.form_add_internaldemand_order&id=#attributes.id#&project_id=#get_internaldemand.project_id#&is_demand=#is_demand#";
			}
		}
		...
		{
			tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][6]['text'] = '#mesaj#';//Tarihçe
			tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][6]['href'] = "#link#";
		}		
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][7]['text'] = 'Belgeler';
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['menus'][7]['onClick'] = "windowopen('#request.self#?fuseaction=#module_name_#.popup_dsp_internaldemand_asset&id=#id#','medium')";

		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['text'] = '#lang_array_main.item[170]#';
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=myhome.list_purchasedemand&event=add";
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['target'] = "_blank";
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['copy']['text'] = '#lang_array_main.item[64]#';
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['copy']['href'] = "#request.self#?fuseaction=myhome.list_purchasedemand&event=add&id=#attributes.id#";
