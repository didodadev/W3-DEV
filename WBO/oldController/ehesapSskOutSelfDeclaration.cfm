<cfif isdefined("attributes.event") and attributes.event is 'det'>
	...
	<cfscript>
		for (i=1;i lte get_puantaj_personal.recordcount; i++)
		{
			't_kidem_amount#i#' = 0;
			't_ihbar_amount#i#' = 0;
			't_yillik_izin_amount#i#' = 0;
			't_ext_salary#i#' = 0;
			't_ssk_paid_izin_amount#i#' = 0;
			't_ssdf_paid_izin_amount#i#' = 0;
			'genel_tatil_amount#i#' = 0;
			'normal_amount#i#' = 0;
			'haftalik_tatil_amount#i#' = 0;
			't_paid_izin#i#' = 0;
			'normal_gun_#i#' = 0;
			// 'genel_odenek_total#i#' = 0 SG 20130816
			't_vergi_istisna_yaz#i#' = 0;
			't_normal_gun#i#' =  0;
			'izin#i#' = 0;
			'EKSIKGUNNEDENI#i#' = 0;
			'total_ikramiye#i#' = 0;
			'total_ikramiye_yaz#i#' = 0;
			'total_kazanc#i#' = 0;
			'total_ucret#i#' = 0;
			'ikramiye_tutar#i#' = 0;
		}
...
<script type="text/javascript">
	<cfif (isdefined("attributes.event") and attributes.event is 'list') or not isdefined("attributes.event")>
		function send_page()
		{
			window.location.href="<cfoutput>#request.self#</cfoutput>?fuseaction=ehesap.popup_ssk_out_self_declaration&event=det&employee_id="+$('#employee_id').val()+"&branch_id="+$('#branch_id').val()+'&in_out_id='+$('#in_out_id').val()+'&employee='+$('#employee').val();
		}
...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'ehesap.popup_ssk_out_self_declaration';
	WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'hr/ehesap/display/ssk_out_self_declaration.cfm';
