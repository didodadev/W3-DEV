...
<cfelseif isdefined("attributes.event") and attributes.event is "upd">
    ...
    <cfif GET_ACTION_DETAIL.recordcount>
    	<cfif get_action_detail.payroll_type eq 134>
			<cfset p_type = 112>
            <cfset attributes.bordro_type = 14>
        <cfelseif get_action_detail.payroll_type eq 135>
            <cfset p_type = 111>
...
<script type="text/javascript">
	...
	function kontrol()
	{
		...
		<cfif (isdefined("attributes.event") and attributes.event is "add") or not isdefined("attributes.event")>
			...
			var get_cash_3 = wrk_safe_query('chq_get_cash_3','dsn2',0,selected_cash); 
			if(get_cash_3.TRANSFER_CHEQUE_ACC_CODE =="")
			{
					alert ("<cf_get_lang dictionary_id='54497.Kasaların Yoldaki Çekler Muhasebe Kodu tanımlanmamıştır'>");
					return false;
			}
			return true;
		<cfelseif isdefined("attributes.event") and attributes.event is "upd">
...
<cfscript>
	...
	WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'cheque/form/add_cheque_transfer.cfm';
	WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'cheque/query/add_cheque_transfer.cfm';
	WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.form_add_cheque_transfer&event=upd';
	...
	WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_add_cheque_transfer';
	WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'cheque/form/upd_cheque_transfer.cfm';
	WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'cheque/query/upd_cheque_transfer.cfm';
	WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_add_cheque_transfer&event=upd';
	...
	{		
		...
		tabMenuStruct['#attributes.fuseaction#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=cheque.form_add_cheque_transfer";
