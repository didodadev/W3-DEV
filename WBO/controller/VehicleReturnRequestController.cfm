<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'assetcare.add_vehicle_return_request';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'V16/assetcare/form/add_vehicle_return_request.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'V16/assetcare/query/add_vehicle_return_request.cfm';
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'assetcare.upd_vehicle_return_request&event=upd&request_row_id=';

		if(isdefined("attributes.request_row_id"))
		{
			WOStruct['#attributes.fuseaction#']['upd'] = structNew();
			WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'assetcare.upd_vehicle_return_request&event=upd&request_row_id=';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'V16/assetcare/form/upd_vehicle_return_request.cfm';
			...
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'assetcare.upd_vehicle_return_request&event=upd&request_row_id=';
	...
	else
	{
		...
		else if(caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=assetcare.add_vehicle_return_request&event=add";
