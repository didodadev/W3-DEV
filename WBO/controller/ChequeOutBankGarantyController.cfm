<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = '/V16/cheque/form/add_payroll_bank_guaranty_tem.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = '/V16/cheque/query/add_payroll_bank_guaranty_tem.cfm';
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.form_add_payroll_bank_guaranty_tem&event=upd&ID=';
		WOStruct['#attributes.fuseaction#']['add']['formName'] = 'form_payroll_revenue';
		WOStruct['#attributes.fuseaction#']['add']['js'] = "javascript:gizle_goster_ikili('payroll_bank_quaranty_team','payroll_bank_quaranty_team_bask');";

		if(isdefined("attributes.id"))
		{
			WOStruct['#attributes.fuseaction#']['upd'] = structNew();
			WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_upd_payroll_bank_guaranty_tem';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/V16/cheque/form/upd_payroll_bank_guaranty_tem.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = '/V16/cheque/query/upd_payroll_bank_guaranty_tem.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_add_payroll_bank_guaranty_tem&event=upd&ID=';
	...
	else
	{
		...
		tabMenuStruct['#fuseactController#']['tabMenus'] = structNew();
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['onclick'] = "windowopen('#request.self#?fuseaction=cheque.form_add_payroll_bank_guaranty_tem','project');";
