<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'settings.imp_steps';
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'V16\settings\display\imp_steps.cfm';
	...
	else
		{
			...
			{			
				...
				tabMenuStruct['#fuseactController#']['tabMenus']['list']['menus'][i]['text'] = '#getLang('','Dashboard',63588)#';
				tabMenuStruct['#fuseactController#']['tabMenus']['list']['menus'][i]['href'] = "#request.self#?fuseaction=settings.imp_dashboard";
				i=i+1;
