<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'cheque.form_add_voucher_bank_guaranty_return';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = '/V16/cheque/form/add_voucher_bank_guaranty_return.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = '/V16/cheque/query/add_voucher_bank_guaranty_return.cfm';
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'service.list_service_report&event=upd&id=';
		WOStruct['#attributes.fuseaction#']['add']['formName'] = 'form_payroll_revenue';
		WOStruct['#attributes.fuseaction#']['add']['js'] = "javascript:gizle_goster_ikili('voucher_bank_quaranty_return','voucher_bank_quaranty_return_bask');";
	
		if(isdefined("attributes.id"))
		{
			WOStruct['#attributes.fuseaction#']['upd'] = structNew();
			WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_upd_voucher_bank_guaranty_return';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/V16/cheque/form/upd_voucher_bank_guaranty_return.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = '/V16/cheque/query/upd_voucher_bank_guaranty_return.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#attributes.id#';
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_add_voucher_bank_guaranty_return&event=upd&id=';
			WOStruct['#attributes.fuseaction#']['add']['js'] = "javascript:gizle_goster_ikili('voucher_bank_quaranty_return','voucher_bank_quaranty_return_bask');";
		...
		WOStruct['#attributes.fuseaction#']['systemObject']['pageSettings'] = "['item-process','item-bank_account','item-emp_name','item-payroll_revenue_date']";
	}
	else
	{
		...
		else if(caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=cheque.form_add_voucher_bank_guaranty_return";
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['menus']['1']['onClick'] = "windowopen('#request.self#?fuseaction=objects.popup_list_order_account_cards&voucher_payroll_id=#url.id#&action_id=#attributes.id#&process_cat=#caller.get_action_detail.PAYROLL_TYPE#','wide');";
		}
