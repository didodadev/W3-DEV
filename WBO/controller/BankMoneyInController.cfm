...
<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'V16/bank/form/add_invest_money.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'V16/bank/query/add_invest_money.cfm';
		...
		if(isdefined("attributes.id") and len(attributes.id))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'bank.form_upd_invest_money';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'V16/bank/form/upd_invest_money.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'V16/bank/query/upd_invest_money.cfm';
			...
			WOStruct['#attributes.fuseaction#']['upd']['formName'] = 'upd_invest_money';
			...
			WOStruct['#attributes.fuseaction#']['del']['fuseaction'] = '#request.self#?fuseaction=bank.del_invest_money&id=#attributes.id#&old_process_type=##caller.get_action_detail.action_type_id##&paper_no=##caller.get_action_detail.paper_no##';
			WOStruct['#attributes.fuseaction#']['del']['filePath'] = 'V16/bank/query/del_invest_money.cfm';
			WOStruct['#attributes.fuseaction#']['del']['queryPath'] = 'V16/bank/query/del_invest_money.cfm';
		...
		if(attributes.event is 'add' or attributes.event is 'upd')
		{
			...
			WOStruct['#attributes.fuseaction#']['systemObject']['pageSettings'] = "['item_process_cat','item_cash_id','item_bank_accounts','item_date','item_action_value','item-employee']";
		}
