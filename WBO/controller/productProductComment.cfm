<cfscript>
    if(attributes.tabMenuController eq 0){
        ...
        WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'V16/product/display/list_product_comment.cfm';
        WOStruct['#attributes.fuseaction#']['list']['queryPath'] = 'V16/product/display/list_product_comment.cfm';
    }
