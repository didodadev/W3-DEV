<cfscript>
	if(attributes.tabMenuController eq 0)
		{
			...
			WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'V16/cheque/form/add_payroll_endorsement.cfm';
			WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'V16/cheque/query/add_payroll_endorsement.cfm';
			WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.form_add_payroll_endorsement&event=upd&ID=';
			WOStruct['#attributes.fuseaction#']['add']['formName'] = 'form_payroll_revenue';
			WOStruct['#attributes.fuseaction#']['add']['js'] = "javascript:gizle_goster_basket(payroll_endorsement);";
			
			if(isdefined("attributes.id"))
			{
				WOStruct['#attributes.fuseaction#']['upd'] = structNew();
				WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
				WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_upd_payroll_endorsement';
				WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'V16/cheque/form/upd_payroll_endorsement.cfm';
				WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'V16/cheque/query/upd_payroll_endorsement.cfm';
				WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_add_payroll_endorsement&event=upd&ID=';
				WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#attributes.id#';	
				WOStruct['#attributes.fuseaction#']['upd']['js'] = "javascript:gizle_goster_basket(payroll_endorsement);";
	...
	else
	{
		...
		tabMenuStruct['#fuseactController#']['tabMenus'] = structNew();
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=cheque.form_add_payroll_endorsement";
		...
		WOStruct['#attributes.fuseaction#']['systemObject']['pageSettings'] = "['item-process_cat','item-company_id','item-payroll_no','item-pro_employee_id','item-payroll_revenue_date','item-special_definition_ids']";
