...
<!---
	<cfsavecontent variable="message"><cf_get_lang_main no='125.Sayı Mesajı Hatası'></cfsavecontent> list maxrows
	<cfsavecontent variable="message"><cf_get_lang_main no='647.Başlık Girmelisiniz'></cfsavecontent> add Konu
	<cfsavecontent variable="message"><cf_get_lang_main no='647.Baslik Girmelisiniz'></cfsavecontent> update başlık
--->