<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		if(attributes.fuseaction is 'myhome.list_travel_demands')
		...
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'myhome.list_travel_demands&event=upd&TRAVEL_DEMAND_ID=';
		...
		if(isdefined("attributes.TRAVEL_DEMAND_ID"))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#contentEncryptingandDecodingAES(isEncode:1,content:attributes.TRAVEL_DEMAND_ID,accountKey:'wrk')#';
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'myhome.list_travel_demands&event=upd&TRAVEL_DEMAND_ID=';
			
			WOStruct['#attributes.fuseaction#']['del'] = structNew();
			WOStruct['#attributes.fuseaction#']['del']['window'] = 'emptypopup';
			WOStruct['#attributes.fuseaction#']['del']['fuseaction'] = '#request.self#?fuseaction=ehesap.emptypopup_del_travel_demand&travel_demand_id=##CALLER.travel_demand_id##';
			...
			WOStruct['#attributes.fuseaction#']['del']['nextEvent'] = 'myhome.list_travel_demands';
		}
	}
	else
	{
		...
		{			
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add']['icons']['list-ul']['href'] = "#request.self#?fuseaction=myhome.list_travel_demands";
		...
		else if(caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['list-ul']['href'] = "#request.self#?fuseaction=myhome.list_travel_demands";
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['print']['text'] = '#getLang('main',62)#';
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['print']['onClick'] = "window.open('#request.self#?fuseaction=objects.popup_print_files&action_id=#attributes.travel_demand_id#&action=#attributes.fuseaction#','WOC')";
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['check']['text'] = '#getLang('main',49)#';
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['check']['onClick'] = "buttonClickFunction()";
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['text'] = '#getLang('main',170)#';
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=myhome.list_travel_demands&event=add";
