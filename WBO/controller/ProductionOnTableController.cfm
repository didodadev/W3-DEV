<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'prod.in_productions';
		...
		if(isdefined("upd"))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'prod.form_upd_prod_order';
			...
			WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#upd#';
		...
		WOStruct['#attributes.fuseaction#']['multi-add']['nextEvent'] = 'prod.order&event=upd&upd=';
	...
	else
	{
		...
		{			
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add']['icons']['list-ul']['href'] = "#request.self#?fuseaction=prod.in_productions";
		...
		{			
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['multi-add']['icons']['list-ul']['href'] = "#request.self#?fuseaction=prod.in_productions";
		...
		else if(caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['list-ul']['href'] = "#request.self#?fuseaction=prod.in_productions";
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['check']['text'] = '#getLang('main',49)#';
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['check']['onClick'] = "buttonClickFunction()";
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['print']['text'] = '#getLang('main',62)#';
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['print']['onClick'] = "windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=#attributes.upd#&print_type=281','page');";
			...
			{
				tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['copy']['text'] = '#getLang('main',64)#'; 
				tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['copy']['href'] = "#request.self#?fuseaction=prod.order&event=add#attributes.upd#";
			}
			...
			{
				tabMenuStruct['#fuseactController#']['tabMenus']['upd']['menus'][i]['text'] = '#getLang('main',551)#';
				tabMenuStruct['#fuseactController#']['tabMenus']['upd']['menus'][i]['href'] = "#request.self#?fuseaction=prod.form_upd_prod_order&upd=#GET_DET_PO.PO_RELATED_ID#";	
				i=i+1;
			}
	...
	WOStruct['#attributes.fuseaction#']['systemObject']['pageExtendedEventList'] = 'add,upd,multi-add,list';
