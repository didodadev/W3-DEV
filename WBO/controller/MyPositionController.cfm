<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'myhome.my_position';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'V16/myhome/display/my_position.cfm';
	...
	else
	{
		...
		{			
            ...
            tabMenuStruct['#fuseactController#']['tabMenus']['add']['menus'][0]['text'] = "#getLang('','Özgeçmiş','49821')#";
            tabMenuStruct['#fuseactController#']['tabMenus']['add']['menus'][0]['href'] = "#request.self#?fuseaction=myhome.my_profile";
            tabMenuStruct['#fuseactController#']['tabMenus']['add']['menus'][0]['target'] = "_blank";
            tabMenuStruct['#fuseactController#']['tabMenus']['add']['menus'][1]['text'] = "#getLang('','Bilgilerim','31150')#";
            tabMenuStruct['#fuseactController#']['tabMenus']['add']['menus'][1]['href'] = "#request.self#?fuseaction=myhome.my_detail";
