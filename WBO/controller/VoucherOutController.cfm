<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = '/V16/cheque/form/add_voucher_payroll_endorsement.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'V16/cheque/query/add_voucher_payroll_endorsement.cfm';
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.form_add_voucher_payroll_endorsement';
		...
		if(isdefined("attributes.id"))
		{
			...
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_upd_payroll_voucher_endorsement';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'V16/cheque/form/upd_voucher_payroll_endorsement.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'V16/cheque/query/upd_voucher_payroll_endorsement.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#attributes.id#';
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_add_voucher_payroll_endorsement&event=upd&id=';
	...
	else
	{
		...
		else if(caller.attributes.event is 'upd')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['upd']['icons']['add']['href'] = "#request.self#?fuseaction=cheque.form_add_voucher_payroll_endorsement";
	...
	WOStruct['#attributes.fuseaction#']['systemObject']['pageSettings'] = "['item-process_cat','item-company_id','item-pro_employee_id','item-payroll_revenue_date']";
</cfscript>
