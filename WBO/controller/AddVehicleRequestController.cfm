<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['add']['fuseaction'] = 'assetcare.add_vehicle_exchange_request';
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'V16/assetcare/form/add_vehicle_exchange_request.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = '/V16/assetcare/query/add_vehicle_exchange_request.cfm';
		WOStruct['#attributes.fuseaction#']['add']['nextEvent'] = 'cheque.form_upd_voucher_payroll_entry&event=upd&request_row_id=';

		if(isdefined("attributes.request_row_id"))
		{
			WOStruct['#attributes.fuseaction#']['upd'] = structNew();
			WOStruct['#attributes.fuseaction#']['upd']['window'] = 'normal';
			WOStruct['#attributes.fuseaction#']['upd']['fuseaction'] = 'cheque.form_upd_voucher_payroll_entry&event=upd&request_row_id=';
			WOStruct['#attributes.fuseaction#']['upd']['filePath'] = '/V16/assetcare/form/upd_vehicle_exchange_request.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = '/V16/assetcare/query/upd_vehicle_exchange_request.cfm';
			WOStruct['#attributes.fuseaction#']['upd']['Identity'] = '#attributes.request_row_id#';
			WOStruct['#attributes.fuseaction#']['upd']['nextEvent'] = 'cheque.form_upd_voucher_payroll_entry&event=upd&request_row_id=';
		...
		if(listFind('upd,del',attributes.event))
		{
			...
			WOStruct['#attributes.fuseaction#']['del']['fuseaction'] = 'assetcare.emptypopup_del_vehicle_purchase_request&request_row_id=#attributes.request_row_id#&request_id=#attributes.request_id#';
