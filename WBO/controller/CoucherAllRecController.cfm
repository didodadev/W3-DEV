<cfscript>
	if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['fuseaction'] = 'finance.form_add_voucher_exp';
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'V16/finance/display/add_voucher_exp.cfm';
		
	
		WOStruct['#attributes.fuseaction#']['add_cash'] = structNew();
		WOStruct['#attributes.fuseaction#']['add_cash']['window'] = 'normal';
		WOStruct['#attributes.fuseaction#']['add_cash']['fuseaction'] = 'finance.form_add_voucher_cash_exp';
		WOStruct['#attributes.fuseaction#']['add_cash']['filePath'] = 'V16/finance/form/add_voucher_cash_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_cash']['querypath'] = 'V16/finance/query/add_voucher_cash_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_cash']['nextEvent'] = 'finance.form_add_voucher_exp';
		
		WOStruct['#attributes.fuseaction#']['add_bank'] = structNew();
		WOStruct['#attributes.fuseaction#']['add_bank']['window'] = 'normal';
		WOStruct['#attributes.fuseaction#']['add_bank']['fuseaction'] = 'finance.form_add_voucher_bank_exp';
		WOStruct['#attributes.fuseaction#']['add_bank']['filePath'] = 'V16/finance/form/add_voucher_bank_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_bank']['querypath'] = 'V16/finance/query/add_voucher_bank_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_bank']['nextEvent'] = 'finance.form_add_voucher_exp';
		
		WOStruct['#attributes.fuseaction#']['add_payment'] = structNew();
		WOStruct['#attributes.fuseaction#']['add_payment']['window'] = 'normal';
		WOStruct['#attributes.fuseaction#']['add_payment']['fuseaction'] = 'finance.form_add_voucher_payment_exp';
		WOStruct['#attributes.fuseaction#']['add_payment']['filePath'] = 'V16/finance/form/add_voucher_payment_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_payment']['querypath'] = 'V16/finance/query/add_voucher_payment_exp.cfm';
		WOStruct['#attributes.fuseaction#']['add_payment']['nextEvent'] = 'finance.form_add_voucher_exp';
	}
	...
	else
	{
		...
		{			
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add_cash']['icons']['list-ul']['href'] = "#request.self#?fuseaction=finance.form_add_voucher_exp";
		...
		else if(caller.attributes.event is 'add_bank')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add_bank']['icons']['list-ul']['href'] = "#request.self#?fuseaction=finance.form_add_voucher_exp";
		...
		else if(caller.attributes.event is 'add_payment')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add_payment']['icons']['list-ul']['href'] = "#request.self#?fuseaction=finance.form_add_voucher_exp";
		...
		else if(caller.attributes.event is 'add_giro')
		{
			...
			tabMenuStruct['#fuseactController#']['tabMenus']['add_giro']['icons']['list-ul']['href'] = "#request.self#?fuseaction=finance.form_add_voucher_exp";
