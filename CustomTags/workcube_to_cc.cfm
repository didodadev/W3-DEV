		...
		<div class="col col-12 col-xs-12" style="border:1px solid #b3aeae; padding:3%;">
			<cfif isdefined("attributes.to_dsp_name")>
				<div class="col col-6 col-xs-6" style="border-bottom:1px solid #b3aeae;padding-bottom:1%;">
					<a href="javascript://"  onclick="try{opener_control();}catch(e){};openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=<cfoutput>#str_link_fuse##main_str_url#&select_list=#select_list#&row_count=tbl_to_names_row_count&table_name=tbl_to_names&table_row_name=workcube_to_row&field_grp_id=to_grp_ids&field_wgrp_id=to_wgrp_ids&function_row_name=workcube_to_delRow</cfoutput>&comp_id_list='+document.getElementById('comp_id_list').value);">
                    <i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>" alt="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a>
			...
			<cfif isdefined("attributes.cc2_dsp_name")>
				<div style="border-bottom:1px solid #b3aeae;padding-bottom:1%;">
					<a href="javascript://" onclick="openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=<cfoutput>#str_link_fuse##main_str_url_cc2#&table_name=tbl_cc2_names&row_count=tbl_cc2_names_row_count&select_list=#select_list#&table_row_name=workcube_cc2_row&field_grp_id=cc2_grp_ids&field_wgrp_id=cc2_wgrp_ids&function_row_name=workcube_cc2_delRow</cfoutput>');">
					<i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>" alt="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a>
...
<cfelse>
			...
			<div class="col col-6 col-xs-6">
				...
				<table id="tbl_to_names" name="tbl_to_names" cellspacing="0">
					<div class="col col-12 col-xs-12">
						...
						<cfif isdefined("get_all_people") and get_all_people.recordcount>
							...
							<cfoutput query="get_all_people">
								...
								<div class="col col-12 col-xs-12" id="workcube_to_row#int_row#" name="workcube_to_row#int_row#" style="border-bottom:1px solid ##b3aeae;padding-top:3%;padding-bottom:3%;">
									...
									<div class="col col-12 col-xs-12" nowrap="nowrap">
										...
										<cfif not (isdefined('attributes.from_purchase_offer') and len(member_id) and get_for_offer_id.recordcount)>
											<a href="javascript://" onclick="workcube_to_delRow(#int_row#,#int_id#);"><i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" alt="<cf_get_lang dictionary_id='57463.Sil'>"></i></a>								
										</cfif>
										<cfscript>
											custag_link_str = '';
											//custag_detay='';
										...
										<cfif isdefined('session.ep.userid')>
											<a href="javascript://" onclick="openBoxDraggable('#request.self#?fuseaction=#custag_link_str#');">#name#</a>
										<cfelseif isdefined('session.pp.userid')>
											#name#
										<cfelse>
											<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=#custag_link_str#','list');">#name#</a>									
										</cfif>
									...
									<cfif isdefined('attributes.from_purchase_offer')>
										...
										<td class="text-center" width="20"><a href="javascript://" class="tableyazi" onclick="control_related_offer(#get_for_offer_id.recordcount#,'#member_id#')"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>" alt="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a></td>
										<cfif attributes.print_all eq 2 and not get_for_offer_id.recordcount>
											<td><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=#attributes.action_id#&print_type=90&keyword=#member_id#','page');"><i class="fa fa-print" title="<cf_get_lang dictionary_id='57474.Yazdır'>" alt="<cf_get_lang dictionary_id='57474.Yazdır'>"></i></a></td>
										<cfelse>
											<td><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=<cfif attributes.print_all is 1>#attributes.action_id#<cfelse>#get_for_offer_id.offer_id#</cfif>&print_type=90&keyword=#member_id#','page');"><i class="fa fa-print" title="<cf_get_lang dictionary_id='57474.Yazdır'>" alt="<cf_get_lang dictionary_id='57474.Yazdır'>"></i></a></td>
										</cfif>
										<td colspan="3"></td>
									</cfif>
						...
						<cfif isdefined("get_all_people") and get_all_people.recordcount>
							<div id="hepsini_sil_id1">
								<div class="col col-12 col-xs-12" style="padding-top:15%;"><a style="color:red;" href="javascript://" onclick="hepsini_sil(1)"><cfoutput>#caller.getLang('main','Hepsini Sil',30036)#</cfoutput></a></div><!---Hepsini Sil--->
							</div>
						</cfif>
					</div>						
				</table>
			...
			<cfelse>
						...
						<div class="col col-12 col-xs-12" id="workcube_cc_row#int_row#" name="workcube_cc_row#int_row#" style="border-bottom: 1px solid ##b3aeae;padding:3% 0 3% 0;">
							<div class="col col-12 col-xs-12">
								...
								<input type="hidden" name="#input6#" id="#input6#" value="<cfif ID_6 neq -1>#ID_6#</cfif>">
                              	...
                              	<a href="javascript://" onclick="workcube_cc_delRow(#int_row#,#int_id#);"><i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" alt="<cf_get_lang dictionary_id='57463.Sil'>"></i></a>
								<cfscript>
									custag_link_str = '';
									//custag_detay='';
									// if(ID_1 neq -1) custag_link_str = 'objects.popup_emp_det&emp_id=' & ID_1;
                ...
                <cfif get_all_people_cc.recordcount>
                    <div id="hepsini_sil_id2">
                        <div class="col col-12 col-xs-12" style="padding-top:15%;"><a style="color:red;" href="javascript://" onclick="hepsini_sil(2)"><cfoutput>#caller.getLang('main','Hepsini Sil',30036)#</cfoutput></a></div><!---Hepsini Sil--->
					</div>
                </cfif>
			</div>
		</table>
			...
			<cfelse>
					...
					<cfoutput query="get_all_people_cc2">
						...
						<tr id="workcube_cc2_row#int_row#" name="workcube_cc2_row#int_row#"  style="display='';">
							<td><input type="hidden" name="#input1#" id="#input1#" value="<cfif ID_1 neq -1>#ID_1#</cfif>">
								...
								<a href="javascript://" onclick="workcube_cc2_delRow(#int_row#,#int_id#);"><i class="fa fa-minus" title="<cf_get_lang dictionary_id='57463.Sil'>" alt="<cf_get_lang dictionary_id='57463.Sil'>"></i></a>
							</td>
							<td>
								<cfscript>
									custag_link_str = '';
                ...
                <cfif get_all_people_cc2.recordcount>
                    <tr id="hepsini_sil_id3">
                        <td colspan="5"><a href="javascript://" onclick="hepsini_sil(3)"><cfoutput>#caller.getLang('main','Hepsini Sil',30036)#</cfoutput></a></td><!---Hepsini Sil--->
                    </tr>
                </cfif>
            </table>
		</div>				
    ...
    <cfif (isdefined("get_all_people") and get_all_people.recordcount) and (isdefined('attributes.from_purchase_offer') and not get_for_offer_ids.recordcount)>
        <tr id="hepsini_sil_id">
            <td colspan="5"><a href="javascript://" onclick="hepsini_sil(1)"><cfoutput>#caller.getLang('main','Hepsini Sil',30036)#</cfoutput></a></td><!---Hepsini Sil--->
        </tr>
    </cfif>
	</div>
</cfif>
<cfelse>
	...
	<thead>
		<cfif isdefined("attributes.to_dsp_name")>
			<tr>
				<th width="20">
					<a href="javascript://"  onclick="try{opener_control();}catch(e){};openBoxDraggable('<cfoutput>#request.self#</cfoutput>?fuseaction=<cfoutput>#str_link_fuse##main_str_url#&select_list=#select_list#&row_count=tbl_to_names_row_count&table_name=tbl_to_names&table_row_name=workcube_to_row&field_grp_id=to_grp_ids&field_wgrp_id=to_wgrp_ids&function_row_name=workcube_to_delRow</cfoutput>&comp_id_list='+document.getElementById('comp_id_list').value);"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>" alt="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a>
				</th>
									...
									<cfoutput query="get_all_people">
										...
										<tr id="workcube_to_row#int_row#" name="workcube_to_row#int_row#" style="" height="18">
											...
											<cfif isdefined('attributes.from_purchase_offer')>
												...
												<td class="text-center" width="20"><a href="javascript://" class="tableyazi" onclick="control_related_offer(#get_for_offer_id.recordcount#,'#member_id#')"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='44630.Ekle'>" alt="<cf_get_lang dictionary_id='44630.Ekle'>"></i></a></td>
												<cfif attributes.print_all eq 2 and not get_for_offer_id.recordcount>
													<td class="text-center" width="20"><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=#attributes.action_id#&print_type=90&keyword=#member_id#','page');"><i class="fa fa-print" title="<cf_get_lang dictionary_id='57474.Yazdır'>" alt="<cf_get_lang dictionary_id='57474.Yazdır'>"></i></a></td>
												<cfelse>
													<td class="text-center" width="20"><a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&action_id=<cfif attributes.print_all is 1>#attributes.action_id#<cfelse>#get_for_offer_id.offer_id#</cfif>&print_type=90&keyword=#member_id#','page');"><i class="fa fa-print" title="<cf_get_lang dictionary_id='57474.Yazdır'>" alt="<cf_get_lang dictionary_id='57474.Yazdır'>"></i></a></td>
												</cfif>
											<cfelse>
												<td colspan="3"></td>
											</cfif>
						...
						<tbody id="tbl_cc_names" name="tbl_cc_names">
							...
							<cfif get_all_people_cc.recordcount>
								<tr id="hepsini_sil_id2">
									<td colspan="5"><a href="javascript://" onclick="hepsini_sil(2)"><cfoutput>#caller.getLang('main','Hepsini Sil',30036)#</cfoutput></a></td><!---Hepsini Sil--->
								</tr>
							</cfif>
						</tbody>
