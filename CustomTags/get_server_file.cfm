...
<cfif attributes.output_server eq caller.fusebox.server_machine>
	...
	<cfelseif attributes.output_type eq 2>
		...
		<cfelseif attributes.image_link eq 2>
			...
			<a href="#caller.file_web_path##attributes.output_file#" title="#attributes.alt#"><i class="#attributes.icon#"></i></a>
			<cfelse>
	...
	<cfelseif attributes.output_type eq 6>
		<a href="#request.self#?fuseaction=objects.popup_download_file&file_name=#attributes.output_file#"><i class="catalyst-cloud-download"></i></a>
