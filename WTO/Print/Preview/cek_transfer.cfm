...
<table width="650" border="0" cellspacing="0" cellpadding="0">
    <tr> 
		...
		<cfoutput query="CHECK">
            ...
            #address#<br/>
            <b><cf_get_lang dictionary_id='63896.Telefon'>: </b> (#tel_code#) - #tel#  #tel2#  #tel3# #tel4# <br/>
            <b><cf_get_lang dictionary_id='57488.Fax'>: </b> #fax# <br/>
            <b><cf_get_lang dictionary_id='58762.Vergi Dairesi'> : </b> #TAX_OFFICE# <b><cf_get_lang dictionary_id='57487.No'> : </b> #TAX_NO#<br/>
            #web# - #email#
        </cfoutput>
        </td>
    </tr>
...
<table width="100%" height="30">
    <tr>
       <td style="height:6mm;" align="center"><strong><cf_get_lang dictionary_id='64037.Çek Transfer Bordrosu'></strong></td>
    </tr>
</table>
<table width="650" border="0">
    <tr>
    	<td style="text-align:left;">
        	<strong><cf_get_lang dictionary_id='50200.Kasasından'> : </strong>
            <cfloop query="GET_TO_CASHES">
				<cfif cash_id eq get_action_detail.payroll_cash_id>#CASH_NAME#</cfif>
            </cfloop>
        </td>
        <td style="text-align:right;"><strong><cf_get_lang dictionary_id='57742.Tarih'></strong> :#dateformat(get_action_detail.PAYROLL_REVENUE_DATE,dateformat_style)#</td>
    </tr>
    <tr>
    	<td style="text-align:left;">
        	<strong><cf_get_lang dictionary_id='50216.Kasasına'> : </strong>
            <cfloop query="GET_TO_CASHES">
...
<table width="650">
    <tr class="txtbold">
		<td><cf_get_lang dictionary_id='54490.Çek No'></td>
        ...
        <tr>
            <td style="text-align:left;">
                <table>
                    ...
                    <tr>
                        <td style="height:5mm;"><strong><cf_get_lang dictionary_id='33212.Toplam Çek Sayısı'></strong></td>
                        <td><strong>:</strong>&nbsp;&nbsp;&nbsp;#GET_CHEQUE_HISTORY.KAYIT#</td>
                    </tr>
                    <tr>
                        <td style="height:5mm;"><strong><cf_get_lang dictionary_id='57861.Ortalama Vade'></strong></td>
            ...
            <td style="text-align:right;">
                <table border="0">
                	<tr>
                    	<td style="text-align:left; width:20mm;"><strong><cf_get_lang dictionary_id='57492.Toplam'> #session.ep.money#</strong></td>
                    ...
                    <tr>
                        <cfif listlen(list_birim) eq 1 and list_birim neq session.ep.money>
                            <td style="text-align:left; width:20mm;"><strong><cf_get_lang dictionary_id='57492.Toplam'> #get_cheque_detail.CURRENCY_ID#</strong></td>
