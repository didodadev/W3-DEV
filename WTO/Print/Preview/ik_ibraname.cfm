...
<table width="650" align="center" height="35">
  <tr>
	...
	<span class="headbold">#branch_fullname#</span><br/><br/>
	#ADDRESS#
	</cfoutput>
	</td>
  </tr>
...
<table width="650" align="center">
  <tr>
	...
	işyerinden 
	<strong>
	<cfif get_in_out.explanation_id eq -1>Giriş
	<cfelseif get_in_out.explanation_id eq 0>Tanımsız
	<cfelseif get_in_out.explanation_id eq 1>(4857 29)Toplu İşçi Çıkarma<!--- 12 --->
	<cfelseif get_in_out.explanation_id eq 2>(4857 17)Bildirimli Fesih İşçi Tarafından<!--- 13 --->
	<cfelseif get_in_out.explanation_id eq 26>(4857 17)Bildirimli Fesih İşveren Tarafından<!--- 12 --->
	<cfelseif get_in_out.explanation_id eq 27>Belirli Süreli Sözleşmenin Bitimi<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 21>(4857 15)Deneme Süresi İçinde İşçi Tarafından<!--- 1 --->
	<cfelseif get_in_out.explanation_id eq 25>(4857 15)Deneme Süresi İçinde İşveren Tarafından<!--- 2 --->
	<!--- <option value="16">(4857 17)İstifa ---><!--- 13 ---><!--- bu satır kalksın dedi M. bey (2. option ile aynı imiş) ---><!--- </option> --->
	<cfelseif get_in_out.explanation_id eq 6>(1475 14)Askerlik<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 7>(1475 14)Evlenme<!--- 10 --->
	<cfelseif get_in_out.explanation_id eq 3>(1475 14)Malülen Emeklilik<!--- 9 --->
	<cfelseif get_in_out.explanation_id eq 4>(1475 14)Normal Emeklilik<!--- 9 --->
	<cfelseif get_in_out.explanation_id eq 5>(1475 14)Ölüm<!--- 7 --->
	<cfelseif get_in_out.explanation_id eq 14>(4857 24-1)Sağlık Nedeni İle<!--- 4 --->
	<cfelseif get_in_out.explanation_id eq 9>(4857 25-1)Sağlık Nedeni İle<!--- 3 --->
	<cfelseif get_in_out.explanation_id eq 10>(4857 24-2)İşverenin Ahlak ve İyi Niyetine Aykırı Hareketi<!--- 4 --->
	<cfelseif get_in_out.explanation_id eq 8>(4857 16)İşe Ara Verme(Zorunlu Nedenler)<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 13>(4857 17)İşe Ara Verme(Zorunlu Nedenler)<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 15>(4857 25-2)İşçinin Ahlak ve İyi Niyet Kurallarına Aykırı Hareketi<!--- 3 --->
	<cfelseif get_in_out.explanation_id eq 11>(4857 25-2)Disiplin Kurulu Kararı İle Fesih<!--- 3 --->
	<cfelseif get_in_out.explanation_id eq 12>(4857 25-2)Devamsızlık<!--- 3 --->
	<cfelseif get_in_out.explanation_id eq 17>İşin Sona Ermesi<!--- 12 --->
	<cfelseif get_in_out.explanation_id eq 18>Nakil<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 19>İşyerinin Kapanması<!--- 12 --->
	<cfelseif get_in_out.explanation_id eq 20>Vize Süresinin Bitimi<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 22>Mevsim Bitimi<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 23>Kampanya Bitimi<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 31>İş Sözleşmesinin Haklı Nedenlerle İşverence Feshi<!--- 11 --->
	<cfelseif get_in_out.explanation_id eq 24>Statü Değişikliği(Memur Sözleşmeli)<!--- 11 --->
	</cfif>
	...
	ettiğimi beyan eder <strong>#get_branch.branch_fullname#</strong> 'yi tam bir şekilde ibra eylerim.
	</cfoutput></td>
  </tr>
</table>
<br/><br/>
