	  ...
	  <tr class="color-list">
		<td>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="20">
			  <td class="txtboldblue"><cf_get_lang_main no='583.Bölüm'> #get_quiz_chapters.currentrow#: #chapter# </td>
			</tr>
      ...
      <table border="0">
        <tr class="color-list" align="center">
          ...
          <cfif get_quiz_chapters.ANSWER_NUMBER neq 0>
			...
			<cfif get_quiz_info.form_open_type neq 2><td class="txtbold"><cf_get_lang_main no='2112.Ortak Degerlendirme'></td></cfif>
			</cfif>
        </tr>
        <!--- Sorular basliyor --->
        <cfloop query="get_quiz_questions">
          ...
          <cfloop from="1" to="20" index="i">
            <cfif len(evaluate("get_quiz_questions.answer#i#_photo")) or len(evaluate("get_quiz_questions.answer#i#_text"))>
              <tr class="color-list">
	            <td align="center"><cf_get_lang no="785.Gözlemlenemedi"></td>
                <td>
					<cfloop query="GET_EMP_QUIZ_ANSWERS">
...
<tr height="20" class="color-row">
  <td><cf_get_lang no='745.Kayıtlı Bölüm Bulunamadı!'></td>
				...
				<tr class="color-list" height="22">
                  <td height="22" class="txtboldblue"><cf_get_lang no='1630.Genel Görüşler'></td>
                </tr>
                <tr>
                  <td class="color-row">
                    <table>
					  ...
					  <cfif get_perf_detail.manager_3_emp_id neq session.ep.userid>
					  <tr>
                        <td><cf_get_lang no='1226.İkinci Değerlendirme Yöneticisinin Görüş ve Düşünceleri'></td>
                      </tr>
                      <tr>
                ...
                <tr class="color-header" height="22">
                  <td valign="top" class="color-row">
                    <table width="320">
					  <tr>
                        <td><cf_get_lang_main no='364.Kişinin Aldığı Puan / Toplam Puan'></td>
                        <td>
					...
					<td>
						<table width="320">
							<tr>
								...
								<td><strong>2.<cf_get_lang_main no='1869.Amir'></strong><br/><cf_get_lang_main no='1545.İmza'></td>
							</tr>
							<tr height="25">
								<td></td>
							</tr>
