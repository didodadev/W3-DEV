...
<cfquery name="CONTROL" datasource="#DSN2#">
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td  height="35" class="headbold"><cf_get_lang dictionary_id='54611.Şube Finansal Günlük Durum Raporu'>(#get_daily_store_report.branch_name#)</td>
      <td  style="text-align:right;"><cf_get_lang dictionary_id='30631.Tarih'> :#dateformat(get_daily_store_report.store_report_date,dateformat_style)#
	  <!--- sil 
...
<table cellspacing="0" cellpadding="0" style="width:190mm;" border="0" align="center" bordercolor="#000000">
  <tr bgcolor="#FFFFFF">
    <td colspan="9" class="headbold"><cf_get_lang dictionary_id='58657.Kasalar'></td>
  </tr>
  <tr height="25" bgcolor="#FFFFFF">
    <td class="txtboldblue"><cf_get_lang dictionary_id='54574.Kasa No'></td>
    <td class="txtboldblue"><cf_get_lang dictionary_id='54577.Kasiyer'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='54585.Nakit Satış'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='54586.Kredili Satış'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='37285.Toplam Satış'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='58438.Z Raporu'></td>
    <td class="txtboldblue">&nbsp;<cf_get_lang dictionary_id='54597.Z No'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='58717.Açık'></td>
  </tr>
   <cfscript>
		toplam_1=0;
		toplam_2=0;
  ...
  <cfoutput>
    <tr height="16" bgcolor="##FFFFFF">
      <td class="txtboldblue" colspan="2"><cf_get_lang dictionary_id='57492.Toplam'></td>
...
<table cellspacing="0" cellpadding="0" width="98%" border="1" bordercolor="#000000" align="center">
      ...
      <tr height="22" bgcolor="#FFFFFF">
        <td class="txtboldblue"><cf_get_lang dictionary_id='57521.Banka'></td>
...
<table cellspacing="0" cellpadding="0" width="98%" border="1" bordercolor="#000000" align="center">
  ...
  <tr height="22" bgcolor="#FFFFFF">
    ...
    <td class="txtboldblue" width="120"><cf_get_lang dictionary_id='36199.Açıklama'></td>
    <td  class="txtboldblue" style="text-align:right;"><cf_get_lang dictionary_id='57673.Tutar'></td>
...
<table cellspacing="0" cellpadding="0" width="98%" border="1" bordercolor="##000000" align="center">
        <tr height="20" bgcolor="##FFFFFF">
          <td class="headbold" colspan="2">#session.ep.money# <cf_get_lang dictionary_id='58052.Özet'></td>
          <td width="100"><cf_get_lang dictionary_id='54604.Dünden Kalan'></td>
          <td width="251"  style="text-align:right;">#tlformat(toplam_devreden_in)# #session.ep.money#</td>
          <td rowspan="7" valign="top" width="64"><cf_get_lang dictionary_id='57810.Ek Bilgi'></td>
          <td width="480" rowspan="7" valign="top">&nbsp;<cfif len(get_daily_store_report.detail)>#get_daily_store_report.detail#</cfif></td>
        </tr>
       <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td width="100"><cf_get_lang dictionary_id='50245.Alışveriş Çekleri'></td>
          <td width="251"  style="text-align:right;">#tlformat(cek_toplam)# #session.ep.money#</td>
        </tr>
	    <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td width="100"><cf_get_lang dictionary_id='56929.Nakit Satış'></td>
          <td width="251"  style="text-align:right;">#tlformat(toplam_1)# #session.ep.money#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='54586.Kredili Satış'></td>
          <td  style="text-align:right;">#tlformat(toplam_2)# #session.ep.money#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='37285.Toplam Satış'></td>
          <td  style="text-align:right;">#tlformat(toplam_3)# #session.ep.money#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='58658.Ödemeler'></td>
          <td  style="text-align:right;">#tlformat(toplam_expense_1)# #session.ep.money#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='58089.Gelirler'></td>
          <td  style="text-align:right;">#tlformat(income_toplam_expense_1)# #session.ep.money#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='54609.Kasa Açıkları'></td>
          <td  style="text-align:right;">#tlformat(toplam_5)# #session.ep.money#</td>
		  <td><cf_get_lang dictionary_id='54606.Düzenleyen'></td>
          <td>&nbsp;#get_emp_info(get_daily_store_report.report_order_emp,0,0)#</td>
        </tr>
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='54607.Bankaya Yatan'></td>
          <td  style="text-align:right;">#tlformat(get_daily_store_report.bankaya_yatan)# #session.ep.money#</td>
            <td><cf_get_lang dictionary_id='30982.Onaylayan'></td>
        ...
        <tr height="20" bgcolor="##FFFFFF">
          <td colspan="2">&nbsp;</td>
          <td><cf_get_lang dictionary_id='58034.Devreden'></td>
