...
<cfloop array="#wocArrayList#" index="i">
	...
	<cfquery name="get_emp_kidem_dahil_odeneks" datasource="#dsn#">
		SELECT
			...
			EMPLOYEES_PUANTAJ_ROWS_EXT.GELIR_VERGISI,
			EMPLOYEES_PUANTAJ_ROWS_EXT.DAMGA_VERGISI,
	...
	<cfset GV_EXT = 0>
	<cfset DV_EXT = 0>
	<cfset AMOUNT_PAY_EXT = 0>
	<cfoutput query="get_emp_kidem_dahil_odeneks">
		<cfif AMOUNT_2 EQ 0><!--- ARTI --->
			<cfset TEMP_AVG = TEMP_AVG + AMOUNT>
			<cfset GV_EXT = GV_EXT + GELIR_VERGISI>
			<cfset DV_EXT = DV_EXT + DAMGA_VERGISI>
			<cfset AMOUNT_PAY_EXT = AMOUNT_PAY_EXT + AMOUNT_PAY>
		<cfelse><!--- YÜZDE --->
...
<table  style="width:210mm">
	...
	<table class="print_border">
		...
		<tr style="text-align:right;">
			...
			<td>#tlformat(get_puantaj_row.kidem_amount - get_puantaj_row.kidem_amount_damga_vergisi)#</td>
		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='53864.İzin Ücreti'></td>
			<td><cfif get_puantaj_row.yillik_izin_amount gt 0>#tlformat(get_puantaj_row.yillik_izin_amount)#<cfelse>-</cfif></td>
			<td><cfif get_puantaj_row.ssk_statute eq 2>#tlformat(get_puantaj_row.yillik_izin_amount-(gvm_izin-get_puantaj_row.yillik_izin_amount_ssk_isci_issizlik))#<cfelse>#tlformat(get_puantaj_row.yillik_izin_amount_ssk_isci_hissesi + get_puantaj_row.yillik_izin_amount_ssk_isci_issizlik)#</cfif></td>
			...
			<td><cfif get_puantaj_row.yillik_izin_amount gt 0>#tlformat(get_puantaj_row.yillik_izin_amount_gelir_vergisi)#<cfelse>-</cfif></td>
			<td><cfif get_puantaj_row.yillik_izin_amount gt 0>#tlformat(get_puantaj_row.yillik_izin_amount_gelir_vergisi)#<cfelse>-</cfif></td>
			<td><cfif get_puantaj_row.yillik_izin_amount gt 0>#tlformat(get_puantaj_row.yillik_izin_amount_damga_vergisi)#<cfelse>-</cfif></td>
			...
			<td><cfif get_puantaj_row.yillik_izin_amount gt 0>#tlformat(yillik_izin_amount_net_)#<cfelse>-</cfif></td>
		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='55752.İhbar Tazminatı'></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#tlformat(get_puantaj_row.ihbar_amount)#<cfelse>-</cfif></td>
			<td><cf_get_lang dictionary_id='55626.Muaf'></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#tlformat(gvm_ihbar)#<cfelse>-</cfif></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#tlformat(kumulatif_gelir+gvm_ihbar)#<cfelse>-</cfif></td>
			<td ><cfif get_in_out.ihbar_amount gt 0>#TLFormat(get_in_out.ihbar_amount * get_puantaj_row.TAX_RATIO)#<cfelse>-</cfif></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#TLFormat(get_puantaj_row.ihbar_amount_gelir_vergisi)#<cfelse>-</cfif></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#tlformat(get_puantaj_row.ihbar_amount_damga_vergisi)#<cfelse>-</cfif></td>
			<td><cfif get_in_out.ihbar_amount gt 0>#TLFormat(get_puantaj_row.ihbar_amount - get_puantaj_row.ihbar_amount_gelir_vergisi - get_puantaj_row.ihbar_amount_damga_vergisi)#<cfelse>-</cfif></td>
		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='55724.Fazla Mesai'></td>
			<td><cfif len(get_puantaj_row.ext_salary)>#TLFormat(get_puantaj_row.ext_salary)#</cfif></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td><cfif len(get_puantaj_row.ext_salary)>#TLFormat(get_puantaj_row.ext_salary - get_puantaj_row.ext_salary_net - (get_puantaj_row.ext_salary*get_program_parameters.stamp_tax_binde / 1000))#</cfif></td>
			<td><cfif len(get_puantaj_row.ext_salary)>#TLFormat(get_puantaj_row.ext_salary*get_program_parameters.stamp_tax_binde / 1000)#</cfif></td>
			<td><cfif len(get_puantaj_row.ext_salary)>#TLFormat(get_puantaj_row.ext_salary_net)#</cfif></td>

		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='38997.Ek Kazanç'></td>
			<td>#tlformat(TEMP_AVG)#</td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td>#tlformat(GV_EXT)#</td>
			<td>#tlformat(DV_EXT)#</td>
			<td>#tlformat(TEMP_AVG-GV_EXT-DV_EXT)#</td>

		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='59399.Özel Kesintiler'></td>
			<td><cfif get_puantaj_row.OZEL_KESINTI_2>#tlformat(get_puantaj_row.OZEL_KESINTI_2)#</cfif></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td><cfif len(get_puantaj_row.OZEL_KESINTI) or get_puantaj_row.OZEL_KESINTI_2>#tlformat(get_puantaj_row.OZEL_KESINTI+get_puantaj_row.OZEL_KESINTI_2_net)#</cfif></td>
		</tr>
		<tr style="text-align:right;">
			<td class="txtbold"><cf_get_lang dictionary_id='57492.Toplam'></td>
			...
			<td><cfif get_in_out.kidem_amount + get_in_out.ihbar_amount + get_puantaj_row.yillik_izin_amount gt 0>#tlformat(kumulatif_gelir+gvm_izin+gvm_ihbar)#<cfelse>0</cfif></td>
			<td>#TLFormat((get_in_out.ihbar_amount * get_puantaj_row.TAX_RATIO)+get_puantaj_row.yillik_izin_amount_gelir_vergisi)#</td>
			<td>#tlformat(get_puantaj_row.yillik_izin_amount_gelir_vergisi + get_puantaj_row.ihbar_amount_gelir_vergisi + (get_puantaj_row.ext_salary - get_puantaj_row.ext_salary_net - (get_puantaj_row.ext_salary*get_program_parameters.stamp_tax_binde / 1000)))#</td>
			<td>#tlformat(get_puantaj_row.yillik_izin_amount_damga_vergisi + get_puantaj_row.ihbar_amount_damga_vergisi + get_puantaj_row.kidem_amount_damga_vergisi + (get_puantaj_row.ext_salary*get_program_parameters.stamp_tax_binde / 1000))#</td>
			<td>#tlformat(yillik_izin_amount_net_ + (get_puantaj_row.ihbar_amount - get_puantaj_row.ihbar_amount_gelir_vergisi - get_puantaj_row.ihbar_amount_damga_vergisi) + get_puantaj_row.kidem_amount_net + get_puantaj_row.ext_salary_net)#</td>
		</tr>
		<tr>
