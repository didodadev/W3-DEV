...
<br/><br/>
<table align="center" style="width:60mm;height:70mm">
	...
	<cfif GET_PROPERTY.recordcount>
			<tr>
				...
				<table width="100%">
					<tr>
						<td width="80" style="font-size:8px;font-weight:bold" bgcolor="999999"><cf_get_lang_main no='220.Özellik'></td>
						<td style="font-size:8px;font-weight:bold" bgcolor="999999"><cf_get_lang_main no='217.Açıklama'></td>
					</tr>
					<cfoutput query="GET_PROPERTY" maxrows="15">
