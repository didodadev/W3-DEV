<!--- Arac Islem Baski Coklu --->
<cfsetting showdebugoutput="no">
<cfquery name="GET_REQUEST" datasource="#DSN#">
	SELECT * FROM ASSET_P_REQUEST_ROWS WHERE ASSET_P_REQUEST_ROWS.REQUEST_ROW_ID = #attributes.action_id#
</cfquery>
<cfif attributes.action_type eq 0><!--- satis --->
	...
	SELECT
		...
		PROCESS_TYPE_ROWS
	WHERE
		ASSET_P_REQUEST_ROWS.REQUEST_ID = #get_request.request_id# AND
		...
		<tr class="color-row">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="40" class="txtbold"><cf_get_lang no="908.Talep No">: #get_request_rows.request_id#</td>
							<td width="160" class="headbold"><cf_get_lang_main no='1068.ARAÇ'> <cf_get_lang_main no='280.İŞLEM'> <cf_get_lang no='956.FORMU'></td>
						</tr>
					</table><hr>
					<table width="100%">
						<tr>
						...
						<tr>
							...
							<td>: <cf_get_lang no="836.Satış Talebi"></td>
						</tr>
						<tr>
							<td colspan="4"></td>
						</tr>
		...
		<tr class="color-row">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="30" class="txtbold"><cf_get_lang no="908.Talep No">: #get_request_rows.request_id#</td>
							<td width="160" class="headbold"><cf_get_lang_main no='1068.ARAÇ'> <cf_get_lang_main no='280.İŞLEM'> <cf_get_lang no='956.FORMU'></td>
						</tr>
					</table><hr><br/>
					<table width="100%">
				...
				<tr>
					...
					<table width="100%">
						<tr class="txtbold">
							...
							<td><cf_get_lang_main no='1435.Marka'> / <cf_get_lang_main no="2244.Marka Tipi"></td>
							<td><cf_get_lang_main no='813.Model'></td>
							<td><cf_get_lang no="909.Pert Plaka"></td>
						</tr>
						<cfloop query="GET_REQUEST_ROWS">
						<tr>
							<td>
							...
							<table border="0" style="width:180mm" cellspacing="0" cellpadding="0">
								<tr>
									...
									<!--- <td width="130">
											...
											</td> <!--- Hedefdeki Genel Mudur karmasikligindan dolayi --->--->
								</tr>
							</table>
							</td>
						</tr>
