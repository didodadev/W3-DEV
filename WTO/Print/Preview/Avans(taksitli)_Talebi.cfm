							...
							<cfif len(CHECK.ASSET_FILE_NAME2)>
								...
								<table border="0" bordercolorlight="000000" cellspacing="0" cellpadding="0" width="100%">
									...
									<tr style="height:7mm">
										...
										<cfif attributes.iid eq 1><cf_get_lang dictionary_id='31574.Taksitli Avans Talebi'>
										<cfelseif attributes.iid eq 0><cf_get_lang dictionary_id='53503.Avans Talebi'></cfif>
									</td>
									</tr>
								</table>
							</cfif>
				...
				<tr style="height:86mm">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<table border="0" bordercolorlight="000000" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='51081.Talep Eden'></td>
									<td style="width:110mm">: #get_emp_info(get_payment_request.record_emp,0,0)#</td>
								</tr>
								<tr>
									<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='57742.Tarih'></td>
								...
								<tr>
									...
									<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='58516.Ödeme Yöntemi'></td>
									<td>: #PAY_METHODS.paymethod#</td>
								</tr>
								</cfif>
								<tr>
									<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='57673.Tutar'></td>
								...
								<cfif attributes.iid eq 1>
									<tr>
										<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='54816.Taksit Sayısı'></td>
									...
									<tr>
										<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='57153.Taksit'> <cf_get_lang dictionary_id='63411.Miktarı'></td>
										<td>: #TLformat(get_payment_request.amount_get/get_payment_request.taksit_number)# TL</td>
									</tr>
								</cfif>
								<tr>
									<td style="height:8mm;width:25mm" class="minik_yazi_"><cf_get_lang dictionary_id='57629.Açıklama'></td>
						...
						<tr style="height:50mm">
							...
							<table border="0" width="100%" height="100%">
								<tr style="height:7mm">
									<td class="minik_yazi_"><u><cf_get_lang dictionary_id='51081.Talep Eden'></u></td>
									<td class="minik_yazi_"><u>1.<cf_get_lang dictionary_id='57500.Onay'></u></td>
									<td class="minik_yazi_"><u>2.<cf_get_lang dictionary_id='57500.Onay'></u></td>
								</tr>
							</table>
							</td>
						</tr>						
