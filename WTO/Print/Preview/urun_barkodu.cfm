				...
				<cfif (sayac mod 3) eq 1>
					...
					<td valign="top">
						<table cellpadding="0" cellspacing="0" style="width:55mm;height:24mm;border:0px solid ##000000;">
							<tr>
								<td align="center">
									<table cellpadding="0" cellspacing="0" style="width:55mm;height:23mm;" border="2" bordercolor="##FFFFFF">
										<tr align="center">
											<td style="font-size:14px;font-family:arial; text-align:center;">
												#product_name#<br/>
												<CF_BarcodeGenerator BarCode="#get_product_detail.BARCODE#" BarCodeType="9" ThickWidth="5" ThinWidth="#0.08 * (10 / 3.14)#" Height="45">
											</td>
										</tr>
									</table>
								</td>
...
<cfelse>
	<script language="JavaScript">
		alert("Gönderilen Veriler Ile Bu Sablon Kullanilamaz !");
		history.back();
	</script>
	<cfabort> 
</cfif>
