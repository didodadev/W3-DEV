...
<cfif isDefined('Get_Comp.Borc') and len(Get_Comp.Borc)><cfset BORC = Get_Comp.Borc><cfelse><cfset BORC = 0></cfif>
<cfif isDefined('Get_Comp.Alacak') and len(Get_Comp.Alacak)><cfset ALACAK = Get_Comp.Alacak><cfelse><cfset ALACAK = 0></cfif>
<!--- uye bilgileri --->
<cfset member_name = "">
<cfset member_code = "">
...
<cfif not isDefined('get_comp.recordcount')>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <cfoutput>
                            ...
                            <cf_get_lang dictionary_id='58762.Vergi Dairesi'>: #member_taxoffice# - <cf_get_lang dictionary_id='57752.Vergi No'> : #member_taxno#<br>
							<cf_get_lang dictionary_id='57499.Telefon'> : #member_phone# - <cf_get_lang dictionary_id='57488.Fax'> : #member_fax#
                        </cfoutput><br>
                        </td>
                    </tr>
                </table>
