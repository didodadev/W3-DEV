            ...
            <cfoutput>
                ...
                <tr>
                    <td colspan="3">Yukarıda bilgileri belirtilen <b>#get_emp_short_info.EMPLOYEE_NAME# #get_emp_short_info.EMPLOYEE_SURNAME#</b>
                            <b>#dateformat(get_emp_short_info.KIDEM_DATE,dateformat_style)#</b> tarihinden beri kurumumuzda çalışmaktadır.
                    </td>
                </tr>
                <tr>
                    <td style="text-align:justify;" colspan="3">İş bu belge 4857 sayılı kanunun 28'nci maddesine göre düzenlenmiştir ve maaşında haciz yoktur.</td>
                </tr>
                <tr>
                    <td height="50px;"></td>
                </tr>
