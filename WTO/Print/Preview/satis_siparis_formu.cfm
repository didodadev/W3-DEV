...
<!---<cfif not isdefined("attributes.action_id")><!--- Toplu Printte gelmesin diye eklendi --->
	<b><cf_get_lang dictionary_id="865.Seçmiş Olduğunuz Şablon Bu İşlem İçin Uygun Değil">!
...
<!--- Baska sayfalardan include edildiginde sorun olmamasi adina eklendi fbs20130412 --->
...
</cfif><cfif isdefined("Get_Order.Company_Id") and Len(Get_Order.Company_Id)>
...
<cfif isdefined("Get_Upper_Position") and Len(Get_Upper_Position.UPPER_POSITION_CODE)>
                        ...
                        <td class="print-head">
                            ...
                            <!---<tr>
                                ...
                                <td style="text-align:right;">
                                    ...
                                    <b><cf_get_lang dictionary_id='57499.Telefon'></b>: #Our_Company.tel_code# #Our_Company.tel#<br/>
                                    <b><cf_get_lang dictionary_id='57488.Fax'></b>: #Our_Company.tel_code# #Our_Company.fax#<br/>
                                    #Our_Company.web#&nbsp;&nbsp;#Our_Company.email#
                                </td>
                            </tr> --->
                                <tr>
                                    <cfif ( isdefined("action") and action is "sales.list_order" ) or isDefined("attributes.action_type") and attributes.action_type eq 'order_id' >
                                        <td class="print_title"><cf_get_lang dictionary_id='58207.SATIŞ SİPARİŞ"'></td>
                                    <cfelseif isdefined("action") and action is "sales.list_order_instalment">
                                        <td class="print_title"><cf_get_lang dictionary_id='58208.TAKSİTLİ SATIŞLAR"'></td>
                                    </cfif>
                                    <td style="text-align:right;">
                ...
                <tr class="row_border">
                    <td> 
                        ...
                        <table  style="width:140mm">
                            <tr> <td><b><cf_get_lang dictionary_id='57880.Belge No'></b></td>
                                <td>#ORDER_NUMBER#</td>
                                <td><b><cf_get_lang dictionary_id='29501.Sipariş Tarihi'></b></td>
                                    <td>#DateFormat(Get_Order.order_date,dateformat_style)#</td>
                            </tr>
                            <tr>
                            ...
                            <!---    <td style="width:100px;"valign=""><b><cf_get_lang dictionary_id='58723.Adres'></b></td> --->
                            </tr>
                            <tr>
                            ...
                            <table width="100%" style="height:35px;">
                                <tr>
                                    <td style="width:100px;"><b><cf_get_lang dictionary_id='58723.Adres'></b></td>
                                    <td >#get_order.Ship_Address#</td>
                                </tr> 
                            </table>
                        </table>
                    </td>
                    ...
                    <table  class="print_border"  style="width:180mm">
                        <tr>
                            <th><b><cf_get_lang dictionary_id='58585.KOD'></b></td>
                            <th style="width:130px"><b><cf_get_lang dictionary_id='38019.ürün ismi'></b></td>
                            ...
                            <th><b><cf_get_lang dictionary_id='33304.Vergi'></b></th> 
                            <th><b><cf_get_lang dictionary_id='57673.Tutar'></b></th>
                        <!---    <th style="width:100px"><b><cf_get_lang dictionary_id='57492.Toplam'></b></td> --->
                        </tr>
                    ...
                    <table class="print_border" style="width:140mm" >
                        <cfif i eq Page_Count>
                                <tr>  <th style="width:100px"><b><cf_get_lang dictionary_id='57641.İskonto'></b></th>
                                    <th style="width:100px"><b>  <cf_get_lang dictionary_id='58083.Net'></b> <b><cf_get_lang dictionary_id='58084.Fiyat'><cf_get_lang dictionary_id='58659.Tutar'></b></th>
                                
                                    <th style="width:100px"><b><cf_get_lang dictionary_id='57492.toplam'><cf_get_lang dictionary_id='33304.Vergi'></b></th> 
                                    <th style="width:100px"><b><cf_get_lang dictionary_id='29534.Toplam Tutar'></b></th>
                                <!---   <th style="width:100px"><b><cf_get_lang dictionary_id="33314.Kur Bilgisi"></th> --->
                                </tr>  
                                <td style="text-align:right;">#TLFormat(sepet_toplam_indirim)# 
                                    <cfif isdefined("session.ep")>
                                        #session.ep.money#
                                    <cfelseif isDefined("session.pp")>
                                        #session.pp.money#
                                ...
                                <td style="text-align:right;">#TLFormat(sepet_total)#
                                    <cfif isdefined("session.ep")>
                                        #session.ep.money#
                                    <cfelseif isDefined("session.pp")>
                                        #session.pp.money#
                                ...
                                <td style="text-align:right;">#TLFormat(sepet_total_tax)#
                                    <cfif isdefined("session.ep")>
                                        #session.ep.money#
                                    <cfelseif isDefined("session.pp")>
                                        #session.pp.money#
                                ...
                                <td style="text-align:right;">#TLFormat(sepet_net_total)#
                                    <cfif isdefined("session.ep")>
                                        #session.ep.money#
                                    <cfelseif isDefined("session.pp")>
                                        #session.pp.money#
                    ...
                    <table style="width:140mm">
                        <tr>
                            <td class="bold"><b><cf_get_lang dictionary_id="33306.ONAYLAR"></td>
                        </tr>
                        <tr>
                            <td style="width:50mm;" class="bold"><cf_get_lang dictionary_id='29511.YÖNETİCİ'></b><b><cf_get_lang dictionary_id='57500.ONAY'></b></td>
                            <td style="width:50mm;" class="bold"><cf_get_lang dictionary_id='29511.YÖNETİCİ'></b><b><cf_get_lang dictionary_id='57500.ONAY'></td>
                        </tr>
                        <tr>
                            <td><cfif isDefined("Get_Upper_Position") and len(Get_Upper_Position.UPPER_POSITION_CODE)>#Get_Chief1_Name.EMPLOYEE_NAME# #Get_Chief1_Name.EMPLOYEE_SURNAME#</cfif></td>
                            <td>&nbsp;</td>
                        </tr>
                    </table> 
                    <table>
