		...
		<cfquery name="get_bank_branch" datasource="#dsn3#" maxrows="#arguments.maxrows#">
			...
			WHERE
				...
				<cfif isDefined("arguments.keyword") and len(arguments.keyword)>
					AND BANK_BRANCH_NAME LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#arguments.keyword#%">
				</cfif>
				<cfif isDefined("arguments.bank_name") and len(arguments.bank_name)>
					AND BANK_NAME LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#arguments.bank_name#%">
				</cfif>
		</cfquery>
	<cfelse>
