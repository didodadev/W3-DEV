...
function get_wrk_message_div(message_header,message_body,file)
{
	if(arguments[2]!=null)
	{
		...
		document.getElementById("messageDiv").style.zIndex = 99999;
		goster(messageDiv);
		...
		document.getElementById("messageDivBody").innerHTML = '<br />'+file_type_download+':'; // file_type_download:special_functions'ın içinden geliyor. Dosya Türü yazısını getirmektedir.Genel bir kelime olduğu için farklı farklı alanlardan çağrılabilir.
		document.getElementById("messageDivBody").innerHTML += '<b>' + message_body + '</b><br /><br />';
		document.getElementById("messageDivBody").innerHTML += '<a href="' + file + '" target="'+ target +'" onclick="gizle(messageDiv);" class="tableyazi"><img src="/images/digital_asset.png" border="0" title="'+message_header+'" /></a>';
		document.getElementById('messageDivBody').innerHTML += '<a href="javascript://" onclick="open_save_popup(\''+ file +'\');" class="tableyazi"><img src="/images/digital_asset_save.png" width="45" height="45" border="0" title="'+save_to_my_computer+'"></a>';
